    ...
    public:
        ...
        bool findMinCuts() {
            ...
            while (!active.empty()) {
                ...
                if (isHypernode(u)) {
                    work_since_last_global_relabel += dischargeHypernode(u);
                } else if (isOutNode(u)) {
                    work_since_last_global_relabel += dischargeOutNode(u);
                } else {
                    work_since_last_global_relabel += dischargeInNode(u);
                }
            }
            LOGGER << V(flow_value);
