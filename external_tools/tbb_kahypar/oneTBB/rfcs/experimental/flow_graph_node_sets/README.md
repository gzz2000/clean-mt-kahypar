...
For example in the following code, the use of `tbb_kahypar::flow::precedes(n2, n3)` causes two edges
...
```cpp
  int main()
  {
      ...
      tbb_kahypar::flow::function_node<int,int> n2{ g, 1,
          [](int msg) {
              std::printf("2:%d\n", msg);
              return msg;
          } };

      tbb_kahypar::flow::function_node<int,int> n3(g, 1,
          [](int msg) {
              std::printf("3:%d\n", msg);
              return msg;
          });

      using mfn_t = tbb_kahypar::flow::multifunction_node<int, std::tuple<int, int> >;
      mfn_t n1(tbb_kahypar::flow::precedes(n2, n3), 1,
