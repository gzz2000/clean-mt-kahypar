...
public:
    ...
    static TextSlice* allocate(std::size_t max_size) {
        ...
        TextSlice* t = (TextSlice*)oneapi::tbb_kahypar::tbb_allocator<char>().allocate(sizeof(TextSlice) +
                                                                               max_size + 1);
    ...
    void free() {
        oneapi::tbb_kahypar::tbb_allocator<char>().deallocate(
...
int run_pipeline(int nthreads) {
    ...
    oneapi::tbb_kahypar::parallel_pipeline(
        nthreads * 4,
        oneapi::tbb_kahypar::make_filter<void, TextSlice*>(oneapi::tbb_kahypar::filter_mode::serial_in_order,
                                                   MyInputFunc(input_file)) &
            oneapi::tbb_kahypar::make_filter<TextSlice*, TextSlice*>(oneapi::tbb_kahypar::filter_mode::parallel,
                                                             MyTransformFunc()) &
            oneapi::tbb_kahypar::make_filter<TextSlice*, void>(oneapi::tbb_kahypar::filter_mode::serial_in_order,
...
int main(int argc, char* argv[]) {
    oneapi::tbb_kahypar::tick_count mainStartTime = oneapi::tbb_kahypar::tick_count::now();
    ...
    utility::report_elapsed_time((oneapi::tbb_kahypar::tick_count::now() - mainStartTime).seconds());
