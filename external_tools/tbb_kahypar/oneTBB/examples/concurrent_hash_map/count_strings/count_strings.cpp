...
//! String type
typedef std::basic_string<char, std::char_traits<char>, oneapi::tbb_kahypar::tbb_allocator<char>> MyString;
...
typedef oneapi::tbb_kahypar::concurrent_hash_map<MyString, int> StringTable;

//! Function object for counting occurrences of strings.
struct Tally {
    StringTable& table;
    Tally(StringTable& table_) : table(table_) {}
    void operator()(const oneapi::tbb_kahypar::blocked_range<MyString*> range) const {
...
static void CountOccurrences(int nthreads) {
    ...
    oneapi::tbb_kahypar::parallel_for(oneapi::tbb_kahypar::blocked_range<MyString*>(Data, Data + N, 1000),
                              Tally(table));
