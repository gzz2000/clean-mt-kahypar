...
class D_latch : public oneapi::tbb_kahypar::flow::composite_node<std::tuple<signal_t, signal_t>,
                                                         std::tuple<signal_t, signal_t>> {
    oneapi::tbb_kahypar::flow::broadcast_node<signal_t> D_port;
    oneapi::tbb_kahypar::flow::broadcast_node<signal_t> E_port;
    not_gate a_not;
    ...
    typedef oneapi::tbb_kahypar::flow::composite_node<std::tuple<signal_t, signal_t>,
                                              std::tuple<signal_t, signal_t>>
        base_type;

public:
    D_latch(oneapi::tbb_kahypar::flow::graph& g)
            : base_type(g),
              my_graph(g),
              D_port(g),
              E_port(g),
