...
using oneapi::tbb_kahypar::flow::make_edge;
using oneapi::tbb_kahypar::flow::cast_to;
using oneapi::tbb_kahypar::flow::input_port;
using oneapi::tbb_kahypar::flow::output_port;
...
template <>
class gate<1>
        : public oneapi::tbb_kahypar::flow::composite_node<std::tuple<signal_t>, std::tuple<signal_t>> {
protected:
    typedef oneapi::tbb_kahypar::flow::indexer_node<signal_t> input_port_t;
    typedef oneapi::tbb_kahypar::flow::multifunction_node<input_port_t::output_type, std::tuple<signal_t>>
        gate_fn_t;
    typedef gate_fn_t::output_ports_type ports_type;
    typedef oneapi::tbb_kahypar::flow::composite_node<std::tuple<signal_t>, std::tuple<signal_t>> base_type;

public:
    template <typename Body>
    gate(oneapi::tbb_kahypar::flow::graph& g, Body b)
            : base_type(g),
              my_graph(g),
              in_ports(g),
              gate_fn(g, 1, b) {
...
protected:
    oneapi::tbb_kahypar::flow::graph& my_graph;
...
template <>
class gate<2> : public oneapi::tbb_kahypar::flow::composite_node<std::tuple<signal_t, signal_t>,
                                                         std::tuple<signal_t>> {
protected:
    typedef oneapi::tbb_kahypar::flow::indexer_node<signal_t, signal_t> input_port_t;
    typedef oneapi::tbb_kahypar::flow::multifunction_node<input_port_t::output_type, std::tuple<signal_t>>
        gate_fn_t;
    typedef gate_fn_t::output_ports_type ports_type;
    typedef oneapi::tbb_kahypar::flow::composite_node<std::tuple<signal_t, signal_t>, std::tuple<signal_t>>
        base_type;
...
template <>
class gate<3> : public oneapi::tbb_kahypar::flow::composite_node<std::tuple<signal_t, signal_t, signal_t>,
                                                         std::tuple<signal_t>> {
protected:
    typedef oneapi::tbb_kahypar::flow::indexer_node<signal_t, signal_t, signal_t> input_port_t;
    typedef oneapi::tbb_kahypar::flow::multifunction_node<input_port_t::output_type, std::tuple<signal_t>>
        gate_fn_t;
    typedef gate_fn_t::output_ports_type ports_type;
    typedef oneapi::tbb_kahypar::flow::composite_node<std::tuple<signal_t, signal_t, signal_t>,
                                              std::tuple<signal_t>>
        base_type;
...
template <>
class gate<4> : public oneapi::tbb_kahypar::flow::composite_node<
                    std::tuple<signal_t, signal_t, signal_t, signal_t>,
                    std::tuple<signal_t>> {
protected:
    typedef oneapi::tbb_kahypar::flow::indexer_node<signal_t, signal_t, signal_t, signal_t> input_port_t;
    typedef oneapi::tbb_kahypar::flow::multifunction_node<input_port_t::output_type, std::tuple<signal_t>>
        gate_fn_t;
    typedef gate_fn_t::output_ports_type ports_type;
    typedef oneapi::tbb_kahypar::flow::composite_node<std::tuple<signal_t, signal_t, signal_t, signal_t>,
                                              std::tuple<signal_t>>
        base_type;
...
class steady_signal {
    ...
    oneapi::tbb_kahypar::flow::write_once_node<signal_t> signal_node;

public:
    steady_signal(oneapi::tbb_kahypar::flow::graph& g, signal_t v)
            : my_graph(g),
              init_signal(v),
              signal_node(g) {}
    ...
    oneapi::tbb_kahypar::flow::write_once_node<signal_t>& get_out() {
        return signal_node;
    }
    void activate() {
...
class pulse {
    ...
    public:
        ...
        signal_t operator()(oneapi::tbb_kahypar::flow_control& fc) {
            rt_sleep((int)ms);
    ...
    int reps, init_reps;
    oneapi::tbb_kahypar::flow::input_node<signal_t> clock_node;

public:
    pulse(oneapi::tbb_kahypar::flow::graph& g, std::size_t _ms = 1000, int _reps = -1)
            : my_graph(g),
              ms(_ms),
              init_ms(_ms),
              reps(_reps),
    ...
    oneapi::tbb_kahypar::flow::input_node<signal_t>& get_out() {
        return clock_node;
    }
    void activate() {
        clock_node.activate();
...
class push_button {
    oneapi::tbb_kahypar::flow::graph& my_graph;
    oneapi::tbb_kahypar::flow::overwrite_node<signal_t> push_button_node;

public:
    push_button(oneapi::tbb_kahypar::flow::graph& g) : my_graph(g), push_button_node(g) {
    ...
    oneapi::tbb_kahypar::flow::overwrite_node<signal_t>& get_out() {
...
class toggle {
    oneapi::tbb_kahypar::flow::graph& my_graph;
    signal_t state;
    oneapi::tbb_kahypar::flow::overwrite_node<signal_t> toggle_node;

public:
    toggle(oneapi::tbb_kahypar::flow::graph& g) : my_graph(g), state(undefined), toggle_node(g) {}
...
public:
    buffer(oneapi::tbb_kahypar::flow::graph& g) : gate<1>(g, buffer_body()) {}
...
public:
    not_gate(oneapi::tbb_kahypar::flow::graph& g) : gate<1>(g, not_body()) {}
...
public:
    and_gate(oneapi::tbb_kahypar::flow::graph& g) : gate<N>(g, and_body()) {}
...
public:
    or_gate(oneapi::tbb_kahypar::flow::graph& g) : gate<N>(g, or_body()) {}
...
public:
    xor_gate(oneapi::tbb_kahypar::flow::graph& g) : gate<N>(g, xor_body()) {}
...
public:
    nor_gate(oneapi::tbb_kahypar::flow::graph& g) : gate<N>(g, nor_body()) {}
...
class led {
    ...
    public:
        led_body(signal_t& s, std::string& l, bool r)
                : state(s),
                  ...
                  report_changes(r),
                  touched(false) {}
        oneapi::tbb_kahypar::flow::continue_msg operator()(signal_t b) {
            if (!touched || b != state) {
                state = b;
            ...
            return oneapi::tbb_kahypar::flow::continue_msg();
        }
    };
    oneapi::tbb_kahypar::flow::graph& my_graph;
    std::string label;
    signal_t state;
    bool report_changes;
    oneapi::tbb_kahypar::flow::function_node<signal_t, oneapi::tbb_kahypar::flow::continue_msg> led_node;

public:
    led(oneapi::tbb_kahypar::flow::graph& g, std::string l, bool rc = false)
            : my_graph(g),
              label(l),
              state(undefined),
              report_changes(rc),
    ...
    oneapi::tbb_kahypar::flow::function_node<signal_t, oneapi::tbb_kahypar::flow::continue_msg>& get_in() {
        return led_node;
    }
    void display() {
        if (state == high)
...
public:
    digit(oneapi::tbb_kahypar::flow::graph& g, std::string l, bool rc = false)
