...
class two_bit_adder : public oneapi::tbb_kahypar::flow::composite_node<
    ...
    typedef oneapi::tbb_kahypar::flow::composite_node<
        std::tuple<signal_t, signal_t, signal_t, signal_t, signal_t>,
        std::tuple<signal_t, signal_t, signal_t>>
        base_type;

public:
    two_bit_adder(oneapi::tbb_kahypar::flow::graph& g)
            : base_type(g),
              my_graph(g),
