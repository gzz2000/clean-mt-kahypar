...
class one_bit_adder
        : public oneapi::tbb_kahypar::flow::composite_node<std::tuple<signal_t, signal_t, signal_t>,
                                                   std::tuple<signal_t, signal_t>> {
    oneapi::tbb_kahypar::flow::broadcast_node<signal_t> A_port;
    oneapi::tbb_kahypar::flow::broadcast_node<signal_t> B_port;
    oneapi::tbb_kahypar::flow::broadcast_node<signal_t> CI_port;
    xor_gate<2> FirstXOR;
...
public:
    one_bit_adder(oneapi::tbb_kahypar::flow::graph& g)
            : base_type(g),
              my_graph(g),
              A_port(g),
              B_port(g),
