...
class fractal {
    ...
    //! Renders the fractal
    void render(oneapi::tbb_kahypar::task_group_context &context);
...
public:
    ...
    void run(oneapi::tbb_kahypar::task_group_context &context);
...
class fractal_group {
    ...
    oneapi::tbb_kahypar::task_group_context context[2];
    oneapi::tbb_kahypar::task_arena arenas[2];
    oneapi::tbb_kahypar::task_group groups[2];
