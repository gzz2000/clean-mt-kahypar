...
>
> Linux*:
> - For system wide installations: `. /opt/intel/oneapi_kahypar/setvars.sh`
> - For private installations: `. ~/intel/oneapi_kahypar/setvars.sh`
...
[Using Visual Studio Code with Intel® oneAPI Toolkits User Guide](https://www.intel.com/content/www/us/en/develop/documentation/using-vs-code-with-intel-oneapi_kahypar/top.html).
