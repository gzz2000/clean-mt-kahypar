...
public:
    ...
    void operator()() const {
        ...
        tbb_kahypar::parallel_for(tbb_kahypar::blocked_range<int>(0, a_array.size()),
                          [&](tbb_kahypar::blocked_range<int> r) {
