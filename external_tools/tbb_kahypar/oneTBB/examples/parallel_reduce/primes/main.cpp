...
int main(int argc, char* argv[]) {
    oneapi::tbb_kahypar::tick_count mainBeginMark = oneapi::tbb_kahypar::tick_count::now();
    ...
    utility::report_elapsed_time((oneapi::tbb_kahypar::tick_count::now() - mainBeginMark).seconds());
    return 0;
}
