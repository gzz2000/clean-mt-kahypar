...
void initialize(pointVec_t &points) {
    ...
    oneapi::tbb_kahypar::parallel_for(range_t(0, cfg::numberOfPoints, FillRNDPointsVector_buf::grainSize),
...
point_t divide(const pointVec_t &P, pointVec_t &P_reduced, const point_t &p1, const point_t &p2) {
    ...
    oneapi::tbb_kahypar::parallel_reduce(
        range_t(0, P.size(), SplitByCP_buf::grainSize), sbcpb, oneapi::tbb_kahypar::simple_partitioner());
