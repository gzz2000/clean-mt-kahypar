...
private:
    ...
    void ParallelUpdateStress(oneapi::tbb_kahypar::affinity_partitioner& affinity);

    void UpdateVelocity(Rectangle const& r);

    void SerialUpdateVelocity();
    void ParallelUpdateVelocity(oneapi::tbb_kahypar::affinity_partitioner& affinity);
};
