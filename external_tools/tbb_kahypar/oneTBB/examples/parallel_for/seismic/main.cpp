...
int main(int argc, char *argv[]) {
    ...
    if (video.init_window(u.UniverseWidth, u.UniverseHeight)) {
        ...
        for (int p = options.threads.first; p <= options.threads.last;
            ...
            oneapi::tbb_kahypar::tick_count xwayParallelismStartTime = oneapi::tbb_kahypar::tick_count::now();
            u.InitializeUniverse(video);
            ...
            if (!options.silent) {
                double fps =
                    ...
                    ((oneapi::tbb_kahypar::tick_count::now() - xwayParallelismStartTime).seconds());
