...
class RPolygon;
typedef oneapi::tbb_kahypar::scalable_allocator<RPolygon> RPolygon_allocator;
...
typedef class oneapi::tbb_kahypar::concurrent_vector<RPolygon, RPolygon_allocator> concurrent_Polygon_map_t;
typedef class oneapi::tbb_kahypar::enumerable_thread_specific<Polygon_map_t> ETS_Polygon_map_t;
typedef class std::vector<RPolygon_flagged, oneapi::tbb_kahypar::tbb_allocator<RPolygon_flagged>>
