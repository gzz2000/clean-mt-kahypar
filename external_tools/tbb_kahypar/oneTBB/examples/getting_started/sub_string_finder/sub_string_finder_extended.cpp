...
int main() {
    ...
    oneapi::tbb_kahypar::tick_count serial_t0 = oneapi::tbb_kahypar::tick_count::now();
    SerialSubStringFinder(to_scan, max2, pos2);
    oneapi::tbb_kahypar::tick_count serial_t1 = oneapi::tbb_kahypar::tick_count::now();
    std::cout << " Done with serial version."
              << "\n";

    oneapi::tbb_kahypar::tick_count parallel_t0 = oneapi::tbb_kahypar::tick_count::now();
    oneapi::tbb_kahypar::parallel_for(oneapi::tbb_kahypar::blocked_range<std::size_t>(0, num_elem, 100),
                              SubStringFinder(to_scan.c_str(), num_elem, &max1[0], &pos1[0]));
    oneapi::tbb_kahypar::tick_count parallel_t1 = oneapi::tbb_kahypar::tick_count::now();
