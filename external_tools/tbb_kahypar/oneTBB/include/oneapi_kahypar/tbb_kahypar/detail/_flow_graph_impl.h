...
typedef tbb_kahypar::concurrent_priority_queue<graph_task*, graph_task_comparator> graph_task_priority_queue_t;
...
private:
    ...
    tbb_kahypar::spin_mutex nodelist_mutex;
...
inline graph_task* prioritize_task(graph& g, graph_task& gt) {
    ...
    using tbb_kahypar::detail::d1::submit;
