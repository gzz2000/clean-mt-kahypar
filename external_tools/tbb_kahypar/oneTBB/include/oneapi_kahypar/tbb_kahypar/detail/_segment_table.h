...
protected:
    using segment_table_allocator_traits = tbb_kahypar::detail::allocator_traits<segment_table_allocator_type>;
...
public:
        ...
        noexcept(derived_type::is_noexcept_assignment)
    {
        ...
        if (this != &other) {
            ...
            internal_move_assign(std::move(other), tbb_kahypar::detail::disjunction<is_equal_type, pocma_type>());
        }
        return *this;
    }
        ...
        noexcept(derived_type::is_noexcept_swap)
    {
        ...
        if (this != &other) {
            ...
            internal_swap(other, tbb_kahypar::detail::disjunction<is_equal_type, pocs_type>());
        }
    }
    ...
    static constexpr segment_index_type segment_index_of( size_type index ) {
        return size_type(tbb_kahypar::detail::log2(uintptr_t(index|1)));
    }
