...
struct is_always_equal_detector<Allocator, tbb_kahypar::detail::void_t<typename Allocator::is_always_equal>>
{
...
public:
    ...
    template <typename T>
    using rebind_traits = typename tbb_kahypar::detail::allocator_traits<typename base_type::template rebind_alloc<T>>;
