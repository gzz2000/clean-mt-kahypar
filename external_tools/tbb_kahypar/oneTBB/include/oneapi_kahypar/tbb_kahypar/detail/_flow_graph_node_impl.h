...
public:
    ...
    function_input(
      ...
      : base_type(g, max_concurrency, a_priority, noexcept(tbb_kahypar::detail::invoke(body, input_type())))
    ...
    output_type apply_body_impl( const input_type& i) {
        ...
        output_type v = tbb_kahypar::detail::invoke(*my_body, i);
...
public:
    ...
    multifunction_input(graph &g, size_t max_concurrency,Body& body, node_priority_t a_priority )
      : base_type(g, max_concurrency, a_priority, noexcept(tbb_kahypar::detail::invoke(body, input_type(), my_output_ports)))
