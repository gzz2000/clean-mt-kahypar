...
struct comp_is_transparent<Compare, tbb_kahypar::detail::void_t<typename Compare::is_transparent>> : std::true_type {};
...
struct has_transparent_key_equal<Key, Hasher, KeyEqual, tbb_kahypar::detail::void_t<typename Hasher::transparent_key_equal>> : std::true_type {
