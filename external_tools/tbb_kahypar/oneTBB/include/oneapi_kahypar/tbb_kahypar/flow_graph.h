...
concept node_body_return_type = std::same_as<OutputType, tbb_kahypar::detail::d2::continue_msg> ||
...
concept continue_node_body = std::copy_constructible<Body> &&
                             requires( Body& body, const tbb_kahypar::detail::d2::continue_msg& v ) {
...
concept input_node_body = std::copy_constructible<Body> &&
                          requires( Body& body, tbb_kahypar::detail::d1::flow_control& fc ) {
    ...
    void handle_operations_impl(buffer_operation *op_list, derived_type* derived) {
        ...
        if (try_forwarding && !forwarder_busy) {
            if(is_graph_active(this->my_graph)) {
                ...
                // error: function "tbb_kahypar::flow::interfaceX::combine_tasks" cannot be called with the given argument list
...
public:
    ...
    bool remove_successor( successor_type &r ) override {
        ...
        tbb_kahypar::detail::d2::remove_predecessor(r, *this);
...
public:
    ...
    void operator()( const Input &v, Ports & ) noexcept(noexcept(tbb_kahypar::detail::invoke(my_body, v, std::declval<gateway_type&>()))) {
        tbb_kahypar::detail::invoke(my_body, v, *this->my_gateway);
    }
...
protected:
    ...
    struct register_predecessor_task : public graph_task {
        ...
        d1::task* execute(d1::execution_data& ed) override {
            ...
            using tbb_kahypar::detail::d2::register_predecessor;
            using tbb_kahypar::detail::d2::register_successor;
