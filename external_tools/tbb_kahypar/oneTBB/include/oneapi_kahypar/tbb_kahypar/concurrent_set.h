...
template <typename Key, typename Compare = std::less<Key>, typename Allocator = tbb_kahypar::tbb_allocator<Key>>
...
template <typename It,
          ...
          typename Alloc = tbb_kahypar::tbb_allocator<iterator_value_t<It>>,
...
template <typename Key,
          ...
          typename Alloc = tbb_kahypar::tbb_allocator<Key>,
          typename = std::enable_if_t<is_allocator_v<Alloc>>,
          typename = std::enable_if_t<!is_allocator_v<Comp>>>
