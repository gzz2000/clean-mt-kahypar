...
struct reduction_tree_node : public tree_node {
    tbb_kahypar::detail::aligned_space<Body> zombie_space;
    Body& left_body;
...
struct start_reduce : public task {
    ...
    void run_body( Range &r ) {
        tbb_kahypar::detail::invoke(*my_body, r);
    }
...
public:
    ...
    lambda_reduce_body( lambda_reduce_body& other, tbb_kahypar::split )
    ...
    void operator()(Range& range) {
        my_value = tbb_kahypar::detail::invoke(my_real_body, range, std::move(my_value));
    }

    void join( lambda_reduce_body& rhs ) {
        my_value = tbb_kahypar::detail::invoke(my_reduction, std::move(my_value), std::move(rhs.my_value));
    }
