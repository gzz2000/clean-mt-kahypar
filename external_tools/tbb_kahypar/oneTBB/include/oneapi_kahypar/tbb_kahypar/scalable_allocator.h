...
#include "oneapi_kahypar/tbb_kahypar/detail/_namespace_injection.h"
#include <cstdlib>
#include <utility>
#include <new> /* std::bad_alloc() */
#else
#include "oneapi_kahypar/tbb_kahypar/detail/_export.h"
...
inline std::pmr::memory_resource* scalable_memory_resource() noexcept {
    static tbb_kahypar::detail::d1::scalable_resource_impl scalable_res;
    return &scalable_res;
}
