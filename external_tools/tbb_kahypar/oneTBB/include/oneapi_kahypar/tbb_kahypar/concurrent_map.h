...
template <typename Key, typename Value, typename Compare = std::less<Key>, typename Allocator = tbb_kahypar::tbb_allocator<std::pair<const Key, Value>>>
...
template <typename It,
          ...
          typename Alloc = tbb_kahypar::tbb_allocator<iterator_alloc_pair_t<It>>,
...
template <typename Key, typename T,
          ...
          typename Alloc = tbb_kahypar::tbb_allocator<std::pair<const Key, T>>,
          typename = std::enable_if_t<is_allocator_v<Alloc>>,
          typename = std::enable_if_t<!is_allocator_v<Comp>>>
