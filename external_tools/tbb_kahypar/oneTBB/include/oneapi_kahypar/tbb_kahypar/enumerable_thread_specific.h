...
class callback_leaf: public callback_base, Constructor {
    ...
    using my_allocator_type = typename tbb_kahypar::tbb_allocator<callback_leaf>;
    ...
    void destroy() override {
        ...
        tbb_kahypar::detail::allocator_traits<my_allocator_type>::destroy(alloc, this);
        tbb_kahypar::detail::allocator_traits<my_allocator_type>::deallocate(alloc, this, 1);
    }
...
class enumerable_thread_specific: ets_base<ETS_key_type> {
    ...
    using internal_collection_type = tbb_kahypar::concurrent_vector< padded_element, padded_allocator_type >;
