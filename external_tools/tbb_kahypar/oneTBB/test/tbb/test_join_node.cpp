...
public:
    ...
    typedef typename tbb_kahypar::flow::join_node<OutputTupleType, tbb_kahypar::flow::tag_matching> join_node_type;
...
public:
    ...
    typedef typename std::tuple<int, tbb_kahypar::flow::continue_msg> input_tuple_type;
    typedef tbb_kahypar::flow::join_node<input_tuple_type, tbb_kahypar::flow::reserving> input_join_type;
    ...
    static void test() {
        ...
        for(int maxTag = 1; maxTag <10; maxTag *= 3) {
            ...
            JType * my_join = makeJoin<N, JType, tbb_kahypar::flow::tag_matching>::create(g);
            // input_node for continue messages
            tbb_kahypar::flow::input_node<tbb_kahypar::flow::continue_msg> snode(g, recirc_input_node_body());
            // reserving join that matches recirculating tags with continue messages.
            input_join_type * my_input_join = makeJoin<2, input_join_type, tbb_kahypar::flow::reserving>::create(g);
            // tbb_kahypar::flow::make_edge(snode, tbb_kahypar::flow::input_port<1>(*my_input_join));
            tbb_kahypar::flow::make_edge(snode, std::get<1>(my_input_join->input_ports()));
            // queue to hold the tags
            tbb_kahypar::flow::queue_node<int> tag_queue(g);
            tbb_kahypar::flow::make_edge(tag_queue, tbb_kahypar::flow::input_port<0>(*my_input_join));
            ...
            tbb_kahypar::flow::function_node<TType, int> recreate_tag(g, tbb_kahypar::flow::unlimited, recirc_output_func_body<TType>());
            tbb_kahypar::flow::make_edge(*my_join, recreate_tag);
            // now the recirculating part (output back to the queue)
            tbb_kahypar::flow::make_edge(recreate_tag, tag_queue);
            ...
            tbb_kahypar::flow::remove_edge(*my_join, recreate_tag);
            makeJoin<N, JType, tbb_kahypar::flow::tag_matching>::destroy(my_join);
            tbb_kahypar::flow::remove_edge(tag_queue, tbb_kahypar::flow::input_port<0>(*my_input_join));
            tbb_kahypar::flow::remove_edge(snode, tbb_kahypar::flow::input_port<1>(*my_input_join));
            makeJoin<2, input_join_type, tbb_kahypar::flow::reserving>::destroy(my_input_join);
        }
    }
};
...
public:
    typedef tbb_kahypar::flow::join_node<JType, tbb_kahypar::flow::tag_matching> join_node_type;
    static void do_test() {
...
//! \brief \ref error_guessing
TEST_CASE("Main test"){
    test_main<tbb_kahypar::flow::queueing>();
    test_main<tbb_kahypar::flow::reserving>();
    test_main<tbb_kahypar::flow::tag_matching>();
}
...
TEST_CASE("Test reservation on the port") {
    ...
    tbb_kahypar::flow::buffer_node<int> buffer1(g), buffer2(g);
    tbb_kahypar::flow::join_node<std::tuple<int, int>, tbb_kahypar::flow::reserving> join(g);
    tbb_kahypar::flow::buffer_node<std::tuple<int, int>> buffer3(g);

    auto& port0 = tbb_kahypar::flow::input_port<0>(join);
    auto& port1 = tbb_kahypar::flow::input_port<1>(join);

    tbb_kahypar::flow::make_edge(buffer1, port0);
    tbb_kahypar::flow::make_edge(buffer2, port1);
    tbb_kahypar::flow::make_edge(join, buffer3);
