...
void test_dynamic_link(const char* lib_name) {
    ...
    static const tbb_kahypar::detail::r1::dynamic_link_descriptor LinkTable[] = {
        { "foo1", (tbb_kahypar::detail::r1::pointer_to_handler*)(void*)(&foo1_handler) },
        { "foo2", (tbb_kahypar::detail::r1::pointer_to_handler*)(void*)(&foo2_handler) }
    };
#if !_WIN32
    ...
    if (tbb_kahypar::detail::r1::dynamic_link(lib_name, LinkTable, sizeof(LinkTable) / sizeof(LinkTable[0]))) {
...
#endif
    static const tbb_kahypar::detail::r1::dynamic_link_descriptor table[] = {
        { symbol, (tbb_kahypar::detail::r1::pointer_to_handler*)(void*)(&handler) },
    };

    constexpr int load_flags =
        tbb_kahypar::detail::r1::DYNAMIC_LINK_DEFAULT & ~tbb_kahypar::detail::r1::DYNAMIC_LINK_BUILD_ABSOLUTE_PATH;
    const bool link_result = tbb_kahypar::detail::r1::dynamic_link(lib_name, table,
...
TEST_CASE("Test dynamic_link with bad library") {
...
#if !__TBB_WIN8UI_SUPPORT
    const std::size_t len = tbb_kahypar::detail::r1::abs_path(lib_name, path, sizeof(path));
    ...
    REQUIRE_MESSAGE(tbb_kahypar::detail::r1::file_exists(path), msg);
#endif

    // The library exists, check that it will not be loaded.
    void (*handler)() = nullptr;
    static const tbb_kahypar::detail::r1::dynamic_link_descriptor table[] = {
        { "foo", (tbb_kahypar::detail::r1::pointer_to_handler*)(void*)(&handler) },
    };
