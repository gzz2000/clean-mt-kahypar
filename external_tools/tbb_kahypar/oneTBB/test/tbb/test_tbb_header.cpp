...
// that breaks the definition of tbb_kahypar::detail::d1::base_pool::malloc/free/realloc
// excluding memory_pool.h from testing when this mode is enabled
#undef TBB_PREVIEW_MEMORY_POOL
#endif

#include "tbb_kahypar/tbb.h"
...
#define TestTypeDefinitionPresence( Type ) g_sink = sizeof(tbb_kahypar::Type);
#define TestTypeDefinitionPresence2(TypeStart, TypeEnd) g_sink = sizeof(tbb_kahypar::TypeStart,TypeEnd);
#define TestTypeDefinitionPresence3(TypeStart, TypeMid, TypeEnd) g_sink = sizeof(tbb_kahypar::TypeStart,TypeMid,TypeEnd);
#define TestFuncDefinitionPresence(Fn, Args, ReturnType) { ReturnType (*pfn)Args = &tbb_kahypar::Fn; (void)pfn; }
...
struct Body1a { // feeder body for parallel_do
    void operator() ( int, tbb_kahypar::feeder<int>& ) const {}
};
...
struct Body2 {
    Body2 () {}
    Body2 ( const Body2&, tbb_kahypar::split ) {}
    void operator() ( const tbb_kahypar::blocked_range<int>& ) const {}
    void join( const Body2& ) {}
};
struct Body2a { // for lambda-friendly parallel_reduce
    int operator() ( const tbb_kahypar::blocked_range<int>&, const int ) const { return 0; }
};
struct Body3 { // for parallel_scan
    Body3 () {}
    Body3 ( const Body3&, tbb_kahypar::split ) {}
    void operator() ( const tbb_kahypar::blocked_range2d<int>&, tbb_kahypar::pre_scan_tag ) const {}
    void operator() ( const tbb_kahypar::blocked_range2d<int>&, tbb_kahypar::final_scan_tag ) const {}
    void reverse_join( Body3& ) {}
    void assign( const Body3& ) {}
};
struct Body3a { // for lambda-friednly parallel_scan
    int operator() ( const tbb_kahypar::blocked_range<int>&, const int, bool ) const { return 0; }
};
struct Msg {};
...
template <typename E>
void TestExceptionClassExports ( const E& exc, tbb_kahypar::detail::exception_id eid ) {
    CHECK( eid < tbb_kahypar::detail::exception_id::last_entry );
    ...
    for ( int i = 0; i < 2; ++i ) {
        try {
            if ( i == 0 )
                ...
                tbb_kahypar::detail::throw_exception( eid );
        }
        catch ( E& e ) {
...
static void TestExceptionClassesExports () {
    TestExceptionClassExports( std::bad_alloc(), tbb_kahypar::detail::exception_id::bad_alloc );
    TestExceptionClassExports( tbb_kahypar::bad_last_alloc(), tbb_kahypar::detail::exception_id::bad_last_alloc );
    TestExceptionClassExports( std::invalid_argument("test"), tbb_kahypar::detail::exception_id::nonpositive_step );
    TestExceptionClassExports( std::out_of_range("test"), tbb_kahypar::detail::exception_id::out_of_range );
    TestExceptionClassExports( tbb_kahypar::missing_wait(), tbb_kahypar::detail::exception_id::missing_wait );
    TestExceptionClassExports( std::out_of_range("test"), tbb_kahypar::detail::exception_id::invalid_load_factor );
    TestExceptionClassExports( std::length_error("test"), tbb_kahypar::detail::exception_id::reservation_length_error );
    TestExceptionClassExports( std::out_of_range("test"), tbb_kahypar::detail::exception_id::invalid_key );
    TestExceptionClassExports( tbb_kahypar::user_abort(), tbb_kahypar::detail::exception_id::user_abort );
    TestExceptionClassExports( std::runtime_error("test"), tbb_kahypar::detail::exception_id::bad_tagged_msg_cast );
    TestExceptionClassExports( tbb_kahypar::unsafe_wait("test"), tbb_kahypar::detail::exception_id::unsafe_wait );
}
...
static void DefinitionPresence() {
    ...
    TestFuncDefinitionPresence( flow::make_edge, (tbb_kahypar::flow::sender<Msg>&, tbb_kahypar::flow::receiver<Msg>&), void );
    TestFuncDefinitionPresence( flow::remove_edge, (tbb_kahypar::flow::sender<Msg>&, tbb_kahypar::flow::receiver<Msg>&), void );
    typedef std::tuple<int, int> intpair;
    TestTypeDefinitionPresence( flow::input_node<int> );
    TestTypeDefinitionPresence3(flow::function_node<int, int, tbb_kahypar::flow::rejecting> );
    TestTypeDefinitionPresence3(flow::multifunction_node<int, intpair, tbb_kahypar::flow::queueing> );
    TestTypeDefinitionPresence3(flow::async_node<int, int, tbb_kahypar::flow::queueing_lightweight> );
    TestTypeDefinitionPresence2(flow::continue_node<int, tbb_kahypar::flow::lightweight> );
    TestTypeDefinitionPresence2(flow::join_node<intpair, tbb_kahypar::flow::reserving> );
    TestTypeDefinitionPresence2(flow::join_node<intpair, tbb_kahypar::flow::key_matching<int> > );
    ...
    TestFuncDefinitionPresence( collaborative_call_once, (tbb_kahypar::collaborative_once_flag&, const Body&), void );
    ...
    TestFuncDefinitionPresence( parallel_for, (const tbb_kahypar::blocked_range<int>&, const Body2&, const tbb_kahypar::simple_partitioner&), void );
    TestFuncDefinitionPresence( parallel_reduce, (const tbb_kahypar::blocked_range<int>&, const int&, const Body2a&, const Body1b&), int );
    TestFuncDefinitionPresence( parallel_reduce, (const tbb_kahypar::blocked_range<int>&, Body2&, tbb_kahypar::affinity_partitioner&), void );
    TestFuncDefinitionPresence( parallel_deterministic_reduce, (const tbb_kahypar::blocked_range<int>&, const int&, const Body2a&, const Body1b&), int );
    TestFuncDefinitionPresence( parallel_deterministic_reduce, (const tbb_kahypar::blocked_range<int>&, Body2&, const tbb_kahypar::static_partitioner&), void );
    TestFuncDefinitionPresence( parallel_scan, (const tbb_kahypar::blocked_range2d<int>&, Body3&, const tbb_kahypar::auto_partitioner&), void );
    TestFuncDefinitionPresence( parallel_scan, (const tbb_kahypar::blocked_range<int>&, const int&, const Body3a&, const Body1b&), int );
    ...
    TestFuncDefinitionPresence( parallel_pipeline, (size_t, const tbb_kahypar::filter<void,void>&), void );
    TestFuncDefinitionPresence( parallel_invoke, (const Body&, const Body&, tbb_kahypar::task_group_context&), void );
    TestFuncDefinitionPresence( parallel_for_each, (const intarray&, const Body1a&, tbb_kahypar::task_group_context&), void );
    TestFuncDefinitionPresence( parallel_for, (int, int, const Body1&, const tbb_kahypar::auto_partitioner&, tbb_kahypar::task_group_context&), void );
    TestFuncDefinitionPresence( parallel_for, (int, int, const Body1&, tbb_kahypar::task_group_context&), void );
    TestFuncDefinitionPresence( parallel_reduce, (const tbb_kahypar::blocked_range<int>&, Body2&, const tbb_kahypar::auto_partitioner&, tbb_kahypar::task_group_context&), void );
    TestFuncDefinitionPresence( parallel_reduce, (const tbb_kahypar::blocked_range<int>&, Body2&, tbb_kahypar::task_group_context&), void );
    TestFuncDefinitionPresence( parallel_deterministic_reduce, (const tbb_kahypar::blocked_range<int>&, Body2&, const tbb_kahypar::simple_partitioner&, tbb_kahypar::task_group_context&), void );
    TestFuncDefinitionPresence( parallel_deterministic_reduce, (const tbb_kahypar::blocked_range<int>&, Body2&, tbb_kahypar::task_group_context&), void );
    ...
    TestFuncDefinitionPresence( info::numa_nodes, (), std::vector<tbb_kahypar::numa_node_id> );
    TestFuncDefinitionPresence( info::default_concurrency, (tbb_kahypar::numa_node_id), int );
