...
void jn_follows_and_precedes() {
    ...
    follows_and_precedes_testing::test_follows
        <msg_t, tbb_kahypar::flow::join_node<JoinOutputType>, tbb_kahypar::flow::buffer_node<msg_t>>(messages_for_follows);
    follows_and_precedes_testing::test_follows
        <msg_t, tbb_kahypar::flow::join_node<JoinOutputType, tbb_kahypar::flow::queueing>>(messages_for_follows);
    follows_and_precedes_testing::test_follows
        <msg_t, tbb_kahypar::flow::join_node<JoinOutputType, tbb_kahypar::flow::reserving>, tbb_kahypar::flow::buffer_node<msg_t>>(messages_for_follows);
    ...
    follows_and_precedes_testing::test_follows
        <msg_t, tbb_kahypar::flow::join_node<JoinOutputType, tbb_kahypar::flow::key_matching<msg_t, hash_compare>>, tbb_kahypar::flow::buffer_node<msg_t>>
        (messages_for_follows, b, b, b);

    follows_and_precedes_testing::test_precedes
        <msg_t, tbb_kahypar::flow::join_node<JoinOutputType>>(messages_for_precedes);
    follows_and_precedes_testing::test_precedes
        <msg_t, tbb_kahypar::flow::join_node<JoinOutputType, tbb_kahypar::flow::queueing>>(messages_for_precedes);
    follows_and_precedes_testing::test_precedes
        <msg_t, tbb_kahypar::flow::join_node<JoinOutputType, tbb_kahypar::flow::reserving>>(messages_for_precedes);
    follows_and_precedes_testing::test_precedes
        <msg_t, tbb_kahypar::flow::join_node<JoinOutputType, tbb_kahypar::flow::key_matching<msg_t, hash_compare>>>
...
void jn_msg_key_matching_follows_and_precedes() {
    ...
    follows_and_precedes_testing::test_follows
        <msg_t, tbb_kahypar::flow::join_node<JoinOutputType, tbb_kahypar::flow::key_matching<std::size_t>>, tbb_kahypar::flow::buffer_node<msg_t>>
        (messages_for_follows);
    follows_and_precedes_testing::test_precedes
        <msg_t, tbb_kahypar::flow::join_node<JoinOutputType, tbb_kahypar::flow::key_matching<std::size_t>>>
...
void test_try_put_and_wait_queueing() {
    ...
    arena.execute([] {
        ...
        tbb_kahypar::flow::join_node<tuple_type, tbb_kahypar::flow::queueing> join(g);

        tbb_kahypar::flow::function_node<tuple_type, int, tbb_kahypar::flow::rejecting> function(g, tbb_kahypar::flow::serial,
            [&](tuple_type tuple) noexcept {
                ...
                if (input == wait_message) {
                    for (auto item : new_work_items) {
                        tbb_kahypar::flow::input_port<0>(join).try_put(item);
                        tbb_kahypar::flow::input_port<1>(join).try_put(item);
                        tbb_kahypar::flow::input_port<2>(join).try_put(item);
                    }
                }
        ...
        tbb_kahypar::flow::make_edge(join, function);
        ...
        tbb_kahypar::flow::input_port<0>(join).try_put(wait_message);
        tbb_kahypar::flow::input_port<1>(join).try_put(wait_message);
        tbb_kahypar::flow::input_port<2>(join).try_put_and_wait(wait_message);
...
void test_try_put_and_wait_reserving() {
    ...
    arena.execute([]{
        ...
        using tuple_type = std::tuple<int, int, int>;
        tbb_kahypar::flow::queue_node<int> buffer1(g);
        tbb_kahypar::flow::queue_node<int> buffer2(g);
        tbb_kahypar::flow::queue_node<int> buffer3(g);

        tbb_kahypar::flow::join_node<tuple_type, tbb_kahypar::flow::reserving> join(g);
        ...
        tbb_kahypar::flow::make_edge(buffer1, tbb_kahypar::flow::input_port<0>(join));
        tbb_kahypar::flow::make_edge(buffer2, tbb_kahypar::flow::input_port<1>(join));
        tbb_kahypar::flow::make_edge(buffer3, tbb_kahypar::flow::input_port<2>(join));
        tbb_kahypar::flow::make_edge(join, function);
...
void test_try_put_and_wait_key_matching(Body... body) {
    ...
    arena.execute([=] {
        ...
        tbb_kahypar::flow::join_node<tuple_type, tbb_kahypar::flow::key_matching<int>> join(g, body..., body..., body...);
        ...
        for (std::size_t i = start_work_items.size(); i != 0; --i) {
            tbb_kahypar::flow::input_port<0>(join).try_put(start_work_items[i - 1]);
        }
