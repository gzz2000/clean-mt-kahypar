...
public:
    ...
    OutputType operator()(tbb_kahypar::flow_control& fc) {
        UPDATE_COUNTS();
...
class test_input_body<tbb_kahypar::flow::continue_msg, TType> : WaitThrow<serial_type, TType> {
    using WaitThrow<serial_type, TType>::WaitAndThrow;
    std::atomic<int> *my_current_val;
public:
    test_input_body(std::atomic<int> &my_cnt) : my_current_val(&my_cnt) { }

    tbb_kahypar::flow::continue_msg operator()( tbb_kahypar::flow_control & fc) {
        UPDATE_COUNTS();
...
class multifunction_node_body : WaitThrow<Conc,T> {
    ...
    typedef typename tbb_kahypar::flow::multifunction_node<InputType,OutputTupleType> NodeType;
...
public:
    ...
    OutputTuple operator()(tbb_kahypar::flow_control& fc) {
        UPDATE_COUNTS();
...
void run_one_input_node_test(bool throwException, bool flog) {
    ...
    typedef absorber_body<ItemType, tbb_kahypar::flow::continue_msg, absorbThrowType, unlimited_type> parallel_absorb_body_type;
    ...
    tbb_kahypar::flow::input_node<ItemType> sn(g, src_body_type(input_body_count));
    parallel_absorb_body_type ab2(absorber_body_count);
    tbb_kahypar::flow::function_node<ItemType> parallel_fn(g,tbb_kahypar::flow::unlimited,ab2);
    ...
    for(int runcnt = 0; runcnt < 2; ++runcnt) {
        ...
        int src_cnt = tbb_kahypar::flow::copy_body<src_body_type>(sn).count_value();
        int sink_cnt = tbb_kahypar::flow::copy_body<parallel_absorb_body_type>(parallel_fn).count_value();
        if(throwException) {
        ...
        src_cnt = tbb_kahypar::flow::copy_body<src_body_type>(sn).count_value();
        sink_cnt = tbb_kahypar::flow::copy_body<parallel_absorb_body_type>(parallel_fn).count_value();
...
struct AttachPoint<NodeType,ItemType,indx,multifunc_node_type> {
    static tbb_kahypar::flow::sender<ItemType> &GetSender(NodeType &n) {
        return tbb_kahypar::flow::output_port<indx>(n);
    }
};
...
run_one_functype_node_test(bool throwException, bool flog, const char * /*name*/) {
    ...
    SinkNodeType0 sink0(g,tbb_kahypar::flow::unlimited,SinkNodeBodyType0(sink0_count));
    SinkNodeType1 sink1(g,tbb_kahypar::flow::unlimited,SinkNodeBodyType1(sink1_count));
    ...
    for(int iter = 0; iter < 2; ++iter) {  // run, reset, run again
        ...
        bool okayNoExceptionsCaught = (g_ExceptionInMaster && !g_MasterExecutedThrow) || (!g_ExceptionInMaster && !g_NonMasterExecutedThrow) || !throwException;
        int ib0_cnt = tbb_kahypar::flow::copy_body<InputNodeBodyType0>(input0).count_value();
        int ib1_cnt = tbb_kahypar::flow::copy_body<InputNodeBodyType1>(input1).count_value();
        int t_cnt   = tbb_kahypar::flow::copy_body<TestNodeBodyType>(node_to_test).count_value();
        int nb0_cnt = tbb_kahypar::flow::copy_body<SinkNodeBodyType0>(sink0).count_value();
        int nb1_cnt = tbb_kahypar::flow::copy_body<SinkNodeBodyType1>(sink1).count_value();
        if(throwException) {
        ...
        input0_count = input1_count = sink0_count = sink1_count = test_count = 0;
        CHECK_MESSAGE( (0 == tbb_kahypar::flow::copy_body<InputNodeBodyType0>(input0).count_value()),"Reset input 0 failed");
        CHECK_MESSAGE( (0 == tbb_kahypar::flow::copy_body<InputNodeBodyType1>(input1).count_value()),"Reset input 1 failed");
        CHECK_MESSAGE( (0 == tbb_kahypar::flow::copy_body<TestNodeBodyType>(node_to_test).count_value()),"Reset test_node failed");
        CHECK_MESSAGE( (0 == tbb_kahypar::flow::copy_body<SinkNodeBodyType0>(sink0).count_value()),"Reset sink 0 failed");
        CHECK_MESSAGE( (0 == tbb_kahypar::flow::copy_body<SinkNodeBodyType1>(sink1).count_value()),"Reset sink 1 failed");
...
void run_function_node_test() {
    ...
    typedef absorber_body<Item23,tbb_kahypar::flow::continue_msg, NType1, unlimited_type> SinkBodyType1;
    typedef absorber_body<Item23,tbb_kahypar::flow::continue_msg, NType2, unlimited_type> SinkBodyType2;

    typedef tbb_kahypar::flow::input_node<Item12> InputType;
    typedef tbb_kahypar::flow::function_node<Item12, Item23, NodePolicy> TestType;
    typedef tbb_kahypar::flow::function_node<Item23,tbb_kahypar::flow::continue_msg> SnkType;
...
void test_function_node() {
    ...
    run_function_node_test<isThrowing, nonThrowing, int, nonThrowing, int, nonThrowing, nonThrowing, tbb_kahypar::flow::rejecting, serial_type>();
    g_Wakeup_Msg = "function_node(1b): Missed wakeup or machine is overloaded?";
    run_function_node_test<nonThrowing, nonThrowing, int, isThrowing, int, nonThrowing, nonThrowing, tbb_kahypar::flow::rejecting, serial_type>();
    g_Wakeup_Msg = "function_node(1c): Missed wakeup or machine is overloaded?";
    run_function_node_test<nonThrowing, nonThrowing, int, nonThrowing, int, isThrowing, nonThrowing, tbb_kahypar::flow::rejecting, serial_type>();

    // serial queueing
    g_Wakeup_Msg = "function_node(2): Missed wakeup or machine is overloaded?";
    run_function_node_test<isThrowing, nonThrowing, int, nonThrowing, int, nonThrowing, nonThrowing, tbb_kahypar::flow::queueing, serial_type>();
    run_function_node_test<nonThrowing, nonThrowing, int, isThrowing, int, nonThrowing, nonThrowing, tbb_kahypar::flow::queueing, serial_type>();
    run_function_node_test<nonThrowing, nonThrowing, int, nonThrowing, int, isThrowing, nonThrowing, tbb_kahypar::flow::queueing, serial_type>();
    CheckType<int>::check_type_counter = 0;
    run_function_node_test<nonThrowing, nonThrowing, CheckType<int>, nonThrowing, CheckType<int>, isThrowing, nonThrowing, tbb_kahypar::flow::queueing, serial_type>();
    CHECK_MESSAGE( (!CheckType<int>::check_type_counter), "Some items leaked in test");

    // unlimited parallel rejecting
    g_Wakeup_Msg = "function_node(3): Missed wakeup or machine is overloaded?";
    run_function_node_test<isThrowing, nonThrowing, int, nonThrowing, int, nonThrowing, nonThrowing, tbb_kahypar::flow::rejecting, unlimited_type>();
    run_function_node_test<nonThrowing, nonThrowing, int, isThrowing, int, nonThrowing, nonThrowing, tbb_kahypar::flow::rejecting, unlimited_type>();
    run_function_node_test<nonThrowing, nonThrowing, int, nonThrowing, int, nonThrowing, isThrowing, tbb_kahypar::flow::rejecting, unlimited_type>();

    // limited parallel rejecting
    g_Wakeup_Msg = "function_node(4): Missed wakeup or machine is overloaded?";
    run_function_node_test<isThrowing, nonThrowing, int, nonThrowing, int, nonThrowing, nonThrowing, tbb_kahypar::flow::rejecting, limited_type>();
    run_function_node_test<nonThrowing, nonThrowing, int, isThrowing, int, nonThrowing, nonThrowing, tbb_kahypar::flow::rejecting, (size_t)limited_type>();
    run_function_node_test<nonThrowing, nonThrowing, int, nonThrowing, int, nonThrowing, isThrowing, tbb_kahypar::flow::rejecting, (size_t)limited_type>();

    // limited parallel queueing
    g_Wakeup_Msg = "function_node(5): Missed wakeup or machine is overloaded?";
    run_function_node_test<isThrowing, nonThrowing, int, nonThrowing, int, nonThrowing, nonThrowing, tbb_kahypar::flow::queueing, (size_t)limited_type>();
    run_function_node_test<nonThrowing, nonThrowing, int, isThrowing, int, nonThrowing, nonThrowing, tbb_kahypar::flow::queueing, (size_t)limited_type>();
    run_function_node_test<nonThrowing, nonThrowing, int, nonThrowing, int, nonThrowing, isThrowing, tbb_kahypar::flow::queueing, (size_t)limited_type>();

    // everyone throwing
    g_Wakeup_Msg = "function_node(6): Missed wakeup or machine is overloaded?";
    run_function_node_test<isThrowing, isThrowing, int, isThrowing, int, isThrowing, isThrowing, tbb_kahypar::flow::rejecting, unlimited_type>();
    g_Wakeup_Msg = g_Orig_Wakeup_Msg;
}
...
void run_multifunction_node_test() {
    ...
    typedef absorber_body<Item23Type0,tbb_kahypar::flow::continue_msg, NType1, unlimited_type> SinkBodyType1;
    typedef absorber_body<Item23Type1,tbb_kahypar::flow::continue_msg, NType2, unlimited_type> SinkBodyType2;

    typedef tbb_kahypar::flow::input_node<Item12> InputType;
    typedef tbb_kahypar::flow::multifunction_node<Item12, ItemTuple, NodePolicy> TestType;
    typedef tbb_kahypar::flow::function_node<Item23Type0,tbb_kahypar::flow::continue_msg> SnkType0;
    typedef tbb_kahypar::flow::function_node<Item23Type1,tbb_kahypar::flow::continue_msg> SnkType1;
...
void test_multifunction_node() {
    ...
    // serial rejecting
    run_multifunction_node_test<isThrowing, nonThrowing, int, nonThrowing, std::tuple<int,float>, nonThrowing, nonThrowing, tbb_kahypar::flow::rejecting, serial_type>();
    g_Wakeup_Msg = "multifunction_node(test throws,rejecting,serial): Missed wakeup or machine is overloaded?";
    run_multifunction_node_test<nonThrowing, nonThrowing, int, isThrowing, std::tuple<int,int>, nonThrowing, nonThrowing, tbb_kahypar::flow::rejecting, serial_type>();
    g_Wakeup_Msg = "multifunction_node(sink throws,rejecting,serial): Missed wakeup or machine is overloaded?";
    run_multifunction_node_test<nonThrowing, nonThrowing, int, nonThrowing, std::tuple<int,int>, isThrowing, nonThrowing, tbb_kahypar::flow::rejecting, serial_type>();

    g_Wakeup_Msg = "multifunction_node(2): Missed wakeup or machine is overloaded?";
    // serial queueing
    run_multifunction_node_test<isThrowing, nonThrowing, int, nonThrowing, std::tuple<int,int>, nonThrowing, nonThrowing, tbb_kahypar::flow::queueing, serial_type>();
    run_multifunction_node_test<nonThrowing, nonThrowing, int, isThrowing, std::tuple<int,int>, nonThrowing, nonThrowing, tbb_kahypar::flow::queueing, serial_type>();
    run_multifunction_node_test<nonThrowing, nonThrowing, int, nonThrowing, std::tuple<int,int>, isThrowing, nonThrowing, tbb_kahypar::flow::queueing, serial_type>();
    CheckType<int>::check_type_counter = 0;
    run_multifunction_node_test<nonThrowing, nonThrowing, CheckType<int>, nonThrowing, std::tuple<CheckType<int>, CheckType<int> >, isThrowing, nonThrowing, tbb_kahypar::flow::queueing, serial_type>();
    CHECK_MESSAGE( (!CheckType<int>::check_type_counter), "Some items leaked in test");

    g_Wakeup_Msg = "multifunction_node(3): Missed wakeup or machine is overloaded?";
    // unlimited parallel rejecting
    run_multifunction_node_test<isThrowing, nonThrowing, int, nonThrowing, std::tuple<int,int>, nonThrowing, nonThrowing, tbb_kahypar::flow::rejecting, unlimited_type>();
    run_multifunction_node_test<nonThrowing, nonThrowing, int, isThrowing, std::tuple<int,int>, nonThrowing, nonThrowing, tbb_kahypar::flow::rejecting, unlimited_type>();
    run_multifunction_node_test<nonThrowing, nonThrowing, int, nonThrowing, std::tuple<int,int>, nonThrowing, isThrowing, tbb_kahypar::flow::rejecting, unlimited_type>();

    g_Wakeup_Msg = "multifunction_node(4): Missed wakeup or machine is overloaded?";
    // limited parallel rejecting
    run_multifunction_node_test<isThrowing, nonThrowing, int, nonThrowing, std::tuple<int,int>, nonThrowing, nonThrowing, tbb_kahypar::flow::rejecting, limited_type>();
    run_multifunction_node_test<nonThrowing, nonThrowing, int, isThrowing, std::tuple<int,int>, nonThrowing, nonThrowing, tbb_kahypar::flow::rejecting, (size_t)limited_type>();
    run_multifunction_node_test<nonThrowing, nonThrowing, int, nonThrowing, std::tuple<int,int>, nonThrowing, isThrowing, tbb_kahypar::flow::rejecting, (size_t)limited_type>();

    g_Wakeup_Msg = "multifunction_node(5): Missed wakeup or machine is overloaded?";
    // limited parallel queueing
    run_multifunction_node_test<isThrowing, nonThrowing, int, nonThrowing, std::tuple<int,int>, nonThrowing, nonThrowing, tbb_kahypar::flow::queueing, (size_t)limited_type>();
    run_multifunction_node_test<nonThrowing, nonThrowing, int, isThrowing, std::tuple<int,int>, nonThrowing, nonThrowing, tbb_kahypar::flow::queueing, (size_t)limited_type>();
    run_multifunction_node_test<nonThrowing, nonThrowing, int, nonThrowing, std::tuple<int,int>, nonThrowing, isThrowing, tbb_kahypar::flow::queueing, (size_t)limited_type>();

    g_Wakeup_Msg = "multifunction_node(6): Missed wakeup or machine is overloaded?";
    // everyone throwing
    run_multifunction_node_test<isThrowing, isThrowing, int, isThrowing, std::tuple<int,int>, isThrowing, isThrowing, tbb_kahypar::flow::rejecting, unlimited_type>();
    g_Wakeup_Msg = g_Orig_Wakeup_Msg;
}
...
void run_one_continue_node_test (bool throwException, bool flog) {
    ...
    SinkNodeType sink(g,tbb_kahypar::flow::unlimited,SinkNodeBodyType(sink_count));
    tbb_kahypar::flow::broadcast_node<tbb_kahypar::flow::continue_msg> b1(g), b2(g), b3(g);
    make_edge(input, b1);
    make_edge(b1,b2);
    make_edge(b1,b3);
    ...
    for(int iter = 0; iter < 2; ++iter) {
        ...
        bool okayNoExceptionsCaught = (g_ExceptionInMaster && !g_MasterExecutedThrow) || (!g_ExceptionInMaster && !g_NonMasterExecutedThrow) || !throwException;
        int ib_cnt = tbb_kahypar::flow::copy_body<InputNodeBodyType>(input).count_value();
        int t_cnt   = tbb_kahypar::flow::copy_body<TestNodeBodyType>(node_to_test).count_value();
        int nb_cnt = tbb_kahypar::flow::copy_body<SinkNodeBodyType>(sink).count_value();
        if(throwException) {
            CHECK_MESSAGE( (g.exception_thrown() || okayNoExceptionsCaught), "Exception not caught by graph");
            CHECK_MESSAGE( (g.is_cancelled() || okayNoExceptionsCaught), "Cancellation not signalled in graph");
        ...
        CHECK_MESSAGE( (0 == tbb_kahypar::flow::copy_body<InputNodeBodyType>(input).count_value()),"Reset input failed");
        CHECK_MESSAGE( (0 == tbb_kahypar::flow::copy_body<TestNodeBodyType>(node_to_test).count_value()),"Reset test_node failed");
        CHECK_MESSAGE( (0 == tbb_kahypar::flow::copy_body<SinkNodeBodyType>(sink).count_value()),"Reset sink failed");
    }
#if USE_TASK_SCHEDULER_OBSERVER
    o.observe(false);
#endif
...
void run_continue_node_test() {
    typedef test_input_body<tbb_kahypar::flow::continue_msg,IType> IBodyType;
    typedef absorber_body<tbb_kahypar::flow::continue_msg,ItemType,CType,unlimited_type> ContBodyType;
    typedef absorber_body<ItemType,tbb_kahypar::flow::continue_msg, AType, unlimited_type> SinkBodyType;

    typedef tbb_kahypar::flow::input_node<tbb_kahypar::flow::continue_msg> InputType;
    typedef tbb_kahypar::flow::continue_node<ItemType> TestType;
    typedef tbb_kahypar::flow::function_node<ItemType,tbb_kahypar::flow::continue_msg> SnkType;
...
void run_buffer_queue_and_overwrite_node_test() {
    ...
    typedef absorber_body<BufferItemType,tbb_kahypar::flow::continue_msg,SinkThrowType,unlimited_type> SinkBodyType;

    typedef tbb_kahypar::flow::input_node<BufferItemType> InputType;
    typedef tbb_kahypar::flow::buffer_node<BufferItemType> BufType;
    typedef tbb_kahypar::flow::queue_node<BufferItemType>  QueType;
    typedef tbb_kahypar::flow::overwrite_node<BufferItemType>  OvrType;
    typedef tbb_kahypar::flow::function_node<BufferItemType,tbb_kahypar::flow::continue_msg> SnkType;
...
void run_sequencer_node_test() {
    ...
    typedef tbb_kahypar::flow::input_node<BufferItemType> InputType;
    typedef tbb_kahypar::flow::sequencer_node<BufferItemType>  SeqType;
    typedef tbb_kahypar::flow::function_node<BufferItemType,tbb_kahypar::flow::continue_msg> SnkType;
...
void run_priority_queue_node_test() {
    ...
    typedef tbb_kahypar::flow::input_node<BufferItemType> InputType;
    typedef tbb_kahypar::flow::priority_queue_node<BufferItemType,LessBodyType>  PrqType;
    typedef tbb_kahypar::flow::function_node<BufferItemType,tbb_kahypar::flow::continue_msg> SnkType;
...
template<> struct graph_policy_name<tbb_kahypar::flow::queueing>  {
    static const char* name() {return "queueing"; }
};
template<> struct graph_policy_name<tbb_kahypar::flow::reserving> {
    static const char* name() {return "reserving"; }
};
template<> struct graph_policy_name<tbb_kahypar::flow::tag_matching> {
...
struct run_one_join_node_test {
    ...
    static void execute_test(bool throwException,bool flog) {
        ...
        SinkType sink(g,tbb_kahypar::flow::unlimited,SinkBodyType(sink_count));
        make_edge(input0,tbb_kahypar::flow::input_port<0>(node_to_test));
        make_edge(input1,tbb_kahypar::flow::input_port<1>(node_to_test));
        make_edge(node_to_test, sink);
        for(int iter = 0; iter < 2; ++iter) {
            ResetGlobals(throwException,flog);
            if(throwException) {
            ...
            bool okayNoExceptionsCaught = (g_ExceptionInMaster && !g_MasterExecutedThrow) || (!g_ExceptionInMaster && !g_NonMasterExecutedThrow) || !throwException;
            int ib0_cnt = tbb_kahypar::flow::copy_body<InputBodyType0>(input0).count_value();
            int ib1_cnt = tbb_kahypar::flow::copy_body<InputBodyType1>(input1).count_value();
            int nb_cnt = tbb_kahypar::flow::copy_body<SinkBodyType>(sink).count_value();
            if(throwException) {
                CHECK_MESSAGE( (g.exception_thrown() || okayNoExceptionsCaught), "Exception not caught by graph");
                CHECK_MESSAGE( (g.is_cancelled() || okayNoExceptionsCaught), "Cancellation not signalled in graph");
            ...
            if(iter == 0) {
                remove_edge(node_to_test, sink);
                tbb_kahypar::flow::input_port<0>(node_to_test).try_put(ItemType0(g_NumItems + 1));
                tbb_kahypar::flow::input_port<1>(node_to_test).try_put(ItemType1(g_NumItems + 2));
                g.wait_for_all();
                g.reset();
                input0_count = input1_count = sink_count = 0;
                make_edge(node_to_test, sink);
            ...
            CHECK_MESSAGE( (0 == tbb_kahypar::flow::copy_body<InputBodyType0>(input0).count_value()),"Reset input failed");
            CHECK_MESSAGE( (0 == tbb_kahypar::flow::copy_body<InputBodyType1>(input1).count_value()),"Reset input failed");
            nb_cnt = tbb_kahypar::flow::copy_body<SinkBodyType>(sink).count_value();
            CHECK_MESSAGE( (0 == tbb_kahypar::flow::copy_body<SinkBodyType>(sink).count_value()),"Reset sink failed");
        }
...
struct run_one_join_node_test<
    ...
    static void execute_test(bool throwException,bool flog) {
        ...
        for(int iter = 0; iter < 2; ++iter) {
            ...
            if(iter == 0) {
                remove_edge(node_to_test, sink);
                tbb_kahypar::flow::input_port<0>(node_to_test).try_put(ItemType0(g_NumItems + 4));
                tbb_kahypar::flow::input_port<1>(node_to_test).try_put(ItemType1(g_NumItems + 2));
...
void run_join_node_test() {
    ...
    typedef absorber_body<OutputTuple,tbb_kahypar::flow::continue_msg,SinkThrowType,unlimited_type> SinkBodyType;

    typedef typename tbb_kahypar::flow::input_node<ItemType0> InputType0;
    typedef typename tbb_kahypar::flow::input_node<ItemType1> InputType1;
    typedef typename tbb_kahypar::flow::join_node<OutputTuple,JP> TestJoinType;
    typedef typename tbb_kahypar::flow::function_node<OutputTuple,tbb_kahypar::flow::continue_msg> SinkType;
...
void run_limiter_node_test() {
    ...
    typedef tbb_kahypar::flow::input_node<BufferItemType> InputType;
    typedef tbb_kahypar::flow::limiter_node<BufferItemType>  LmtType;
    typedef tbb_kahypar::flow::function_node<BufferItemType,tbb_kahypar::flow::continue_msg> SnkType;
...
void run_one_split_node_test(bool throwException, bool flog) {
    ...
    SinkType0 sink0(g,tbb_kahypar::flow::unlimited,SinkBodyType0(sink0_count));
    SinkType1 sink1(g,tbb_kahypar::flow::unlimited,SinkBodyType1(sink1_count));
    make_edge(input, node_to_test);
    make_edge(tbb_kahypar::flow::output_port<0>(node_to_test), sink0);
    make_edge(tbb_kahypar::flow::output_port<1>(node_to_test), sink1);
    ...
    for(int iter = 0; iter < 2; ++iter) {  // run, reset, run again
        ...
        bool okayNoExceptionsCaught = (g_ExceptionInMaster && !g_MasterExecutedThrow) || (!g_ExceptionInMaster && !g_NonMasterExecutedThrow) || !throwException;
        int ib_cnt = tbb_kahypar::flow::copy_body<InputBodyType>(input).count_value();
        int nb0_cnt = tbb_kahypar::flow::copy_body<SinkBodyType0>(sink0).count_value();
        int nb1_cnt = tbb_kahypar::flow::copy_body<SinkBodyType1>(sink1).count_value();
        if(throwException) {
            CHECK_MESSAGE( (g.exception_thrown() || okayNoExceptionsCaught), "Exception not caught by graph");
            CHECK_MESSAGE( (g.is_cancelled() || okayNoExceptionsCaught), "Cancellation not signalled in graph");
        ...
        input_count = sink0_count = sink1_count = 0;
        CHECK_MESSAGE( (0 == tbb_kahypar::flow::copy_body<InputBodyType>(input).count_value()),"Reset input failed");
        CHECK_MESSAGE( (0 == tbb_kahypar::flow::copy_body<SinkBodyType0>(sink0).count_value()),"Reset sink 0 failed");
        CHECK_MESSAGE( (0 == tbb_kahypar::flow::copy_body<SinkBodyType1>(sink1).count_value()),"Reset sink 1 failed");
    }
#if USE_TASK_SCHEDULER_OBSERVER
    o.observe(false);
#endif
...
void run_split_node_test() {
    ...
    typedef absorber_body<ItemType0,tbb_kahypar::flow::continue_msg,SinkThrowType,unlimited_type> SinkBodyType0;
    typedef absorber_body<ItemType1,tbb_kahypar::flow::continue_msg,SinkThrowType,unlimited_type> SinkBodyType1;

    typedef typename tbb_kahypar::flow::input_node<InputTuple> InputType;
    typedef typename tbb_kahypar::flow::split_node<InputTuple> TestSplitType;
    typedef typename tbb_kahypar::flow::function_node<ItemType0,tbb_kahypar::flow::continue_msg> SinkType0;
    typedef typename tbb_kahypar::flow::function_node<ItemType1,tbb_kahypar::flow::continue_msg> SinkType1;
...
void run_indexer_node_test() {
    ...
    typedef test_input_body<ItemType0,InputThrowType> InputBodyType0;
    typedef test_input_body<ItemType1,InputThrowType> InputBodyType1;
    typedef typename tbb_kahypar::flow::indexer_node<ItemType0, ItemType1> TestNodeType;
    typedef absorber_body<typename TestNodeType::output_type,tbb_kahypar::flow::continue_msg,SinkThrowType,unlimited_type> SinkBodyType;

    typedef typename tbb_kahypar::flow::input_node<ItemType0> InputType0;
    typedef typename tbb_kahypar::flow::input_node<ItemType1> InputType1;
    typedef typename tbb_kahypar::flow::function_node<typename TestNodeType::output_type,tbb_kahypar::flow::continue_msg> SinkType;
...
public:
    ...
    void operator() (tbb_kahypar::flow::continue_msg) const {
        ++nExceptions;
...
test_flow_graph_exception0() {
    ...
    tbb_kahypar::flow::graph g;
    tbb_kahypar::flow::broadcast_node<tbb_kahypar::flow::continue_msg> start(g);
    tbb_kahypar::flow::continue_node<tbb_kahypar::flow::continue_msg> fooNode(g, f);

    // Construct edge
    tbb_kahypar::flow::make_edge(start, fooNode);

    // Execute graph
    CHECK_MESSAGE( (!g.exception_thrown()), "exception_thrown flag already set");
    CHECK_MESSAGE( (!g.is_cancelled()), "canceled flag already set");
    try {
        start.try_put(tbb_kahypar::flow::continue_msg());
        g.wait_for_all();
...
void TestOneThreadNum(int nThread) {
    ...
    tbb_kahypar::task_arena arena(nThread);
	arena.execute(
        [&]() {
            ...
            for(int i = 0; i < 4; ++i) {
                ...
                // join_nodes
                test_join_node<tbb_kahypar::flow::queueing>();
                test_join_node<tbb_kahypar::flow::reserving>();
                test_join_node<tbb_kahypar::flow::tag_matching>();
...
TEST_CASE("Testing several threads"){
    ...
    for(unsigned int nThread=utils::MaxThread; nThread >= utils::MinThread; --nThread) {
        tbb_kahypar::global_control thread_limit(tbb_kahypar::global_control::max_allowed_parallelism, nThread);
