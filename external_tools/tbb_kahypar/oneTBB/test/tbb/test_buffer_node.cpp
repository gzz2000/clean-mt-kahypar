...
template< typename T >
void spin_try_get( tbb_kahypar::flow::buffer_node<T> &b, T &value ) {
...
struct parallel_puts : utils::NoAssign {
    ...
    tbb_kahypar::flow::buffer_node<T> &my_b;

    parallel_puts( tbb_kahypar::flow::buffer_node<T> &b ) : my_b(b) {}
...
struct parallel_gets : utils::NoAssign {
    ...
    parallel_gets( tbb_kahypar::flow::buffer_node<T> &b, touches<T> &t) : my_b(b), my_touches(t) {}
...
struct parallel_put_get : utils::NoAssign {
    ...
    parallel_put_get( tbb_kahypar::flow::buffer_node<T> &b, touches<T> &t ) : my_b(b), my_touches(t) {}
...
int test_reservation() {
    ...
    // Simple tests
    tbb_kahypar::flow::buffer_node<T> b(g);
...
int test_parallel(int num_threads) {
    tbb_kahypar::flow::graph g;
    tbb_kahypar::flow::buffer_node<T> b(g);
    tbb_kahypar::flow::buffer_node<T> b2(g);
    tbb_kahypar::flow::buffer_node<T> b3(g);
    T bogus_value(-1);
    T j = bogus_value;
    ...
    tbb_kahypar::flow::make_edge( b, b2 );
    tbb_kahypar::flow::make_edge( b2, b3 );
    ...
    NativeParallelFor( num_threads, parallel_puts<T>(b) );
    // copy b:
    tbb_kahypar::flow::buffer_node<T> b_copy(b);
...
using tbb_kahypar::TBB_INTERNAL_NAMESPACE::register_predecessor;
using tbb_kahypar::TBB_INTERNAL_NAMESPACE::remove_predecessor;
...
int test_serial() {
    ...
    tbb_kahypar::flow::remove_edge(b, b2);
...
void test_follows_and_precedes_api() {
    ...
    follows_and_precedes_testing::test_follows<msg_t, tbb_kahypar::flow::buffer_node<msg_t>>(messages_for_follows);
    follows_and_precedes_testing::test_precedes<msg_t, tbb_kahypar::flow::buffer_node<msg_t>>(messages_for_precedes);
}
#endif
...
void test_buffer_node_try_put_and_wait() {
    ...
    // test_buffer_push returns the index from which the items processed during wait_for_all() starts
    {
        ...
        std::size_t after_start = test_buffer_push<tbb_kahypar::flow::buffer_node<int>>(start_work_items, wait_message,
...

    {
        ...
        std::size_t after_start = test_buffer_pull<tbb_kahypar::flow::buffer_node<int>>(start_work_items, wait_message, occupier,
                                                                                new_work_items, processed_items);
    ...
    // Test reserve
    {
        ...
        for (int threshold : thresholds) {
            ...
            std::size_t after_start = test_buffer_reserve<tbb_kahypar::flow::buffer_node<int>>(threshold,
...
TEST_CASE("Resets"){
    test_resets<int,tbb_kahypar::flow::buffer_node<int> >();
    test_resets<float,tbb_kahypar::flow::buffer_node<float> >();
}
