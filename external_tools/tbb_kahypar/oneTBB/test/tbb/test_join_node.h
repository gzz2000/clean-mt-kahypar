...
using tbb_kahypar::detail::d2::type_to_key_function_body;
using tbb_kahypar::detail::d2::type_to_key_function_body_leaf;
using tbb_kahypar::detail::d2::hash_buffer;
using tbb_kahypar::detail::d1::tbb_hash_compare;
...
struct is_key_matching_join<tbb_kahypar::flow::key_matching<K, KHash> > {
    static const bool value;
    typedef K key_type;
};

template<class K, class KHash>
const bool is_key_matching_join<tbb_kahypar::flow::key_matching<K, KHash> >::value = true;
...
class recirc_func_body {
    TT my_mult;
public:
    typedef std::tuple<int, tbb_kahypar::flow::continue_msg> input_type;
...
public:
    ...
    TT operator()(tbb_kahypar::flow_control& fc) {
        int lc = my_count;
...
struct filter_out_message_based_key_matching<message_based_key_matching<K, KHash> > {
    ...
    typedef tbb_kahypar::flow::key_matching<K, KHash> policy;
};
...
class makeJoin {
public:
    static JType *create(tbb_kahypar::flow::graph& g) {
...
class makeJoin<2, JType, tbb_kahypar::flow::key_matching<K, KHash> > {
...
class makeJoin<2, JType, tbb_kahypar::flow::tag_matching> {
    typedef typename JType::output_type TType;
    typedef typename std::tuple_element<0, TType>::type T0;
    typedef typename std::tuple_element<1, TType>::type T1;
public:
...
template<typename JType, typename K, typename KHash>
class makeJoin<3, JType, tbb_kahypar::flow::key_matching<K, KHash> > {
    typedef typename JType::output_type TType;
    typedef typename std::tuple_element<0, TType>::type T0;
    typedef typename std::tuple_element<1, TType>::type T1;
...
template<typename JType>
class makeJoin<3, JType, tbb_kahypar::flow::tag_matching> {
    typedef typename JType::output_type TType;
    typedef typename std::tuple_element<0, TType>::type T0;
    typedef typename std::tuple_element<1, TType>::type T1;
    typedef typename std::tuple_element<2, TType>::type T2;
...
template<typename JType, typename K, typename KHash>
class makeJoin<4, JType, tbb_kahypar::flow::key_matching<K, KHash> > {
    typedef typename JType::output_type TType;
    typedef typename std::tuple_element<0, TType>::type T0;
    typedef typename std::tuple_element<1, TType>::type T1;
    typedef typename std::tuple_element<2, TType>::type T2;
...
template<typename JType>
class makeJoin<4, JType, tbb_kahypar::flow::tag_matching> {
    typedef typename JType::output_type TType;
    typedef typename std::tuple_element<0, TType>::type T0;
    typedef typename std::tuple_element<1, TType>::type T1;
    typedef typename std::tuple_element<2, TType>::type T2;
...
template<typename JType, typename K, typename KHash>
class makeJoin<5, JType, tbb_kahypar::flow::key_matching<K, KHash> > {
    typedef typename JType::output_type TType;
    typedef typename std::tuple_element<0, TType>::type T0;
    typedef typename std::tuple_element<1, TType>::type T1;
    typedef typename std::tuple_element<2, TType>::type T2;
...
template<typename JType>
class makeJoin<5, JType, tbb_kahypar::flow::tag_matching> {
    typedef typename JType::output_type TType;
    typedef typename std::tuple_element<0, TType>::type T0;
    typedef typename std::tuple_element<1, TType>::type T1;
    typedef typename std::tuple_element<2, TType>::type T2;
...
template<typename JType, typename K, typename KHash>
class makeJoin<6, JType, tbb_kahypar::flow::key_matching<K, KHash> > {
    typedef typename JType::output_type TType;
    typedef typename std::tuple_element<0, TType>::type T0;
    typedef typename std::tuple_element<1, TType>::type T1;
    typedef typename std::tuple_element<2, TType>::type T2;
...
template<typename JType>
class makeJoin<6, JType, tbb_kahypar::flow::tag_matching> {
    typedef typename JType::output_type TType;
    typedef typename std::tuple_element<0, TType>::type T0;
    typedef typename std::tuple_element<1, TType>::type T1;
    typedef typename std::tuple_element<2, TType>::type T2;
...
template<typename JType, typename K, typename KHash>
class makeJoin<7, JType, tbb_kahypar::flow::key_matching<K, KHash> > {
    typedef typename JType::output_type TType;
    typedef typename std::tuple_element<0, TType>::type T0;
    typedef typename std::tuple_element<1, TType>::type T1;
    typedef typename std::tuple_element<2, TType>::type T2;
...
template<typename JType>
class makeJoin<7, JType, tbb_kahypar::flow::tag_matching> {
    typedef typename JType::output_type TType;
    typedef typename std::tuple_element<0, TType>::type T0;
    typedef typename std::tuple_element<1, TType>::type T1;
    typedef typename std::tuple_element<2, TType>::type T2;
...
template<typename JType, typename K, typename KHash>
class makeJoin<8, JType, tbb_kahypar::flow::key_matching<K, KHash> > {
    typedef typename JType::output_type TType;
    typedef typename std::tuple_element<0, TType>::type T0;
    typedef typename std::tuple_element<1, TType>::type T1;
    typedef typename std::tuple_element<2, TType>::type T2;
...
template<typename JType>
class makeJoin<8, JType, tbb_kahypar::flow::tag_matching> {
    typedef typename JType::output_type TType;
    typedef typename std::tuple_element<0, TType>::type T0;
    typedef typename std::tuple_element<1, TType>::type T1;
    typedef typename std::tuple_element<2, TType>::type T2;
...
template<typename JType, typename K, typename KHash>
class makeJoin<9, JType, tbb_kahypar::flow::key_matching<K, KHash> > {
    typedef typename JType::output_type TType;
    typedef typename std::tuple_element<0, TType>::type T0;
    typedef typename std::tuple_element<1, TType>::type T1;
    typedef typename std::tuple_element<2, TType>::type T2;
...
template<typename JType>
class makeJoin<9, JType, tbb_kahypar::flow::tag_matching> {
    typedef typename JType::output_type TType;
    typedef typename std::tuple_element<0, TType>::type T0;
    typedef typename std::tuple_element<1, TType>::type T1;
    typedef typename std::tuple_element<2, TType>::type T2;
...
template<typename JType, typename K, typename KHash>
class makeJoin<10, JType, tbb_kahypar::flow::key_matching<K, KHash> > {
    typedef typename JType::output_type TType;
    typedef typename std::tuple_element<0, TType>::type T0;
    typedef typename std::tuple_element<1, TType>::type T1;
    typedef typename std::tuple_element<2, TType>::type T2;
...
template<typename JType>
class makeJoin<10, JType, tbb_kahypar::flow::tag_matching> {
    typedef typename JType::output_type TType;
    typedef typename std::tuple_element<0, TType>::type T0;
    typedef typename std::tuple_element<1, TType>::type T1;
    typedef typename std::tuple_element<2, TType>::type T2;
...
public:
    ...
    typedef tbb_kahypar::flow::join_node<std::tuple<int, tbb_kahypar::flow::continue_msg>, tbb_kahypar::flow::reserving> input_join_type;
    typedef typename join_node_type::output_type TT;

    typedef typename std::tuple_element<ELEM-1, TT>::type IT;
    typedef typename tbb_kahypar::flow::input_node<IT> my_input_node_type;
    typedef typename tbb_kahypar::flow::function_node<std::tuple<int, tbb_kahypar::flow::continue_msg>, IT> my_recirc_function_type;
    static void print_remark(const char * str) {
        input_node_helper<ELEM-1, JNT>::print_remark(str);
        INFO(", " << name_of<IT>::name());
    }
    static void add_input_nodes(join_node_type &my_join, tbb_kahypar::flow::graph &g, int nInputs) {
        for(int i = 0; i < nInputs; ++i) {
            my_input_node_type *new_node = new my_input_node_type(g, my_input_body<IT, ELEM>(i, nInputs));
            tbb_kahypar::flow::make_edge(*new_node, tbb_kahypar::flow::input_port<ELEM-1>(my_join));
    ...
    static void add_recirc_func_nodes(join_node_type &my_join, input_join_type &my_input, tbb_kahypar::flow::graph &g) {
        my_recirc_function_type *new_node = new my_recirc_function_type(g, tbb_kahypar::flow::unlimited, recirc_func_body<IT>((IT)(ELEM+1)));
        tbb_kahypar::flow::make_edge(*new_node, tbb_kahypar::flow::input_port<ELEM-1>(my_join));
        tbb_kahypar::flow::make_edge(my_input, *new_node);
    ...
    static void remove_input_nodes(join_node_type& my_join, int nInputs) {
        for(int i = 0; i< nInputs; ++i) {
            ...
            tbb_kahypar::flow::remove_edge(*dp, tbb_kahypar::flow::input_port<ELEM-1>(my_join));
            delete dp;
        }
    ...
    static void remove_recirc_func_nodes(join_node_type& my_join, input_join_type &my_input) {
        ...
        tbb_kahypar::flow::remove_edge(*fn, tbb_kahypar::flow::input_port<ELEM-1>(my_join));
        tbb_kahypar::flow::remove_edge(my_input, *fn);
        delete fn;
...
public:
    ...
    static void add_input_nodes(join_node_type &my_join, tbb_kahypar::flow::graph &g, int nInputs) {
        for(int i = 0; i < nInputs; ++i) {
            ...
            tbb_kahypar::flow::make_edge(*new_node, tbb_kahypar::flow::input_port<0>(my_join));
    ...
    static void add_recirc_func_nodes(join_node_type &my_join, input_join_type &my_input, tbb_kahypar::flow::graph &g) {
        my_recirc_function_type *new_node = new my_recirc_function_type(g, tbb_kahypar::flow::unlimited, recirc_func_body<IT>((IT)(2)));
        tbb_kahypar::flow::make_edge(*new_node, tbb_kahypar::flow::input_port<0>(my_join));
        tbb_kahypar::flow::make_edge(my_input, *new_node);
    ...
    static void remove_input_nodes(join_node_type& my_join, int nInputs) {
        for(int i = 0; i < nInputs; ++i) {
            ...
            tbb_kahypar::flow::remove_edge(*dp, tbb_kahypar::flow::input_port<0>(my_join));
            delete dp;
        }
    }
    ...
    static void remove_recirc_func_nodes(join_node_type& my_join, input_join_type &my_input) {
        ...
        tbb_kahypar::flow::remove_edge(*fn, tbb_kahypar::flow::input_port<0>(my_join));
        tbb_kahypar::flow::remove_edge(my_input, *fn);
        delete fn;
    }
};
...
public:
    ...
    static void test() {
        ...
        for(int nInputs = 1; nInputs<=MaxNInputs; ++nInputs) {
            ...
            tbb_kahypar::flow::queue_node<TType> outq1(g);
            tbb_kahypar::flow::queue_node<TType> outq2(g);

            tbb_kahypar::flow::make_edge(*my_join, outq1);
            tbb_kahypar::flow::make_edge(*my_join, outq2);
            ...
            tbb_kahypar::flow::remove_edge(*my_join, outq1);
            tbb_kahypar::flow::remove_edge(*my_join, outq2);
...
public:
    ...
    typedef typename std::tuple_element<ELEM-1, TT>::type IT;
    typedef typename tbb_kahypar::flow::queue_node<IT> my_queue_node_type;
    static void print_remark() {
        serial_queue_helper<ELEM-1, JType>::print_remark();
        INFO(", " << name_of<IT>::name());
    }
    static void add_queue_nodes(tbb_kahypar::flow::graph &g, JType &my_join) {
        serial_queue_helper<ELEM-1, JType>::add_queue_nodes(g, my_join);
        my_queue_node_type *new_node = new my_queue_node_type(g);
        tbb_kahypar::flow::make_edge(*new_node, std::get<ELEM-1>(my_join.input_ports()));
        all_input_nodes[ELEM-1][0] = (void *)new_node;
    }
    ...
    static void remove_queue_nodes(JType &my_join) {
        ...
        tbb_kahypar::flow::remove_edge(*vptr, std::get<ELEM-1>(my_join.input_ports()));
...
public:
    ...
    static void remove_queue_nodes(JType &my_join) {
        ...
        tbb_kahypar::flow::remove_edge(*vptr, std::get<0>(my_join.input_ports()));
        delete vptr;
    }
};
...
template<typename JType, class JP>
void test_one_serial(JType &my_join, tbb_kahypar::flow::graph &g) {
    typedef typename JType::output_type TType;
    ...
    tbb_kahypar::flow::queue_node< q3_input_type > q3(g);

    tbb_kahypar::flow::make_edge(my_join, q3);
    ...
    tbb_kahypar::flow::remove_edge(my_join, q3);
    tbb_kahypar::flow::limiter_node<q3_input_type> limiter(g, Count / 2);
    tbb_kahypar::flow::make_edge(my_join, limiter);
    tbb_kahypar::flow::make_edge(limiter, q3);
...
template<
    ...
    class generate_test {
    public:
        typedef tbb_kahypar::flow::join_node<OutputTupleType, typename filter_out_message_based_key_matching<J>::policy> join_node_type;
        static void do_test() {
...
template<>
void test_input_port_policies<tbb_kahypar::flow::reserving>() {
    tbb_kahypar::flow::graph g;
    typedef tbb_kahypar::flow::join_node<std::tuple<int, int>, tbb_kahypar::flow::reserving > JType; // two-phase is the default policy
                                                                                           // create join_node<type0,type1> jn
    JType jn(g);
    // create output_queue oq0, oq1
    typedef JType::output_type OQType;
    tbb_kahypar::flow::queue_node<OQType> oq0(g);
    tbb_kahypar::flow::queue_node<OQType> oq1(g);
    // create iq0, iq1
    typedef tbb_kahypar::flow::queue_node<int> IQType;
    IQType iq0(g);
    IQType iq1(g);
    // create qnp, qnq
    IQType qnp(g);
    ...
    tbb_kahypar::flow::make_edge(jn, oq0);
    tbb_kahypar::flow::make_edge(jn, oq1);

    // attach iq0, iq1 to jn
    tbb_kahypar::flow::make_edge(iq0, std::get<0>(jn.input_ports()));
    tbb_kahypar::flow::make_edge(iq1, std::get<1>(jn.input_ports()));

    for(int loop = 0; loop < 3; ++loop) {
        // place one item in iq0
        CHECK_MESSAGE( (iq0.try_put(1)), "Error putting to iq1");
        // attach iq0 to qnp
        tbb_kahypar::flow::make_edge(iq0, qnp);
        ...
        // detach qnp from iq0
        tbb_kahypar::flow::remove_edge(iq0, qnp); // if we don't remove qnp it will gobble any values we put in iq0
                                          // place item in iq0
        ...
        tbb_kahypar::flow::make_edge(iq0, qnp);
        tbb_kahypar::flow::make_edge(iq1, qnq);
        g.wait_for_all();
        {
            int i;
        ...
        tbb_kahypar::flow::remove_edge(iq0, qnp);
        tbb_kahypar::flow::remove_edge(iq1, qnq);
    } // for ( int loop ...
}
...
// an item, verifying that the item in the queue is consumed.
template<>
void test_input_port_policies<tbb_kahypar::flow::queueing>() {
    tbb_kahypar::flow::graph g;
    typedef tbb_kahypar::flow::join_node<std::tuple<int, int>, tbb_kahypar::flow::queueing > JType;
    // create join_node<type0,type1> jn
    JType jn(g);
    // create output_queue oq0, oq1
    typedef JType::output_type OQType;
...
template<typename T>
struct myTagValue {
    tbb_kahypar::flow::tag_value operator()(T i) { return tbb_kahypar::flow::tag_value(i); }
};

template<>
struct myTagValue<CheckType<int> > {
    tbb_kahypar::flow::tag_value operator()(CheckType<int> i) { return tbb_kahypar::flow::tag_value((int)i); }
};
...
template<>
void test_input_port_policies<tbb_kahypar::flow::tag_matching>() {
    tbb_kahypar::flow::graph g;
    typedef tbb_kahypar::flow::join_node<std::tuple<int, CheckType<int> >, tbb_kahypar::flow::tag_matching > JoinNodeType;
    typedef JoinNodeType::output_type CheckTupleType;
    JoinNodeType testJoinNode(g, myTagValue<int>(), myTagValue<CheckType<int> >());
    tbb_kahypar::flow::queue_node<CheckTupleType> checkTupleQueue0(g);
    tbb_kahypar::flow::queue_node<CheckTupleType> checkTupleQueue1(g);
    {
        Checker<CheckType<int> > my_check;


        typedef tbb_kahypar::flow::queue_node<int> IntQueueType;
        typedef tbb_kahypar::flow::queue_node<CheckType<int> > CheckQueueType;
        ...
        tbb_kahypar::flow::make_edge(testJoinNode, checkTupleQueue0);
        tbb_kahypar::flow::make_edge(testJoinNode, checkTupleQueue1);

        // attach intInputQueue, checkInputQueue to testJoinNode
        tbb_kahypar::flow::make_edge(intInputQueue, tbb_kahypar::flow::input_port<0>(testJoinNode));
        tbb_kahypar::flow::make_edge(checkInputQueue, tbb_kahypar::flow::input_port<1>(testJoinNode));
        ...
        for(int loop = 0; loop < 4; ++loop) {
            ...
            tbb_kahypar::flow::make_edge(intInputQueue, intEmptyTestQueue);
            ...
            tbb_kahypar::flow::make_edge(checkInputQueue, checkEmptyTestQueue);
            g.wait_for_all();
            {
                int intVal1;
            ...
            tbb_kahypar::flow::remove_edge(intInputQueue, intEmptyTestQueue);
            tbb_kahypar::flow::remove_edge(checkInputQueue, checkEmptyTestQueue);
        } // for ( int loop ...
...
template<> struct policy_name<tbb_kahypar::flow::queueing> {
const char* msg_beg() { return "queueing\n";}
const char* msg_end() { return "test queueing extract\n";}
};

template<> struct policy_name<tbb_kahypar::flow::reserving> {
const char* msg_beg() { return "reserving\n";}
const char* msg_end() { return "test reserving extract\n";}
};

template<> struct policy_name<tbb_kahypar::flow::tag_matching> {
