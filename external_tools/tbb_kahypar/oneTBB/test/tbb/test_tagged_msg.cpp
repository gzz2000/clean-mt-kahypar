...
using tbb_kahypar::flow::cast_to;
using tbb_kahypar::flow::is_a;
...
typedef tbb_kahypar::flow::tagged_msg<size_t, int, char, double, odd_array_type, odder_array, d_vector, CheckType<int>, counted_array_type, i_vector_array> tagged_msg_type;

// test base of tagged_msg
void TestWrapper() {
    using tbb_kahypar::detail::d2::Wrapper;
    Wrapper<int> wi(42);
    Wrapper<int> wic(23);
...
void RunTests() {
    ...
    tbb_kahypar::flow::tagged_msg<char, int, char, double> k('a', 4);
    k.set_tag('b');
