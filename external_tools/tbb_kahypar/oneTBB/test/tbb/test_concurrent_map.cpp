...
struct AllowMultimapping<tbb_kahypar::concurrent_multimap<Args...>> : std::true_type {};
...
using map_type = tbb_kahypar::concurrent_map<int, int, std::less<int>, MyAllocator<int, int>>;
using multimap_type = tbb_kahypar::concurrent_multimap<int, int, std::less<int>, MyAllocator<int, int>>;
using checked_map_type = tbb_kahypar::concurrent_map<int, CheckType<int>, std::less<int>, MyAllocator<int, CheckType<int>>>;
using checked_multimap_type = tbb_kahypar::concurrent_multimap<int, CheckType<int>, std::less<int>, MyAllocator<int, CheckType<int>>>;
using greater_map_type = tbb_kahypar::concurrent_map<int, int, std::greater<int>, MyAllocator<int, int>>;
using greater_multimap_type = tbb_kahypar::concurrent_multimap<int, int, std::greater<int>, MyAllocator<int, int>>;
using checked_state_map_type = tbb_kahypar::concurrent_map<intptr_t, FooWithAssign, std::less<intptr_t>,
                                                   MyAllocator<intptr_t, FooWithAssign>>;
using checked_state_multimap_type = tbb_kahypar::concurrent_multimap<intptr_t, FooWithAssign, std::less<intptr_t>,
                                                             MyAllocator<intptr_t, FooWithAssign>>;
...
struct COMapTraits : OrderedMoveTraitsBase {
    ...
    using container_type = tbb_kahypar::concurrent_map<T, T, std::less<T>, Allocator>;
...
struct COMultimapTraits : OrderedMoveTraitsBase {
    template <typename T, typename Allocator>
    using container_type = tbb_kahypar::concurrent_multimap<T, T, std::less<T>, Allocator>;
...
struct OrderedMapTypesTester {
    ...
    void check( const std::list<ValueType>& lst ) {
        ...
        TypeTester<DefCtorPresent, tbb_kahypar::concurrent_map<key_type, mapped_type>>(lst);
        TypeTester<DefCtorPresent, tbb_kahypar::concurrent_multimap<key_type, mapped_type>>(lst);
    }
}; // struct OrderedMapTypesTester
...
void test_specific_types() {
    ...
    test_emplace_insert<tbb_kahypar::concurrent_map<int*, test::unique_ptr<int>>,std::false_type>
                       (new int, new int);
    test_emplace_insert<tbb_kahypar::concurrent_multimap<int*, test::unique_ptr<int>>,std::false_type>
                       (new int, new int);
}
...
void test_cycles_absense() {
    for (std::size_t execution = 0; execution != 10; ++execution) {
        tbb_kahypar::concurrent_multimap<int, int> mmap;
        std::vector<int> v(2);
...
TEST_CASE("concurrent_map::swap with not always equal allocator") {
    using not_always_equal_alloc_map_type = tbb_kahypar::concurrent_map<int, int, std::less<int>,
...
TEST_CASE("concurrent_multimap::swap with not always equal allocator") {
    using not_always_equal_alloc_mmap_type = tbb_kahypar::concurrent_multimap<int, int, std::less<int>,
                                                                      NotAlwaysEqualAllocator<std::pair<const int, int>>>;
...
TEST_CASE("concurrent_map throwing copy constructor") {
    using exception_map_type = tbb_kahypar::concurrent_map<ThrowOnCopy, ThrowOnCopy>;
    test_exception_on_copy_ctor<exception_map_type>();
}

//! \brief \ref error_guessing
TEST_CASE("concurrent_multimap throwing copy constructor") {
    using exception_mmap_type = tbb_kahypar::concurrent_multimap<ThrowOnCopy, ThrowOnCopy>;
...
TEST_CASE("container_range concept for concurrent_map ranges") {
    static_assert(test_concepts::container_range<typename tbb_kahypar::concurrent_map<int, int>::range_type>);
    static_assert(test_concepts::container_range<typename tbb_kahypar::concurrent_map<int, int>::const_range_type>);
}

//! \brief \ref error_guessing
TEST_CASE("container_range concept for concurrent_multimap ranges") {
    static_assert(test_concepts::container_range<typename tbb_kahypar::concurrent_multimap<int, int>::range_type>);
    static_assert(test_concepts::container_range<typename tbb_kahypar::concurrent_multimap<int, int>::const_range_type>);
}
