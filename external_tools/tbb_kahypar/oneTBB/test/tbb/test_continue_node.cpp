...
struct fake_continue_sender : public tbb_kahypar::flow::sender<tbb_kahypar::flow::continue_msg>
{
    typedef tbb_kahypar::flow::sender<tbb_kahypar::flow::continue_msg>::successor_type successor_type;
...
void run_continue_nodes( int p, tbb_kahypar::flow::graph& g, tbb_kahypar::flow::continue_node< OutputType >& n ) {
    fake_continue_sender fake_sender;
    for (size_t i = 0; i < N; ++i) {
        tbb_kahypar::detail::d2::register_predecessor(n, fake_sender);
    }
    ...
    for (size_t num_receivers = 1; num_receivers <= MAX_NODES; ++num_receivers ) {
        ...
        harness_graph_executor<tbb_kahypar::flow::continue_msg, OutputType>::execute_count = 0;

        for (size_t r = 0; r < num_receivers; ++r ) {
            tbb_kahypar::flow::make_edge( n, *receivers[r] );
        }

        utils::NativeParallelFor( p, parallel_puts<tbb_kahypar::flow::continue_msg>(n) );
        g.wait_for_all();

        // 2) the nodes will receive puts from multiple predecessors simultaneously,
        size_t ec = harness_graph_executor<tbb_kahypar::flow::continue_msg, OutputType>::execute_count;
        ...
        for (size_t r = 0; r < num_receivers; ++r ) {
            tbb_kahypar::flow::remove_edge( n, *receivers[r] );
        }
    }
}
...
void continue_nodes( Body body ) {
    for (int p = 1; p < 2*4/*MaxThread*/; ++p) {
        ...
        tbb_kahypar::flow::continue_node< OutputType > exe_node( g, body );
        run_continue_nodes( p, g, exe_node);
        exe_node.try_put(tbb_kahypar::flow::continue_msg());
        tbb_kahypar::flow::continue_node< OutputType > exe_node_copy( exe_node );
...
struct inc_functor {
    ...
    OutputType operator()( tbb_kahypar::flow::continue_msg ) {
...
void continue_nodes_with_copy( ) {
    ...
    for (int p = 1; p < 2*4/*MaxThread*/; ++p) {
        ...
        tbb_kahypar::flow::continue_node< OutputType > exe_node( g, cf );
        fake_continue_sender fake_sender;
        for (size_t i = 0; i < N; ++i) {
            tbb_kahypar::detail::d2::register_predecessor(exe_node, fake_sender);
        }
        ...
        for (size_t num_receivers = 1; num_receivers <= MAX_NODES; ++num_receivers ) {
            ...
            utils::NativeParallelFor( p, parallel_puts<tbb_kahypar::flow::continue_msg>(exe_node) );
            g.wait_for_all();
        ...
        inc_functor<OutputType> body_copy = tbb_kahypar::flow::copy_body< inc_functor<OutputType> >( exe_node );
        ...
        body_copy = tbb_kahypar::flow::copy_body< inc_functor<OutputType> >( exe_node );
...
void run_continue_nodes() {
    harness_graph_executor< tbb_kahypar::flow::continue_msg, OutputType>::max_executors = 0;
    continue_nodes<OutputType>( []( tbb_kahypar::flow::continue_msg i ) -> OutputType { return harness_graph_executor<tbb_kahypar::flow::continue_msg, OutputType>::func(i); } );
    continue_nodes<OutputType>( &harness_graph_executor<tbb_kahypar::flow::continue_msg, OutputType>::func );
    continue_nodes<OutputType>( typename harness_graph_executor<tbb_kahypar::flow::continue_msg, OutputType>::functor() );
...
void test_concurrency(int num_threads) {
    tbb_kahypar::task_arena arena(num_threads);
    arena.execute(
        [&] {
            run_continue_nodes<tbb_kahypar::flow::continue_msg>();
...
void test_lightweight_policy() {
    ...
    tbb_kahypar::flow::continue_node<tbb_kahypar::flow::continue_msg, tbb_kahypar::flow::lightweight>
        node1(g, lightweight_policy_body(count1));
    tbb_kahypar::flow::continue_node<tbb_kahypar::flow::continue_msg, tbb_kahypar::flow::lightweight>
        node2(g, lightweight_policy_body(count2));

    tbb_kahypar::flow::make_edge(node1, node2);
    const size_t n = 10;
    for(size_t i = 0; i < n; ++i) {
        node1.try_put(tbb_kahypar::flow::continue_msg());
    }
    g.wait_for_all();

    lightweight_policy_body body1 = tbb_kahypar::flow::copy_body<lightweight_policy_body>(node1);
    lightweight_policy_body body2 = tbb_kahypar::flow::copy_body<lightweight_policy_body>(node2);
...
void test_follows_and_precedes_api() {
    ...
    follows_and_precedes_testing::test_follows
        <msg_t, tbb_kahypar::flow::continue_node<msg_t>>
...
void test_try_put_and_wait_default() {
    ...
    arena.execute([&]{
        ...
        tbb_kahypar::flow::continue_node<tbb_kahypar::flow::continue_msg>* start_node = nullptr;

        tbb_kahypar::flow::continue_node<tbb_kahypar::flow::continue_msg> cont(g,
            [&](tbb_kahypar::flow::continue_msg) noexcept {
                static bool put_ten_msgs = true;
                if (put_ten_msgs) {
                    for (std::size_t i = 0; i < 10; ++i) {
                        start_node->try_put(tbb_kahypar::flow::continue_msg{});
                    }
                    put_ten_msgs = false;
                }
            });
        ...
        tbb_kahypar::flow::continue_node<tbb_kahypar::flow::continue_msg, tbb_kahypar::flow::lightweight> writer(g,
            [&](tbb_kahypar::flow::continue_msg) noexcept {
                ++processed_items;
            });

        tbb_kahypar::flow::make_edge(cont, writer);

        cont.try_put_and_wait(tbb_kahypar::flow::continue_msg{});
...
void test_try_put_and_wait_lightweight() {
    ...
    arena.execute([&]{
        ...
        tbb_kahypar::flow::continue_node<int, tbb_kahypar::flow::lightweight>* start_node = nullptr;

        tbb_kahypar::flow::continue_node<int, tbb_kahypar::flow::lightweight> cont(g,
            [&](tbb_kahypar::flow::continue_msg) noexcept {
        ...
        tbb_kahypar::flow::function_node<int, int, tbb_kahypar::flow::lightweight> writer(g, tbb_kahypar::flow::unlimited,
            [&](int input) noexcept {
        ...
        for (auto item : start_work_items) {
            (void)item;
            cont.try_put(tbb_kahypar::flow::continue_msg{});
        }
...
void test_metainfo_buffering() {
    ...
    arena.execute([&] {
        ...
        tbb_kahypar::flow::continue_node<tbb_kahypar::flow::continue_msg>* b_ptr = nullptr;

        tbb_kahypar::flow::continue_node<tbb_kahypar::flow::continue_msg> a(g,
            [&](tbb_kahypar::flow::continue_msg) noexcept {
                call_order.push_back('A');
                static std::once_flag flag; // Send a signal to B only in the first call
                std::call_once(flag, [&]{ b_ptr->try_put(tbb_kahypar::flow::continue_msg{}); });
            });

        tbb_kahypar::flow::continue_node<tbb_kahypar::flow::continue_msg> b(g,
            [&](tbb_kahypar::flow::continue_msg) noexcept {
                call_order.push_back('B');
                a.try_put(tbb_kahypar::flow::continue_msg{});
            });

        b_ptr = &b;

        tbb_kahypar::flow::continue_node<tbb_kahypar::flow::continue_msg, tbb_kahypar::flow::lightweight> c(g,
            [&](tbb_kahypar::flow::continue_msg) noexcept {
                call_order.push_back('C');
            });

        tbb_kahypar::flow::make_edge(a, c);
        tbb_kahypar::flow::make_edge(b, c);

        a.try_put_and_wait(tbb_kahypar::flow::continue_msg{});
...
TEST_CASE("constraints for continue_node input") {
    static_assert(utils::well_formed_instantiation<tbb_kahypar::flow::continue_node, test_concepts::Copyable>);
    static_assert(!utils::well_formed_instantiation<tbb_kahypar::flow::continue_node, test_concepts::NonCopyable>);
}

template <typename Input, typename Body>
concept can_call_continue_node_ctor = requires( tbb_kahypar::flow::graph& graph, Body body,
                                                tbb_kahypar::flow::buffer_node<int>& f, std::size_t num,
                                                tbb_kahypar::flow::node_priority_t priority  ) {
    tbb_kahypar::flow::continue_node<Input>(graph, body);
    tbb_kahypar::flow::continue_node<Input>(graph, body, priority);
    tbb_kahypar::flow::continue_node<Input>(graph, num, body);
    tbb_kahypar::flow::continue_node<Input>(graph, num, body, priority);
#if __TBB_PREVIEW_FLOW_GRAPH_NODE_SET
    tbb_kahypar::flow::continue_node<Input>(tbb_kahypar::flow::follows(f), body);
    tbb_kahypar::flow::continue_node<Input>(tbb_kahypar::flow::follows(f), body, priority);
    tbb_kahypar::flow::continue_node<Input>(tbb_kahypar::flow::follows(f), num, body);
    tbb_kahypar::flow::continue_node<Input>(tbb_kahypar::flow::follows(f), num, body, priority);
#endif // __TBB_PREVIEW_FLOW_GRAPH_NODE_SET
};
