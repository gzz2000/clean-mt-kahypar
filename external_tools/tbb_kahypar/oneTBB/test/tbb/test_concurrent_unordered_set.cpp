...
struct AllowMultimapping<tbb_kahypar::concurrent_unordered_multiset<Args...>> : std::true_type {};
...
using set_type = tbb_kahypar::concurrent_unordered_set<int, std::hash<int>, std::equal_to<int>, MyAllocator<int>>;
using multiset_type = tbb_kahypar::concurrent_unordered_multiset<int, std::hash<int>, std::equal_to<int>, MyAllocator<int>>;
using degenerate_set_type = tbb_kahypar::concurrent_unordered_set<int, degenerate_hash<int>, std::equal_to<int>, MyAllocator<int>>;
using degenerate_multiset_type = tbb_kahypar::concurrent_unordered_multiset<int, degenerate_hash<int>, std::equal_to<int>, MyAllocator<int>>;

using checked_set_type = tbb_kahypar::concurrent_unordered_set<CheckType<int>, std::hash<CheckType<int>>, std::equal_to<CheckType<int>>, MyAllocator<CheckType<int>>>;
using checked_multiset_type = tbb_kahypar::concurrent_unordered_multiset<CheckType<int>, std::hash<CheckType<int>>,
                                                                 std::equal_to<CheckType<int>>, MyAllocator<CheckType<int>>>;
using checked_state_set_type = tbb_kahypar::concurrent_unordered_set<FooWithAssign, std::hash<FooWithAssign>, std::equal_to<FooWithAssign>,
                                                             MyAllocator<FooWithAssign>>;
using checked_state_multiset_type = tbb_kahypar::concurrent_unordered_multiset<FooWithAssign, std::hash<FooWithAssign>, std::equal_to<FooWithAssign>,
                                                                       MyAllocator<FooWithAssign>>;

struct CusetTraits : UnorderedMoveTraitsBase {
    template <typename T, typename Allocator>
    using container_type = tbb_kahypar::concurrent_unordered_set<T, std::hash<T>, std::equal_to<T>, Allocator>;
...
struct CumultisetTraits : UnorderedMoveTraitsBase {
    template <typename T, typename Allocator>
    using container_type = tbb_kahypar::concurrent_unordered_multiset<T, std::hash<T>, std::equal_to<T>, Allocator>;
...
struct UnorderedSetTypesTester {
    ...
    void check( const std::list<ValueType>& lst ) {
        TypeTester<DefCtorPresent, tbb_kahypar::concurrent_unordered_set<ValueType, std::hash<ValueType>, utils::IsEqual>>(lst);
        TypeTester<DefCtorPresent, tbb_kahypar::concurrent_unordered_multiset<ValueType, std::hash<ValueType>, utils::IsEqual>>(lst);
    }
};
...
void test_specific_types() {
    ...
    test_emplace_insert<tbb_kahypar::concurrent_unordered_set<test::unique_ptr<int>>,
                        std::false_type>(new int, new int);
    test_emplace_insert<tbb_kahypar::concurrent_unordered_multiset<test::unique_ptr<int>>,
                        std::false_type>(new int, new int);
}
...
TEST_CASE("concurrent_unordered_set::swap with not always equal allocator") {
    using not_always_equal_alloc_set_type = tbb_kahypar::concurrent_unordered_set<int, std::hash<int>, std::equal_to<int>,
...
TEST_CASE("concurrent_unordered_multiset::swap with not always equal allocator") {
    using not_always_equal_alloc_mset_type = tbb_kahypar::concurrent_unordered_multiset<int, std::hash<int>, std::equal_to<int>,
                                                                                NotAlwaysEqualAllocator<int>>;
...
TEST_CASE("concurrent_unordered_set throwing copy constructor") {
    using exception_set_type = tbb_kahypar::concurrent_unordered_set<ThrowOnCopy>;
    test_exception_on_copy_ctor<exception_set_type>();
}

//! \brief \ref error_guessing
TEST_CASE("concurrent_unordered_multimap throwing copy constructor") {
    using exception_mset_type = tbb_kahypar::concurrent_unordered_multiset<ThrowOnCopy>;
...
TEST_CASE("container_range concept for concurrent_unordered_set ranges") {
    static_assert(test_concepts::container_range<typename tbb_kahypar::concurrent_unordered_set<int>::range_type>);
    static_assert(test_concepts::container_range<typename tbb_kahypar::concurrent_unordered_set<int>::const_range_type>);
}

//! \brief \ref error_guessing
TEST_CASE("container_range concept for concurrent_unordered_multiset ranges") {
    static_assert(test_concepts::container_range<typename tbb_kahypar::concurrent_unordered_multiset<int>::range_type>);
    static_assert(test_concepts::container_range<typename tbb_kahypar::concurrent_unordered_multiset<int>::const_range_type>);
}
#endif // __TBB_CPP20_CONCEPTS_PRESENT

//! \brief \ref regression
TEST_CASE("reserve(0) issue regression test") {
    test_reserve_regression<oneapi::tbb_kahypar::concurrent_unordered_set<int>>();
    test_reserve_regression<oneapi::tbb_kahypar::concurrent_unordered_multiset<int>>();
}
