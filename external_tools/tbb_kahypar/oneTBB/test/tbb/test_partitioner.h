...
public:
    RangeBase(size_t _begin, size_t _end, RangeStatisticData *statData,
        ...
        { }
    RangeBase(RangeBase& r, tbb_kahypar::split) : RangeStatisticCollector(r, r.size()) {
        *this = r;
 ...
 * BlockedRange uses tbb_kahypar::blocked_range formula for proportion calculation
...
public:
    ...
    RoundedDownRange(RoundedDownRange& r, tbb_kahypar::split)
        : RangeBase<RoundedDownRange, float>(r, tbb_kahypar::split()) { }
...
public:
    RoundedUpRange(size_t _begin, size_t _end, RangeStatisticData *statData,
        ...
        : RangeBase<RoundedUpRange, float>(_begin, _end, statData, provide_feedback,
                                           ensure_non_empty_size) { }
    RoundedUpRange(RoundedUpRange& r, tbb_kahypar::split)
        : RangeBase<RoundedUpRange, float>(r, tbb_kahypar::split()) { }
...
public:
    Range1_2(size_t _begin, size_t _end, RangeStatisticData *statData,
        ...
        : RangeBase<Range1_2, float>(_begin, _end, statData, provide_feedback,
                                     ensure_non_empty_size) { }
    Range1_2(Range1_2& r, tbb_kahypar::split) : RangeBase<Range1_2, float>(r, tbb_kahypar::split()) { }
...
public:
    Range1_999(size_t _begin, size_t _end, RangeStatisticData *statData,
        ...
        : RangeBase<Range1_999, float>(_begin, _end, statData, provide_feedback,
                                       ensure_non_empty_size) { }
    Range1_999(Range1_999& r, tbb_kahypar::split) : RangeBase<Range1_999, float>(r, tbb_kahypar::split()) { }
...
public:
    Range999_1(size_t _begin, size_t _end, RangeStatisticData *statData,
        ...
        : RangeBase<Range999_1, float>(_begin, _end, statData, provide_feedback,
                                       ensure_non_empty_size) { }
    Range999_1(Range999_1& r, tbb_kahypar::split) : RangeBase<Range999_1, float>(r, tbb_kahypar::split()) { }
...
public:
    SimpleReduceBody() { }
    SimpleReduceBody(SimpleReduceBody&, tbb_kahypar::split) { }
    template <typename Range>
    void operator()(Range&) { }
...
public:
    ...
    SplitConstructorAssertedRange(SplitConstructorAssertedRange& r, tbb_kahypar::split) {
        *this = r;
...
public:
    ...
    Range1( Range1& r, tbb_kahypar::split ) : SplitConstructorAssertedRange(r, tbb_kahypar::split()) { }
...
public:
    Range6(bool assert_in_nonproportional, bool assert_in_proportional)
        : SplitConstructorAssertedRange(assert_in_nonproportional, assert_in_proportional) { }
    Range6(Range6& r, tbb_kahypar::split) : SplitConstructorAssertedRange(r, tbb_kahypar::split()) { }
};
