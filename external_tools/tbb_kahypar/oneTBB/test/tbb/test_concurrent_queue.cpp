...
void TestQueueWorksWithPrimitiveTypes() {
    TestPrimitiveTypes<tbb_kahypar::concurrent_queue<char>, char>(MaxThread, (char)1);
    TestPrimitiveTypes<tbb_kahypar::concurrent_queue<int>, int>(MaxThread, (int)-12);
    TestPrimitiveTypes<tbb_kahypar::concurrent_queue<float>, float>(MaxThread, (float)-1.2f);
    TestPrimitiveTypes<tbb_kahypar::concurrent_queue<double>, double>(MaxThread, (double)-4.3);
    TestPrimitiveTypes<tbb_kahypar::concurrent_bounded_queue<char>, char>(MaxThread, (char)1);
    TestPrimitiveTypes<tbb_kahypar::concurrent_bounded_queue<int>, int>(MaxThread, (int)-12);
    TestPrimitiveTypes<tbb_kahypar::concurrent_bounded_queue<float>, float>(MaxThread, (float)-1.2f);
    TestPrimitiveTypes<tbb_kahypar::concurrent_bounded_queue<double>, double>(MaxThread, (double)-4.3);
}
...
#if HAVE_m128
    TestVectorTypes<ClassWithSSE, tbb_kahypar::concurrent_queue<ClassWithSSE> >();
    TestVectorTypes<ClassWithSSE, tbb_kahypar::concurrent_bounded_queue<ClassWithSSE> >();
#endif /* HAVE_m128 */
#if HAVE_m256
    if( have_AVX() ) {
        TestVectorTypes<ClassWithAVX, tbb_kahypar::concurrent_queue<ClassWithAVX> >();
        TestVectorTypes<ClassWithAVX, tbb_kahypar::concurrent_bounded_queue<ClassWithAVX> >();
    }
#endif /* HAVE_m256 */
}
...
TEST_CASE("Test exception in allocation") {
    ...
    using queue_type = tbb_kahypar::concurrent_queue<int, allocator_type>;
...
//! \brief \ref regression \ref error_guessing
TEST_CASE("Test exception in allocation") {
    CopyWithThrowElement<tbb_kahypar::concurrent_queue<throw_element>>();
    CopyWithThrowElement<tbb_kahypar::concurrent_bounded_queue<throw_element>>();
}
...
TEST_CASE("Test clear and dtor with TrackableItem") {
    test_tracking_dtors_on_clear<oneapi::tbb_kahypar::concurrent_queue<TrackableItem>>();
    test_tracking_dtors_on_clear<oneapi::tbb_kahypar::concurrent_bounded_queue<TrackableItem>>();
}
...
TEST_CASE("test capacity on modifying operations") {
    ...
    using queue_type = oneapi::tbb_kahypar::concurrent_bounded_queue<int>;
