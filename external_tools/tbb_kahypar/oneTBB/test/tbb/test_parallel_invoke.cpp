...
TEST_CASE("Test memory leaks") {
    ...
    tbb_kahypar::global_control control(tbb_kahypar::global_control::max_allowed_parallelism, concurrency_limit);
...
void test_from_2_to_10_arguments(const Body& body, const std::atomic<std::size_t>& counter) {
    ...
    tbb_kahypar::parallel_invoke(body, body, body);
    tbb_kahypar::parallel_invoke(body, body, body, body);
    tbb_kahypar::parallel_invoke(body, body, body, body, body);
    tbb_kahypar::parallel_invoke(body, body, body, body, body, body);
    tbb_kahypar::parallel_invoke(body, body, body, body, body, body, body);
    tbb_kahypar::parallel_invoke(body, body, body, body, body, body, body, body);
    tbb_kahypar::parallel_invoke(body, body, body, body, body, body, body, body, body);
    tbb_kahypar::parallel_invoke(body, body, body, body, body, body, body, body, body, body);
