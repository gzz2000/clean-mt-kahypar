...
typedef tbb_kahypar::flow::async_node< int, int, tbb_kahypar::flow::queueing > counting_async_node_type;
typedef counting_async_node_type::gateway_type counting_gateway_type;

struct counting_async_unlimited_body {

    counting_async_unlimited_body(tbb_kahypar::task_group_context& graph_tgc) : my_tgc( graph_tgc ) {}
...
private:
    tbb_kahypar::task_group_context& my_tgc;
};
...
struct counting_async_serial_body : counting_async_unlimited_body {
    ...
    counting_async_serial_body(tbb_kahypar::task_group_context& tgc)
...
void test_reset() {
    ...
    tbb_kahypar::task_group_context graph_ctx;
    tbb_kahypar::flow::graph g(graph_ctx);
    counting_async_node_type a(g, tbb_kahypar::flow::serial, counting_async_serial_body(graph_ctx) );
    ...
    for (int i = 0; i < R; ++i) {
        tbb_kahypar::flow::make_edge(a, *r[i]);
    }
    ...
    counting_async_serial_body b1 = tbb_kahypar::flow::copy_body<counting_async_serial_body>(a);
    ...
    g.reset(tbb_kahypar::flow::rf_reset_protocol);
    ...
    counting_async_serial_body b2 = tbb_kahypar::flow::copy_body<counting_async_serial_body>(a);
    ...
    counting_async_serial_body b3 = tbb_kahypar::flow::copy_body<counting_async_serial_body>(a);
    ...
    counting_async_serial_body b4 = tbb_kahypar::flow::copy_body<counting_async_serial_body>(a);
    ...
    tbb_kahypar::flow::make_edge(a, *r[0]);
    for (int i = 0; i < N; ++i) {
       a.try_put(i);
    }
    g.wait_for_all();
    ...
    counting_async_serial_body b5 = tbb_kahypar::flow::copy_body<counting_async_serial_body>(a);
    ...
    g.reset(static_cast<tbb_kahypar::flow::reset_flags>(tbb_kahypar::flow::rf_reset_bodies|tbb_kahypar::flow::rf_clear_edges));
    for (int i = 0; i < N; ++i) {
       a.try_put(i);
    }
    g.wait_for_all();
    ...
    // the local body count should now be 3*N
    // and all of the counting receivers should remain at a count of 2N+1, except r[0] which should be 3N+1
    counting_async_serial_body b6 = tbb_kahypar::flow::copy_body<counting_async_serial_body>(a);
...
public:
    ...
    typedef tbb_kahypar::flow::async_node< input_type, output_type > async_node_type;
...
struct basic_test {
    ...
    static int run(int async_expected_items = UNKNOWN_NUMBER_OF_ITEMS) {
        ...
        tbb_kahypar::flow::function_node< int, input_type > start_node(
            g, tbb_kahypar::flow::unlimited, [](int input) { return input_type(input); }
        );
        ...
        tbb_kahypar::flow::function_node< output_type > end_node(
            g, tbb_kahypar::flow::unlimited,
        ...
        tbb_kahypar::flow::make_edge( start_node, offload_node );
        tbb_kahypar::flow::make_edge( offload_node, end_node );
...
int test_copy_ctor() {
    ...
    tbb_kahypar::task_group_context graph_ctx;
    counting_async_node_type a(g, tbb_kahypar::flow::unlimited, counting_async_unlimited_body(graph_ctx) );
    counting_async_node_type b(a);

    tbb_kahypar::flow::make_edge(a, r1);                             // C++11-style of making edges
    tbb_kahypar::flow::make_edge(tbb_kahypar::flow::output_port<0>(b), r2);  // usual way of making edges
...
struct spin_test {
    ...
    static int run(int nthreads, int async_expected_items = UNKNOWN_NUMBER_OF_ITEMS) {
        ...
        tbb_kahypar::flow::function_node<output_type> end_node(
            g, tbb_kahypar::flow::unlimited, end_body_type(std::this_thread::get_id(), spin_barrier)
        );
...
void test_for_spin_avoidance() {
    ...
    tbb_kahypar::global_control gc(tbb_kahypar::global_control::max_allowed_parallelism, nthreads);
    tbb_kahypar::task_arena a(nthreads);
    a.execute([&] {
...
class enqueueing_on_inner_level {
    ...
    typedef tbb_kahypar::flow::async_node<Input, Output> async_node_type;
    typedef typename async_node_type::gateway_type gateway_type;
    ...
    public:
        ...
        void operator()(int) const {
            ...
            tbb_kahypar::flow::function_node< output_type > end_node( g, tbb_kahypar::flow::unlimited, [](output_type){} );
...
public:
    static int run ()
    {
        const int nthreads = tbb_kahypar::this_task_arena::max_concurrency();
        utils::SpinBarrier spin_barrier( nthreads );

        async_activity_type my_async_activity( UNKNOWN_NUMBER_OF_ITEMS, true );

        tbb_kahypar::parallel_for( 0, nthreads, body_graph_with_async( spin_barrier, my_async_activity ) );
        return 0;
    }
};
...
TEST_CASE("Basic tests"){
    tbb_kahypar::task_arena arena(utils::MaxThread);
    arena.execute(
        [&]() {
            run_tests<int, int>();
...
TEST_CASE("Lightweight tests"){
    lightweight_testing::test<tbb_kahypar::flow::async_node>(NUMBER_OF_MSGS);
}
...
TEST_CASE("constraints for async_node input") {
    ...
    static_assert(utils::well_formed_instantiation<tbb_kahypar::flow::async_node, InputObject, int>);
    static_assert(utils::well_formed_instantiation<tbb_kahypar::flow::async_node, int, int>);
    static_assert(!utils::well_formed_instantiation<tbb_kahypar::flow::async_node, test_concepts::NonCopyable, int>);
    static_assert(!utils::well_formed_instantiation<tbb_kahypar::flow::async_node, test_concepts::NonDefaultInitializable, int>);
}

template <typename Input, typename Output, typename Body>
concept can_call_async_node_ctor = requires( tbb_kahypar::flow::graph& graph, std::size_t concurrency,
                                             Body body, tbb_kahypar::flow::node_priority_t priority, tbb_kahypar::flow::buffer_node<int>& f ) {
    tbb_kahypar::flow::async_node<Input, Output>(graph, concurrency, body);
    tbb_kahypar::flow::async_node<Input, Output>(graph, concurrency, body, priority);
#if __TBB_PREVIEW_FLOW_GRAPH_NODE_SET
    tbb_kahypar::flow::async_node<Input, Output>(tbb_kahypar::flow::follows(f), concurrency, body);
    tbb_kahypar::flow::async_node<Input, Output>(tbb_kahypar::flow::follows(f), concurrency, body, priority);
#endif // __TBB_PREVIEW_FLOW_GRAPH_NODE_SET
};
