...
using tbb_kahypar::detail::r1::intrusive_list_node;
...
struct DataItemWithInheritedNode : VerificationBase, DataItemWithInheritedNodeBase {
    friend class tbb_kahypar::detail::r1::intrusive_list<DataItemWithInheritedNode>;
...
using intrusive_list1 = tbb_kahypar::detail::r1::intrusive_list<DataItemWithInheritedNode>;
using intrusive_list2 = tbb_kahypar::detail::r1::memptr_intrusive_list<DataItemWithMemberNodes,
                                                               DataItemWithMemberNodeBase,
                                                               &DataItemWithMemberNodeBase::m_BaseNode>;

using intrusive_list3 = tbb_kahypar::detail::r1::memptr_intrusive_list<DataItemWithMemberNodes,
...
TEST_CASE("Test tbb_kahypar::detail::r1::intrusive_list operations") {
    test_list_operations<intrusive_list1, DataItemWithInheritedNode>();
}

//! \brief \ref error_guessing
TEST_CASE("Test tbb_kahypar::detail::r1::memptr_intrusive_list operations") {
