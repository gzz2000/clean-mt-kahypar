...
template <>
void TestIsWriter<oneapi::tbb_kahypar::null_rw_mutex>( const char* ) {
    using scoped_lock = typename oneapi::tbb_kahypar::null_rw_mutex::scoped_lock;

    oneapi::tbb_kahypar::null_rw_mutex nrw_mutex;
