...
TEST_CASE("testing GetBoolEnvironmentVariable") {
    test_environment_variable(tbb_kahypar::detail::r1::GetBoolEnvironmentVariable, false);
}

//! \brief \ref error_guessing
TEST_CASE("testing GetIntegralEnvironmentVariable") {
    test_environment_variable(tbb_kahypar::detail::r1::GetIntegralEnvironmentVariable, -1L);
}
