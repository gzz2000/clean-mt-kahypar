...
struct getval_helper {
    ...
    static int get_integer_val(OT const &o) {
        stored_type res = tbb_kahypar::flow::cast_to<stored_type>(o);
        return (int)res;
    }
};
...
public:
    ...
    static void add_input_nodes(indexer_node_type &my_indexer, tbb_kahypar::flow::graph &g, int nInputs) {
        for(int i=0; i < nInputs; ++i) {
            my_input_node_type *new_node = new my_input_node_type(g, my_input_body<IT>((IT)(ELEM+1), i, nInputs));
            tbb_kahypar::flow::make_edge(*new_node, tbb_kahypar::flow::input_port<ELEM-1>(my_indexer));
    ...
    static void remove_input_nodes(indexer_node_type& my_indexer, int nInputs) {
        for(int i=0; i< nInputs; ++i) {
            ...
            tbb_kahypar::flow::remove_edge(*dp, tbb_kahypar::flow::input_port<ELEM-1>(my_indexer));
            delete dp;
        }
...
public:
    ...
    static void add_input_nodes(indexer_node_type &my_indexer, tbb_kahypar::flow::graph &g, int nInputs) {
        for(int i=0; i < nInputs; ++i) {
            ...
            tbb_kahypar::flow::make_edge(*new_node, tbb_kahypar::flow::input_port<0>(my_indexer));
    ...
    static void remove_input_nodes(indexer_node_type& my_indexer, int nInputs) {
        for(int i=0; i < nInputs; ++i) {
            ...
            tbb_kahypar::flow::remove_edge(*dp, tbb_kahypar::flow::input_port<0>(my_indexer));
            delete dp;
        }
    }
};
...
public:
    ...
    static void test() {
        ...
        for(int nInputs = 1; nInputs <= MaxNInputs; ++nInputs) {
            ...
            tbb_kahypar::flow::make_edge(my_indexer, outq1);
            tbb_kahypar::flow::make_edge(my_indexer, outq2);
            ...
            tbb_kahypar::flow::remove_edge(my_indexer, outq1);
            tbb_kahypar::flow::remove_edge(my_indexer, outq2);
        }
    }
};
...
public:
    ...
    static void fill_one_queue(int maxVal, IType &my_indexer) {
        ...
        for(int i = 0; i < maxVal; ++i) {
            CHECK_MESSAGE(tbb_kahypar::flow::input_port<ELEM-1>(my_indexer).try_put((IT)(i*(ELEM+1))), "");
        }
    }
    static void put_one_queue_val(int myVal, IType &my_indexer) {
        ...
        CHECK_MESSAGE(tbb_kahypar::flow::input_port<ELEM-1>(my_indexer).try_put((IT)(myVal*(ELEM+1))), "");
    }
...
public:
    ...
    static void fill_one_queue(int maxVal, IType &my_indexer) {
        for(int i = 0; i < maxVal; ++i) {
            CHECK_MESSAGE(tbb_kahypar::flow::input_port<0>(my_indexer).try_put((IT)(i*2)), "");
        }
    }
    static void put_one_queue_val(int myVal, IType &my_indexer) {
        CHECK_MESSAGE(tbb_kahypar::flow::input_port<0>(my_indexer).try_put((IT)(myVal*2)), "");
    }
    static void check_queue_value(OT &v) {
...
void test_one_serial( IType &my_indexer, tbb_kahypar::flow::graph &g) {
    ...
    tbb_kahypar::flow::make_edge(my_indexer, q3);
...
class generate_test {
public:
    typedef tbb_kahypar::flow::indexer_node<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9>  indexer_node_type;
    static void do_test() {
...
public:
    typedef tbb_kahypar::flow::indexer_node<T0, T1, T2, T3, T4, T5, T6, T7, T8>  indexer_node_type;
    static void do_test() {
        TestType<indexer_node_type>::test();
    }
};
...
public:
    typedef tbb_kahypar::flow::indexer_node<T0, T1, T2, T3, T4, T5, T6, T7>  indexer_node_type;
    static void do_test() {
        TestType<indexer_node_type>::test();
    }
};
...
public:
    typedef tbb_kahypar::flow::indexer_node<T0, T1, T2, T3, T4, T5, T6>  indexer_node_type;
    static void do_test() {
        TestType<indexer_node_type>::test();
    }
};
...
public:
    typedef tbb_kahypar::flow::indexer_node<T0, T1, T2, T3, T4, T5>  indexer_node_type;
    static void do_test() {
        TestType<indexer_node_type>::test();
    }
};
...
public:
    typedef tbb_kahypar::flow::indexer_node<T0, T1, T2, T3, T4>  indexer_node_type;
    static void do_test() {
        TestType<indexer_node_type>::test();
    }
};
...
public:
    typedef tbb_kahypar::flow::indexer_node<T0, T1, T2, T3>  indexer_node_type;
    static void do_test() {
        TestType<indexer_node_type>::test();
    }
};
...
public:
    typedef tbb_kahypar::flow::indexer_node<T0, T1, T2>  indexer_node_type;
    static void do_test() {
        TestType<indexer_node_type>::test();
    }
};
...
public:
    typedef tbb_kahypar::flow::indexer_node<T0, T1>  indexer_node_type;
    static void do_test() {
        TestType<indexer_node_type>::test();
    }
};
...
public:
    typedef tbb_kahypar::flow::indexer_node<T0>  indexer_node_type;
    static void do_test() {
        TestType<indexer_node_type>::test();
    }
};
...
bool check_edge(tbb_kahypar::flow::graph& g,
                tbb_kahypar::flow::broadcast_node<input_t>& start,
                tbb_kahypar::flow::buffer_node<tagged_msg_t>& buf,
                input_t input_value) {
    ...
    CHECK_MESSAGE( ((tbb_kahypar::flow::cast_to<input_t>(msg) == input_value)), "Wrong item value");
    return true;
}
...
void check_edge(tbb_kahypar::flow::graph& g, BN& bn, tbb_kahypar::flow::buffer_node<indexer_output_t>& buf, Type, tbb_kahypar::detail::index_sequence<Seq...>) {
...
void test_follows_impl(std::tuple<Args...> t, tbb_kahypar::detail::index_sequence<Seq...> seq) {
...
void test_follows() {
    test_follows_impl(std::tuple<Args...>(), tbb_kahypar::detail::make_index_sequence<sizeof...(Args)>());
}
...
void test_try_put_and_wait() {
    ...
    arena.execute([] {
        ...
        tbb_kahypar::flow::indexer_node<int, float> indexer(g);
        using output_type = decltype(indexer)::output_type;

        tbb_kahypar::flow::function_node<output_type, int> function(g, tbb_kahypar::flow::serial,
            [&](output_type tag_msg) noexcept {
                if (tag_msg.tag() == 0) {
                    int input = tag_msg.cast_to<int>();
                    if (input == wait_message) {
                        for (auto item : new_work_items) {
                            tbb_kahypar::flow::input_port<0>(indexer).try_put(item);
                            tbb_kahypar::flow::input_port<1>(indexer).try_put(float(item));
                        }
                    }
        ...
        tbb_kahypar::flow::make_edge(indexer, function);
        ...
        tbb_kahypar::flow::input_port<0>(indexer).try_put_and_wait(wait_message);
