...
template< typename T >
void spin_try_get( tbb_kahypar::flow::priority_queue_node<T> &q, T &value ) {
...
struct parallel_puts : utils::NoAssign {
    tbb_kahypar::flow::priority_queue_node<T> &my_q;
    parallel_puts( tbb_kahypar::flow::priority_queue_node<T> &q ) : my_q(q) {}
...
struct parallel_gets : utils::NoAssign {
    tbb_kahypar::flow::priority_queue_node<T> &my_q;
    parallel_gets( tbb_kahypar::flow::priority_queue_node<T> &q) : my_q(q) {}
...
struct parallel_put_get : utils::NoAssign {
    tbb_kahypar::flow::priority_queue_node<T> &my_q;
    parallel_put_get( tbb_kahypar::flow::priority_queue_node<T> &q ) : my_q(q) {}
...
int test_reservation(int) {
    ...
    // Simple tests
    tbb_kahypar::flow::priority_queue_node<T> q(g);
...
int test_parallel(int num_threads) {
    tbb_kahypar::flow::graph g;
    tbb_kahypar::flow::priority_queue_node<T> q(g);
    tbb_kahypar::flow::priority_queue_node<T> q2(g);
    tbb_kahypar::flow::priority_queue_node<T> q3(g);
    T bogus_value(-1);
    T j = bogus_value;
    ...
    tbb_kahypar::flow::make_edge( q, q2 );
    tbb_kahypar::flow::make_edge( q2, q3 );
    NativeParallelFor( num_threads, parallel_puts<T>(q) );
    g.wait_for_all();
    ...
    NativeParallelFor( num_threads, parallel_puts<T>(q) );
    tbb_kahypar::flow::priority_queue_node<T> q_copy(q);
    g.wait_for_all();
    j = bogus_value;
...
int test_serial() {
    ...
    tbb_kahypar::flow::remove_edge( q, q2 );
...
void test_follows_and_precedes_api() {
    ...
    follows_and_precedes_testing::test_follows <int, tbb_kahypar::flow::priority_queue_node<int>>(messages_for_follows);
    follows_and_precedes_testing::test_precedes <int, tbb_kahypar::flow::priority_queue_node<int>>(messages_for_precedes);
}
#endif
...
void test_pqueue_node_try_put_and_wait() {
    ...
    // test_buffer_push returns the index from which the items processed during wait_for_all() starts
    {
        ...
        std::size_t after_start = test_buffer_push<tbb_kahypar::flow::priority_queue_node<int>>(start_work_items, wait_message,
...

    {
        ...
        std::size_t after_start = test_buffer_pull<tbb_kahypar::flow::priority_queue_node<int>>(start_work_items, wait_message, occupier,
                                                                                        new_work_items, processed_items);
    ...
    // Test reserve
    {
        ...
        for (int threshold : thresholds) {
            ...
            std::size_t after_start = test_buffer_reserve<tbb_kahypar::flow::priority_queue_node<int>>(threshold,
...
TEST_CASE("Reset tests"){
    INFO("Testing resets\n");
    test_resets<int,tbb_kahypar::flow::priority_queue_node<int> >();
    test_resets<float,tbb_kahypar::flow::priority_queue_node<float> >();
}
