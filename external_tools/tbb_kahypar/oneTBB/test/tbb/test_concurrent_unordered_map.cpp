...
struct AllowMultimapping<tbb_kahypar::concurrent_unordered_multimap<Args...>> : std::true_type {};
...
using map_type = tbb_kahypar::concurrent_unordered_map<int, int, std::hash<int>, std::equal_to<int>, MyAllocator<int, int>>;
using multimap_type = tbb_kahypar::concurrent_unordered_multimap<int, int, std::hash<int>, std::equal_to<int>, MyAllocator<int, int>>;
using degenerate_map_type = tbb_kahypar::concurrent_unordered_map<int, int, degenerate_hash<int>, std::equal_to<int>, MyAllocator<int, int>>;
using degenerate_multimap_type = tbb_kahypar::concurrent_unordered_multimap<int, int, degenerate_hash<int>, std::equal_to<int>, MyAllocator<int, int>>;

using checked_map_type = tbb_kahypar::concurrent_unordered_map<int, CheckType<int>, std::hash<int>, std::equal_to<int>, MyAllocator<int, CheckType<int>>>;
using checked_multimap_type = tbb_kahypar::concurrent_unordered_multimap<int, CheckType<int>, std::hash<int>, std::equal_to<int>, MyAllocator<int, CheckType<int>>>;
using checked_state_map_type = tbb_kahypar::concurrent_unordered_map<intptr_t, FooWithAssign, std::hash<intptr_t>,
                                                             std::equal_to<intptr_t>, MyAllocator<intptr_t, FooWithAssign>>;
using checked_state_multimap_type = tbb_kahypar::concurrent_unordered_multimap<intptr_t, FooWithAssign, std::hash<intptr_t>,
                                                                       std::equal_to<intptr_t>, MyAllocator<intptr_t, FooWithAssign>>;

struct CumapTraits : UnorderedMoveTraitsBase {
    template <typename T, typename Allocator>
    using container_type = tbb_kahypar::concurrent_unordered_map<T, T, std::hash<T>, std::equal_to<T>, Allocator>;
...
struct CumultimapTraits : UnorderedMoveTraitsBase {
    template <typename T, typename Allocator>
    using container_type = tbb_kahypar::concurrent_unordered_multimap<T, T, std::hash<T>, std::equal_to<T>, Allocator>;
...
struct UnorderedMapTypesTester {
    ...
    void check( const std::list<ValueType>& lst ) {
        ...
        TypeTester<DefCtorPresent, table_type<tbb_kahypar::concurrent_unordered_map, key_type, mapped_type>>(lst);
        TypeTester<DefCtorPresent, table_type<tbb_kahypar::concurrent_unordered_multimap, key_type, mapped_type>>(lst);
    }
}; // struct UnorderedMapTypesTester
...
void test_specific_types() {
    ...
    test_emplace_insert<tbb_kahypar::concurrent_unordered_map<int*, test::unique_ptr<int>>, std::false_type>
                       (new int, new int);
    test_emplace_insert<tbb_kahypar::concurrent_unordered_multimap<int*, test::unique_ptr<int>>, std::false_type>
                       (new int, new int);
}
...
TEST_CASE("concurrent_unordered_map::swap with not always equal allocator") {
    using not_always_equal_alloc_map_type = tbb_kahypar::concurrent_unordered_map<int, int, std::hash<int>, std::equal_to<int>,
...
TEST_CASE("concurrent_unordered_multimap::swap with not always equal allocator") {
    using not_always_equal_alloc_mmap_type = tbb_kahypar::concurrent_unordered_multimap<int, int, std::hash<int>, std::equal_to<int>,
                                                                                NotAlwaysEqualAllocator<std::pair<const int, int>>>;
...
TEST_CASE("concurrent_unordered_map throwing copy constructor") {
    using exception_map_type = tbb_kahypar::concurrent_unordered_map<ThrowOnCopy, ThrowOnCopy>;
    test_exception_on_copy_ctor<exception_map_type>();
}

//! \brief \ref error_guessing
TEST_CASE("concurrent_unordered_multimap throwing copy constructor") {
    using exception_mmap_type = tbb_kahypar::concurrent_unordered_multimap<ThrowOnCopy, ThrowOnCopy>;
...
TEST_CASE("concurrent_unordered_map whitebox throwing copy constructor") {
    ...
    using exception_mmap_type = tbb_kahypar::concurrent_unordered_map<int, int, std::hash<int>, std::equal_to<int>, allocator_type>;
...
TEST_CASE("container_range concept for concurrent_unordered_map ranges") {
    static_assert(test_concepts::container_range<typename tbb_kahypar::concurrent_unordered_map<int, int>::range_type>);
    static_assert(test_concepts::container_range<typename tbb_kahypar::concurrent_unordered_map<int, int>::const_range_type>);
}

//! \brief \ref error_guessing
TEST_CASE("container_range concept for concurrent_unordered_multimap ranges") {
    static_assert(test_concepts::container_range<typename tbb_kahypar::concurrent_unordered_multimap<int, int>::range_type>);
    static_assert(test_concepts::container_range<typename tbb_kahypar::concurrent_unordered_multimap<int, int>::const_range_type>);
}
#endif // __TBB_CPP20_CONCEPTS_PRESENT

//! \brief \ref regression
TEST_CASE("reserve(0) issue regression test") {
    test_reserve_regression<oneapi::tbb_kahypar::concurrent_unordered_map<int, int>>();
    test_reserve_regression<oneapi::tbb_kahypar::concurrent_unordered_multimap<int, int>>();
}
