...
using tbb_kahypar::detail::d2::SUCCESSFULLY_ENQUEUED;
...
struct converter<InputType,tbb_kahypar::flow::continue_msg> {
    static tbb_kahypar::flow::continue_msg convert_value(const InputType &/*i*/) {
        return tbb_kahypar::flow::continue_msg();
    }
};

template<typename OutputType>
struct converter<tbb_kahypar::flow::continue_msg,OutputType> {
    static OutputType convert_value(const tbb_kahypar::flow::continue_msg &/*i*/) {
        return OutputType();
    }
};
...
template< typename OutputType >
struct harness_graph_default_functor< tbb_kahypar::flow::continue_msg, OutputType > {
    static OutputType construct( tbb_kahypar::flow::continue_msg ) {
        return OutputType();
    }
};

template< typename InputType >
struct harness_graph_default_functor< InputType, tbb_kahypar::flow::continue_msg > {
    static tbb_kahypar::flow::continue_msg construct( InputType ) {
        return tbb_kahypar::flow::continue_msg();
    }
};

template< >
struct harness_graph_default_functor< tbb_kahypar::flow::continue_msg, tbb_kahypar::flow::continue_msg > {
    static tbb_kahypar::flow::continue_msg construct( tbb_kahypar::flow::continue_msg ) {
        return tbb_kahypar::flow::continue_msg();
    }
};
...
struct harness_graph_default_multifunction_functor {
    ...
    typedef typename tbb_kahypar::flow::multifunction_node<InputType,OutputSet>::output_ports_type ports_type;
...
struct harness_graph_executor {
    ...
    typedef tfunctor<tbb_kahypar::null_rw_mutex> functor;
...
struct harness_graph_multifunction_executor {
    typedef typename tbb_kahypar::flow::multifunction_node<InputType,OutputTuple>::output_ports_type ports_type;
...
template< typename T >
struct harness_counting_receiver : public tbb_kahypar::flow::receiver<T> {
    harness_counting_receiver& operator=(const harness_counting_receiver&) = delete;

    std::atomic< size_t > my_count;
    T max_value;
    size_t num_copies;
    tbb_kahypar::flow::graph& my_graph;

    harness_counting_receiver(tbb_kahypar::flow::graph& g) : num_copies(1), my_graph(g) {
       my_count = 0;
    }
    ...
    tbb_kahypar::flow::graph& graph_reference() const override {
        return my_graph;
    }

    tbb_kahypar::detail::d2::graph_task *try_put_task( const T & ) override {
      ++my_count;
      return const_cast<tbb_kahypar::detail::d2::graph_task*>(SUCCESSFULLY_ENQUEUED);
    }

#if __TBB_PREVIEW_FLOW_GRAPH_TRY_PUT_AND_WAIT
    tbb_kahypar::detail::d2::graph_task *try_put_task( const T &t, const tbb_kahypar::detail::d2::message_metainfo& ) override {
...
//! Counts the number of puts received
template< typename T >
struct harness_mapped_receiver : public tbb_kahypar::flow::receiver<T> {
    ...
    T max_value;
    size_t num_copies;
    typedef tbb_kahypar::concurrent_unordered_multiset<T> multiset_type;
    multiset_type *my_multiset;
    tbb_kahypar::flow::graph& my_graph;

    harness_mapped_receiver(tbb_kahypar::flow::graph& g) : my_multiset(nullptr), my_graph(g) {
       my_count = 0;
    }
    ...
    tbb_kahypar::detail::d2::graph_task* try_put_task( const T &t ) override {
      if ( my_multiset ) {
    ...
    void reset_receiver(tbb_kahypar::flow::reset_flags /*f*/) {
        my_count = 0;
...
//! Counts the number of puts received
template< typename T >
struct harness_counting_sender : public tbb_kahypar::flow::sender<T> {
    ...
    typedef typename tbb_kahypar::flow::sender<T>::successor_type successor_type;
...
#if __TBB_PREVIEW_FLOW_GRAPH_TRY_PUT_AND_WAIT
    bool try_get( T & v, tbb_kahypar::detail::d2::message_metainfo& ) override {
        return try_get(v);
    }
#endif
...
struct serial_continue_body {
    ...
    T operator()(const tbb_kahypar::flow::continue_msg& /*in*/) {
...
void test_resets() {
    const int NN = 3;
    bool nFound[NN];
    tbb_kahypar::task_arena arena{4};
    arena.execute(
        [&] {
            tbb_kahypar::task_group_context   tgc;
            tbb_kahypar::flow::graph          g(tgc);
            BufferType                b0(g);
            tbb_kahypar::flow::queue_node<T>  q0(g);
            T j{};
            ...
            tbb_kahypar::flow::make_edge(b0,q0);
            ...
            tbb_kahypar::flow::function_node<T, T, tbb_kahypar::flow::rejecting> sfn(g, tbb_kahypar::flow::serial, serial_fn_body<T>(serial_fn_state0));
            tbb_kahypar::flow::queue_node<T> outq(g);
            tbb_kahypar::flow::remove_edge(b0,q0);
            tbb_kahypar::flow::make_edge(b0, sfn);
            tbb_kahypar::flow::make_edge(sfn,outq);
...
class harness_reserving_body {
    ...
    tbb_kahypar::flow::buffer_node<DataType> &my_buffer_node;
public:
    harness_reserving_body(ReservingNodeType<DataType> &reserving_node, tbb_kahypar::flow::buffer_node<DataType> &bn) : my_reserving_node(reserving_node), my_buffer_node(bn) {}
...
void test_reserving_nodes() {
    ...
    tbb_kahypar::flow::buffer_node<DataType> buffering_n(g);
    tbb_kahypar::flow::join_node< std::tuple<DataType, DataType>, tbb_kahypar::flow::reserving > join_n(g);
    harness_counting_receiver< std::tuple<DataType, DataType> > end_receiver(g);

    tbb_kahypar::flow::make_edge(reserving_n, tbb_kahypar::flow::input_port<0>(join_n));
    tbb_kahypar::flow::make_edge(buffering_n, tbb_kahypar::flow::input_port<1>(join_n));
    tbb_kahypar::flow::make_edge(join_n, end_receiver);
...
void test_nested_make_edge_single_item_buffer_to_continue_receiver() {
    ...
    using cnode_t = tbb_kahypar::flow::continue_node<msg_t>;
    ...
    cnode_t edge_adder{g, 
        [&](const msg_t& m) {
            ...
            tbb_kahypar::flow::make_edge(b, execute_one_time);
            return m;
        }};

    tbb_kahypar::flow::make_edge(edge_adder, execute_one_time);
...
void test_unlimited_lightweight_execution(unsigned N) {
    tbb_kahypar::flow::graph g;
    NodeType node(g, tbb_kahypar::flow::unlimited, concurrency_checker_body());
...
private:
    void increase_and_check(const std::thread::id& /*input*/) {
        ...
        bool is_inside_task = oneapi::tbb_kahypar::task::current_context() != nullptr;
...
void test_limited_lightweight_execution(unsigned N, unsigned concurrency) {
    CHECK_MESSAGE(concurrency != tbb_kahypar::flow::unlimited,
...
void test_exception_ligthweight_policy(){
    ...
    using IndexerNodeType = oneapi::tbb_kahypar::flow::indexer_node<int, int>;
    using FuncNodeType = NodeType<IndexerNodeType::output_type, output_tuple_type, tbb_kahypar::flow::lightweight>;
    oneapi::tbb_kahypar::flow::graph g;

    IndexerNodeType indexer(g);
    FuncNodeType tested_node(g, oneapi::tbb_kahypar::flow::serial, throwing_body<threshold>(counter));
    oneapi::tbb_kahypar::flow::make_edge(indexer, tested_node);
...
void test_lightweight(unsigned N) {
    ...
    test_limited_lightweight_execution<NodeType>(N, tbb_kahypar::flow::serial);
    test_limited_lightweight_execution<NodeType>(N, (std::min)(std::thread::hardware_concurrency() / 2, N/2));

    test_limited_lightweight_execution_with_throwing_body<NodeType>(N, tbb_kahypar::flow::serial);
}

template<template<typename, typename, typename> class NodeType>
void test(unsigned N) {
    typedef std::thread::id input_type;
    typedef NodeType<input_type, output_tuple_type, tbb_kahypar::flow::queueing_lightweight> node_type;
