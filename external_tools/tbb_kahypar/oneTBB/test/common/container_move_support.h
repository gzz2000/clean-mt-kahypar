...
struct TwoMemoryArenasFixture {
          ...
          dst_allocator(dst_arena_fixture.allocator)
    {
        ...
        using Traits_POCMA = typename tbb_kahypar::detail::allocator_traits<allocator_type>::propagate_on_container_move_assignment;
...
struct MoveFixture {
    ...
    using allocator_type = typename tbb_kahypar::detail::allocator_traits<Allocator>::template rebind_alloc<container_value_type>;
