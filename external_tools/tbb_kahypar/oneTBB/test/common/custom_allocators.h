...
#include "test.h"
#include <oneapi_kahypar/tbb_kahypar/detail/_allocator_traits.h>
#include <memory>
#include <atomic>
...
class LocalCountingAllocator : public BaseAllocatorType {
    ...
    using base_traits = tbb_kahypar::detail::allocator_traits<base_type>;
...
class StaticCountingAllocator : public BaseAllocatorType {
    using base_type = BaseAllocatorType;
    using base_traits = tbb_kahypar::detail::allocator_traits<BaseAllocatorType>;
    using counter_type = std::atomic<std::size_t>;
public:
    using value_type = typename base_type::value_type;
