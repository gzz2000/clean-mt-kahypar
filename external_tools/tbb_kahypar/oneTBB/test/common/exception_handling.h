...
class eh_test_observer : public tbb_kahypar::task_scheduler_observer {
public:
...
#define UPDATE_COUNTS()     \
    { \
        ...
        if( tbb_kahypar::is_current_task_group_canceling() ) ++g_TGCCancelled; \
    }
...
struct Cancellator {
    ...
    Cancellator( tbb_kahypar::task_group_context& ctx, intptr_t threshold )
