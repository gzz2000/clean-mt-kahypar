...
using tbb_kahypar::detail::try_call;
...
//! Native parallel loop with grainsize (like tbb_kahypar::blocked_range)
template <typename Index, typename Body>
...
template <typename T>
using supports_iterator = tbb_kahypar::detail::supports<T, iterator_traits_value_type,
...
template <typename T>
using supports_input_iterator = tbb_kahypar::detail::supports<T, is_equality_comparable,
                                                         is_unequality_comparable,
                                                         is_dereferenceable_by_arrow,
                                                         is_postincrementable>;
template <typename T>
using supports_bidirectional_iterator = tbb_kahypar::detail::supports<T, is_predecrementable,
                                                                 is_postdecrementable>;

template <typename T>
using supports_random_access_iterator = tbb_kahypar::detail::supports<T, is_add_assignable,
                                                                 is_sub_assignable,
                                                                 have_operator_plus,
                                                                 have_operator_minus,
...
template <typename T, std::size_t N>
tbb_kahypar::blocked_range<T*> make_blocked_range( T(& array)[N] ) {
    return tbb_kahypar::blocked_range<T*>(array, array + N);
}

template <typename T>
void check_range_bounds_after_splitting( const tbb_kahypar::blocked_range<T>& original, const tbb_kahypar::blocked_range<T>& first,
                                         const tbb_kahypar::blocked_range<T>& second, const T& expected_first_end )
{
