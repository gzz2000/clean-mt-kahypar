...
struct testing_method_follows<tbb_kahypar::flow::join_node<Args...>> : std::integral_constant<int, 1> {};
template <typename... Args>
struct testing_method_follows<tbb_kahypar::flow::continue_node<Args...>> : std::integral_constant<int, 1> {};

template <typename... Args>
struct testing_method_follows<tbb_kahypar::flow::overwrite_node<Args...>> : std::integral_constant<int, 2> {};
template <typename... Args>
struct testing_method_follows<tbb_kahypar::flow::write_once_node<Args...>> : std::integral_constant<int, 2> {};

template <typename... Args>
struct testing_method_follows<tbb_kahypar::flow::multifunction_node<Args...>> : std::integral_constant<int, 3> {};

template <typename MessageType, typename NodeType, typename PredecessorType>
class edge_checker_follows {
public:
    static void check(tbb_kahypar::flow::graph& g,
                      NodeType& node,
...
private:
    ...
    static void check_impl(tbb_kahypar::flow::graph& g,
                           NodeType& node,
                           std::array<PredecessorType, 3>& preds,
                           std::array<MessageType, 3>& messages,
                           std::integral_constant<int, 0>) {
        tbb_kahypar::flow::buffer_node<typename NodeType::output_type> buffer(g);
        tbb_kahypar::flow::make_edge(node, buffer);
    ...
    static void check_impl(tbb_kahypar::flow::graph& g,
        ...
        typedef typename std::remove_reference<decltype(tbb_kahypar::flow::output_port<0>(node))>::type multioutput;
        tbb_kahypar::flow::buffer_node<typename multioutput::output_type> buf(tbb_kahypar::flow::follows(tbb_kahypar::flow::output_port<0>(node)));
...
template <typename... Args>
struct testing_method_precedes<tbb_kahypar::flow::buffer_node<Args...>> : std::integral_constant<int, 1> {};
template <typename... Args>
struct testing_method_precedes<tbb_kahypar::flow::queue_node<Args...>> : std::integral_constant<int, 1> {};
template <typename... Args>
struct testing_method_precedes<tbb_kahypar::flow::priority_queue_node<Args...>> : std::integral_constant<int, 1> {};
template <typename... Args>
struct testing_method_precedes<tbb_kahypar::flow::sequencer_node<Args...>> : std::integral_constant<int, 1> {};

template <typename... Args>
struct testing_method_precedes<tbb_kahypar::flow::join_node<Args...>> : std::integral_constant<int, 2> {};
...
class edge_checker_precedes {
    ...
    using SuccessorOutputType = typename tbb_kahypar::flow::buffer_node<NodeOutputType>::output_type;
public:
    static void check(tbb_kahypar::flow::graph& g,
                      NodeType& node,
                      std::array<tbb_kahypar::flow::buffer_node<NodeOutputType>, 3>& successors,
...
private:
    ...
    static void check_impl(tbb_kahypar::flow::graph& g,
                           NodeType& node,
                           std::array<tbb_kahypar::flow::buffer_node<typename NodeType::output_type>, 3>& successors,
                           std::vector<MessageType>& messages,
                           std::integral_constant<int, 1>) {
        ...
        tbb_kahypar::flow::write_once_node<SuccessorOutputType>
            buffer(tbb_kahypar::flow::follows(successors[0], successors[1], successors[2]));
    ...
    static void check_impl(tbb_kahypar::flow::graph& g,
        ...
        CHECK_MESSAGE((messages.size() == 3),
               "messages.size() has to be 3 to test nodes what send a message to the first available successor");
        std::array<tbb_kahypar::flow::buffer_node<MessageType>, 3> preds = {
	  {
	    tbb_kahypar::flow::buffer_node<MessageType>(g), 
	    tbb_kahypar::flow::buffer_node<MessageType>(g), 
	    tbb_kahypar::flow::buffer_node<MessageType>(g)
	  }
	};

        make_edge(preds[0], tbb_kahypar::flow::input_port<0>(node));
        make_edge(preds[1], tbb_kahypar::flow::input_port<1>(node));
        make_edge(preds[2], tbb_kahypar::flow::input_port<2>(node));
...
template<typename MessageType,
         typename NodeType,
         typename PredecessorType=tbb_kahypar::flow::broadcast_node<MessageType>,
