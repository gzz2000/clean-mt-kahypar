...
struct Range {
    Range( Range&, tbb_kahypar::split ) requires EnableSplitCtor {}
...
struct ParallelForEachFeederBody {
    void operator()( const T&, tbb_kahypar::feeder<FeederT>& ) const requires (EnableFunctionCallOperator == State::correct) {}
    void operator()( const T&, tbb_kahypar::feeder<FeederT>& ) requires (EnableFunctionCallOperator == State::incorrect_constness) {}
    void operator()( Dummy, tbb_kahypar::feeder<FeederT>& ) const requires (EnableFunctionCallOperator == State::incorrect_first_input) {}
...
struct ParallelReduceBody {
    ParallelReduceBody( ParallelReduceBody&, tbb_kahypar::split ) requires EnableSplitCtor {}
    // Prospective destructors
...
struct ParallelScanBody {
    ParallelScanBody( ParallelScanBody&, tbb_kahypar::split ) requires EnableSplitCtor {}
    ...
    void operator()( const Range&, tbb_kahypar::pre_scan_tag ) requires (EnablePreScanRoundBrackets == State::correct) {}
    void operator()( Dummy, tbb_kahypar::pre_scan_tag ) requires (EnablePreScanRoundBrackets == State::incorrect_first_input) {}
    void operator()( const Range&, Dummy ) requires (EnablePreScanRoundBrackets == State::incorrect_second_input) {}

    void operator()( const Range&, tbb_kahypar::final_scan_tag ) requires (EnableFinalScanRoundBrackets == State::correct) {}
    void operator()( Dummy, tbb_kahypar::final_scan_tag ) requires (EnableFinalScanRoundBrackets == State::incorrect_first_input) {}
...
struct InputNodeBody {
    ...
    Output operator()( tbb_kahypar::flow_control& ) requires (EnableFunctionCallOperator == State::correct) { return Output{}; }
    Output operator()( Dummy ) requires (EnableFunctionCallOperator == State::incorrect_first_input) { return Output{}; }
    Dummy operator()( tbb_kahypar::flow_control& ) requires (EnableFunctionCallOperator == State::incorrect_return_type) { return Dummy{}; }
};
...
using output_ports_type = typename tbb_kahypar::flow::multifunction_node<Input, Output>::output_ports_type;
...
template <typename Input, typename Output>
using gateway_type = typename tbb_kahypar::flow::async_node<Input, Output>::gateway_type;
...
struct ContinueNodeBody {
    ...
    Output operator()( tbb_kahypar::flow::continue_msg ) requires (EnableFunctionCallOperator == State::correct) { return Output{}; }
    Output operator()( Dummy ) requires (EnableFunctionCallOperator == State::incorrect_first_input) { return Output{}; }
    Dummy operator()( tbb_kahypar::flow::continue_msg ) requires (EnableFunctionCallOperator == State::incorrect_return_type) { return Dummy{}; }
};
...
template <typename T>
concept container_range = tbb_kahypar::detail::tbb_range<T> &&
