...
class SmartRange : public oneapi::tbb_kahypar::blocked_range<Value> {
    using base_range = oneapi::tbb_kahypar::blocked_range<Value>;
public:
    ...
    SmartRange(SmartRange& other, oneapi::tbb_kahypar::split)
        : base_range(other, oneapi::tbb_kahypar::split{}), change_vector(other.change_vector) {}
