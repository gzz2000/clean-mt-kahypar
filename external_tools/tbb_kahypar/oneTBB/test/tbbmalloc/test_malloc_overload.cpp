...
#include "tbb_kahypar/tbbmalloc_proxy.h"
#endif
...
#include "oneapi_kahypar/tbb_kahypar/detail/_utils.h"  // tbb_kahypar::detail::is_aligned
                               ...
                               void (*free_p)(void*))
{
    ...
    REQUIRE(tbb_kahypar::detail::is_aligned(ptr, 128));
    free_p(ptr);
}
...
void CheckVallocFuncOverload(void *(*valloc_p)(size_t), void (*free_p)(void*))
{
    ...
    scalableMallocCheckSize(ptr, minLargeObjectSize);
    REQUIRE(tbb_kahypar::detail::is_aligned(ptr, sysconf(_SC_PAGESIZE)));
    free_p(ptr);
}
...
void CheckPvalloc(void *(*pvalloc_p)(size_t), void (*free_p)(void*))
{
    ...
    for (size_t sz = 0; sz<=largeSz; sz+=largeSz) {
        ...
        REQUIRE(tbb_kahypar::detail::is_aligned(ptr, memoryPageSize));
        free_p(ptr);
    }
}
...
#endif
            REQUIRE(tbb_kahypar::detail::is_aligned(ptr, align[a]));
            free(ptr);
        }
}
...
*/
    ...
    REQUIRE(tbb_kahypar::detail::is_aligned(ptr, 1024));
    free(ptr);
#endif
