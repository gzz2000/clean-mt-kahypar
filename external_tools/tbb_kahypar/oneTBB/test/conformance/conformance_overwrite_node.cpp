...
TEST_CASE("overwrite_node broadcast"){
    conformance::test_forwarding<oneapi::tbb_kahypar::flow::overwrite_node<int>, int>(1);
}

//! Test function_node buffering
//! \brief \ref requirement
TEST_CASE("overwrite_node buffering"){
    conformance::test_buffering<oneapi::tbb_kahypar::flow::overwrite_node<int>, int>();
}
...
TEST_CASE("overwrite_node copy constructor"){
    conformance::test_copy_ctor_for_buffering_nodes<oneapi::tbb_kahypar::flow::overwrite_node<int>>();
}

//! Test inheritance relations
//! \brief \ref interface
TEST_CASE("overwrite_node superclasses"){
    conformance::test_inheritance<oneapi::tbb_kahypar::flow::overwrite_node<int>, int, int>();
    conformance::test_inheritance<oneapi::tbb_kahypar::flow::overwrite_node<void*>, void*, void*>();
}
...
TEST_CASE("overwrite_node with reserving join_node as successor"){
    conformance::test_with_reserving_join_node_class<oneapi::tbb_kahypar::flow::overwrite_node<int>>();
}
