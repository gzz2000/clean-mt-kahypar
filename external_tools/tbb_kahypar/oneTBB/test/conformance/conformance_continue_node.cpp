...
int continue_body_f(const tbb_kahypar::flow::continue_msg&) { return 1; }
void continue_void_body_f(const tbb_kahypar::flow::continue_msg&) {}

void test_deduction_guides() {
    using tbb_kahypar::flow::continue_msg;
...
TEST_CASE("continue body") {
    conformance::test_body_exec<oneapi::tbb_kahypar::flow::continue_node<output_msg>, oneapi::tbb_kahypar::flow::continue_msg, output_msg>();
}

//! Test continue_node is a graph_node, receiver<continue_msg>, and sender<Output>
//! \brief \ref interface
TEST_CASE("continue_node superclasses"){
    conformance::test_inheritance<oneapi::tbb_kahypar::flow::continue_node<int>, oneapi::tbb_kahypar::flow::continue_msg, int>();
    conformance::test_inheritance<oneapi::tbb_kahypar::flow::continue_node<void*>, oneapi::tbb_kahypar::flow::continue_msg, void*>();
    conformance::test_inheritance<oneapi::tbb_kahypar::flow::continue_node<output_msg>, oneapi::tbb_kahypar::flow::continue_msg, output_msg>();
}
...
TEST_CASE("continue_node and body copying"){
    conformance::test_copy_body_function<oneapi::tbb_kahypar::flow::continue_node<int>, conformance::copy_counting_object<int, oneapi::tbb_kahypar::flow::continue_msg>>();
}
...
TEST_CASE("continue_node broadcast"){
    ...
    conformance::test_forwarding<oneapi::tbb_kahypar::flow::continue_node<int>, oneapi::tbb_kahypar::flow::continue_msg, int>(1, fun);
}
...
TEST_CASE("continue_node buffering"){
    ...
    conformance::test_buffering<oneapi::tbb_kahypar::flow::continue_node<int>, oneapi::tbb_kahypar::flow::continue_msg>(fun);
}
...
TEST_CASE("continue_node constructors"){
    ...
    continue_node<int> proto2(g, fun, oneapi::tbb_kahypar::flow::node_priority_t(1));
    continue_node<int> proto3(g, 2, fun);
    continue_node<int> proto4(g, 2, fun, oneapi::tbb_kahypar::flow::node_priority_t(1));

    continue_node<int, lightweight> lw_node1(g, fun, lightweight());
    continue_node<int, lightweight> lw_node2(g, fun, lightweight(), oneapi::tbb_kahypar::flow::node_priority_t(1));
    continue_node<int, lightweight> lw_node3(g, 2, fun, lightweight());
    continue_node<int, lightweight> lw_node4(g, 2, fun, lightweight(), oneapi::tbb_kahypar::flow::node_priority_t(1));
}
...
TEST_CASE("continue_node copy constructor"){
    ...
    conformance::dummy_functor<oneapi::tbb_kahypar::flow::continue_msg> fun1;
    using counting_body = conformance::copy_counting_object<output_msg, oneapi::tbb_kahypar::flow::continue_msg>;
    counting_body fun2;

    continue_node<oneapi::tbb_kahypar::flow::continue_msg> node0(g, fun1);
    ...
    oneapi::tbb_kahypar::flow::make_edge(node0, node1);
    oneapi::tbb_kahypar::flow::make_edge(node1, node2);
    ...
    oneapi::tbb_kahypar::flow::make_edge(node_copy, node3);

    node_copy.try_put(oneapi::tbb_kahypar::flow::continue_msg());
    g.wait_for_all();
    ...
    node1.try_put(oneapi::tbb_kahypar::flow::continue_msg());
    node1.try_put(oneapi::tbb_kahypar::flow::continue_msg());
    node0.try_put(oneapi::tbb_kahypar::flow::continue_msg());
    g.wait_for_all();
...
TEST_CASE("continue_node number_of_predecessors") {
    ...
    oneapi::tbb_kahypar::flow::continue_node<oneapi::tbb_kahypar::flow::continue_msg> node1(g, fun);
    oneapi::tbb_kahypar::flow::continue_node<oneapi::tbb_kahypar::flow::continue_msg> node2(g, 1, fun);
    oneapi::tbb_kahypar::flow::continue_node<oneapi::tbb_kahypar::flow::continue_msg> node3(g, 1, fun);
    oneapi::tbb_kahypar::flow::continue_node<int> node4(g, fun); 

    oneapi::tbb_kahypar::flow::make_edge(node1, node2);
    oneapi::tbb_kahypar::flow::make_edge(node2, node4);
    oneapi::tbb_kahypar::flow::make_edge(node1, node3);
    oneapi::tbb_kahypar::flow::make_edge(node1, node3);
    oneapi::tbb_kahypar::flow::remove_edge(node1, node3);
    oneapi::tbb_kahypar::flow::make_edge(node3, node4);
    node3.try_put(oneapi::tbb_kahypar::flow::continue_msg());
    node2.try_put(oneapi::tbb_kahypar::flow::continue_msg());
    node1.try_put(oneapi::tbb_kahypar::flow::continue_msg());
...
TEST_CASE("continue_node priority support"){
    conformance::test_priority<oneapi::tbb_kahypar::flow::continue_node<oneapi::tbb_kahypar::flow::continue_msg, int>, oneapi::tbb_kahypar::flow::continue_msg>();
}

//! Test node Output class meet the CopyConstructible requirements.
//! \brief \ref requirement
TEST_CASE("continue_node Output class") {
    conformance::test_output_class<oneapi::tbb_kahypar::flow::continue_node<conformance::copy_counting_object<int, oneapi::tbb_kahypar::flow::continue_msg>>, conformance::copy_counting_object<int, oneapi::tbb_kahypar::flow::continue_msg>>();
}
...
TEST_CASE("continue_node `try_put' statement not wait for the execution of the body to complete") {
    ...
    oneapi::tbb_kahypar::flow::continue_node<oneapi::tbb_kahypar::flow::continue_msg> node1(g, body);
    node1.try_put(oneapi::tbb_kahypar::flow::continue_msg());
