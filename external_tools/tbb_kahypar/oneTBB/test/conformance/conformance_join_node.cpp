...
TEST_CASE("join_node copy constructor"){
    ...
    oneapi::tbb_kahypar::flow::continue_node<int> node0( g,
                                [](oneapi::tbb_kahypar::flow::continue_msg) { return 1; } );

    oneapi::tbb_kahypar::flow::join_node<std::tuple<int>> node1(g);
    conformance::test_push_receiver<std::tuple<int>> node2(g);
    conformance::test_push_receiver<std::tuple<int>> node3(g);

    oneapi::tbb_kahypar::flow::make_edge(node0, oneapi::tbb_kahypar::flow::input_port<0>(node1));
    oneapi::tbb_kahypar::flow::make_edge(node1, node2);
    oneapi::tbb_kahypar::flow::join_node<std::tuple<int>> node_copy(node1);

    oneapi::tbb_kahypar::flow::make_edge(node_copy, node3);

    oneapi::tbb_kahypar::flow::input_port<0>(node_copy).try_put(1);
    g.wait_for_all();
    ...
    oneapi::tbb_kahypar::flow::remove_edge(node1, node2);
    oneapi::tbb_kahypar::flow::input_port<0>(node1).try_put(1);
    g.wait_for_all();
    oneapi::tbb_kahypar::flow::join_node<std::tuple<int>> node_copy2(node1);
    oneapi::tbb_kahypar::flow::make_edge(node_copy2, node3);
    oneapi::tbb_kahypar::flow::input_port<0>(node_copy2).try_put(2);
    g.wait_for_all();
...
TEST_CASE("join_node inheritance"){
    CHECK_MESSAGE((std::is_base_of<oneapi::tbb_kahypar::flow::graph_node,
                   oneapi::tbb_kahypar::flow::join_node<my_input_tuple>>::value),
                   "join_node should be derived from graph_node");
    CHECK_MESSAGE((std::is_base_of<oneapi::tbb_kahypar::flow::sender<my_input_tuple>,
                   oneapi::tbb_kahypar::flow::join_node<my_input_tuple>>::value),
...
TEST_CASE("join_node queueing policy and broadcast property") {
    oneapi::tbb_kahypar::flow::graph g;
    oneapi::tbb_kahypar::flow::function_node<int, int>
        f1( g, oneapi::tbb_kahypar::flow::unlimited, [](const int &i) { return i; } );
    oneapi::tbb_kahypar::flow::function_node<float, float>
        f2( g, oneapi::tbb_kahypar::flow::unlimited, [](const float &f) { return f; } );
    oneapi::tbb_kahypar::flow::continue_node<input_msg> c1( g,
                            [](oneapi::tbb_kahypar::flow::continue_msg) { return input_msg(1); } );

    oneapi::tbb_kahypar::flow::join_node<my_input_tuple, oneapi::tbb_kahypar::flow::queueing> testing_node(g);

    conformance::test_push_receiver<my_input_tuple> q_node(g);

    std::atomic<int> number{1};
    oneapi::tbb_kahypar::flow::function_node<my_input_tuple, my_input_tuple>
        f3( g, oneapi::tbb_kahypar::flow::unlimited,
    ...
    oneapi::tbb_kahypar::flow::make_edge(f1, oneapi::tbb_kahypar::flow::input_port<0>(testing_node));
    oneapi::tbb_kahypar::flow::make_edge(f2, oneapi::tbb_kahypar::flow::input_port<1>(testing_node));
    oneapi::tbb_kahypar::flow::make_edge(c1, oneapi::tbb_kahypar::flow::input_port<2>(testing_node));
    ...
    f1.try_put(3);
    f2.try_put(2.5f);
    c1.try_put(oneapi::tbb_kahypar::flow::continue_msg());
    g.wait_for_all();
    ...
    oneapi::tbb_kahypar::flow::remove_edge(testing_node, f3);
...
TEST_CASE("join_node reserving policy") {
    conformance::test_with_reserving_join_node_class<oneapi::tbb_kahypar::flow::write_once_node<int>>();
}
...
TEST_CASE("join_node key_matching policy"){
    oneapi::tbb_kahypar::flow::graph g;
    auto body1 = [](const oneapi::tbb_kahypar::flow::continue_msg &) -> int { return 1; };
    auto body2 = [](const float &val) -> int { return static_cast<int>(val); };

    oneapi::tbb_kahypar::flow::join_node<std::tuple<oneapi::tbb_kahypar::flow::continue_msg, float>,
        oneapi::tbb_kahypar::flow::key_matching<int, MyHash<int>>> testing_node(g, body1, body2);

    oneapi::tbb_kahypar::flow::input_port<0>(testing_node).try_put(oneapi::tbb_kahypar::flow::continue_msg());
    oneapi::tbb_kahypar::flow::input_port<1>(testing_node).try_put(1.3f);

    g.wait_for_all();

    std::tuple<oneapi::tbb_kahypar::flow::continue_msg, float> tmp;
...
TEST_CASE("join_node tag_matching policy"){
    oneapi::tbb_kahypar::flow::graph g;
    auto body1 = [](const oneapi::tbb_kahypar::flow::continue_msg &) -> oneapi::tbb_kahypar::flow::tag_value { return 1; };
    auto body2 = [](const float &val) -> oneapi::tbb_kahypar::flow::tag_value { return static_cast<oneapi::tbb_kahypar::flow::tag_value>(val); };

    oneapi::tbb_kahypar::flow::join_node<std::tuple<oneapi::tbb_kahypar::flow::continue_msg, float>,
        oneapi::tbb_kahypar::flow::tag_matching> testing_node(g, body1, body2);
...
TEST_CASE("join_node output_ports") {
    oneapi::tbb_kahypar::flow::graph g;
    oneapi::tbb_kahypar::flow::join_node<std::tuple<int>> node(g);

    CHECK_MESSAGE((std::is_same<oneapi::tbb_kahypar::flow::join_node<std::tuple<int>>::input_ports_type&,
