...
void test_input_node_rf_reset_protocol(){
    ...
    oneapi::tbb_kahypar::flow::input_node<int> node(g, fun);
    oneapi::tbb_kahypar::flow::limiter_node<int> rejecter(g, 0);

    oneapi::tbb_kahypar::flow::make_edge(node, rejecter);

    node.activate();
    g.wait_for_all();

    g.reset(oneapi::tbb_kahypar::flow::rf_reset_protocol);
...
void test_functional_nodes_rf_reset_protocol(){
    ...
    oneapi::tbb_kahypar::global_control control(oneapi::tbb_kahypar::global_control::max_allowed_parallelism, concurrency_limit);

    conformance::counting_functor<int> counting_body;
    Node f(g, oneapi::tbb_kahypar::flow::serial, counting_body);
...
void test_nodes_with_body_rf_reset_bodies(Args... node_args){
    ...
    g.reset(oneapi::tbb_kahypar::flow::rf_reset_bodies);
    testing_node.try_put(InputType());
    g.wait_for_all();
...
void test_limiter_node_rf_reset_protocol(){
    ...
    oneapi::tbb_kahypar::flow::limiter_node<int> testing_node(g, limit);
    conformance::test_push_receiver<int> suc_node(g);

    oneapi::tbb_kahypar::flow::make_edge(testing_node, suc_node);
...
void test_join_node_rf_reset_protocol(){
    ...
    oneapi::tbb_kahypar::flow::join_node<std::tuple<int>, oneapi::tbb_kahypar::flow::queueing> testing_node(g);

    oneapi::tbb_kahypar::flow::input_port<0>(testing_node).try_put(1);
...
TEST_CASE("graph reset with rf_clear_edges") {
    ...
    oneapi::tbb_kahypar::flow::queue_node<int> successor(g);
    oneapi::tbb_kahypar::flow::queue_node<std::tuple<int>> successor2(g);
    oneapi::tbb_kahypar::flow::queue_node<oneapi::tbb_kahypar::flow::indexer_node<int>::output_type> successor3(g);

    //node types
    oneapi::tbb_kahypar::flow::continue_node<int> ct(g, body());
    oneapi::tbb_kahypar::flow::split_node< std::tuple<int> > s(g);
    oneapi::tbb_kahypar::flow::input_node<int> src(g, body());
    oneapi::tbb_kahypar::flow::function_node<int, int> fxn(g, oneapi::tbb_kahypar::flow::unlimited, body());
    oneapi::tbb_kahypar::flow::multifunction_node<int, std::tuple<int, int> > m_fxn(g, oneapi::tbb_kahypar::flow::unlimited, body());
    oneapi::tbb_kahypar::flow::broadcast_node<int> bc(g);
    oneapi::tbb_kahypar::flow::limiter_node<int> lim(g, 2);
    oneapi::tbb_kahypar::flow::indexer_node<int> ind(g);
    oneapi::tbb_kahypar::flow::join_node< std::tuple< int >, oneapi::tbb_kahypar::flow::queueing > j(g);
    oneapi::tbb_kahypar::flow::buffer_node<int> bf(g);
    oneapi::tbb_kahypar::flow::priority_queue_node<int> pq(g);
    oneapi::tbb_kahypar::flow::write_once_node<int> wo(g);
    oneapi::tbb_kahypar::flow::overwrite_node<int> ovw(g);
    oneapi::tbb_kahypar::flow::sequencer_node<int> seq(g, conformance::sequencer_functor<int>());

    oneapi::tbb_kahypar::flow::make_edge(ct, successor);
    oneapi::tbb_kahypar::flow::make_edge(s, successor);
    oneapi::tbb_kahypar::flow::make_edge(src, successor);
    oneapi::tbb_kahypar::flow::make_edge(fxn, successor);
    oneapi::tbb_kahypar::flow::make_edge(m_fxn, successor);
    oneapi::tbb_kahypar::flow::make_edge(bc, successor);
    oneapi::tbb_kahypar::flow::make_edge(lim, successor);
    oneapi::tbb_kahypar::flow::make_edge(ind, successor3);
    oneapi::tbb_kahypar::flow::make_edge(j, successor2);
    oneapi::tbb_kahypar::flow::make_edge(bf, successor);
    oneapi::tbb_kahypar::flow::make_edge(pq, successor);
    oneapi::tbb_kahypar::flow::make_edge(wo, successor);
    oneapi::tbb_kahypar::flow::make_edge(ovw, successor);
    oneapi::tbb_kahypar::flow::make_edge(seq, successor);

    g.wait_for_all();
    g.reset(oneapi::tbb_kahypar::flow::rf_clear_edges);

    ct.try_put(oneapi::tbb_kahypar::flow::continue_msg());
    ...
    bc.try_put(1);
    lim.try_put(1);
    oneapi::tbb_kahypar::flow::input_port<0>(ind).try_put(1);
    oneapi::tbb_kahypar::flow::input_port<0>(j).try_put(1);
    bf.try_put(1);
    pq.try_put(1);
    wo.try_put(1);
    ovw.try_put(1);
...
TEST_CASE("graph cancel") {
    ...
    oneapi::tbb_kahypar::flow::function_node<int> f(g, oneapi::tbb_kahypar::flow::serial, [&](int) {
        ++executed;
