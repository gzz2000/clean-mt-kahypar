...
TEST_CASE("buffer_node single_push"){
    conformance::test_forwarding_single_push<oneapi::tbb_kahypar::flow::buffer_node<int>>();
}

//! Test function_node buffering
//! \brief \ref requirement
TEST_CASE("buffer_node buffering"){
    conformance::test_buffering<oneapi::tbb_kahypar::flow::buffer_node<int>, int>();
}
...
TEST_CASE("buffer_node copy constructor"){
    conformance::test_copy_ctor_for_buffering_nodes<oneapi::tbb_kahypar::flow::buffer_node<int>>();
}

//! Test inheritance relations
//! \brief \ref interface
TEST_CASE("buffer_node superclasses"){
    conformance::test_inheritance<oneapi::tbb_kahypar::flow::buffer_node<int>, int, int>();
    conformance::test_inheritance<oneapi::tbb_kahypar::flow::buffer_node<void*>, void*, void*>();
}
...
TEST_CASE("buffer_node methods"){
    ...
    oneapi::tbb_kahypar::flow::buffer_node<int> testing_node(g);
