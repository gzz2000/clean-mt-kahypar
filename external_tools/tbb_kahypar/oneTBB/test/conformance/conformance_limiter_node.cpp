...
TEST_CASE("limiter_node limiting"){
    ...
    oneapi::tbb_kahypar::flow::limiter_node<input_msg> node1(g, limit);
...
TEST_CASE("limiter_node broadcast"){
    conformance::test_forwarding<oneapi::tbb_kahypar::flow::limiter_node<int>, int>(1, 5);
    conformance::test_forwarding<oneapi::tbb_kahypar::flow::limiter_node<input_msg>, input_msg>(1, 5);
}
...
TEST_CASE("limiter_node buffering"){
    conformance::test_buffering<oneapi::tbb_kahypar::flow::limiter_node<int>, int>(5);
    conformance::test_buffering<oneapi::tbb_kahypar::flow::limiter_node<int, int>, int>(5);
}
...
TEST_CASE("limiter_node superclasses"){
    conformance::test_inheritance<oneapi::tbb_kahypar::flow::limiter_node<int>, int, int>();
    conformance::test_inheritance<oneapi::tbb_kahypar::flow::limiter_node<float>, float, float>();
    conformance::test_inheritance<oneapi::tbb_kahypar::flow::limiter_node<input_msg>, input_msg, input_msg>();
}
...
TEST_CASE("limiter_node decrementer"){
    ...
    oneapi::tbb_kahypar::flow::graph g;
    oneapi::tbb_kahypar::flow::limiter_node<int, int> limit(g, threshold);
    oneapi::tbb_kahypar::flow::queue_node<int> queue(g);
    ...
    oneapi::tbb_kahypar::flow::limiter_node<int, long long> limit2(g, threshold2);
    ...
    oneapi::tbb_kahypar::flow::limiter_node<int, long long> limit3(g, threshold3);
    ...
    oneapi::tbb_kahypar::flow::limiter_node<int> limit4(g, threshold4);
    make_edge(limit4, queue);

    limit4.try_put(-1);
    CHECK_MESSAGE(limit4.decrementer().try_put(oneapi::tbb_kahypar::flow::continue_msg()),
