...
class adder : public oneapi::tbb_kahypar::flow::composite_node<std::tuple<int, int>, std::tuple<int>> {
    oneapi::tbb_kahypar::flow::join_node<std::tuple<int,int>, oneapi::tbb_kahypar::flow::queueing> j;
    oneapi::tbb_kahypar::flow::function_node<std::tuple<int,int>, int> f;
    oneapi::tbb_kahypar::flow::queue_node<int> qn;
    using base_type = oneapi::tbb_kahypar::flow::composite_node<std::tuple<int,int>, std::tuple<int>>;
...
public:
    adder(oneapi::tbb_kahypar::flow::graph &g) : base_type(g), j(g), f(g, oneapi::tbb_kahypar::flow::unlimited, f_body()), qn(g) {
        make_edge(j, f);
        make_edge(f, qn);

        base_type::input_ports_type input_tuple(oneapi::tbb_kahypar::flow::input_port<0>(j), oneapi::tbb_kahypar::flow::input_port<1>(j));
...
TEST_CASE("composite_node superclasses"){
    CHECK_MESSAGE((std::is_base_of<oneapi::tbb_kahypar::flow::graph_node, adder>::value), "composite_node should be derived from graph_node");
}
...
TEST_CASE("composite_node ports"){
    ...
    using InputTupleType = std::tuple<tbb_kahypar::flow::continue_msg, std::tuple<int, int>, int, int, int, int,
                             int, int, int, int, int, int, int, int>;

    using OutputTupleType = std::tuple<tbb_kahypar::flow::continue_msg, std::tuple<int, int>, oneapi::tbb_kahypar::flow::tagged_msg<size_t, int, float>,
                             int, int, int, int, int, int, int, int, int, int, int, int>;

    using EmptyTupleType= std::tuple<>;

    using input_output_type = oneapi::tbb_kahypar::flow::composite_node<InputTupleType, OutputTupleType>;
    using input_only_type = oneapi::tbb_kahypar::flow::composite_node<InputTupleType, EmptyTupleType>;
    using output_only_type = oneapi::tbb_kahypar::flow::composite_node<EmptyTupleType, OutputTupleType>;
    ...
    //node types
    oneapi::tbb_kahypar::flow::continue_node<tbb_kahypar::flow::continue_msg> ct(g, body());
    oneapi::tbb_kahypar::flow::split_node< std::tuple<int, int> > s(g);
    ...
    oneapi::tbb_kahypar::flow::indexer_node<int, float> ind(g);
    oneapi::tbb_kahypar::flow::join_node< std::tuple< int, int >, oneapi::tbb_kahypar::flow::queueing > j(g);
    oneapi::tbb_kahypar::flow::queue_node<int> q(g);
    ...
    auto input_tuple = std::tie(ct, s, m_fxn, fxn, bc, oneapi::tbb_kahypar::flow::input_port<0>(j), lim, q, oneapi::tbb_kahypar::flow::input_port<0>(ind),
                                pq, ovw, wo, bf, seq);
    auto output_tuple = std::tie(ct,j, ind, fxn, src, bc, oneapi::tbb_kahypar::flow::output_port<0>(s), lim, oneapi::tbb_kahypar::flow::output_port<0>(m_fxn),
                                 q, pq, ovw, wo, bf, seq);
