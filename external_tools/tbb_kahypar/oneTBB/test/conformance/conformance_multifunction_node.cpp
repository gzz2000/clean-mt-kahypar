...
TEST_CASE("multifunction_node with rejecting policy"){
    conformance::test_rejecting<oneapi::tbb_kahypar::flow::multifunction_node<int, std::tuple<int>, oneapi::tbb_kahypar::flow::rejecting>>();
}

//! Test nodes for execution with priority in single-threaded configuration
//! \brief \ref interface
TEST_CASE("multifunction_node priority"){
    conformance::test_priority<oneapi::tbb_kahypar::flow::multifunction_node<input_msg, std::tuple<int>>, input_msg>(oneapi::tbb_kahypar::flow::unlimited);
}
...
TEST_CASE("multifunction_node concurrency"){
    conformance::test_concurrency<oneapi::tbb_kahypar::flow::multifunction_node<int, std::tuple<int>>>();
}
...
TEST_CASE("multifunction_node constructors"){
    ...
    multifunction_node<int, std::tuple<int>> fn2(g, unlimited, fun, oneapi::tbb_kahypar::flow::node_priority_t(1));

    multifunction_node<int, std::tuple<int>, lightweight> lw_node1(g, serial, fun, lightweight());
    multifunction_node<int, std::tuple<int>, lightweight> lw_node2(g, serial, fun, lightweight(), oneapi::tbb_kahypar::flow::node_priority_t(1));
}
...
TEST_CASE("multifunction_node copy constructor"){
    conformance::test_copy_ctor<oneapi::tbb_kahypar::flow::multifunction_node<int, std::tuple<int>>>();
}
...
TEST_CASE("multifunction_node buffering"){
    ...
    conformance::test_buffering<oneapi::tbb_kahypar::flow::multifunction_node<input_msg, std::tuple<int>,
    oneapi::tbb_kahypar::flow::rejecting>, input_msg>(oneapi::tbb_kahypar::flow::unlimited, fun);
}
...
TEST_CASE("multifunction_node broadcast"){
    ...
    conformance::test_forwarding<oneapi::tbb_kahypar::flow::multifunction_node<input_msg, std::tuple<int>>, input_msg, int>(1, oneapi::tbb_kahypar::flow::unlimited, fun);
}

//! Test the body object passed to a node is copied
//! \brief \ref interface
TEST_CASE("multifunction_node copy body"){
    conformance::test_copy_body_function<oneapi::tbb_kahypar::flow::multifunction_node<int, std::tuple<int>>, conformance::copy_counting_object<int>>(oneapi::tbb_kahypar::flow::unlimited);
}
...
TEST_CASE("multifunction_node body") {
    conformance::test_body_exec<oneapi::tbb_kahypar::flow::multifunction_node<input_msg, std::tuple<output_msg>, oneapi::tbb_kahypar::flow::rejecting>, input_msg, output_msg>(oneapi::tbb_kahypar::flow::unlimited);
}
...
TEST_CASE("multifunction_node output_ports") {
    ...
    graph g;
    conformance::dummy_functor<int> fun;
    oneapi::tbb_kahypar::flow::multifunction_node <int, std::tuple<int>> node(g, unlimited, fun);

    CHECK_MESSAGE((std::is_same<oneapi::tbb_kahypar::flow::multifunction_node<int, std::tuple<int>>::output_ports_type&,
...
TEST_CASE("Test function_node Output and Input class") {
    ...
    conformance::test_output_input_class<oneapi::tbb_kahypar::flow::multifunction_node<Body, std::tuple<Body>>, Body>();
}
