...
TEST_CASE("broadcast_node broadcasts"){
    conformance::test_forwarding<oneapi::tbb_kahypar::flow::broadcast_node<int>, int>(1);
    conformance::test_forwarding<oneapi::tbb_kahypar::flow::broadcast_node<input_msg>, input_msg>(1);
}

//! Test broadcast_node buffering
//! \brief \ref requirement
TEST_CASE("broadcast_node buffering"){
    conformance::test_buffering<oneapi::tbb_kahypar::flow::broadcast_node<int>, int>();
}

//! Test inheritance relations
//! \brief \ref interface
TEST_CASE("broadcast_node superclasses"){
    conformance::test_inheritance<oneapi::tbb_kahypar::flow::broadcast_node<int>, int, int>();
    conformance::test_inheritance<oneapi::tbb_kahypar::flow::broadcast_node<float>, float, float>();
    conformance::test_inheritance<oneapi::tbb_kahypar::flow::broadcast_node<input_msg>, input_msg, input_msg>();
}
