...
using my_split_type = oneapi::tbb_kahypar::flow::split_node<my_input_tuple>;
...
TEST_CASE("split_node buffering") {
    ...
    oneapi::tbb_kahypar::flow::limiter_node<int> rejecter1(g,0);
    oneapi::tbb_kahypar::flow::limiter_node<float> rejecter2(g,0);
    oneapi::tbb_kahypar::flow::limiter_node<input_msg> rejecter3(g,0);

    oneapi::tbb_kahypar::flow::make_edge(oneapi::tbb_kahypar::flow::output_port<0>(testing_node), rejecter1);
    oneapi::tbb_kahypar::flow::make_edge(oneapi::tbb_kahypar::flow::output_port<1>(testing_node), rejecter2);
    oneapi::tbb_kahypar::flow::make_edge(oneapi::tbb_kahypar::flow::output_port<2>(testing_node), rejecter3);
    ...
    float tmp2 = -1;
    input_msg tmp3(-1);
    CHECK_MESSAGE((oneapi::tbb_kahypar::flow::output_port<0>(testing_node).try_get(tmp1) == false 
                    && tmp1 == -1), "Value should be discarded after rejection");
    CHECK_MESSAGE((oneapi::tbb_kahypar::flow::output_port<1>(testing_node).try_get(tmp2) == false 
                    && tmp2 == -1.f), "Value should be discarded after rejection");
    CHECK_MESSAGE((oneapi::tbb_kahypar::flow::output_port<2>(testing_node).try_get(tmp3) == false 
...
TEST_CASE("split_node broadcast and splitting"){
    ...
    oneapi::tbb_kahypar::flow::make_edge(output_port<0>(testing_node), node2);
    oneapi::tbb_kahypar::flow::make_edge(output_port<1>(testing_node), node3);
    oneapi::tbb_kahypar::flow::make_edge(output_port<2>(testing_node), node4);
...
TEST_CASE("split_node copy constructor"){
    oneapi::tbb_kahypar::flow::graph g;
    oneapi::tbb_kahypar::flow::continue_node<std::tuple<int>> node0( g,
                                [](oneapi::tbb_kahypar::flow::continue_msg) { return std::tuple<int>(1); } );

    oneapi::tbb_kahypar::flow::split_node<std::tuple<int>> node1(g);
    conformance::test_push_receiver<int> node2(g);
    conformance::test_push_receiver<int> node3(g);

    oneapi::tbb_kahypar::flow::make_edge(node0, node1);
    oneapi::tbb_kahypar::flow::make_edge(oneapi::tbb_kahypar::flow::output_port<0>(node1), node2);

    oneapi::tbb_kahypar::flow::split_node<std::tuple<int>> node_copy(node1);

    oneapi::tbb_kahypar::flow::make_edge(oneapi::tbb_kahypar::flow::output_port<0>(node_copy), node3);
...
TEST_CASE("split_node superclasses") {
    CHECK_MESSAGE((std::is_base_of<oneapi::tbb_kahypar::flow::graph_node, my_split_type>::value), "split_node should be derived from graph_node");
    CHECK_MESSAGE((std::is_base_of<oneapi::tbb_kahypar::flow::receiver<my_input_tuple>, my_split_type>::value), "split_node should be derived from receiver<T>");
}
