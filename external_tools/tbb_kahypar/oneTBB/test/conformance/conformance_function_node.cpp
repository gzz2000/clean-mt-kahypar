...
TEST_CASE("Test function_node body") {
    conformance::test_body_exec<oneapi::tbb_kahypar::flow::function_node<input_msg, output_msg>, input_msg, output_msg>(oneapi::tbb_kahypar::flow::unlimited);
}
...
TEST_CASE("function_node constructors"){
    ...
    function_node<int, int> fn2(g, unlimited, fun, oneapi::tbb_kahypar::flow::node_priority_t(1));

    function_node<int, int, lightweight> lw_node1(g, serial, fun, lightweight());
    function_node<int, int, lightweight> lw_node2(g, serial, fun, lightweight(), oneapi::tbb_kahypar::flow::node_priority_t(1));
}
...
TEST_CASE("function_node copy constructor"){
    conformance::test_copy_ctor<oneapi::tbb_kahypar::flow::function_node<int, int>>();
}

//! Test node reject the incoming message if the concurrency limit achieved.
//! \brief \ref interface
TEST_CASE("function_node with rejecting policy"){
    conformance::test_rejecting<oneapi::tbb_kahypar::flow::function_node<int, int, oneapi::tbb_kahypar::flow::rejecting>>();
}
...
TEST_CASE("function_node and body copying"){
    conformance::test_copy_body_function<oneapi::tbb_kahypar::flow::function_node<int, int>, conformance::copy_counting_object<int>>(oneapi::tbb_kahypar::flow::unlimited);
}

//! Test function_node is a graph_node, receiver<Input>, and sender<Output>
//! \brief \ref interface
TEST_CASE("function_node superclasses"){
    conformance::test_inheritance<oneapi::tbb_kahypar::flow::function_node<int, int>, int, int>();
    conformance::test_inheritance<oneapi::tbb_kahypar::flow::function_node<void*, float>, void*, float>();
    conformance::test_inheritance<oneapi::tbb_kahypar::flow::function_node<input_msg, output_msg>, input_msg, output_msg>();
}
...
TEST_CASE("function_node buffering"){
    ...
    conformance::test_buffering<oneapi::tbb_kahypar::flow::function_node<input_msg, int, oneapi::tbb_kahypar::flow::rejecting>, input_msg>(oneapi::tbb_kahypar::flow::unlimited, fun);
    conformance::test_buffering<oneapi::tbb_kahypar::flow::function_node<input_msg, int, oneapi::tbb_kahypar::flow::queueing>, input_msg>(oneapi::tbb_kahypar::flow::unlimited, fun);
}
...
TEST_CASE("function_node broadcast"){
    ...
    conformance::test_forwarding<oneapi::tbb_kahypar::flow::function_node<input_msg, int>, input_msg, int>(1, oneapi::tbb_kahypar::flow::unlimited, fun);
}
...
TEST_CASE("function_node priority support"){
    conformance::test_priority<oneapi::tbb_kahypar::flow::function_node<input_msg, int>, input_msg>(oneapi::tbb_kahypar::flow::unlimited);
}
...
TEST_CASE("concurrency follows set limits"){
    conformance::test_concurrency<oneapi::tbb_kahypar::flow::function_node<int, int>>();
}
...
TEST_CASE("Test function_node Output and Input class") {
    ...
    conformance::test_output_input_class<oneapi::tbb_kahypar::flow::function_node<Body, Body>, Body>();
}
