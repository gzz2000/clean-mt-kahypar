...
int input_body_f(tbb_kahypar::flow_control&) { return 42; }

void test_deduction_guides() {
    using namespace tbb_kahypar::flow;
    graph g;

    auto lambda = [](tbb_kahypar::flow_control&) { return 42; };
    auto non_const_lambda = [](tbb_kahypar::flow_control&) mutable { return 42; };
...
TEST_CASE("input_node and body copying"){
    conformance::test_copy_body_function<oneapi::tbb_kahypar::flow::input_node<int>, conformance::copy_counting_object<int>>();
}
...
TEST_CASE("input_node forwarding"){
    ...
    conformance::test_forwarding<oneapi::tbb_kahypar::flow::input_node<output_msg>, void, output_msg>(5, fun);
}
...
TEST_CASE("input_node buffering"){
    ...
    conformance::test_buffering<oneapi::tbb_kahypar::flow::input_node<int>, int>(fun);
}
...
TEST_CASE("input_node body") {
    ...
    oneapi::tbb_kahypar::flow::input_node<output_msg> node1(g, fun);
    conformance::test_push_receiver<output_msg> node2(g);
...
TEST_CASE("concurrency follows set limits"){
    ...
    oneapi::tbb_kahypar::flow::input_node<int> testing_node(g, counter);
...
TEST_CASE("Test input_node Output class") {
    conformance::test_output_class<oneapi::tbb_kahypar::flow::input_node<conformance::copy_counting_object<int>>>();
}
...
TEST_CASE("input_node `try_get()' call testing: a call to body is made only when the internal buffer is empty.") {
    oneapi::tbb_kahypar::global_control control(oneapi::tbb_kahypar::global_control::max_allowed_parallelism, 1);
    oneapi::tbb_kahypar::flow::graph g;
    input_node_counter fun1(500);
    function_node_counter fun2;

    oneapi::tbb_kahypar::flow::function_node <int, int, oneapi::tbb_kahypar::flow::rejecting> fnode(g, oneapi::tbb_kahypar::flow::serial, fun2);
    oneapi::tbb_kahypar::flow::input_node<int> testing_node(g, fun1);
