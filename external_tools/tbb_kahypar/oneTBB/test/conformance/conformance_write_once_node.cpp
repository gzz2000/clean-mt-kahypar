...
TEST_CASE("write_once_node broadcast"){
    conformance::test_forwarding<oneapi::tbb_kahypar::flow::write_once_node<int>, int>(1);
}

//! Test write_once_node buffering
//! \brief \ref requirement
TEST_CASE("write_once_node buffering"){
    conformance::test_buffering<oneapi::tbb_kahypar::flow::write_once_node<int>, int>();
}
...
TEST_CASE("write_once_node copy constructor"){
    conformance::test_copy_ctor_for_buffering_nodes<oneapi::tbb_kahypar::flow::write_once_node<int>>();
}

//! Test inheritance relations
//! \brief \ref interface
TEST_CASE("write_once_node superclasses"){
    conformance::test_inheritance<oneapi::tbb_kahypar::flow::write_once_node<int>, int, int>();
    conformance::test_inheritance<oneapi::tbb_kahypar::flow::write_once_node<void*>, void*, void*>();
}
...
TEST_CASE("write_once_node constructor"){
    ...
    oneapi::tbb_kahypar::flow::overwrite_node<int> testing_node(g);
...
TEST_CASE("write_once_node methods"){
    oneapi::tbb_kahypar::flow::graph g;
    oneapi::tbb_kahypar::flow::write_once_node<int> testing_node(g);
