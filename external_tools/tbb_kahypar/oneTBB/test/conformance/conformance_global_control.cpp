...
void TestStackSizeSimpleControl() {
    oneapi::tbb_kahypar::global_control s0(oneapi::tbb_kahypar::global_control::thread_stack_size, 1*MB);

    {
        oneapi::tbb_kahypar::global_control s1(oneapi::tbb_kahypar::global_control::thread_stack_size, 8*MB);

        CHECK(8*MB == oneapi::tbb_kahypar::global_control::active_value(oneapi::tbb_kahypar::global_control::thread_stack_size));
    }
    CHECK(1*MB == oneapi::tbb_kahypar::global_control::active_value(oneapi::tbb_kahypar::global_control::thread_stack_size));
}
...
struct StackSizeRun : utils::NoAssign {
    ...
    void operator()( int id ) const {
        oneapi::tbb_kahypar::global_control s1(oneapi::tbb_kahypar::global_control::thread_stack_size, (1+id)*MB);

        barr1->wait();

        REQUIRE(num_threads*MB == oneapi::tbb_kahypar::global_control::active_value(oneapi::tbb_kahypar::global_control::thread_stack_size));
        barr2->wait();
    }
};
...
{
    oneapi::tbb_kahypar::global_control s(oneapi::tbb_kahypar::global_control::max_allowed_parallelism, parallelism);
...
void TestWorkersConstraints()
{
    const size_t max_parallelism =
        oneapi::tbb_kahypar::global_control::active_value(oneapi::tbb_kahypar::global_control::max_allowed_parallelism);
    if (max_parallelism > 3) {
        oneapi::tbb_kahypar::global_control c(oneapi::tbb_kahypar::global_control::max_allowed_parallelism, max_parallelism-1);
        CHECK_MESSAGE(max_parallelism-1 ==
               oneapi::tbb_kahypar::global_control::active_value(oneapi::tbb_kahypar::global_control::max_allowed_parallelism),
               "Allowed parallelism must be decreasable.");
        oneapi::tbb_kahypar::global_control c1(oneapi::tbb_kahypar::global_control::max_allowed_parallelism, max_parallelism-2);
...
struct SetUseRun: utils::NoAssign {
    ...
    void operator()( int id ) const {
        if (id == 0) {
            for (int i=0; i<10; i++) {
                oneapi::tbb_kahypar::parallel_for(0, 1000, utils::DummyBody(10), oneapi::tbb_kahypar::simple_partitioner());
                barr.wait();
            }
        } else {
            for (int i=0; i<10; i++) {
                oneapi::tbb_kahypar::global_control c(oneapi::tbb_kahypar::global_control::max_allowed_parallelism, 8);
                barr.wait();
            }
        }
    }
...
void TestAutoInit()
{
    ...
    utils::ExactConcurrencyLevel::check(expected_threads);
    CHECK_MESSAGE(oneapi::tbb_kahypar::global_control::active_value(oneapi::tbb_kahypar::global_control::max_allowed_parallelism)
    ...
    if (max_parallelism > 2) {
        ...
        oneapi::tbb_kahypar::global_control s(oneapi::tbb_kahypar::global_control::max_allowed_parallelism, max_parallelism-1);
        // TODO: consider better testing approach
...
public:
    ...
    void operator()( int id ) const {
        ...
        if (id) {
            {
                oneapi::tbb_kahypar::global_control c(oneapi::tbb_kahypar::global_control::max_allowed_parallelism, 1);
            ...
            barrier.wait();
            {
                oneapi::tbb_kahypar::global_control c(oneapi::tbb_kahypar::global_control::max_allowed_parallelism, 2);
                utils::ExactConcurrencyLevel::check(1);
                barrier.wait();
...
TEST_CASE("setting stack size") {
    std::size_t default_ss = oneapi::tbb_kahypar::global_control::active_value(oneapi::tbb_kahypar::global_control::thread_stack_size);
    CHECK(default_ss > 0);
    TestStackSizeSimpleControl();
    TestStackSizeThreadsControl();
    CHECK(default_ss == oneapi::tbb_kahypar::global_control::active_value(oneapi::tbb_kahypar::global_control::thread_stack_size));
}
#endif
...
TEST_CASE("terminate_on_exception: default") {
    std::size_t default_toe = oneapi::tbb_kahypar::global_control::active_value(oneapi::tbb_kahypar::global_control::terminate_on_exception);
    CHECK(default_toe == 0);
}
...
TEST_CASE("terminate_on_exception: nested") {
    oneapi::tbb_kahypar::global_control* c0;
    {
        oneapi::tbb_kahypar::global_control c1(oneapi::tbb_kahypar::global_control::terminate_on_exception, 1);
        CHECK(oneapi::tbb_kahypar::global_control::active_value(oneapi::tbb_kahypar::global_control::terminate_on_exception) == 1);
        {
            oneapi::tbb_kahypar::global_control c2(oneapi::tbb_kahypar::global_control::terminate_on_exception, 0);
            CHECK(oneapi::tbb_kahypar::global_control::active_value(oneapi::tbb_kahypar::global_control::terminate_on_exception) == 1);
        }
        CHECK(oneapi::tbb_kahypar::global_control::active_value(oneapi::tbb_kahypar::global_control::terminate_on_exception) == 1);
        c0 = new oneapi::tbb_kahypar::global_control(oneapi::tbb_kahypar::global_control::terminate_on_exception, 0);
    }
    CHECK(oneapi::tbb_kahypar::global_control::active_value(oneapi::tbb_kahypar::global_control::terminate_on_exception) == 0);
    delete c0;
}
...
TEST_CASE("setting same value") {
    ...
    oneapi::tbb_kahypar::global_control* ctl1 = new oneapi::tbb_kahypar::global_control(oneapi::tbb_kahypar::global_control::max_allowed_parallelism, value);
    oneapi::tbb_kahypar::global_control* ctl2 = new oneapi::tbb_kahypar::global_control(oneapi::tbb_kahypar::global_control::max_allowed_parallelism, value);

    std::size_t active = oneapi::tbb_kahypar::global_control::active_value(oneapi::tbb_kahypar::global_control::max_allowed_parallelism);
    REQUIRE(active == value);
    delete ctl2;

    active = oneapi::tbb_kahypar::global_control::active_value(oneapi::tbb_kahypar::global_control::max_allowed_parallelism);
...
TEST_CASE("prolong lifetime simple") {
    tbb_kahypar::task_scheduler_handle hdl1{ tbb_kahypar::attach{} };
    {
        tbb_kahypar::parallel_for(0, 10, utils::DummyBody());

        tbb_kahypar::task_scheduler_handle hdl2;
        hdl2 = tbb_kahypar::task_scheduler_handle{ tbb_kahypar::attach{} };
        hdl2.release();
    }
    bool ok = tbb_kahypar::finalize(hdl1, std::nothrow);
    REQUIRE(ok);
}
...
TEST_CASE("null handle check") {
    tbb_kahypar::task_scheduler_handle hndl;
    REQUIRE_FALSE(hndl);
}
...
TEST_CASE("null handle check 2") {
    tbb_kahypar::task_scheduler_handle hndl{ tbb_kahypar::attach{} };
    bool not_empty = (bool)hndl;

    tbb_kahypar::finalize(hndl, std::nothrow);
...
TEST_CASE("null handle check 3") {
    tbb_kahypar::task_scheduler_handle handle1{ tbb_kahypar::attach{} };
    tbb_kahypar::task_scheduler_handle handle2(std::move(handle1));

    bool handle1_empty = !handle1;
    bool handle2_not_empty = (bool)handle2;

    tbb_kahypar::finalize(handle2, std::nothrow);
...
TEST_CASE("cross thread 1") {
    ...
    utils::NativeParallelFor(1, [&](int) {
        tbb_kahypar::parallel_for(0, 10, utils::DummyBody());
        bool res = tbb_kahypar::finalize(handle, std::nothrow);
        REQUIRE(res);
    });
}
...
TEST_CASE("cross thread 2") {
    ...
    tbb_kahypar::task_scheduler_handle handle;
    utils::NativeParallelFor(1, [&](int) {
        handle = tbb_kahypar::task_scheduler_handle{ tbb_kahypar::attach{} };
        tbb_kahypar::parallel_for(0, 10, utils::DummyBody());
    });
    bool res = tbb_kahypar::finalize(handle, std::nothrow);
    REQUIRE(res);
...
TEST_CASE("simple prolong lifetime 3") {
    ...
    tbb_kahypar::parallel_for(0, 10, utils::DummyBody());
    // Termination
    tbb_kahypar::task_scheduler_handle handle = tbb_kahypar::task_scheduler_handle{ tbb_kahypar::attach{} };
    bool res = tbb_kahypar::finalize(handle, std::nothrow);
    REQUIRE(res);
    // New parallel region
    tbb_kahypar::parallel_for(0, 10, utils::DummyBody());
...
TEST_CASE("Test worker threads remain inactive in enforced serial execution mode") {
    ...
    // Warm-up threads
    tbb_kahypar::parallel_for(std::size_t(0), num_threads, [&] (std::size_t) {
        barrier.wait();
    });

    tbb_kahypar::global_control control(tbb_kahypar::global_control::max_allowed_parallelism, 1);
...
TEST_CASE("terminate_on_exception: enabled") {
    oneapi::tbb_kahypar::global_control c(oneapi::tbb_kahypar::global_control::terminate_on_exception, 1);
...
#pragma warning(disable:4611) // interaction between '_setjmp' and C++ object destruction is non - portable
        ...
        SUBCASE("internal exception") {
            if (setjmp(buffer) == 0) {
                oneapi::tbb_kahypar::parallel_for(0, 1, -1, [](int) {});
        ...
        SUBCASE("user exception") {
            if (setjmp(buffer) == 0) {
                oneapi::tbb_kahypar::parallel_for(0, 1, [](int) {
