...
struct AllowMultimapping<oneapi::tbb_kahypar::concurrent_unordered_multiset<Args...>> : std::true_type {};

template <typename Key>
using Allocator = LocalCountingAllocator<std::allocator<Key>>;

using set_type = oneapi::tbb_kahypar::concurrent_unordered_set<int, std::hash<int>, std::equal_to<int>, Allocator<int>>;
using multiset_type = oneapi::tbb_kahypar::concurrent_unordered_multiset<int, std::hash<int>, std::equal_to<int>, Allocator<int>>;
...
void test_member_types() {
    ...
    static_assert(std::is_same<typename default_container_type::allocator_type, oneapi::tbb_kahypar::tbb_allocator<int>>::value,
...
struct CusetTraits : UnorderedMoveTraitsBase {
    ...
    using container_type = oneapi::tbb_kahypar::concurrent_unordered_set<T, std::hash<T>, std::equal_to<T>, Allocator>;
...
struct CumultisetTraits : UnorderedMoveTraitsBase {
    template <typename T, typename Allocator>
    using container_type = oneapi::tbb_kahypar::concurrent_unordered_multiset<T, std::hash<T>, std::equal_to<T>, Allocator>;
...
TEST_CASE("concurrent_unordered_set member types") {
    test_member_types<oneapi::tbb_kahypar::concurrent_unordered_set>();
}
...
TEST_CASE("heterogeneous overloads in concurrent_unordered_set") {
    check_heterogeneous_functions_key_int<oneapi::tbb_kahypar::concurrent_unordered_set, int>();
    check_heterogeneous_functions_key_string<oneapi::tbb_kahypar::concurrent_unordered_set, std::string>();
}
...
TEST_CASE("CTAD support in concurrent_unordered_set") {
    test_deduction_guides<oneapi::tbb_kahypar::concurrent_unordered_set>();
}
#endif
...
TEST_CASE("concurrent_unordered_set comparisons") {
    test_set_comparisons<oneapi::tbb_kahypar::concurrent_unordered_set>();
}

//! Testing concurrent_unordered_multiset member types
//! \brief \ref interface \ref requirement
TEST_CASE("concurrent_unordered_multiset member types") {
    test_member_types<oneapi::tbb_kahypar::concurrent_unordered_multiset>();
}
...
TEST_CASE("heterogeneous overloads in concurrent_unordered_multiset") {
    check_heterogeneous_functions_key_int<oneapi::tbb_kahypar::concurrent_unordered_multiset, int>();
    check_heterogeneous_functions_key_string<oneapi::tbb_kahypar::concurrent_unordered_multiset, std::string>();
}
...
TEST_CASE("CTAD support in concurrent_unordered_multiset") {
    test_deduction_guides<oneapi::tbb_kahypar::concurrent_unordered_multiset>();
}
#endif
...
TEST_CASE("concurrent_unordered_multiset comparisons") {
    test_set_comparisons<oneapi::tbb_kahypar::concurrent_unordered_multiset>();
}
