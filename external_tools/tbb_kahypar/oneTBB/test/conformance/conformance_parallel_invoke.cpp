...
struct correctness_test_case {
    ...
    static void run_validate_and_reset(oneapi::tbb_kahypar::task_group_context* context_ptr) {
...
void correctness_test(oneapi::tbb_kahypar::task_group_context* context_ptr = nullptr) {
...
struct ParInvokeLauncher {
    oneapi::tbb_kahypar::task_group_context &my_ctx;
    ...
    void operator()() const {
        ...
        oneapi::tbb_kahypar::parallel_invoke(func_array[0], func_array[1], func_array[2], func_array[3],
            func_array[4], func_array[5], func_array[6], func_array[7], func_array[8], func_array[9], my_ctx);
    }

    ParInvokeLauncher ( oneapi::tbb_kahypar::task_group_context& ctx ) : my_ctx(ctx) {}
};
