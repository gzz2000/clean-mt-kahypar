...
struct AllowMultimapping<oneapi::tbb_kahypar::concurrent_unordered_multimap<Args...>> : std::true_type {};

template <typename Key, typename Mapped>
using Allocator = LocalCountingAllocator<std::allocator<std::pair<const Key, Mapped>>>;

using map_type = oneapi::tbb_kahypar::concurrent_unordered_map<int, int, std::hash<int>, std::equal_to<int>, Allocator<int, int>>;
using multimap_type = oneapi::tbb_kahypar::concurrent_unordered_multimap<int, int, std::hash<int>, std::equal_to<int>, Allocator<int, int>>;
...
void test_member_types() {
    ...
    static_assert(std::is_same<typename default_container_type::allocator_type,
                               oneapi::tbb_kahypar::tbb_allocator<std::pair<const int, int>>>::value,
...
void test_heterogeneous_functions() {
    check_heterogeneous_functions_key_int<oneapi::tbb_kahypar::concurrent_unordered_map, int, int>();
    check_heterogeneous_functions_key_int<oneapi::tbb_kahypar::concurrent_unordered_multimap, int, int>();
    check_heterogeneous_functions_key_string<oneapi::tbb_kahypar::concurrent_unordered_map, std::string, std::string>();
    check_heterogeneous_functions_key_string<oneapi::tbb_kahypar::concurrent_unordered_multimap, std::string, std::string>();
}

struct CumapTraits : UnorderedMoveTraitsBase {
    template <typename T, typename Allocator>
    using container_type = oneapi::tbb_kahypar::concurrent_unordered_map<T, T, std::hash<T>, std::equal_to<T>, Allocator>;
...
struct CumultimapTraits : UnorderedMoveTraitsBase {
    template <typename T, typename Allocator>
    using container_type = oneapi::tbb_kahypar::concurrent_unordered_multimap<T, T, std::hash<T>, std::equal_to<T>, Allocator>;
...
TEST_CASE("concurrent_unordered_map member types") {
    test_member_types<oneapi::tbb_kahypar::concurrent_unordered_map>();
}
...
TEST_CASE("insertion by generic pair in concurrent_unordered_map") {
    test_insert_by_generic_pair<oneapi::tbb_kahypar::concurrent_unordered_map>();
}
...
TEST_CASE("CTAD support in concurrent_unordered_map") {
    test_deduction_guides<oneapi::tbb_kahypar::concurrent_unordered_map>();
}
#endif
...
TEST_CASE("concurrent_unordered_map comparisons") {
    test_map_comparisons<oneapi::tbb_kahypar::concurrent_unordered_map>();
}

//! Testing concurrent_unordered_multimap member types
//! \brief \ref interface \ref requirement
TEST_CASE("concurrent_unordered_multimap member types") {
    test_member_types<oneapi::tbb_kahypar::concurrent_unordered_multimap>();
}
...
TEST_CASE("insertion by generic pair in concurrent_unordered_multimap") {
    test_insert_by_generic_pair<oneapi::tbb_kahypar::concurrent_unordered_multimap>();
}
...
TEST_CASE("CTAD support in concurrent_unordered_multimap") {
    test_deduction_guides<oneapi::tbb_kahypar::concurrent_unordered_multimap>();
}
#endif
...
TEST_CASE("concurrent_unordered_multimap comparisons") {
    test_map_comparisons<oneapi::tbb_kahypar::concurrent_unordered_multimap>();
}
