...
TEST_CASE("priority_queue_node single_push"){
    conformance::test_forwarding_single_push<oneapi::tbb_kahypar::flow::priority_queue_node<int>>();
}

//! Test function_node buffering
//! \brief \ref requirement
TEST_CASE("priority_queue_node buffering"){
    conformance::test_buffering<oneapi::tbb_kahypar::flow::priority_queue_node<int>, int>();
}
...
TEST_CASE("priority_queue_node copy constructor"){
    conformance::test_copy_ctor_for_buffering_nodes<oneapi::tbb_kahypar::flow::priority_queue_node<int>>();
}

//! Test inheritance relations
//! \brief \ref interface
TEST_CASE("priority_queue_node superclasses"){
    conformance::test_inheritance<oneapi::tbb_kahypar::flow::priority_queue_node<int>, int, int>();
    conformance::test_inheritance<oneapi::tbb_kahypar::flow::priority_queue_node<void*>, void*, void*>();
}
...
TEST_CASE("priority_queue_node methods"){
    ...
    oneapi::tbb_kahypar::flow::priority_queue_node<int, std::greater<int>> testing_node(g);
