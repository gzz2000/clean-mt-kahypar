...
class numa_binding_observer : public tbb_kahypar::task_scheduler_observer {
...
arena::arena(threading_control* control, unsigned num_slots, unsigned num_reserved_slots, unsigned priority_level
             ...
             , tbb_kahypar::task_arena::leave_policy lp 
#endif
)
{
...
// Enable task_arena.h
#include "oneapi_kahypar/tbb_kahypar/task_arena.h" // task_arena_base
...
#if TBB_USE_ASSERT
void assert_arena_priority_valid( tbb_kahypar::task_arena::priority a_priority ) {
    bool is_arena_priority_correct =
        a_priority == tbb_kahypar::task_arena::priority::high   ||
        a_priority == tbb_kahypar::task_arena::priority::normal ||
        a_priority == tbb_kahypar::task_arena::priority::low;
    __TBB_ASSERT( is_arena_priority_correct,
                  "Task arena priority should be equal to one of the predefined values." );
}
#else
void assert_arena_priority_valid( tbb_kahypar::task_arena::priority ) {}
#endif

unsigned arena_priority_level( tbb_kahypar::task_arena::priority a_priority ) {
    assert_arena_priority_valid( a_priority );
    return d1::num_priority_levels - unsigned(int(a_priority) / d1::priority_stride);
}

tbb_kahypar::task_arena::priority arena_priority( unsigned priority_level ) {
    auto priority = tbb_kahypar::task_arena::priority(
