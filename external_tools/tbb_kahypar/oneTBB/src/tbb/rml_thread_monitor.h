...
#define AVOID_64K_ALIASING(idx) tbb_kahypar::detail::suppress_unused_warning(idx)
#endif /* _WIN32||_WIN64 */
...
static const ::tbb_kahypar::detail::r1::tchar *SyncType_RML = _T("%Constant");
static const ::tbb_kahypar::detail::r1::tchar *SyncObj_ThreadMonitor = _T("RML Thr Monitor");
