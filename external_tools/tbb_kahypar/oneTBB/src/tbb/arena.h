...
class arena_co_cache {
    ...
    tbb_kahypar::spin_mutex my_co_cache_mutex;
...
public:
    ...
    void push(task_dispatcher* s) {
        ...
        {
            tbb_kahypar::spin_mutex::scoped_lock lock(my_co_cache_mutex);
...
public:
    ...
    void set_initial_state(tbb_kahypar::task_arena::leave_policy lp) {
        if (lp == tbb_kahypar::task_arena::leave_policy::automatic) {
            ...
            __TBB_ASSERT(lp == tbb_kahypar::task_arena::leave_policy::fast,
...
struct arena_base : padded<intrusive_list_node> {
    ...
    //! Task pool for the tasks scheduled via tbb_kahypar::resume() function.
...
#if __TBB_PREVIEW_PARALLEL_PHASE
                         , tbb_kahypar::task_arena::leave_policy lp = tbb_kahypar::task_arena::leave_policy::automatic
#endif
    );
