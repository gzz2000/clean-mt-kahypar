...
#define __TBB_SCHEDULER_MUTEX_TYPE tbb_kahypar::spin_mutex
#endif
...
#if TBB_USE_ASSERT
static const std::uintptr_t venom = tbb_kahypar::detail::select_size_t_constant<0xDEADBEEFU, 0xDDEEAADDDEADBEEFULL>::value;
