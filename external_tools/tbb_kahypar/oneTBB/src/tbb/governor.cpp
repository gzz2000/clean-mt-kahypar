...
/*
    ...
    TBB scheduler initialization (as an argument to tbb_kahypar::task_scheduler_init
    constructor).
...
void governor::init_external_thread() {
    ...
    unsigned arena_priority_level = 1; // corresponds to tbb_kahypar::task_arena::priority::normal
...
void constraints_assertion(d1::constraints c) {
    ...
    __TBB_ASSERT_RELEASE(
        ...
        "The constraints::numa_id value is not known to the library. Use tbb_kahypar::info::numa_nodes() to get the list of possible values.");
    ...
    __TBB_ASSERT_RELEASE(c.core_type == system_topology::automatic ||
        ...
        "The constraints::core_type value is not known to the library. Use tbb_kahypar::info::core_types() to get the list of possible values.");
}
