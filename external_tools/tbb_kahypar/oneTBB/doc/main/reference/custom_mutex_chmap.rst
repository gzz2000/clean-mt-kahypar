...
``oneapi::tbb_kahypar::spin_rw_mutex``, ``oneapi::tbb_kahypar::speculative_spin_rw_mutex``, ``oneapi::tbb_kahypar::queuing_rw_mutex``, ``oneapi::tbb_kahypar::null_rw_mutex``,
and ``oneapi::tbb_kahypar::rw_mutex`` meet the requirements above.
