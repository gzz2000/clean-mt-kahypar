...
to optimize operating with ``rvalues`` using functional form of ``tbb_kahypar::parallel_reduce`` and ``tbb_kahypar::parallel_deterministic_reduce`` algorithms.
...
* `oneapi::tbb_kahypar::parallel_reduce specification <https://oneapi-spec.uxlfoundation.org/specifications/oneapi/latest/elements/onetbb/source/algorithms/functions/parallel_reduce_func>`_
* `oneapi::tbb_kahypar::parallel_deterministic_reduce specification <https://oneapi-spec.uxlfoundation.org/specifications/oneapi/latest/elements/onetbb/source/algorithms/functions/parallel_deterministic_reduce_func>`_
