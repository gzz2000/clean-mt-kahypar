...
int main() {
    using map_type = oneapi::tbb_kahypar::concurrent_hash_map<int, int,
                                                      oneapi::tbb_kahypar::tbb_hash_compare<int>,
                                                      oneapi::tbb_kahypar::tbb_allocator<std::pair<const int, int>>,
                                                      SharedMutexWrapper>;
