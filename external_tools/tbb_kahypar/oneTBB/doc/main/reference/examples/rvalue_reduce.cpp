...
int main() {
    ...
    oneapi::tbb_kahypar::parallel_reduce(oneapi::tbb_kahypar::blocked_range<size_t>(0, sets.size()),
                                    std::set<int>{}, // identity element - empty set
                                    [&](const oneapi::tbb_kahypar::blocked_range<size_t>& range, std::set<int>&& value) {
