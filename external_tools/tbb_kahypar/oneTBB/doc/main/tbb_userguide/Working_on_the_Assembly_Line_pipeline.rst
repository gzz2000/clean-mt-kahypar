...
::
   ...
   public:
       ...
       static TextSlice* allocate( size_t max_size ) {
           ...
           TextSlice* t = (TextSlice*)oneapi::tbb_kahypar::tbb_allocator<char>().allocate( sizeof(TextSlice)+max_size+1 );
       ...
       void free() {
           oneapi::tbb_kahypar::tbb_allocator<char>().deallocate((char*)this, sizeof(TextSlice)+(physical_end-begin())+1);
       }
...
::
   ...
   void RunPipeline( int ntoken, FILE* input_file, FILE* output_file ) {
       oneapi::tbb_kahypar::parallel_pipeline(
           ntoken,
           oneapi::tbb_kahypar::make_filter<void,TextSlice*>(
               oneapi::tbb_kahypar::filter_mode::serial_in_order, MyInputFunc(input_file) )
       &
           oneapi::tbb_kahypar::make_filter<TextSlice*,TextSlice*>(
               oneapi::tbb_kahypar::filter_mode::parallel, MyTransformFunc() )
       &
           oneapi::tbb_kahypar::make_filter<TextSlice*,void>(
               oneapi::tbb_kahypar::filter_mode::serial_in_order, MyOutputFunc(output_file) ) );
   } 
...
::
   ...
   void RunPipeline( int ntoken, FILE* input_file, FILE* output_file ) {
       oneapi::tbb_kahypar::filter<void,TextSlice*> f1( oneapi::tbb_kahypar::filter_mode::serial_in_order, 
                                          MyInputFunc(input_file) );
       oneapi::tbb_kahypar::filter<TextSlice*,TextSlice*> f2(oneapi::tbb_kahypar::filter_mode::parallel, 
                                               MyTransformFunc() );
       oneapi::tbb_kahypar::filter<TextSlice*,void> f3(oneapi::tbb_kahypar::filter_mode::serial_in_order, 
                                         MyOutputFunc(output_file) );
       oneapi::tbb_kahypar::filter<void,void> f = f1 & f2 & f3;
       oneapi::tbb_kahypar::parallel_pipeline(ntoken,f);
   }
...
::
   ...
   public:
       ...
       ~MyInputFunc();
       TextSlice* operator()( oneapi::tbb_kahypar::flow_control& fc ) const;
   private:
       FILE* input_file;
   };
   ...
   TextSlice* MyInputFunc::operator()( oneapi::tbb_kahypar::flow_control& fc ) const {
...
the underlying ``oneapi::tbb_kahypar::filter_t`` is built from the functor, and again when the pipeline runs.
