...
void run_test_cases( BOOST_EXPLICIT_TEMPLATE_TYPE(Block) )
{
  ...
  {
    boost_kahypar::dynamic_bitset<Block> lhs(std::string("0")), rhs(std::string("1"));
    Tests::xor_assignment(lhs, rhs);
  }
  {
    boost_kahypar::dynamic_bitset<Block> lhs(long_string), rhs(long_string);
    Tests::xor_assignment(lhs, rhs);
  }
  //=====================================================================
  // Test operator-=
  ...
  { // case pos = block_size / 2, len = size - block_size
    boost_kahypar::dynamic_bitset<Block> b(long_string);
    Tests::set_segment(b, boost_kahypar::dynamic_bitset<Block>::bits_per_block / 2,
            b.size() - boost_kahypar::dynamic_bitset<Block>::bits_per_block, true);
    Tests::set_segment(b, boost_kahypar::dynamic_bitset<Block>::bits_per_block / 2,
            b.size() - boost_kahypar::dynamic_bitset<Block>::bits_per_block, false);
  }
  ...
  { // case pos = block_size / 2, len = size - block_size
    boost_kahypar::dynamic_bitset<Block> b(long_string);
    Tests::reset_segment(b, boost_kahypar::dynamic_bitset<Block>::bits_per_block / 2,
            b.size() - boost_kahypar::dynamic_bitset<Block>::bits_per_block);
  }
  { // case pos = 1, len = size - 2
    boost_kahypar::dynamic_bitset<Block> b(long_string);
  ...
  { // case pos = block_size / 2, len = size - block_size
    boost_kahypar::dynamic_bitset<Block> b(long_string);
    Tests::flip_segment(b, boost_kahypar::dynamic_bitset<Block>::bits_per_block / 2,
            b.size() - boost_kahypar::dynamic_bitset<Block>::bits_per_block);
  }
  { // case pos = 1, len = size - 2
    boost_kahypar::dynamic_bitset<Block> b(long_string);
