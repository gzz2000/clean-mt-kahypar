...
#include <boost_kahypar/dynamic_bitset/serialization.hpp>
...
#include <boost_kahypar/archive/binary_oarchive.hpp>
...
namespace {
    template <typename Block>
        struct SerializableType {
            boost_kahypar::dynamic_bitset<Block> x;
...
#           error "TODO implement file-based test path?"
    ...
    template <typename Block>
        void test_binary_archive( BOOST_EXPLICIT_TEMPLATE_TYPE(Block) ) {
            test_serialization<Block, boost_kahypar::archive::binary_iarchive, boost_kahypar::archive::binary_oarchive>();
        }

    template <typename Block>
        void test_xml_archive( BOOST_EXPLICIT_TEMPLATE_TYPE(Block) ) {
            test_serialization<Block, boost_kahypar::archive::xml_iarchive, boost_kahypar::archive::xml_oarchive>();
        }
}
