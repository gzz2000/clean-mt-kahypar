...
void run_test_cases( BOOST_EXPLICIT_TEMPLATE_TYPE(Block) )
{
  ...
  // Test construction from unsigned long
  {
    ...
    run_numeric_ctor_tests<Tests, ::boost_kahypar::long_long_type>();
    run_numeric_ctor_tests<Tests, ::boost_kahypar::ulong_long_type>();
#endif
...
# endif
  ...
  // Test resize
  {
    boost_kahypar::dynamic_bitset<Block> a;
    Tests::resize(a);
  }
  {
    boost_kahypar::dynamic_bitset<Block> a(std::string("0"));
    Tests::resize(a);
  }
  {
    boost_kahypar::dynamic_bitset<Block> a(std::string("1"));
    Tests::resize(a);
  }
  {
    boost_kahypar::dynamic_bitset<Block> a(long_string);
    Tests::resize(a);
  }
  //=====================================================================
  // Test clear
  ...
  // Test pop back 
  {
    boost_kahypar::dynamic_bitset<Block> a(std::string("01"));
    Tests::pop_back(a);
  }
  {
    boost_kahypar::dynamic_bitset<Block> a(std::string("10"));
    Tests::pop_back(a);
  }
  {
    const int size_to_fill_all_blocks = 4 * bits_per_block;
    boost_kahypar::dynamic_bitset<Block> a(size_to_fill_all_blocks, 255ul);
    Tests::pop_back(a);
  }
  {
    boost_kahypar::dynamic_bitset<Block> a(long_string);
  ...
  {
    const int size_to_fill_all_blocks = 4 * bits_per_block;
    boost_kahypar::dynamic_bitset<Block> a(size_to_fill_all_blocks, 15ul);
    Tests::append_block(a);
  }
  {
    boost_kahypar::dynamic_bitset<Block> a(long_string);
  ...
  {
    boost_kahypar::dynamic_bitset<Block> b1;
...
#if !defined(BOOST_NO_CXX11_ALLOCATOR)
  {
     typedef boost_kahypar::dynamic_bitset<Block,
  ...
  {
    boost_kahypar::dynamic_bitset<Block> b[1] = {};
    (void)b;
  }
}
