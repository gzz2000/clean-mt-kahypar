...
void run_test_cases( BOOST_EXPLICIT_TEMPLATE_TYPE(Block) )
{
  ...
  typedef boost_kahypar::dynamic_bitset<Block> bitset_type;
  ...
  // Test b.to_long()
  {
    boost_kahypar::dynamic_bitset<Block> b;
    Tests::to_ulong(b);
  }
  {
    boost_kahypar::dynamic_bitset<Block> b(std::string("1"));
    Tests::to_ulong(b);
  }
  {
    boost_kahypar::dynamic_bitset<Block> b(bitset_type::bits_per_block,
                                   static_cast<unsigned long>(-1));
    Tests::to_ulong(b);
  }
  {
    std::string str(ul_width - 1, '1');
    boost_kahypar::dynamic_bitset<Block> b(str);
    Tests::to_ulong(b);
  }
  {
    std::string ul_str(ul_width, '1');
    boost_kahypar::dynamic_bitset<Block> b(ul_str);
    Tests::to_ulong(b);
  }
  { // case overflow
    boost_kahypar::dynamic_bitset<Block> b(long_string);
    Tests::to_ulong(b);
  }
  //=====================================================================
  ...
  {
    boost_kahypar::dynamic_bitset<Block> b(std::string("0"));
    Tests::to_string(b);
  }
  {
    boost_kahypar::dynamic_bitset<Block> b(long_string);
  ...
  {
    boost_kahypar::dynamic_bitset<Block> b(8, 255ul);
    Tests::count(b);
  }
  {
    boost_kahypar::dynamic_bitset<Block> b(long_string);
  ...
  {
    boost_kahypar::dynamic_bitset<Block> b(100);
  ...
  {
    boost_kahypar::dynamic_bitset<Block> a, b;
    Tests::subset(a, b);
  }
  {
    boost_kahypar::dynamic_bitset<Block> a(std::string("0")), b(std::string("0"));
    Tests::subset(a, b);
  }
  {
    boost_kahypar::dynamic_bitset<Block> a(std::string("1")), b(std::string("1"));
    Tests::subset(a, b);
  }
  {
    boost_kahypar::dynamic_bitset<Block> a(long_string), b(long_string);
    Tests::subset(a, b);
  }
  {
    boost_kahypar::dynamic_bitset<Block> a(long_string), b(long_string);
  ...
  {
    boost_kahypar::dynamic_bitset<Block> a(std::string("10")), b(std::string("11"));
    Tests::operator_less_than(a, b);
  }
  {
    boost_kahypar::dynamic_bitset<Block> a(std::string("101")), b(std::string("11"));
    Tests::operator_less_than(a, b);
  }
  {
    boost_kahypar::dynamic_bitset<Block> a(std::string("10")), b(std::string("111"));
    Tests::operator_less_than(a, b);
  }
  {
    boost_kahypar::dynamic_bitset<Block> a(long_string), b(long_string);
  ...
  {
    boost_kahypar::dynamic_bitset<Block> a(3, 4ul), b(3, 5ul);
    assert(a < b);
  }
  {
    boost_kahypar::dynamic_bitset<Block> a(3, 4ul), b(3, 4ul);
    assert(!(a < b));
  }
  {
    boost_kahypar::dynamic_bitset<Block> a(3, 5ul), b(3, 4ul);
    assert(!(a < b));
  }
  // when the sizes are not equal lexicographic compare does not necessarily correspond to ulong behavior
  {
    boost_kahypar::dynamic_bitset<Block> a(4, 4ul), b(3, 5ul);
    assert(a < b);
  }
  {
    boost_kahypar::dynamic_bitset<Block> a(3, 4ul), b(4, 5ul);
    assert(!(a < b));
  }
  {
    boost_kahypar::dynamic_bitset<Block> a(4, 4ul), b(3, 4ul);
    assert(a < b);
  }
  {
    boost_kahypar::dynamic_bitset<Block> a(3, 4ul), b(4, 4ul);
    assert(!(a < b));
  }
  {
    boost_kahypar::dynamic_bitset<Block> a(4, 5ul), b(3, 4ul);
    assert(a < b);
  }
  {
    boost_kahypar::dynamic_bitset<Block> a(3, 5ul), b(4, 4ul);
    assert(!(a < b));
  }
  //=====================================================================
  // Test operator<=
  ...
  { // case pos == 0
    std::size_t pos = 0;
    boost_kahypar::dynamic_bitset<Block> b(std::string("1010"));
  ...
  // Test a & b
  {
    boost_kahypar::dynamic_bitset<Block> lhs, rhs;
    Tests::operator_and(lhs, rhs);
  }
  {
    boost_kahypar::dynamic_bitset<Block> lhs(std::string("1")), rhs(std::string("0"));
    Tests::operator_and(lhs, rhs);
  }
  {
    boost_kahypar::dynamic_bitset<Block> lhs(long_string.size(), 0), rhs(long_string);
    Tests::operator_and(lhs, rhs);
  }
  {
    boost_kahypar::dynamic_bitset<Block> lhs(long_string.size(), 1), rhs(long_string);
    Tests::operator_and(lhs, rhs);
  }
  //=====================================================================
  // Test a | b
...
# ifdef BOOST_HAS_LONG_LONG
  run_test_cases< ::boost_kahypar::ulong_long_type>();
# endif
