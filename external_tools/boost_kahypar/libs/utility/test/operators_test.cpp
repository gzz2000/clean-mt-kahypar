...
#include <boost_kahypar/config.hpp>                      // for BOOST_MSVC
#include <boost_kahypar/operators.hpp>                   // for the tested items
#include <boost_kahypar/utility/detail/minstd_rand.hpp>  // for boost_kahypar::detail::minstd_rand
...
namespace
{
    ...
    template <class T>
    class Wrapped1
        : boost_kahypar::operators<Wrapped1<T> >
        , boost_kahypar::shiftable<Wrapped1<T> >
    {
    public:
    ...
    class Wrapped2
        : boost_kahypar::operators<Wrapped2<T, U> >
        , boost_kahypar::operators2<Wrapped2<T, U>, U>
        , boost_kahypar::shiftable1<Wrapped2<T, U>
        , boost_kahypar::shiftable2<Wrapped2<T, U>, U > >
    {
    public:
    ...
    template <class T>
    class Wrapped3
        : boost_kahypar::equivalent<Wrapped3<T> >
        , boost_kahypar::partially_ordered<Wrapped3<T> >
        , boost_kahypar::equality_comparable<Wrapped3<T> >
    {
    public:
    ...
    template <class T, class U>
    class Wrapped4
        : boost_kahypar::equality_comparable1<Wrapped4<T, U>
        , boost_kahypar::equivalent1<Wrapped4<T, U>
        , boost_kahypar::partially_ordered1<Wrapped4<T, U> > > >
        , boost_kahypar::partially_ordered2<Wrapped4<T, U>, U
        , boost_kahypar::equivalent2<Wrapped4<T, U>, U
        , boost_kahypar::equality_comparable2<Wrapped4<T, U>, U> > >
    {
    public:
    ...
    template <class T, class U>
    class Wrapped5
        : boost_kahypar::ordered_field_operators2<Wrapped5<T, U>, U>
        , boost_kahypar::ordered_field_operators1<Wrapped5<T, U> >
    {
    public:
    ...
    template <class T, class U>
    class Wrapped6
        : boost_kahypar::ordered_euclidean_ring_operators2<Wrapped6<T, U>, U>
        , boost_kahypar::ordered_euclidean_ring_operators1<Wrapped6<T, U> >
    {
    public:
...
#define TEST_OP_L(op) test_value_equality(y1 op x1, y2 op x2)
    ...
    struct tester
    {
        void operator()(boost_kahypar::detail::minstd_rand& randomizer) const
        {
    ...
    struct Point
        : boost_kahypar::addable<Point
        , boost_kahypar::subtractable<Point> >
    {
...
main()
{
    ...
    {
        boost_kahypar::detail::minstd_rand r;
        tester<long, int>()(r);
