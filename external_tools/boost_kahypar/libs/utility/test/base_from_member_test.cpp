...
#include <boost_kahypar/config.hpp>       // for BOOST_NO_MEMBER_TEMPLATES
#include <boost_kahypar/noncopyable.hpp>  // for boost_kahypar::noncopyable

#include <boost_kahypar/utility/base_from_member.hpp>  // for boost_kahypar::base_from_member
...
class good_class_1
    : private boost_kahypar::base_from_member<base_or_member>
    , public base_class
{
    typedef boost_kahypar::base_from_member<base_or_member>  pbase_type;
...
// of the "same" type.
class good_class_2
    : private boost_kahypar::base_from_member<base_or_member, 0>
    , private boost_kahypar::base_from_member<base_or_member, 1>
    , private boost_kahypar::base_from_member<base_or_member, 2>
    , public base_class
{
    typedef boost_kahypar::base_from_member<base_or_member, 0>  pbase_type0;
    typedef boost_kahypar::base_from_member<base_or_member, 1>  pbase_type1;
    typedef boost_kahypar::base_from_member<base_or_member, 2>  pbase_type2;
    typedef base_class                                   base_type;
