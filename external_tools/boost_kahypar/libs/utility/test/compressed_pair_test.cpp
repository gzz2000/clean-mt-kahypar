...
// standalone test program for <boost_kahypar/compressed_pair.hpp>
// Revised 03 Oct 2000: 
...
#endif
   // default construct:
   boost_kahypar::compressed_pair<T1,T2> cp1;
   // first param construct:
   boost_kahypar::compressed_pair<T1,T2> cp2(p1);
   cp2.second() = p2;
   BOOST_TEST(cp2.first() == p1);
   BOOST_TEST(cp2.second() == p2);
   // second param construct:
   boost_kahypar::compressed_pair<T1,T2> cp3(p2);
   cp3.first() = p1;
   BOOST_TEST(cp3.second() == p2);
   BOOST_TEST(cp3.first() == p1);
   // both param construct:
   boost_kahypar::compressed_pair<T1,T2> cp4(p1, p2);
   BOOST_TEST(cp4.first() == p1);
   BOOST_TEST(cp4.second() == p2);
   boost_kahypar::compressed_pair<T1,T2> cp5(p3, p4);
   BOOST_TEST(cp5.first() == p3);
   BOOST_TEST(cp5.second() == p4);
   // check const members:
   const boost_kahypar::compressed_pair<T1,T2>& cpr1 = cp4;
   BOOST_TEST(cpr1.first() == p1);
   BOOST_TEST(cpr1.second() == p2);

   // copy construct:
   boost_kahypar::compressed_pair<T1,T2> cp6(cp4);
...
void compressed_pair_array1_tester<T1, T2>::test(first_param_type p1, second_param_type p2, first_param_type, second_param_type)
{
  // default construct:
   ...
   // check const members:
   const boost_kahypar::compressed_pair<T1,T2>& cpr1 = cp3;
...
void compressed_pair_array2_tester<T1, T2>::test(first_param_type p1, second_param_type p2, first_param_type, second_param_type)
{
   ...
   // check const members:
   const boost_kahypar::compressed_pair<T1,T2>& cpr1 = cp2;
   BOOST_TEST(cpr1.first() == p1);
...
void compressed_pair_array_tester<T1, T2>::test(first_param_type p1, second_param_type p2, first_param_type, second_param_type)
{
   ...
   // check const members:
   const boost_kahypar::compressed_pair<T1,T2>& cpr1 = cp1;
   BOOST_TEST(cpr1.first()[0] == p1[0]);
   BOOST_TEST(cpr1.second()[0] == p2[0]);
