...
//
// Test program for boost_kahypar::initialized<T>.
//
...
namespace
{
  // Typical use case for boost_kahypar::initialized<T>: A generic class that 
  ...
  {
    std::string m_key;
    boost_kahypar::initialized<T> m_value;
  public:
...
// Tests boost_kahypar::initialize for a fundamental type, a type with a
