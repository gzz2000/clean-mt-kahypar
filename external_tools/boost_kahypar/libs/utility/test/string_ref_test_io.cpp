...
#include <boost_kahypar/utility/string_ref.hpp>
...
struct context
{
    ...
    context()
    {
        boost_kahypar::string_ref str = test_strings[0];
...
void test_string_ref_output()
{
    typedef CharT char_type;
    typedef std::basic_ostringstream< char_type > ostream_type;
    typedef boost_kahypar::basic_string_ref< char_type > string_ref_type;
