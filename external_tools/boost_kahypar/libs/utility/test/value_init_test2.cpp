...
//
// Test program for the boost_kahypar::value_initialized<T> workaround.
//
...
namespace
{
  ...
  template <typename T>
  bool is_value_initialized(const boost_kahypar::value_initialized<T>& arg)
  {
...
int main()
{
  ...
  BOOST_TEST( is_value_initialized( boost_kahypar::value_initialized<derived_struct>() ) );
  BOOST_TEST( is_value_initialized( boost_kahypar::value_initialized<virtual_destructor_holder[2]>() ) );
  BOOST_TEST( is_value_initialized( boost_kahypar::value_initialized<private_int_array_pair>() ) );
  ...
  BOOST_TEST( is_value_initialized( boost_kahypar::value_initialized<ptr_to_member_struct>() ) );
