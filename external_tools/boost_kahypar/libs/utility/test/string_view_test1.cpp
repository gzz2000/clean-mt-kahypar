...
typedef boost_kahypar::string_view string_view;
...
void test_hash(const std::string& str) {
    string_view ref = str;
    BOOST_TEST(boost_kahypar::hash_value(ref) == boost_kahypar::hash_value(str));
    boost_kahypar::hash<std::string> hstr;
    boost_kahypar::hash<string_view> hsv;
