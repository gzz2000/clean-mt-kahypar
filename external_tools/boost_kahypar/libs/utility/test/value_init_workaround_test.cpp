...
int main()
{
  ...
  const unsigned num_failures =
    FAILED_TO_VALUE_INITIALIZE(boost_kahypar::value_initialized<derived_struct>()) +
    FAILED_TO_VALUE_INITIALIZE(boost_kahypar::value_initialized<virtual_destructor_holder[2]>()) +
    FAILED_TO_VALUE_INITIALIZE(boost_kahypar::value_initialized<private_int_array_pair>()) +
    FAILED_TO_VALUE_INITIALIZE(boost_kahypar::value_initialized<ptr_to_member_struct>());
