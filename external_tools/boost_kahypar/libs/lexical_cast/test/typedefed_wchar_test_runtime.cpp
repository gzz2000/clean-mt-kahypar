...
{
    BOOST_TEST(boost_kahypar::lexical_cast<int>(L'A') == 65);
    BOOST_TEST(boost_kahypar::lexical_cast<int>(L'B') == 66);

    BOOST_TEST(boost_kahypar::lexical_cast<wchar_t>(L"65") == 65);
    BOOST_TEST(boost_kahypar::lexical_cast<wchar_t>(L"66") == 66);
}
