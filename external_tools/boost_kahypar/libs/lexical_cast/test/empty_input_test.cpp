...
void do_test_on_empty_input(T& v)
{
    ...
    BOOST_TEST_THROWS(lexical_cast<boost_kahypar::ulong_long_type>(v), bad_lexical_cast);
    BOOST_TEST_THROWS(lexical_cast<boost_kahypar::long_long_type>(v), bad_lexical_cast);
...
void test_empty_iterator_range()
{
    ...
    boost_kahypar::iterator_range<char*> v;
    ...
    boost_kahypar::iterator_range<const char*> cv;
    ...
    const boost_kahypar::iterator_range<const char*> ccv;
...
{
    my_string st;
    BOOST_TEST_EQ(boost_kahypar::lexical_cast<std::string>(st), std::string());;
}
