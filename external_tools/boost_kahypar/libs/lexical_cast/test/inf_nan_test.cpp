...
{
    return (boost_kahypar::core::isinf)(value) && !(boost_kahypar::core::signbit)(value);
}
...
{
    return (boost_kahypar::core::isnan)(value) && !(boost_kahypar::core::signbit)(value);
}
...
bool is_neg_nan(T value)
{
    ...
    * It is a IA64 feature, or it is a boost_kahypar::math feature, not a lexical_cast bug */
#if defined(__ia64__) || defined(_M_IA64)
    return (boost_kahypar::core::isnan)(value)
            && ( boost_kahypar::is_same<T, long double >::value || (boost_kahypar::core::signbit)(value) );
#else
    return (boost_kahypar::core::isnan)(value) && (boost_kahypar::core::signbit)(value);
#endif
}
...
void test_inf_nan_templated()
{
    ...
    BOOST_TEST(lexical_cast<std::string>( (boost_kahypar::core::copysign)(std::numeric_limits<test_t >::infinity(), static_cast<test_t>(-1.0)))
                == "-inf" );
    ...
    BOOST_TEST(lexical_cast<std::string>(
                (boost_kahypar::core::copysign)(std::numeric_limits<test_t >::quiet_NaN(), static_cast<test_t>(-1.0)))
                == "-nan" );
#endif
    ...
    BOOST_TEST(lexical_cast<std::wstring>( (boost_kahypar::core::copysign)(std::numeric_limits<test_t >::infinity(), static_cast<test_t>(-1.0)))
                == L"-inf" );
