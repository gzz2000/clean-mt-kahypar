//  Testing boost_kahypar::lexical_cast with boost_kahypar::container::string.
//
...
static void testing_template_array_output_on_spec_value(T val)
{
...

    {
        ...
        BOOST_TEST_THROWS(lexical_cast<short_arr_type>(val), boost_kahypar::bad_lexical_cast);
    }

    {
        ...
        BOOST_TEST_THROWS(lexical_cast<ushort_arr_type>(val), boost_kahypar::bad_lexical_cast);
    }

    {
        ...
        BOOST_TEST_EQ(reinterpret_cast<const char*>(&res2[0]), ethalon);
        BOOST_TEST_THROWS(lexical_cast<sshort_arr_type>(val), boost_kahypar::bad_lexical_cast);
    }
    ...
    BOOST_TEST_THROWS(lexical_cast<wshort_arr_type>(val), boost_kahypar::bad_lexical_cast);
    ...
    BOOST_TEST_THROWS(lexical_cast<u16short_arr_type>(val), boost_kahypar::bad_lexical_cast);
#endif
    ...
    BOOST_TEST_THROWS(lexical_cast<u32short_arr_type>(val), boost_kahypar::bad_lexical_cast);
#endif
}
...
{
    testing_template_array_output_on_char_value<boost_kahypar::array>();
    testing_template_array_output_on_spec_value<boost_kahypar::array>(100);
    testing_template_array_output_on_spec_value<boost_kahypar::array>(static_cast<short>(100));
    testing_template_array_output_on_spec_value<boost_kahypar::array>(static_cast<unsigned short>(100));
    testing_template_array_output_on_spec_value<boost_kahypar::array>(static_cast<unsigned int>(100));
}
...
{
    testing_generic_array_input_conversion<boost_kahypar::array>();
}
