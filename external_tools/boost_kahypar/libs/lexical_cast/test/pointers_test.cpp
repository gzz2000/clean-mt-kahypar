...
void test_void_pointers_conversions()
{
    ...
    ss << p_to_null;
    BOOST_TEST_EQ(boost_kahypar::lexical_cast<std::string>(p_to_null), ss.str());
    ss.str(std::string());

    ss << cp_to_data;
    BOOST_TEST_EQ(boost_kahypar::lexical_cast<std::string>(cp_to_data), ss.str());
    ss.str(std::string());

    ss << p_to_data;
    BOOST_TEST_EQ(boost_kahypar::lexical_cast<std::string>(p_to_data), ss.str());
    ss.str(std::string());
}
...
void test_inomplete_type_with_overloaded_ostream_op() {
    ...
    ss_t ss;
    ss << heh;
    BOOST_TEST_EQ(boost_kahypar::lexical_cast<std::string>(heh), ss.str());
}
