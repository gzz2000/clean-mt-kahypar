...
typename boost_kahypar::enable_if<boost_kahypar::is_same<CharT, char>, std::basic_ostream<CharT>&>::type
operator << (std::basic_ostream<CharT>& ostr, const streamable_medium&) {
    return ostr << streamable_medium::value;
}
template <class CharT>
typename boost_kahypar::enable_if<boost_kahypar::is_same<CharT, char>, std::basic_istream<CharT>&>::type
...
typename boost_kahypar::enable_if<boost_kahypar::is_same<CharT, char>, std::basic_ostream<CharT, TraitsT>&>::type
operator << (std::basic_ostream<CharT, TraitsT>& ostr, const streamable_hard&) {
    return ostr << streamable_hard::value;
}
template <class CharT, class TraitsT>
typename boost_kahypar::enable_if<boost_kahypar::is_same<CharT, char>, std::basic_istream<CharT, TraitsT>&>::type
...
template <class CharT>
typename boost_kahypar::enable_if<boost_kahypar::is_same<CharT, wchar_t>, std::basic_ostream<CharT>& >::type
operator << (std::basic_ostream<CharT>& ostr, const wstreamable_medium&) {
    return ostr << wstreamable_medium::value;
}
template <class CharT>
typename boost_kahypar::enable_if<boost_kahypar::is_same<CharT, wchar_t>, std::basic_istream<CharT>& >::type
...
template <class CharT, class TraitsT>
typename boost_kahypar::enable_if<boost_kahypar::is_same<CharT, wchar_t>, std::basic_ostream<CharT, TraitsT>&>::type
operator << (std::basic_ostream<CharT, TraitsT>& ostr, const wstreamable_hard&) {
    return ostr << wstreamable_hard::value;
}
template <class CharT, class TraitsT>
typename boost_kahypar::enable_if<boost_kahypar::is_same<CharT, wchar_t>, std::basic_istream<CharT, TraitsT>&>::type
...
static void test_ostr_impl() {
    T streamable;
    BOOST_TEST_EQ(T::value,  boost_kahypar::lexical_cast<int>(streamable));
    BOOST_TEST_EQ(boost_kahypar::lexical_cast<std::string>(T::value),  boost_kahypar::lexical_cast<std::string>(streamable));
}
...
static void test_wostr_impl() {
    T streamable;
    BOOST_TEST_EQ(T::value,  boost_kahypar::lexical_cast<int>(streamable));
    // BOOST_TEST_EQ(boost_kahypar::lexical_cast<std::string>(T::value), boost_kahypar::lexical_cast<std::string>(streamable)); // Shall not compile???
    BOOST_TEST(boost_kahypar::lexical_cast<std::wstring>(T::value) == boost_kahypar::lexical_cast<std::wstring>(streamable));
}
...
static void test_bistr_impl() {
    ...
    BOOST_TEST(boost_kahypar::lexical_cast<std::wstring>(T::value + 100) == boost_kahypar::lexical_cast<std::wstring>(streamable));
}
...
static void test_istr_impl() {
    boost_kahypar::lexical_cast<T>(T::value);
    boost_kahypar::lexical_cast<T>(boost_kahypar::lexical_cast<std::string>(T::value));
}

template <class T>
static void test_wistr_impl() {
    boost_kahypar::lexical_cast<T>(T::value);
    //boost_kahypar::lexical_cast<T>(boost_kahypar::lexical_cast<std::string>(T::value)); // Shall not compile???
    boost_kahypar::lexical_cast<T>(boost_kahypar::lexical_cast<std::wstring>(T::value));
}
...
static void test_bistr_instr_impl() {
    boost_kahypar::lexical_cast<T>(T::value);
    boost_kahypar::lexical_cast<T>(boost_kahypar::lexical_cast<std::string>(T::value));
    boost_kahypar::lexical_cast<T>(boost_kahypar::lexical_cast<std::wstring>(T::value + 100));
}
...
void test_mixed_stream_character_detection() {
    //boost_kahypar::lexical_cast<std::wstring>(std::string("qwe")); // TODO: ALLOW IT AS EXTENSION!

    BOOST_TEST_EQ(boost_kahypar::lexical_cast<int>(wistreamble_ostreamable::value), wistreamble_ostreamable::value);
    boost_kahypar::lexical_cast<wistreamble_ostreamable>(wistreamble_ostreamable::value);
    BOOST_TEST_EQ(boost_kahypar::lexical_cast<int>(wistreamble_ostreamable()), wistreamble_ostreamable::value);

    boost_kahypar::lexical_cast<istreamble_wostreamable>(istreamble_wostreamable::value);
    BOOST_TEST_EQ(boost_kahypar::lexical_cast<int>(istreamble_wostreamable()), istreamble_wostreamable::value);
}
