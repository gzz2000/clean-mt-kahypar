...
int main()
{
    test_too_long_number<boost_kahypar::intmax_t>('0');
    test_too_long_number<boost_kahypar::uintmax_t>('0');
#if !defined(BOOST_LCAST_NO_WCHAR_T)
    test_too_long_number<boost_kahypar::intmax_t>(L'0');
    test_too_long_number<boost_kahypar::uintmax_t>(L'0');
#endif
