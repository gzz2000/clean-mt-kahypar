...
void test_conversion_with_nonconst_char()
{
    ...
    buffer.push_back('1');
    buffer.push_back('\0');
    BOOST_TEST_EQ(boost_kahypar::lexical_cast<int>(&buffer[0]), 1);

    std::vector<unsigned char> buffer2;
    buffer2.push_back('1');
    buffer2.push_back('\0');
    BOOST_TEST_EQ(boost_kahypar::lexical_cast<int>(&buffer2[0]), 1);

    std::vector<unsigned char> buffer3;
    buffer3.push_back('1');
    buffer3.push_back('\0');
    BOOST_TEST_EQ(boost_kahypar::lexical_cast<int>(&buffer3[0]), 1);

#ifndef BOOST_LCAST_NO_WCHAR_T
    std::vector<wchar_t> buffer4;
    buffer4.push_back(L'1');
    buffer4.push_back(L'\0');
    BOOST_TEST_EQ(boost_kahypar::lexical_cast<int>(&buffer4[0]), 1);
#endif
}
...
void test_traits()
{
    ...
    my_string const s("s");
    BOOST_TEST(boost_kahypar::lexical_cast<char>(s) == s[0]);
    BOOST_TEST(boost_kahypar::lexical_cast<my_string>(s) == s);
    BOOST_TEST(boost_kahypar::lexical_cast<my_string>(-1) == "-1");
    BOOST_TEST(boost_kahypar::lexical_cast<int>(my_string("42")) == 42);
    BOOST_TEST(boost_kahypar::lexical_cast<double>(my_string("1.0")) == 1.0);
}
...
void test_wtraits()
{
    ...
    BOOST_TEST(boost_kahypar::lexical_cast<wchar_t>(s) == s[0]);
    BOOST_TEST(boost_kahypar::lexical_cast<my_string>(s) == s);
    BOOST_TEST(boost_kahypar::lexical_cast<my_string>(-1) == L"-1");
    BOOST_TEST(boost_kahypar::lexical_cast<int>(my_string(L"42")) == 42);
    BOOST_TEST(boost_kahypar::lexical_cast<double>(my_string(L"1.0")) == 1.0);
}
...
// MSVC developer is notified about this issue
    ...
    my_string s("s");
    BOOST_TEST(boost_kahypar::lexical_cast<char>(s) == s[0]);
    BOOST_TEST(boost_kahypar::lexical_cast<std::string>(s) == "s");
    BOOST_TEST(boost_kahypar::lexical_cast<my_string>(s) == s);
    BOOST_TEST(boost_kahypar::lexical_cast<my_string>(1) == "1");
    BOOST_TEST(boost_kahypar::lexical_cast<my_string>("s") == s);
    BOOST_TEST(boost_kahypar::lexical_cast<my_string>(std::string("s")) == s);
#endif
}
...
// MSVC developer is notified about this issue
    ...
    my_string s(L"s");
    BOOST_TEST(boost_kahypar::lexical_cast<wchar_t>(s) == s[0]);
    BOOST_TEST(boost_kahypar::lexical_cast<std::wstring>(s) == L"s");
    BOOST_TEST(boost_kahypar::lexical_cast<my_string>(s) == s);
    BOOST_TEST(boost_kahypar::lexical_cast<my_string>(1) == L"1");
    BOOST_TEST(boost_kahypar::lexical_cast<my_string>(L"s") == s);
    BOOST_TEST(boost_kahypar::lexical_cast<my_string>(std::wstring(L"s")) == s);
#endif
}
...
void test_char_types_conversions()
{
    ...
    BOOST_TEST(boost_kahypar::lexical_cast<std::string>(c_arr) == std::string(c_arr));
    BOOST_TEST(boost_kahypar::lexical_cast<std::string>(uc_arr) == std::string(c_arr));
    BOOST_TEST(boost_kahypar::lexical_cast<std::string>(sc_arr) == std::string(c_arr));

    BOOST_TEST(boost_kahypar::lexical_cast<char>(c_arr[0]) == c_arr[0]);
    BOOST_TEST(boost_kahypar::lexical_cast<char>(uc_arr[0]) == c_arr[0]);
    BOOST_TEST(boost_kahypar::lexical_cast<char>(sc_arr[0]) == c_arr[0]);

    BOOST_TEST(boost_kahypar::lexical_cast<unsigned char>(c_arr[0]) == uc_arr[0]);
    BOOST_TEST(boost_kahypar::lexical_cast<unsigned char>(uc_arr[0]) == uc_arr[0]);
    BOOST_TEST(boost_kahypar::lexical_cast<unsigned char>(sc_arr[0]) == uc_arr[0]);

    BOOST_TEST(boost_kahypar::lexical_cast<signed char>(c_arr[0]) == sc_arr[0]);
    BOOST_TEST(boost_kahypar::lexical_cast<signed char>(uc_arr[0]) == sc_arr[0]);
    BOOST_TEST(boost_kahypar::lexical_cast<signed char>(sc_arr[0]) == sc_arr[0]);

#ifndef BOOST_LCAST_NO_WCHAR_T
    const wchar_t wc_arr[]=L"Test array of chars";

    BOOST_TEST(boost_kahypar::lexical_cast<std::wstring>(wc_arr) == std::wstring(wc_arr));
    BOOST_TEST(boost_kahypar::lexical_cast<wchar_t>(wc_arr[0]) == wc_arr[0]);
...
void operators_overload_test()
{
    ...
    BOOST_TEST_EQ(boost_kahypar::lexical_cast<std::string>(foo), "2");
    BOOST_TEST_EQ((boost_kahypar::lexical_cast<foo_operators_test>("2")).f, 2);

    // Must compile
    (void)boost_kahypar::lexical_cast<foo_operators_test>(foo);
}
...
void test_getting_pointer_to_function()
{
    ...
    f1 p1 = &boost_kahypar::lexical_cast<int, char_arr>;
    BOOST_TEST(p1);

    typedef int(*f2)(const std::string&);
    f2 p2 = &boost_kahypar::lexical_cast<int, std::string>;
    BOOST_TEST(p2);

    typedef std::string(*f3)(const int&);
    f3 p3 = &boost_kahypar::lexical_cast<std::string, int>;
    BOOST_TEST(p3);

    std::vector<int> values;
    std::vector<std::string> ret;
    std::transform(values.begin(), values.end(), ret.begin(), boost_kahypar::lexical_cast<std::string, int>);
}
