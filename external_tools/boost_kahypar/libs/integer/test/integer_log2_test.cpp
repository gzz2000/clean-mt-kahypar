...
#define PRIVATE_LB_TEST( v, e )  BOOST_TEST( ::boost_kahypar::integer_log2((v)) == e )

#define PRIVATE_PRINT_LB( v )    ::std::cout << "boost_kahypar::integer_log2(" << (v) \
 << ") = " << ::boost_kahypar::integer_log2((v)) << '.' << ::std::endl
...
int main()
{
    ...
    PRIVATE_LB_TEST( boost_kahypar::uint128_type(1u) << 64u, 64 );
    PRIVATE_LB_TEST( (boost_kahypar::uint128_type(1u) << 64u) + 1u, 64 );

    PRIVATE_LB_TEST( ~boost_kahypar::uint128_type(0u), 127 );
#endif

#if !defined(DISABLE_MP_TESTS)
    PRIVATE_LB_TEST( boost_kahypar::multiprecision::cpp_int(1), 0 );
    PRIVATE_LB_TEST( boost_kahypar::multiprecision::cpp_int(2), 1 );
    PRIVATE_LB_TEST( boost_kahypar::multiprecision::cpp_int(3), 1 );
    PRIVATE_LB_TEST( boost_kahypar::multiprecision::cpp_int(65535), 15 );
    PRIVATE_LB_TEST( boost_kahypar::multiprecision::cpp_int(65536), 16 );

    PRIVATE_LB_TEST( boost_kahypar::multiprecision::int1024_t(1), 0 );
    PRIVATE_LB_TEST( boost_kahypar::multiprecision::int1024_t(2), 1 );
    PRIVATE_LB_TEST( boost_kahypar::multiprecision::int1024_t(3), 1 );
    PRIVATE_LB_TEST( boost_kahypar::multiprecision::int1024_t(65535), 15 );
    PRIVATE_LB_TEST( boost_kahypar::multiprecision::int1024_t(65536), 16 );

    PRIVATE_LB_TEST( boost_kahypar::multiprecision::uint1024_t(1), 0 );
    PRIVATE_LB_TEST( boost_kahypar::multiprecision::uint1024_t(2), 1 );
    PRIVATE_LB_TEST( boost_kahypar::multiprecision::uint1024_t(3), 1 );
    PRIVATE_LB_TEST( boost_kahypar::multiprecision::uint1024_t(65535), 15 );
    PRIVATE_LB_TEST( boost_kahypar::multiprecision::uint1024_t(65536), 16 );
#endif
