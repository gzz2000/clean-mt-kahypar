...
#include <boost_kahypar/core/lightweight_test.hpp>  // for main

#include <boost_kahypar/cstdlib.hpp>              // for boost_kahypar::exit_success
#include <boost_kahypar/integer/static_log2.hpp>  // for boost_kahypar::static_log2

#include <iostream>  // for std::cout (std::endl indirectly)


// Macros to compact code
#define PRIVATE_LB_TEST( v, e )  BOOST_TEST( ::boost_kahypar::static_log2<v>::value == e )

#define PRIVATE_PRINT_LB( v )    ::std::cout << "boost_kahypar::static_log2<" << (v) \
 << "> = " << ::boost_kahypar::static_log2< (v) >::value << '.' << ::std::endl
