...
#include <boost_kahypar/integer/static_min_max.hpp>  // for boost_kahypar::static_signed_min, etc.
...
{    
    using std::cout;
    using std::endl;
    using boost_kahypar::static_signed_min;
    using boost_kahypar::static_signed_max;
    using boost_kahypar::static_unsigned_min;
    using boost_kahypar::static_unsigned_max;
