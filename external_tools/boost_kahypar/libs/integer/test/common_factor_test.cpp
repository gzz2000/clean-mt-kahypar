...
#include <boost_kahypar/config.hpp>              // for BOOST_MSVC, etc.
#include <boost_kahypar/detail/workaround.hpp>
#include <boost_kahypar/integer/common_factor.hpp>  // for boost_kahypar::integer::gcd, etc.
#include <boost_kahypar/mpl/list.hpp>            // for boost_kahypar::mpl::list
...
#include <boost_kahypar/rational.hpp>
...
class my_wrapped_integer
    : private ::boost_kahypar::shiftable1<my_wrapped_integer<IntType, ID>,
        ::boost_kahypar::operators<my_wrapped_integer<IntType, ID> > >
{
    // Helper type-aliases
...
typedef ::boost_kahypar::mpl::list<signed char, short, int, long,
 ...
 MyInt1
#ifndef DISABLE_MP_TESTS
   , boost_kahypar::multiprecision::cpp_int
#endif
>  signed_test_types;
typedef ::boost_kahypar::mpl::list<unsigned char, unsigned short, unsigned,
 unsigned long,
#if BOOST_WORKAROUND(BOOST_MSVC, <= 1500)
#elif defined(BOOST_HAS_LONG_LONG)
 boost_kahypar::ulong_long_type,
#elif defined(BOOST_HAS_MS_INT64)
 unsigned __int64,
#endif
 MyUnsigned1, MyUnsigned2 /*, boost_kahypar::multiprecision::uint256_t*/>  unsigned_test_types;
...
template< class T > void gcd_int_test() // signed_test_types
{
    ...
    using boost_kahypar::integer::gcd_evaluator;
#else
    using namespace boost_kahypar::integer;
#endif

    // Originally from Boost.Rational tests
    BOOST_TEST_EQ( boost_kahypar::integer::gcd(static_cast<T>(1), static_cast<T>(-1)), static_cast<T>( 1) );
    BOOST_TEST_EQ( boost_kahypar::integer::gcd(static_cast<T>(-1), static_cast<T>(1)), static_cast<T>( 1) );
    BOOST_TEST_EQ( boost_kahypar::integer::gcd(static_cast<T>(1), static_cast<T>(1)), static_cast<T>( 1) );
    BOOST_TEST_EQ( boost_kahypar::integer::gcd(static_cast<T>(-1), static_cast<T>(-1)), static_cast<T>( 1) );
    BOOST_TEST_EQ( boost_kahypar::integer::gcd(static_cast<T>(0), static_cast<T>(0)), static_cast<T>( 0) );
    BOOST_TEST_EQ( boost_kahypar::integer::gcd(static_cast<T>(7), static_cast<T>(0)), static_cast<T>( 7) );
    BOOST_TEST_EQ( boost_kahypar::integer::gcd(static_cast<T>(0), static_cast<T>(9)), static_cast<T>( 9) );
    BOOST_TEST_EQ( boost_kahypar::integer::gcd(static_cast<T>(-7), static_cast<T>(0)), static_cast<T>( 7) );
    BOOST_TEST_EQ( boost_kahypar::integer::gcd(static_cast<T>(0), static_cast<T>(-9)), static_cast<T>( 9) );
    BOOST_TEST_EQ( boost_kahypar::integer::gcd(static_cast<T>(42), static_cast<T>(30)), static_cast<T>( 6) );
    BOOST_TEST_EQ( boost_kahypar::integer::gcd(static_cast<T>(6), static_cast<T>(-9)), static_cast<T>( 3) );
    BOOST_TEST_EQ( boost_kahypar::integer::gcd(static_cast<T>(-10), static_cast<T>(-10)), static_cast<T>(10) );
    BOOST_TEST_EQ( boost_kahypar::integer::gcd(static_cast<T>(-25), static_cast<T>(-10)), static_cast<T>( 5) );
    BOOST_TEST_EQ( boost_kahypar::integer::gcd(static_cast<T>(3), static_cast<T>(7)), static_cast<T>( 1) );
    BOOST_TEST_EQ( boost_kahypar::integer::gcd(static_cast<T>(8), static_cast<T>(9)), static_cast<T>( 1) );
    BOOST_TEST_EQ( boost_kahypar::integer::gcd(static_cast<T>(7), static_cast<T>(49)), static_cast<T>( 7) );
...
void gcd_unmarked_int_test()
{
    ...
    // by a sign.
    BOOST_TEST_EQ( abs(boost_kahypar::integer::gcd(static_cast<MyInt2>(1), static_cast<MyInt2>(-1) )), MyInt2( 1) );
    BOOST_TEST_EQ( abs(boost_kahypar::integer::gcd(static_cast<MyInt2>(-1), static_cast<MyInt2>(1) )), MyInt2( 1) );
    BOOST_TEST_EQ( abs(boost_kahypar::integer::gcd(static_cast<MyInt2>(1), static_cast<MyInt2>(1) )), MyInt2( 1) );
    BOOST_TEST_EQ( abs(boost_kahypar::integer::gcd(static_cast<MyInt2>(-1), static_cast<MyInt2>(-1) )), MyInt2( 1) );
    BOOST_TEST_EQ( abs(boost_kahypar::integer::gcd(static_cast<MyInt2>(0), static_cast<MyInt2>(0) )), MyInt2( 0) );
    BOOST_TEST_EQ( abs(boost_kahypar::integer::gcd(static_cast<MyInt2>(7), static_cast<MyInt2>(0) )), MyInt2( 7) );
    BOOST_TEST_EQ( abs(boost_kahypar::integer::gcd(static_cast<MyInt2>(0), static_cast<MyInt2>(9) )), MyInt2( 9) );
    BOOST_TEST_EQ( abs(boost_kahypar::integer::gcd(static_cast<MyInt2>(-7), static_cast<MyInt2>(0) )), MyInt2( 7) );
    BOOST_TEST_EQ( abs(boost_kahypar::integer::gcd(static_cast<MyInt2>(0), static_cast<MyInt2>(-9) )), MyInt2( 9) );
    BOOST_TEST_EQ( abs(boost_kahypar::integer::gcd(static_cast<MyInt2>(42), static_cast<MyInt2>(30))), MyInt2( 6) );
    BOOST_TEST_EQ( abs(boost_kahypar::integer::gcd(static_cast<MyInt2>(6), static_cast<MyInt2>(-9) )), MyInt2( 3) );
    BOOST_TEST_EQ( abs(boost_kahypar::integer::gcd(static_cast<MyInt2>(-10), static_cast<MyInt2>(-10) )), MyInt2(10) );
    BOOST_TEST_EQ( abs(boost_kahypar::integer::gcd(static_cast<MyInt2>(-25), static_cast<MyInt2>(-10) )), MyInt2( 5) );
    BOOST_TEST_EQ( abs(boost_kahypar::integer::gcd(static_cast<MyInt2>(3), static_cast<MyInt2>(7) )), MyInt2( 1) );
    BOOST_TEST_EQ( abs(boost_kahypar::integer::gcd(static_cast<MyInt2>(8), static_cast<MyInt2>(9) )), MyInt2( 1) );
    BOOST_TEST_EQ( abs(boost_kahypar::integer::gcd(static_cast<MyInt2>(7), static_cast<MyInt2>(49) )), MyInt2( 7) );
}
...
template< class T > void gcd_unsigned_test() // unsigned_test_types
{
    ...
    BOOST_TEST_EQ( boost_kahypar::integer::gcd(static_cast<T>(1u), static_cast<T>(1u)), static_cast<T>( 1u) );
    BOOST_TEST_EQ( boost_kahypar::integer::gcd(static_cast<T>(0u), static_cast<T>(0u)), static_cast<T>( 0u) );
    BOOST_TEST_EQ( boost_kahypar::integer::gcd(static_cast<T>(7u), static_cast<T>(0u)), static_cast<T>( 7u) );
    BOOST_TEST_EQ( boost_kahypar::integer::gcd(static_cast<T>(0u), static_cast<T>(9u)), static_cast<T>( 9u) );
    BOOST_TEST_EQ( boost_kahypar::integer::gcd(static_cast<T>(42u), static_cast<T>(30u)), static_cast<T>( 6u) );
    BOOST_TEST_EQ( boost_kahypar::integer::gcd(static_cast<T>(3u), static_cast<T>(7u)), static_cast<T>( 1u) );
    BOOST_TEST_EQ( boost_kahypar::integer::gcd(static_cast<T>(8u), static_cast<T>(9u)), static_cast<T>( 1u) );
    BOOST_TEST_EQ( boost_kahypar::integer::gcd(static_cast<T>(7u), static_cast<T>(49u)), static_cast<T>( 7u) );
}
...
{
#ifndef BOOST_MSVC
    using boost_kahypar::integer::static_gcd;
#else
    using namespace boost_kahypar::integer;
#endif
...
void gcd_method_test()
{
   ...
   boost_kahypar::random::mt19937 gen;
   boost_kahypar::random::uniform_int_distribution<int> d(0, ((std::numeric_limits<int>::max)() / 2));

   for (unsigned int i = 0; i < 10000; ++i)
   {
      int v1 = d(gen);
      int v2 = d(gen);
      int g = boost_kahypar::integer::gcd_detail::Euclid_gcd(v1, v2);
      BOOST_TEST(v1 % g == 0);
      BOOST_TEST(v2 % g == 0);
      BOOST_TEST_EQ(g, boost_kahypar::integer::gcd_detail::mixed_binary_gcd(v1, v2));
      BOOST_TEST_EQ(g, boost_kahypar::integer::gcd_detail::Stein_gcd(v1, v2));
   }
}
...
{
#ifndef BOOST_MSVC
    using boost_kahypar::integer::lcm;
    using boost_kahypar::integer::lcm_evaluator;
#else
    using namespace boost_kahypar::integer;
#endif

    // Originally from Boost.Rational tests
    BOOST_TEST_EQ( boost_kahypar::integer::lcm(static_cast<T>(1), static_cast<T>(-1)), static_cast<T>( 1) );
    BOOST_TEST_EQ( boost_kahypar::integer::lcm(static_cast<T>(-1), static_cast<T>(1)), static_cast<T>( 1) );
    BOOST_TEST_EQ( boost_kahypar::integer::lcm(static_cast<T>(1), static_cast<T>(1)), static_cast<T>( 1) );
    BOOST_TEST_EQ( boost_kahypar::integer::lcm(static_cast<T>(-1), static_cast<T>(-1)), static_cast<T>( 1) );
    BOOST_TEST_EQ( boost_kahypar::integer::lcm(static_cast<T>(0), static_cast<T>(0)), static_cast<T>( 0) );
    BOOST_TEST_EQ( boost_kahypar::integer::lcm(static_cast<T>(6), static_cast<T>(0)), static_cast<T>( 0) );
    BOOST_TEST_EQ( boost_kahypar::integer::lcm(static_cast<T>(0), static_cast<T>(7)), static_cast<T>( 0) );
    BOOST_TEST_EQ( boost_kahypar::integer::lcm(static_cast<T>(-5), static_cast<T>(0)), static_cast<T>( 0) );
    BOOST_TEST_EQ( boost_kahypar::integer::lcm(static_cast<T>(0), static_cast<T>(-4)), static_cast<T>( 0) );
    BOOST_TEST_EQ( boost_kahypar::integer::lcm(static_cast<T>(18), static_cast<T>(30)), static_cast<T>(90) );
    BOOST_TEST_EQ( boost_kahypar::integer::lcm(static_cast<T>(-6), static_cast<T>(9)), static_cast<T>(18) );
    BOOST_TEST_EQ( boost_kahypar::integer::lcm(static_cast<T>(-10), static_cast<T>(-10)), static_cast<T>(10) );
    BOOST_TEST_EQ( boost_kahypar::integer::lcm(static_cast<T>(25), static_cast<T>(-10)), static_cast<T>(50) );
    BOOST_TEST_EQ( boost_kahypar::integer::lcm(static_cast<T>(3), static_cast<T>(7)), static_cast<T>(21) );
    BOOST_TEST_EQ( boost_kahypar::integer::lcm(static_cast<T>(8), static_cast<T>(9)), static_cast<T>(72) );
    BOOST_TEST_EQ( boost_kahypar::integer::lcm(static_cast<T>(7), static_cast<T>(49)), static_cast<T>(49) );
    // Again with function object:
...
void lcm_unmarked_int_test()
{
    ...
    // marked as such (due to no std::numeric_limits specialization) may be off
    // by a sign.
    BOOST_TEST_EQ( abs(boost_kahypar::integer::lcm(   static_cast<MyInt2>(1), static_cast<MyInt2>(-1) )), MyInt2( 1) );
    BOOST_TEST_EQ( abs(boost_kahypar::integer::lcm(static_cast<MyInt2>(-1), static_cast<MyInt2>(1) )), MyInt2( 1) );
    BOOST_TEST_EQ( abs(boost_kahypar::integer::lcm(static_cast<MyInt2>(1), static_cast<MyInt2>(1) )), MyInt2( 1) );
    BOOST_TEST_EQ( abs(boost_kahypar::integer::lcm(static_cast<MyInt2>(-1), static_cast<MyInt2>(-1) )), MyInt2( 1) );
    BOOST_TEST_EQ( abs(boost_kahypar::integer::lcm(static_cast<MyInt2>(0), static_cast<MyInt2>(0) )), MyInt2( 0) );
    BOOST_TEST_EQ( abs(boost_kahypar::integer::lcm(static_cast<MyInt2>(6), static_cast<MyInt2>(0) )), MyInt2( 0) );
    BOOST_TEST_EQ( abs(boost_kahypar::integer::lcm(static_cast<MyInt2>(0), static_cast<MyInt2>(7) )), MyInt2( 0) );
    BOOST_TEST_EQ( abs(boost_kahypar::integer::lcm(static_cast<MyInt2>(-5), static_cast<MyInt2>(0) )), MyInt2( 0) );
    BOOST_TEST_EQ( abs(boost_kahypar::integer::lcm(static_cast<MyInt2>(0), static_cast<MyInt2>(-4) )), MyInt2( 0) );
    BOOST_TEST_EQ( abs(boost_kahypar::integer::lcm(static_cast<MyInt2>(18), static_cast<MyInt2>(30) )), MyInt2(90) );
    BOOST_TEST_EQ( abs(boost_kahypar::integer::lcm(static_cast<MyInt2>(-6), static_cast<MyInt2>(9) )), MyInt2(18) );
    BOOST_TEST_EQ( abs(boost_kahypar::integer::lcm(static_cast<MyInt2>(-10), static_cast<MyInt2>(-10) )), MyInt2(10) );
    BOOST_TEST_EQ( abs(boost_kahypar::integer::lcm(static_cast<MyInt2>(25), static_cast<MyInt2>(-10) )), MyInt2(50) );
    BOOST_TEST_EQ( abs(boost_kahypar::integer::lcm(static_cast<MyInt2>(3), static_cast<MyInt2>(7) )), MyInt2(21) );
    BOOST_TEST_EQ( abs(boost_kahypar::integer::lcm(static_cast<MyInt2>(8), static_cast<MyInt2>(9) )), MyInt2(72) );
    BOOST_TEST_EQ( abs(boost_kahypar::integer::lcm(static_cast<MyInt2>(7), static_cast<MyInt2>(49) )), MyInt2(49) );
}
...
template< class T > void lcm_unsigned_test() // unsigned_test_types
{
    ...
    // Note that unmarked types (i.e. have no std::numeric_limits
    // specialization) are treated like non/unsigned types
    BOOST_TEST_EQ( boost_kahypar::integer::lcm(static_cast<T>(1u), static_cast<T>(1u)), static_cast<T>( 1u) );
    BOOST_TEST_EQ( boost_kahypar::integer::lcm(static_cast<T>(0u), static_cast<T>(0u)), static_cast<T>( 0u) );
    BOOST_TEST_EQ( boost_kahypar::integer::lcm(static_cast<T>(6u), static_cast<T>(0u)), static_cast<T>( 0u) );
    BOOST_TEST_EQ( boost_kahypar::integer::lcm(static_cast<T>(0u), static_cast<T>(7u)), static_cast<T>( 0u) );
    BOOST_TEST_EQ( boost_kahypar::integer::lcm(static_cast<T>(18u), static_cast<T>(30u)), static_cast<T>(90u) );
    BOOST_TEST_EQ( boost_kahypar::integer::lcm(static_cast<T>(3u), static_cast<T>(7u)), static_cast<T>(21u) );
    BOOST_TEST_EQ( boost_kahypar::integer::lcm(static_cast<T>(8u), static_cast<T>(9u)), static_cast<T>(72u) );
    BOOST_TEST_EQ( boost_kahypar::integer::lcm(static_cast<T>(7u), static_cast<T>(49u)), static_cast<T>(49u) );
}
...
{
#ifndef BOOST_MSVC
    using boost_kahypar::integer::static_lcm;
#else
    using namespace boost_kahypar::integer;
#endif
...
void variadics()
{
   ...
   BOOST_TEST_EQ(boost_kahypar::integer::gcd_range(i, i + 4).first, 4);
   BOOST_TEST_EQ(boost_kahypar::integer::gcd_range(i, i + 4).second, i + 4);
   BOOST_TEST_EQ(boost_kahypar::integer::lcm_range(i, i + 4).first, 11704);
   BOOST_TEST_EQ(boost_kahypar::integer::lcm_range(i, i + 4).second, i + 4);

   unsigned i_gcd_unity[] = { 44, 56, 1, 88 };
   BOOST_TEST_EQ(boost_kahypar::integer::gcd_range(i_gcd_unity, i_gcd_unity + 4).first, 1);
   BOOST_TEST_EQ(boost_kahypar::integer::gcd_range(i_gcd_unity, i_gcd_unity + 4).second, i_gcd_unity + 3);

   unsigned i_lcm_unity[] = { 44, 56, 0, 88 };
   BOOST_TEST_EQ(boost_kahypar::integer::lcm_range(i_lcm_unity, i_lcm_unity + 4).first, 0);
   BOOST_TEST_EQ(boost_kahypar::integer::lcm_range(i_lcm_unity, i_lcm_unity + 4).second, i_lcm_unity + 3);

#ifndef BOOST_NO_CXX11_VARIADIC_TEMPLATES
   BOOST_TEST_EQ(boost_kahypar::integer::gcd(i[0], i[1], i[2], i[3]), 4);
   BOOST_TEST_EQ(boost_kahypar::integer::lcm(i[0], i[1], i[2], i[3]), 11704);
#endif
}
...
{
   typedef boost_kahypar::rational<T> rational;
   BOOST_TEST_EQ(boost_kahypar::integer::gcd(rational(1, 4), rational(1, 3)),
      rational(1, 12));
   BOOST_TEST_EQ(boost_kahypar::integer::lcm(rational(1, 4), rational(1, 3)),
      rational(1));
}
...
#define TEST_SIGNED_( test ) \
    ...
    test<long>(); \
    test<MyInt1>(); \
    test<boost_kahypar::multiprecision::cpp_int>(); \
    test<boost_kahypar::multiprecision::int512_t>();
#else
#define TEST_SIGNED_( test ) \
    test<signed char>(); \
    test<short>(); \
...
#define TEST_UNSIGNED_( test ) \
    ...
    test<MyUnsigned1>(); \
    test<MyUnsigned2>(); \
    test<boost_kahypar::multiprecision::uint512_t>();
#else
#define TEST_UNSIGNED_( test ) \
    test<unsigned char>(); \
    test<unsigned short>(); \
...
# define TEST_UNSIGNED( test ) \
    TEST_UNSIGNED_( test ) \
    test<boost_kahypar::ulong_long_type>();
#elif defined(BOOST_HAS_MS_INT64)
# define TEST_UNSIGNED( test ) \
    TEST_UNSIGNED_( test ) \
