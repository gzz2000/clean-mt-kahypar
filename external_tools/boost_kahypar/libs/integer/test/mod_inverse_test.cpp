...
#include <boost_kahypar/integer/mod_inverse.hpp>
...
using boost_kahypar::integer::mod_inverse;
...
int main()
{
    test_mod_inverse<boost_kahypar::int16_t>();
    test_mod_inverse<boost_kahypar::int32_t>();
    test_mod_inverse<boost_kahypar::int64_t>();
