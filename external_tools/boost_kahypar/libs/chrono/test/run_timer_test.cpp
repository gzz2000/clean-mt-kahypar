...
#include <boost_kahypar/chrono/timer.hpp>
...
using boost_kahypar::chrono::run_timer;
...
namespace
{
  typedef boost_kahypar::chrono::nanoseconds ns;
  ...
  void run_timer_constructor_overload_test()
  {
    ...
    boost_kahypar::chrono::timer<boost_kahypar::chrono::high_resolution_clock> t;
    while ( t.elapsed() < boost_kahypar::chrono::seconds(1) ) {}
    std::cout << "\n";
  ...
  void accuracy_test( int argc, char * argv[] )
  {
    ...
    boost_kahypar::chrono::system_timer           sys;
#ifdef BOOST_CHRONO_HAS_CLOCK_STEADY
    boost_kahypar::chrono::steady_timer        mono;
#endif
    boost_kahypar::chrono::high_resolution_timer  hires;
    boost_kahypar::chrono::process_timer          process;
    ...
    boost_kahypar::chrono::system_timer::duration sys_dur = sys.elapsed();
#ifdef BOOST_CHRONO_HAS_CLOCK_STEADY
    boost_kahypar::chrono::steady_timer::duration mono_dur = mono.elapsed();
#endif
    boost_kahypar::chrono::high_resolution_timer::duration hires_dur = hires.elapsed();
    boost_kahypar::chrono::process_times times;
  ...
  void process_timer_test()
  {
    ...
    boost_kahypar::chrono::process_timer t;
