...
void test_good(std::string str, D res)
{
  ...
  std::istringstream in(str + boost_kahypar::chrono::clock_string<Clock, char>::since());
  clock_time_point tp;
  in >> tp;
  BOOST_TEST(in.eof());
  BOOST_TEST(!in.fail());
  std::cout << "Input=    " << str << std::endl;
  std::cout << "Expected= " << clock_time_point(boost_kahypar::chrono::duration_cast<clock_duration>(res)) << std::endl;
  std::cout << "Obtained= " << tp << std::endl;
  BOOST_TEST( (tp == clock_time_point(boost_kahypar::chrono::duration_cast<clock_duration>(res)) ));
}
...
void test_good(std::string str, D res)
{
  typedef boost_kahypar::chrono::time_point<Clock, D> clock_time_point;
  //typedef typename Clock::duration clock_duration;
  std::istringstream in(str + boost_kahypar::chrono::clock_string<Clock, char>::since());
  clock_time_point tp;
  in >> tp;
...
void test_good_system_clock(std::string str, D res)
{
  ...
  boost_kahypar::chrono::time_point<Clock, D> tp;
  in >> tp;
  BOOST_TEST(in.eof());
  BOOST_TEST(!in.fail());
  std::cout << "Input=    " << str << std::endl;
  std::cout << "Expected= " << boost_kahypar::chrono::time_point<Clock, D>(res) << std::endl;
  std::cout << "Obtained= " << tp << std::endl;
  std::cout << "Expected= " << boost_kahypar::chrono::duration_cast<boost_kahypar::chrono::nanoseconds>(boost_kahypar::chrono::time_point<Clock, D>(res).time_since_epoch()).count() << std::endl;
  std::cout << "Obtained= " << boost_kahypar::chrono::duration_cast<boost_kahypar::chrono::nanoseconds>(tp.time_since_epoch()).count() << std::endl;
  BOOST_TEST( (tp == boost_kahypar::chrono::time_point<Clock, D>(res)));
}
...
void test_good_utc_fmt_system_clock(std::string str, std::string fmt, D res)
{
  ...
  std::istringstream in(str);
  boost_kahypar::chrono::time_point<Clock, D> tp;
  in >> time_fmt(boost_kahypar::chrono::timezone::utc, fmt);
  in >> tp;
  BOOST_TEST(in.eof());
  BOOST_TEST(!in.fail());
  std::cout << "Input=    " << str << std::endl;
  ...
  std::cout << "Expected= " << boost_kahypar::chrono::duration_cast<boost_kahypar::chrono::nanoseconds>(boost_kahypar::chrono::time_point<Clock, D>(res).time_since_epoch()).count() << std::endl;
  std::cout << "Obtained= " << boost_kahypar::chrono::duration_cast<boost_kahypar::chrono::nanoseconds>(tp.time_since_epoch()).count() << std::endl;
  BOOST_TEST_EQ( tp , (boost_kahypar::chrono::time_point<Clock, D>(res)));
}
#endif
template <typename Clock, typename D>
void test_fail(const char* str, D)
{
  ...
  in >> tp;
  BOOST_TEST(in.fail());
  BOOST_TEST( (tp == boost_kahypar::chrono::time_point<Clock, D>()));
}
...
void check_all()
{
  ...
  test_good<Clock> ("5000 deciseconds", duration<boost_kahypar::int_least64_t, deci> (5000));
  test_good<Clock> ("5000 [1/30]seconds", duration<boost_kahypar::int_least64_t, ratio<1, 30> > (5000));
  ...
  test_good<Clock> ("5000 ds", duration<boost_kahypar::int_least64_t, deci> (5000));
  test_good<Clock> ("5000 [1/30]s", duration<boost_kahypar::int_least64_t, ratio<1, 30> > (5000));
...
void check_all_system_clock()
{
  ...
  test_good_system_clock ("1970-01-01 00:08:20.000000 +0000", duration<boost_kahypar::int_least64_t, deci> (5000));
  test_good_system_clock ("1970-01-01 00:02:46.666667 +0000", duration<boost_kahypar::int_least64_t, ratio<1, 30> > (5000));
