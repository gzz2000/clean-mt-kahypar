...
int main()
{
  ...
  boost_kahypar::chrono::system_clock::time_point atnow= boost_kahypar::chrono::system_clock::now();
  {
      std::stringstream strm;
      std::stringstream strm2;
      // does not change anything: strm<<time_fmt(boost_kahypar::chrono::timezone::utc);
      // does not change anything: strm2<<time_fmt(boost_kahypar::chrono::timezone::utc);
      boost_kahypar::chrono::system_clock::time_point atnow2;
      strm<<atnow<<std::endl;
      time_t t = boost_kahypar::chrono::system_clock::to_time_t(atnow);
      std::cout << "A:" << std::endl;
      std::puts(ctime(&t));
      std::cout << "A:" << std::endl;
      ...
      // 1 sec wrong:
      std::cout << "diff:" << boost_kahypar::chrono::duration_cast<microseconds>(atnow2 - atnow).count() <<std::endl;
      BOOST_TEST_EQ(boost_kahypar::chrono::duration_cast<microseconds>(atnow2 - atnow).count(), 0);
      std::stringstream formatted;
      formatted << time_fmt(boost_kahypar::chrono::timezone::utc, "%Y-%m-%d %H:%M:%S");
      formatted << "actual:"<< atnow <<std::endl;
      formatted << "parsed:"<< atnow2 <<std::endl;
      std::cout << formatted.str();
      std::stringstream formatted1;
      formatted1 << time_fmt(boost_kahypar::chrono::timezone::utc, "%Y-%m-%d %H:%M:%S");
      formatted1 << atnow ;
      std::stringstream formatted2;
      formatted2 << time_fmt(boost_kahypar::chrono::timezone::utc, "%Y-%m-%d %H:%M:%S");
      formatted2 << atnow2 ;
...

  {
    std::cout << "FORMATTED" << std::endl;
      ...
      strm<<time_fmt(boost_kahypar::chrono::timezone::utc, "%Y-%m-%d %H:%M:%S");
      strm2<<time_fmt(boost_kahypar::chrono::timezone::utc, "%Y-%m-%d %H:%M:%S");
      strm<<atnow<<std::endl;
      ...
      BOOST_TEST_EQ(boost_kahypar::chrono::duration_cast<seconds>(atnow2 - atnow).count(), 0);
