...
void test()
{
    typedef boost_kahypar::chrono::system_clock Clock1;
    ...
    typedef boost_kahypar::chrono::time_point<Clock1, Duration1> T1;
    typedef boost_kahypar::chrono::time_point<Clock2, Duration2> T2;
