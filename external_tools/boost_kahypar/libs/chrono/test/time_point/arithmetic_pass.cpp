...
int main()
{
  ...
  }
  {
    ...
    boost_kahypar::chrono::time_point<Clock, Duration1> t1(Duration1(3));
    boost_kahypar::chrono::time_point<Clock, Duration2> t2 = t1 - Duration2(5);
  ...
  }
  {
    ...
    typedef boost_kahypar::chrono::milliseconds Duration1;
    typedef boost_kahypar::chrono::microseconds Duration2;
    BOOST_CONSTEXPR boost_kahypar::chrono::time_point<Clock, Duration1> t1(Duration1(3));
    BOOST_CONSTEXPR boost_kahypar::chrono::time_point<Clock, Duration2> t2 = t1 - Duration2(5);
  ...
  }
  {
    ...
    typedef boost_kahypar::chrono::microseconds Duration2;
    boost_kahypar::chrono::time_point<Clock, Duration1> t1(Duration1(3));
    boost_kahypar::chrono::time_point<Clock, Duration2> t2(Duration2(5));
  ...
  }
  {
    ...
    typedef boost_kahypar::chrono::microseconds Duration2;
    BOOST_CONSTEXPR boost_kahypar::chrono::time_point<Clock, Duration1> t1(Duration1(3));
    BOOST_CONSTEXPR boost_kahypar::chrono::time_point<Clock, Duration2> t2(Duration2(5));
  ...
  }
  {
    ...
    BOOST_CONSTEXPR boost_kahypar::chrono::time_point<Clock, Duration2> t3 = Duration2(6) + t1;
