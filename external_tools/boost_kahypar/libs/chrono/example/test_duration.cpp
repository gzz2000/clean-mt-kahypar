...
{
    typedef boost_kahypar::common_type<boost_kahypar::chrono::hours::rep, boost_kahypar::chrono::minutes::rep>::type h_min_rep;
...
void g(nanoseconds d, boost_kahypar::intmax_t res)
{
...
template <class Rep, class Period>
void tmpl(duration<Rep, Period> d, boost_kahypar::intmax_t res)
{
...
void tmpl2(duration<long long, Period> d, boost_kahypar::intmax_t res)
{
    // convert d to nanoseconds, rounding up if it is not an exact conversion
    nanoseconds ns = duration_cast<nanoseconds>(d);
    if (ns < d)
...
int main()
{
    ...
    typedef duration<double, boost_kahypar::ratio<60> > dminutes;
    ...
    tmpl2(duration<long long, boost_kahypar::pico>(333333333333LL), 333333334);  // About 1/3 of a second worth of picoseconds
    ...
    duration<double, boost_kahypar::milli> d2 = 2.5 * milliseconds(3) ;
    (void)d2;
    duration<double, boost_kahypar::milli> d3 = milliseconds(3) / 2.5;
    (void)d3;
    duration<double, boost_kahypar::milli> d4 = milliseconds(3) + milliseconds(5) ;
    (void)d4;
