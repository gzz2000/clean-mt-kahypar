...
template <typename Clock,
          bool = boost_kahypar::is_same<Clock, boost_kahypar::chrono::system_clock>::value,
#ifdef BOOST_CHRONO_HAS_CLOCK_STEADY
    bool = boost_kahypar::is_same<Clock, boost_kahypar::chrono::steady_clock>::value,
#else
    bool = false,
#endif
          bool = boost_kahypar::is_same<Clock, boost_kahypar::chrono::high_resolution_clock>::value
         >
struct name;
