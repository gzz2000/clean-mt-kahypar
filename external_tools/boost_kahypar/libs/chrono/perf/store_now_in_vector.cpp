...
typedef boost_kahypar::chrono::timer<boost_kahypar::chrono::high_resolution_clock> Stopwatch;
...
int main() {
  ...
  test<boost_kahypar::chrono::system_clock>();
#ifdef BOOST_CHRONO_HAS_CLOCK_STEADY
  std::cout << "steady_clock " ;
  test<boost_kahypar::chrono::steady_clock>();
#endif
  std::cout << "high_resolution_clock " ;
  test<boost_kahypar::chrono::high_resolution_clock>();

#if defined(BOOST_CHRONO_HAS_PROCESS_CLOCKS)
  std::cout << "process_real_cpu_clock ";
  test<boost_kahypar::chrono::process_real_cpu_clock>();
#if ! BOOST_OS_WINDOWS || BOOST_PLAT_WINDOWS_DESKTOP
  std::cout << "process_user_cpu_clock ";
  test<boost_kahypar::chrono::process_user_cpu_clock>();
  std::cout << "process_system_cpu_clock " ;
  test<boost_kahypar::chrono::process_system_cpu_clock>();
  std::cout << "process_cpu_clock " ;
  test<boost_kahypar::chrono::process_cpu_clock>();
#endif
#endif
  std::cout << "system_clock ";
  test<boost_kahypar::chrono::system_clock>();
