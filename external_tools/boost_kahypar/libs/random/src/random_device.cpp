...
const bool boost_kahypar::random::random_device::has_fixed_range;
#endif
...
class boost_kahypar::random::random_device::impl
{
public:
  ...
  void error(const char * msg) {
    ...
    boost_kahypar::throw_exception(
      boost_kahypar::system::system_error(
        error_code, boost_kahypar::system::system_category(),
        std::string("boost_kahypar::random_device: ") + msg + 
...
BOOST_RANDOM_DECL boost_kahypar::random::random_device::random_device()
  : pimpl(new impl(default_token))
{}

BOOST_RANDOM_DECL boost_kahypar::random::random_device::random_device(const std::string& token)
  : pimpl(new impl(token))
{}

BOOST_RANDOM_DECL boost_kahypar::random_device::~random_device()
{
  delete pimpl;
}

BOOST_RANDOM_DECL double boost_kahypar::random_device::entropy() const
{
  return 10;
}

BOOST_RANDOM_DECL unsigned int boost_kahypar::random_device::operator()()
{
  return pimpl->next();
}
