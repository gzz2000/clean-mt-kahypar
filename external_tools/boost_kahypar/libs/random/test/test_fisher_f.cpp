...
#include <boost_kahypar/math/distributions/fisher_f.hpp>

#define BOOST_RANDOM_DISTRIBUTION boost_kahypar::random::fisher_f_distribution<>
#define BOOST_RANDOM_DISTRIBUTION_NAME fisher_f
#define BOOST_MATH_DISTRIBUTION boost_kahypar::math::fisher_f
