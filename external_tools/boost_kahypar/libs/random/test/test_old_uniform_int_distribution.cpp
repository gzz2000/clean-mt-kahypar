...
#define BOOST_RANDOM_DISTRIBUTION boost_kahypar::uniform_int<>
...
#define BOOST_RANDOM_UNIFORM_INT boost_kahypar::uniform_int
...
BOOST_AUTO_TEST_CASE(test_random_shuffle)
{
    ...
    typedef boost_kahypar::variate_generator<boost_kahypar::mt19937 &, distribution_type> generator_type;

    boost_kahypar::mt19937 engine1(1234);
    boost_kahypar::mt19937 engine2(1234);

    boost_kahypar::random::random_number_generator<boost_kahypar::mt19937> referenceRand(engine1);
