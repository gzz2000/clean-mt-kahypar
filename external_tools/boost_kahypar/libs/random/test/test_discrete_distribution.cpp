...
using boost_kahypar::random::discrete_distribution;
...
BOOST_AUTO_TEST_CASE(test_constructors) {
    boost_kahypar::random::discrete_distribution<> dist;
    CHECK_PROBABILITIES(dist.probabilities(), list_of(1.0));

#ifndef BOOST_NO_CXX11_HDR_INITIALIZER_LIST
    boost_kahypar::random::discrete_distribution<> dist_il = { 1, 2, 1, 4 };
    CHECK_PROBABILITIES(dist_il.probabilities(), list_of(.125)(.25)(.125)(.5));
#endif
    std::vector<double> probs = boost_kahypar::assign::list_of(1.0)(2.0)(1.0)(4.0);

    boost_kahypar::random::discrete_distribution<> dist_r(probs);
    CHECK_PROBABILITIES(dist_r.probabilities(), list_of(.125)(.25)(.125)(.5));
    
    boost_kahypar::random::discrete_distribution<> dist_it(probs.begin(), probs.end());
    CHECK_PROBABILITIES(dist_it.probabilities(), list_of(.125)(.25)(.125)(.5));
    
    boost_kahypar::random::discrete_distribution<> dist_fun(4, 99, 115, gen());
    CHECK_PROBABILITIES(dist_fun.probabilities(), list_of(.125)(.25)(.125)(.5));

    boost_kahypar::random::discrete_distribution<> copy(dist);
    BOOST_CHECK_EQUAL(dist, copy);
    boost_kahypar::random::discrete_distribution<> copy_r(dist_r);
    BOOST_CHECK_EQUAL(dist_r, copy_r);

    boost_kahypar::random::discrete_distribution<> notpow2(3, 99, 111, gen());
    ...
    boost_kahypar::random::discrete_distribution<> copy_notpow2(notpow2);
    BOOST_CHECK_EQUAL(notpow2, copy_notpow2);
}

BOOST_AUTO_TEST_CASE(test_param) {
    std::vector<double> probs = boost_kahypar::assign::list_of(1.0)(2.0)(1.0)(4.0);
    boost_kahypar::random::discrete_distribution<> dist(probs);
    boost_kahypar::random::discrete_distribution<>::param_type param = dist.param();
    CHECK_PROBABILITIES(param.probabilities(), list_of(.125)(.25)(.125)(.5));
    boost_kahypar::random::discrete_distribution<> copy1(param);
    BOOST_CHECK_EQUAL(dist, copy1);
    boost_kahypar::random::discrete_distribution<> copy2;
    copy2.param(param);
    BOOST_CHECK_EQUAL(dist, copy2);

    boost_kahypar::random::discrete_distribution<>::param_type param_copy = param;
    BOOST_CHECK_EQUAL(param, param_copy);
    BOOST_CHECK(param == param_copy);
    BOOST_CHECK(!(param != param_copy));
    boost_kahypar::random::discrete_distribution<>::param_type param_default;
    CHECK_PROBABILITIES(param_default.probabilities(), list_of(1.0));
    BOOST_CHECK(param != param_default);
    BOOST_CHECK(!(param == param_default));
    
#ifndef BOOST_NO_CXX11_HDR_INITIALIZER_LIST
    boost_kahypar::random::discrete_distribution<>::param_type
        parm_il = { 1, 2, 1, 4 };
    CHECK_PROBABILITIES(parm_il.probabilities(), list_of(.125)(.25)(.125)(.5));
#endif

    boost_kahypar::random::discrete_distribution<>::param_type parm_r(probs);
...
BOOST_AUTO_TEST_CASE(test_min_max) {
    std::vector<double> probs = boost_kahypar::assign::list_of(1.0)(2.0)(1.0);
    boost_kahypar::random::discrete_distribution<> dist;
...
BOOST_AUTO_TEST_CASE(test_comparison) {
    std::vector<double> probs = boost_kahypar::assign::list_of(1.0)(2.0)(1.0)(4.0);
    boost_kahypar::random::discrete_distribution<> dist;
    boost_kahypar::random::discrete_distribution<> dist_copy(dist);
    boost_kahypar::random::discrete_distribution<> dist_r(probs);
    boost_kahypar::random::discrete_distribution<> dist_r_copy(dist_r);
...
BOOST_AUTO_TEST_CASE(test_streaming) {
    ...
    stream << dist;
    boost_kahypar::random::discrete_distribution<> restored_dist;
    stream >> restored_dist;
    BOOST_CHECK_EQUAL(dist, restored_dist);
}

BOOST_AUTO_TEST_CASE(test_generation) {
    std::vector<double> probs = boost_kahypar::assign::list_of(0.0)(1.0);
