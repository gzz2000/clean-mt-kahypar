...
#include <boost_kahypar/math/distributions/extreme_value.hpp>

#define BOOST_RANDOM_DISTRIBUTION boost_kahypar::random::extreme_value_distribution<>
#define BOOST_RANDOM_DISTRIBUTION_NAME extreme_value
#define BOOST_MATH_DISTRIBUTION boost_kahypar::math::extreme_value
