...
BOOST_AUTO_TEST_CASE(test_seed_seq) {
    boost_kahypar::uint32_t expected_param[4] = { 2, 3, 4, 0xdeadbeaf };
    boost_kahypar::uint32_t param[4] = { 2, 3, 4, 0xdeadbeaf };
    boost_kahypar::uint32_t store32[10];
    boost_kahypar::uint64_t store64[10];
    boost_kahypar::uint32_t expected[10] = {
        3155793538u,
        2047427591u,
        2886057794u,
        280666868u,
    ...
    boost_kahypar::random::seed_seq seq;
    ...
    boost_kahypar::uint32_t expected_r[10] = {
        2681148375u,
        3302224839u,
        249244011u,
        1549723892u,
    ...
    boost_kahypar::random::seed_seq seq_r(data);
    ...
    std::fill_n(&store64[0], 10, 0);
    std::fill_n(&param[0], 3, 0);
    boost_kahypar::random::seed_seq seq_it(data.begin(), data.end());
    ...
    std::fill_n(&store64[0], 10, 0);
    std::fill_n(&param[0], 3, 0);
    boost_kahypar::random::seed_seq seq_il = {2, 3, 4};
...
BOOST_AUTO_TEST_CASE(test_seed_seq_short_output) {
    boost_kahypar::uint32_t store32[2];

    boost_kahypar::uint32_t expected_short[2] = {
        4149590228u,
        3175758659u
    };
    ...
    boost_kahypar::random::seed_seq seq(data);
