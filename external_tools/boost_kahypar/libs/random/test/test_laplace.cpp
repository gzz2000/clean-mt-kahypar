...
#include <boost_kahypar/math/distributions/laplace.hpp>

#define BOOST_RANDOM_DISTRIBUTION boost_kahypar::random::laplace_distribution<>
#define BOOST_RANDOM_DISTRIBUTION_NAME laplace
#define BOOST_MATH_DISTRIBUTION boost_kahypar::math::laplace
...
#define BOOST_RANDOM_ARG2_DISTRIBUTION(n) boost_kahypar::uniform_real<>(0.00001, n)
