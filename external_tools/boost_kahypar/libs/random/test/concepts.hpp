...
#include <boost_kahypar/concept/requires.hpp>
...
private:
    SSeq q;
    mutable_random_access_iterator_archetype<boost_kahypar::uint32_t> rb, re;
};
...
public:
    ...
    BOOST_MPL_ASSERT((boost_kahypar::is_arithmetic<result_type>));
...
private:
    ...
    typename boost_kahypar::random::detail::seed_type<result_type>::type s;
    uintmax_t z;
    
    input_iterator_archetype<boost_kahypar::uint32_t> sb, se;
};
...
public:
    ...
    BOOST_MPL_ASSERT((boost_kahypar::is_same<typename P::distribution_type, D>));
