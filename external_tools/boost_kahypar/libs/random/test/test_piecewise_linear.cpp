...
public:
        ...
        cumulative(1, 0.0)
    {
        ...
        boost_kahypar::partial_sum(cumulative, cumulative.begin());
...
bool do_test(int n, int max) {
    ...
    boost_kahypar::variate_generator<boost_kahypar::mt19937&, boost_kahypar::random::piecewise_linear_distribution<> > vgen(gen, dist);
...
bool do_tests(int repeat, int max_n, int trials) {
    boost_kahypar::mt19937 gen;
    boost_kahypar::uniform_int<> idist(2, max_n);
    int errors = 0;
