...
#include <boost_kahypar/math/distributions/weibull.hpp>

#define BOOST_RANDOM_DISTRIBUTION boost_kahypar::random::weibull_distribution<>
#define BOOST_RANDOM_DISTRIBUTION_NAME weibull
#define BOOST_MATH_DISTRIBUTION boost_kahypar::math::weibull
