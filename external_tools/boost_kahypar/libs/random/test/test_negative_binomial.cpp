...
#include <boost_kahypar/math/distributions/negative_binomial.hpp>

#define BOOST_RANDOM_DISTRIBUTION boost_kahypar::random::negative_binomial_distribution<>
#define BOOST_RANDOM_DISTRIBUTION_NAME negative_binomial
#define BOOST_MATH_DISTRIBUTION boost_kahypar::math::negative_binomial
#define BOOST_RANDOM_ARG1_TYPE int
#define BOOST_RANDOM_ARG1_NAME n
#define BOOST_RANDOM_ARG1_DEFAULT 100000
#define BOOST_RANDOM_ARG1_DISTRIBUTION(n) boost_kahypar::uniform_int<>(0, n)
#define BOOST_RANDOM_ARG2_TYPE double
#define BOOST_RANDOM_ARG2_NAME p
#define BOOST_RANDOM_ARG2_DEFAULT 1000.0
#define BOOST_RANDOM_ARG2_DISTRIBUTION(n) boost_kahypar::uniform_01<>()
