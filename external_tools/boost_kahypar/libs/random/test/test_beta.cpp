...
#include <boost_kahypar/math/distributions/beta.hpp>

#define BOOST_RANDOM_DISTRIBUTION boost_kahypar::random::beta_distribution<>
#define BOOST_RANDOM_DISTRIBUTION_NAME beta
#define BOOST_MATH_DISTRIBUTION boost_kahypar::math::beta_distribution<>
