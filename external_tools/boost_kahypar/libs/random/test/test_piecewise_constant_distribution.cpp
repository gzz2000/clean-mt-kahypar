...
using boost_kahypar::random::test::RandomNumberDistribution;
using boost_kahypar::random::piecewise_constant_distribution;
...
using boost_kahypar::assign::list_of;

BOOST_AUTO_TEST_CASE(test_constructors) {
    boost_kahypar::random::piecewise_constant_distribution<> dist;
    CHECK_SEQUENCE(dist.densities(), list_of(1.0));
    CHECK_SEQUENCE(dist.intervals(), list_of(0.0)(1.0));

#ifndef BOOST_NO_CXX11_HDR_INITIALIZER_LIST
    boost_kahypar::random::piecewise_constant_distribution<> dist_il = {
        { 99, 103, 107, 111, 115 },
        gen()
    };
    ...
    boost_kahypar::random::piecewise_constant_distribution<> dist_il2 = {
        { 99 },
        gen()
    };
...
#endif
    std::vector<double> intervals = boost_kahypar::assign::list_of(0)(1)(2)(3)(5);
    std::vector<double> weights = boost_kahypar::assign::list_of(1)(2)(1)(4);
    std::vector<double> intervals2 = boost_kahypar::assign::list_of(99);
    std::vector<double> weights2;

    boost_kahypar::random::piecewise_constant_distribution<> dist_r(intervals, weights);
    CHECK_SEQUENCE(dist_r.intervals(), list_of(0)(1)(2)(3)(5));
    CHECK_SEQUENCE(dist_r.densities(), list_of(.125)(.25)(.125)(.25));

    boost_kahypar::random::piecewise_constant_distribution<>
        dist_r2(intervals2, weights2);
    CHECK_SEQUENCE(dist_r2.intervals(), list_of(0.0)(1.0));
    CHECK_SEQUENCE(dist_r2.densities(), list_of(1.0));
    
    boost_kahypar::random::piecewise_constant_distribution<> dist_it(
        intervals.begin(), intervals.end(), weights.begin());
    CHECK_SEQUENCE(dist_it.intervals(), list_of(0)(1)(2)(3)(5));
    CHECK_SEQUENCE(dist_it.densities(), list_of(.125)(.25)(.125)(.25));
    
    boost_kahypar::random::piecewise_constant_distribution<> dist_it2(
    ...
    boost_kahypar::random::piecewise_constant_distribution<> dist_fun(4, 99,115, gen());
    ...
    boost_kahypar::random::piecewise_constant_distribution<> copy(dist);
    BOOST_CHECK_EQUAL(dist, copy);
    boost_kahypar::random::piecewise_constant_distribution<> copy_r(dist_r);
    BOOST_CHECK_EQUAL(dist_r, copy_r);

    boost_kahypar::random::piecewise_constant_distribution<> notpow2(3, 99, 111, gen());
    ...
    boost_kahypar::random::piecewise_constant_distribution<> copy_notpow2(notpow2);
...
BOOST_AUTO_TEST_CASE(test_param) {
    std::vector<double> intervals = boost_kahypar::assign::list_of(0)(1)(2)(3)(5);
    std::vector<double> weights = boost_kahypar::assign::list_of(1)(2)(1)(4);
    std::vector<double> intervals2 = boost_kahypar::assign::list_of(0);
    std::vector<double> weights2;
    boost_kahypar::random::piecewise_constant_distribution<> dist(intervals, weights);
    boost_kahypar::random::piecewise_constant_distribution<>::param_type
        param = dist.param();
    CHECK_SEQUENCE(param.intervals(), list_of(0)(1)(2)(3)(5));
    CHECK_SEQUENCE(param.densities(), list_of(.125)(.25)(.125)(.25));
    boost_kahypar::random::piecewise_constant_distribution<> copy1(param);
    BOOST_CHECK_EQUAL(dist, copy1);
    boost_kahypar::random::piecewise_constant_distribution<> copy2;
    copy2.param(param);
    ...
    BOOST_CHECK(!(param != param_copy));
    boost_kahypar::random::piecewise_constant_distribution<>::param_type param_default;
...
#ifndef BOOST_NO_CXX11_HDR_INITIALIZER_LIST
    boost_kahypar::random::piecewise_constant_distribution<>::param_type parm_il = {
        { 99, 103, 107, 111, 115 },
        gen()
    };
    ...
    boost_kahypar::random::piecewise_constant_distribution<>::param_type parm_il2 = {
        { 99 },
        gen()
    };
...
BOOST_AUTO_TEST_CASE(test_comparison) {
    ...
    std::vector<double> weights = boost_kahypar::assign::list_of(1)(2)(1)(4);
    boost_kahypar::random::piecewise_constant_distribution<> dist;
    boost_kahypar::random::piecewise_constant_distribution<> dist_copy(dist);
    boost_kahypar::random::piecewise_constant_distribution<> dist_r(intervals, weights);
    boost_kahypar::random::piecewise_constant_distribution<> dist_r_copy(dist_r);
...
BOOST_AUTO_TEST_CASE(test_streaming) {
    ...
    stream << dist;
    boost_kahypar::random::piecewise_constant_distribution<> restored_dist;
    stream >> restored_dist;
    BOOST_CHECK_EQUAL(dist, restored_dist);
}

BOOST_AUTO_TEST_CASE(test_generation) {
    std::vector<double> intervals = boost_kahypar::assign::list_of(1)(2);
    std::vector<double> weights = boost_kahypar::assign::list_of(1);
