...
#define BOOST_RANDOM_URNG boost_kahypar::random::mt19937
...
struct seed_seq_0 {
    ...
    void generate(It begin, It end) const {
        std::fill(begin, end, boost_kahypar::uint32_t(0));
    }
};
