...
#define BOOST_RANDOM_DISTRIBUTION boost_kahypar::random::cauchy_distribution<>
#define BOOST_RANDOM_DISTRIBUTION_NAME cauchy
#define BOOST_MATH_DISTRIBUTION boost_kahypar::math::cauchy
...
#define BOOST_RANDOM_ARG2_DISTRIBUTION(n) boost_kahypar::uniform_real<>(0.001, n)
