...
#include <boost_kahypar/random/niederreiter_base2.hpp>
#include <boost_kahypar/random/uniform_01.hpp>

#include <boost_kahypar/math/constants/constants.hpp>
 ...
 */
boost_kahypar::random::niederreiter_base2 gen(4);


int main()
{
  typedef boost_kahypar::tuple<double, double, double> point_t;
  ...
  >>*/
  boost_kahypar::random::uniform_01<double> dist;
  ...
  for (std::size_t i = 0; i != n_points; ++i)
  {
    ...
    */
    ...
    double phi = boost_kahypar::math::constants::two_pi<double>() * dist(gen);
