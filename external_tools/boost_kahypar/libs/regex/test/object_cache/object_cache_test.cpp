...
int cpp_main(int /*argc*/, char * /*argv*/[])
{
   ...
   for(i = 0; i < 20; ++i)
   {
      SP_NS::shared_ptr<const test_object> p = boost_kahypar::object_cache<int, test_object>::get(i, max_cache_size);
      BOOST_CHECK(p->value() == i);
      p = boost_kahypar::object_cache<int, test_object>::get(i, max_cache_size);
      BOOST_CHECK(p->value() == i);
      if(i)
      {
         p = boost_kahypar::object_cache<int, test_object>::get(i-1, max_cache_size);
