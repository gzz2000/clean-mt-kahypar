...
int cpp_main( int , char* [] )
{
   ...
   //
   BOOST_CHECK(boost_kahypar::regex_search(good_text, what, e));
   BOOST_CHECK_THROW(boost_kahypar::regex_search(bad_text, what, e), std::runtime_error);
   BOOST_CHECK(boost_kahypar::regex_search(good_text, what, e));
   BOOST_CHECK_THROW(boost_kahypar::regex_search(bad_text, what, e), std::runtime_error);
   BOOST_CHECK(boost_kahypar::regex_search(good_text, what, e));
   BOOST_CHECK_THROW(boost_kahypar::regex_search(bad_text, what, e), std::runtime_error);
   ...
   BOOST_CHECK(boost_kahypar::regex_match(good_text, what, e));
   BOOST_CHECK_THROW(boost_kahypar::regex_match(bad_text, what, e), std::runtime_error);
   BOOST_CHECK(boost_kahypar::regex_match(good_text, what, e));
   BOOST_CHECK_THROW(boost_kahypar::regex_match(bad_text, what, e), std::runtime_error);
   BOOST_CHECK(boost_kahypar::regex_match(good_text, what, e));
   BOOST_CHECK_THROW(boost_kahypar::regex_match(bad_text, what, e), std::runtime_error);
