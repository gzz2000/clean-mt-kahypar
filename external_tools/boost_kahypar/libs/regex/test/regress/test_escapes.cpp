...
void test_character_escapes()
{
   ...
   //TEST_INVALID_REGEX("\\c=", boost_kahypar::regex::extended);
   //TEST_INVALID_REGEX("\\c?", boost_kahypar::regex::extended);
   ...
   TEST_REGEX_SEARCH("\\~", boost_kahypar::regex::extended, "~", match_default, make_array(0, 1, -2, -2));
   TEST_REGEX_SEARCH("\\j", boost_kahypar::regex::extended, "j", match_default, make_array(0, 1, -2, -2));
}
