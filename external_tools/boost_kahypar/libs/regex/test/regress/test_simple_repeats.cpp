...
void test_simple_repeats()
{
   ...
   TEST_INVALID_REGEX("(*)", perl);
   TEST_INVALID_REGEX("(*)", boost_kahypar::regex::extended);
   ...
   TEST_INVALID_REGEX("({1,2})", boost_kahypar::regex::extended);
   TEST_INVALID_REGEX("^{1,2}", perl);
   TEST_INVALID_REGEX("^{1,2}", boost_kahypar::regex::extended);
   TEST_INVALID_REGEX("${1,2}", perl);
   TEST_INVALID_REGEX("${1,2}", boost_kahypar::regex::extended);
   ...
   TEST_INVALID_REGEX("\\A{1,2}", perl);
   TEST_INVALID_REGEX("a|{1,2}", perl);
   TEST_INVALID_REGEX("a|{1,2}", boost_kahypar::regex::extended);
...
{
   using namespace boost_kahypar::regex_constants;
   // boost_kahypar::regex::extended repeat checking to exercise new algorithms:
