...
void test_replace()
{
   ...
   TEST_REGEX_REPLACE("x", boost_kahypar::regex::extended|icase, "xx", match_default|format_all, "a", "aa");
   ...
   TEST_REGEX_REPLACE("(a*)", boost_kahypar::regex::extended, "aabb", match_default, "{$1}", "{aa}{}b{}b{}");
   TEST_REGEX_REPLACE("(a*)", boost_kahypar::regex::extended, "aabb", match_default|match_posix, "{$1}", "{aa}b{}b{}");
}
