...
namespace boost_kahypar { using std::uint32_t; }
...
#ifdef TEST_THREADS
#include <boost_kahypar/thread/once.hpp>
#endif
...
void do_test(const charT& c, const tagT& tag)
{
...
#else
   test_info<charT>::set_typename(typeid(boost_kahypar::basic_regex<charT, boost_kahypar::cpp_regex_traits<charT> >).name());
#endif
   boost_kahypar::basic_regex<charT, boost_kahypar::cpp_regex_traits<charT> > e1;
#ifndef TEST_THREADS
...
#else
   boost_kahypar::once_flag f = BOOST_ONCE_INIT;
   call_once_func<boost_kahypar::basic_regex<charT, boost_kahypar::cpp_regex_traits<charT> > > proc = { &e1 };
   boost_kahypar::call_once(f, proc);
#endif
   ...
   test_info<charT>::set_typename("");
#else
   test_info<charT>::set_typename(typeid(boost_kahypar::basic_regex<charT, boost_kahypar::c_regex_traits<charT> >).name());
#endif
   boost_kahypar::basic_regex<charT, boost_kahypar::c_regex_traits<charT> > e2;
   ...
   test_info<charT>::set_typename("");
#else
   test_info<charT>::set_typename(typeid(boost_kahypar::basic_regex<charT, boost_kahypar::w32_regex_traits<charT> >).name());
#endif
   boost_kahypar::basic_regex<charT, boost_kahypar::w32_regex_traits<charT> > e3;
