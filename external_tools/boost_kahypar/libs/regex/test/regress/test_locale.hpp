...
public:
   ...
   test_locale(const char* c_name, boost_kahypar::uint32_t lcid);
   ~test_locale();
...
#endif
   static boost_kahypar::uint32_t win_locale()
   {
...
#endif
   static boost_kahypar::uint32_t s_win_locale_inst;
...
#endif
   int             m_old_cpp_state;
   boost_kahypar::uint32_t m_old_win_locale;
   int             m_old_win_state;
