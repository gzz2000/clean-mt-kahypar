...
public:
   ...
   ~de_fuzz_output() 
   {
      ...
      {
         std::string filename = "corpus_" + boost_kahypar::lexical_cast<std::string>(j);
...
private:
   struct data_type
   {
      ...
      boost_kahypar::regex_constants::syntax_option_type options;
      string_type search_text;
      boost_kahypar::regex_constants::match_flag_type match_options;
   ...
   {
      static boost_kahypar::thread_specific_ptr<data_type> pd;
      if(pd.get() == 0)
   ...
   {
#ifdef TEST_THREADS
      static boost_kahypar::once_flag f = BOOST_ONCE_INIT;
      boost_kahypar::call_once(f,&init_data);
      return do_get_data();
#else
      static data_type d = {};
      return d;
...
public:
   ...
   static void set_info(
      ...
      boost_kahypar::regex_constants::match_flag_type match_options = boost_kahypar::match_default,
   ...
   static boost_kahypar::regex_constants::syntax_option_type syntax_options()
   {
      return data().options;
   }
   ...
   static boost_kahypar::regex_constants::match_flag_type match_options()
   {
