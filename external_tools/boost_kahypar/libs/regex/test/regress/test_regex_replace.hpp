...
void test_regex_replace(boost_kahypar::basic_regex<charT, traits>& r)
{
   ...
   string_type result = boost_kahypar::regex_replace(search_text, r, format_string, opts);
...
template<class charT, class traits>
void test(boost_kahypar::basic_regex<charT, traits>& r, const test_regex_replace_tag&)
{
