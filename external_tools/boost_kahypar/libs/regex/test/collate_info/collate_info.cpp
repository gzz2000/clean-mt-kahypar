...
void print_sort_syntax(const traits& pt, const char* name)
{
   ...
   char_type delim;
   unsigned result = ::boost_kahypar::BOOST_REGEX_DETAIL_NS::find_sort_syntax(&pt, &delim);
   std::cout << "   ";
   switch(result)
   {
...
int cpp_main(int /*argc*/, char * /*argv*/[])
{
   ...
   boost_kahypar::c_regex_traits<char> a;
   print_sort_syntax(a, "boost_kahypar::c_regex_traits<char>");
#ifndef BOOST_NO_WREGEX
   boost_kahypar::c_regex_traits<wchar_t> b;
   print_sort_syntax(b, "boost_kahypar::c_regex_traits<wchar_t>");
#endif
#endif
#ifndef BOOST_NO_STD_LOCALE
   boost_kahypar::cpp_regex_traits<char> c;
   print_sort_syntax(c, "boost_kahypar::cpp_regex_traits<char>");
#ifndef BOOST_NO_WREGEX
   boost_kahypar::cpp_regex_traits<wchar_t> d;
   print_sort_syntax(d, "boost_kahypar::cpp_regex_traits<wchar_t>");
#endif
