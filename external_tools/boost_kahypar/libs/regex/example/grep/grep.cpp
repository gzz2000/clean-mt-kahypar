...
boost_kahypar::regex_constants::syntax_option_type flags = boost_kahypar::regex_constants::basic;
boost_kahypar::regex re;
...
void process_stream(std::istream& is)
{
   ...
   {
      bool result = boost_kahypar::regex_search(line, what, re);
      if(result)
      {
...
int main(int argc, char * argv[])
{
   try{
      ...
      {
         flags = boost_kahypar::regex_constants::extended;
      }
      if(vm.count("basic-regexp"))
      {
         flags = boost_kahypar::regex_constants::basic;
      }
      if(vm.count("perl-regexp"))
      {
         flags = boost_kahypar::regex_constants::perl;
      }
      if(vm.count("ignore-case"))
      {
         flags |= boost_kahypar::regex_constants::icase;
      }
