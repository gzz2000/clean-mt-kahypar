...
class class_index
{
   ...
   typedef boost_kahypar::match_results<std::string::const_iterator> arg_type;

   bool grep_callback(const boost_kahypar::match_results<std::string::const_iterator>& what);
public:
...
bool class_index::grep_callback(const boost_kahypar::match_results<std::string::const_iterator>& what)
{
