...
bool regex_callback(const boost_kahypar::match_results<std::string::const_iterator>& what)
{
...
int main(int argc, const char** argv)
{
   ...
   for(int i = 1; i < argc; ++i)
   {
      ...
      boost_kahypar::sregex_iterator m1(text.begin(), text.end(), expression);
      boost_kahypar::sregex_iterator m2;
