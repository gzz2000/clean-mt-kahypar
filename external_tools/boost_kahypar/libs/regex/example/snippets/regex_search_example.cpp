...
boost_kahypar::regex expression(re);
...
void IndexClasses(map_type& m, const std::string& file)
{
   ...
   boost_kahypar::match_results<std::string::const_iterator> what;
   boost_kahypar::match_flag_type flags = boost_kahypar::match_default;
   while(boost_kahypar::regex_search(start, end, what, expression, flags))   
   {
      ...
      start = what[0].second;      
      // update flags:
      flags |= boost_kahypar::match_prev_avail;
      flags |= boost_kahypar::match_not_bob;
   }
}
