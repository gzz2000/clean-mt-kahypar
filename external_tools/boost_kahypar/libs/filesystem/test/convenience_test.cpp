...
int cpp_main(int, char*[])
{
    ...
    BOOST_TEST(throws_fs_error(
        boost_kahypar::bind(fs::create_directories, is_a_file)));
    BOOST_TEST(throws_fs_error(
        boost_kahypar::bind(fs::create_directories, is_a_file / "aa")));
    ...
    BOOST_TEST(throws_fs_error(
        boost_kahypar::bind(create_recursive_iterator, "/no-such-path")));
