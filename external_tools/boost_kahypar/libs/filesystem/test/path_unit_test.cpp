...
#include <boost_kahypar/filesystem/detail/utf8_codecvt_facet.hpp> // for imbue tests
#include "test_codecvt.hpp"                               // for codecvt arg tests
#include <boost_kahypar/detail/lightweight_test_report.hpp>
#include <boost_kahypar/smart_ptr.hpp> // used constructor tests
...
void fun(const boost_kahypar::shared_ptr< Base >&)
{
}
...
void test_constructors()
{
    ...
    boost_kahypar::shared_ptr< Derived > pDerived(new Derived());
