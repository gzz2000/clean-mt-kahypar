...
class codecvt_error_cat final :
    public boost_kahypar::system::error_category
{
public:
...
BOOST_FILESYSTEM_DECL boost_kahypar::system::error_category const& codecvt_error_category() noexcept
{
    static
...
{
    codecvt_error_category_initializer() { boost_kahypar::filesystem::codecvt_error_category(); }
};
