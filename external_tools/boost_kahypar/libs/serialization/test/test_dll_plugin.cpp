...
class polymorphic_derived1 : public polymorphic_base
{
    ...
    const char * get_key() const{
        return
            boost_kahypar::serialization::type_info_implementation<
...
void save_exported(const char *testfile)
{
    ...
    boost_kahypar::serialization::extended_type_info const * const d2_eti =
        boost_kahypar::serialization::extended_type_info::find(
