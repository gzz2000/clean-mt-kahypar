...
void load_derived(const char *testfile)
{
    ...
    const boost_kahypar::serialization::extended_type_info * p1;
    p1 = & boost_kahypar::serialization::type_info_implementation<polymorphic_derived1>
        ::type::get_const_instance();

    BOOST_CHECK(NULL != p1);

    const boost_kahypar::serialization::extended_type_info * p2;
    p2 = boost_kahypar::serialization::type_info_implementation<polymorphic_derived1>
    ...
    BOOST_CHECK_MESSAGE(
        & boost_kahypar::serialization::type_info_implementation<polymorphic_derived2>
            ::type::get_const_instance()
        ==
        boost_kahypar::serialization::type_info_implementation<polymorphic_derived2>
    ...
    p2 = boost_kahypar::serialization::type_info_implementation<polymorphic_base>
    ...
    BOOST_CHECK_MESSAGE(
        & boost_kahypar::serialization::type_info_implementation<polymorphic_derived2>
            ::type::get_const_instance()
        == boost_kahypar::serialization::type_info_implementation<polymorphic_base>
...
void load_registered(const char *testfile)
{
    ...
    BOOST_CHECK_MESSAGE(
        & boost_kahypar::serialization::type_info_implementation<polymorphic_derived1>
            ::type::get_const_instance()
        == boost_kahypar::serialization::type_info_implementation<polymorphic_base>
            ::type::get_const_instance().get_derived_extended_type_info(*rb1),
