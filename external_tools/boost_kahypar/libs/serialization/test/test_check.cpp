...
#include <sstream>
#include <boost_kahypar/config.hpp> // BOOST_STATIC_CONST
...
BOOST_CLASS_IMPLEMENTATION(check1, boost_kahypar::serialization::object_serializable)
BOOST_CLASS_TRACKING(check1, boost_kahypar::serialization::track_selectively)
...
BOOST_CLASS_IMPLEMENTATION(check2, boost_kahypar::serialization::object_serializable)
BOOST_CLASS_VERSION(check2, 1)
// use track always to turn off warning tested above
BOOST_CLASS_TRACKING(check2, boost_kahypar::serialization::track_always)
...
BOOST_CLASS_TRACKING(check3, boost_kahypar::serialization::track_never)
...
int main(int /* argc */, char * /* argv */[]){
    std::stringstream s;
    {
        boost_kahypar::archive::text_oarchive oa(s);
    ...
    {
        boost_kahypar::archive::text_iarchive ia(s);
