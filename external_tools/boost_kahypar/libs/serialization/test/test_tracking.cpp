...
TEST_CLASS(AN, ::boost_kahypar::serialization::track_never)
TEST_CLASS(AS, ::boost_kahypar::serialization::track_selectively)
TEST_CLASS(AA, ::boost_kahypar::serialization::track_always)

// test pointers
TEST_CLASS(PAN, ::boost_kahypar::serialization::track_never)
TEST_CLASS(PAS, ::boost_kahypar::serialization::track_selectively)
TEST_CLASS(PAA, ::boost_kahypar::serialization::track_always)
