...
#include <boost_kahypar/serialization/shared_ptr_132.hpp>
#include <boost_kahypar/serialization/shared_ptr.hpp>
#include <boost_kahypar/serialization/weak_ptr.hpp>
...
void save_and_load2(T & first, T & second)
{
    ...
    boost_kahypar::shared_ptr<A> first1, second1;
...
int test_main(int /* argc */, char * /* argv */[])
{
    ...
    boost_kahypar_132::shared_ptr<A> spa;
