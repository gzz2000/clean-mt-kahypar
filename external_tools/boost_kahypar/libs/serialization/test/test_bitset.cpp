...
#include <boost_kahypar/serialization/bitset.hpp>
...
int test_main( int /* argc */, char* /* argv */[] )
{
...

    {
        ...
        test_oarchive oa( os );
        oa << boost_kahypar::serialization::make_nvp( "bitset", bitsetA );
    }
    ...
    std::bitset<8> bitsetB;
    {
        ...
        test_iarchive ia( is );
        ia >> boost_kahypar::serialization::make_nvp( "bitset", bitsetB );
    }
