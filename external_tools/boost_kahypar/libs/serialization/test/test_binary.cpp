...
#include <boost_kahypar/serialization/binary_object.hpp>
...
class A {
    ...
    void serialize(Archive & ar, const unsigned int /* file_version */){
        ar & boost_kahypar::serialization::make_nvp(
            "data",
            boost_kahypar::serialization::make_binary_object(data, sizeof(data))
        );
    }
...
int test_main( int /* argc */, char* /* argv */[] )
{
    ...
    std::memset(s1_4, '\0', sizeof(s1_4));
    {
        ...
        oa << boost_kahypar::serialization::make_nvp(
            "s1",
            boost_kahypar::serialization::make_binary_object(
                s1,
                sizeof(s1)
            )
        );
    ...
    }
    {
        ...
        ia >> boost_kahypar::serialization::make_nvp(
            "s1",
            boost_kahypar::serialization::make_binary_object(
                s1_1,
                sizeof(s1)
