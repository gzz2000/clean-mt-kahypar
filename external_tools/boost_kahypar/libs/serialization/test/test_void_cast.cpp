...
const boost_kahypar::serialization::extended_type_info & eti(){
    return boost_kahypar::serialization::singleton<
        boost_kahypar::serialization::extended_type_info_typeid< T >
    >::get_const_instance();
}
...
test_main( int /* argc */, char* /* argv */[] )
{
    ...
    BOOST_CHECK(vpd == boost_kahypar::serialization::void_downcast(
        eti<Derived>(),
        eti<Base1>(),
        vpb1
    ));
    BOOST_CHECK(vpb1 == boost_kahypar::serialization::void_upcast(
        eti<Derived>(),
        eti<Base1>(),
        vpd
    ));
    ...
    BOOST_CHECK(vpb2 == boost_kahypar::serialization::void_upcast(
        eti<Derived>(),
        eti<Base2>(),
        vpd
    ));
    BOOST_CHECK(vpmd == boost_kahypar::serialization::void_downcast(
        eti<MostDerived>(),
        eti<Derived>(),
        vpd
    ));
    BOOST_CHECK(vpd == boost_kahypar::serialization::void_upcast(
        eti<MostDerived>(),
        eti<Derived>(),
        vpmd
    ));
    ...
    BOOST_CHECK(NULL == boost_kahypar::serialization::void_downcast(
        eti<Base2>(),
        eti<Base1>(),
        vpb1
    ));
    ...
    boost_kahypar::serialization::void_cast_register<Derived, Base1>(
        static_cast<Derived *>(NULL),
        static_cast<Base1 *>(NULL)
    );
    boost_kahypar::serialization::void_cast_register<Derived, Base2>(
        static_cast<Derived *>(NULL),
        static_cast<Base2 *>(NULL)
    );
    boost_kahypar::serialization::void_cast_register<MostDerived, Derived>(
