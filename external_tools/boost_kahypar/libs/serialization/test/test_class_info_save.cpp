...
class A
{
    ...
    void serialize(Archive & /*ar*/, const unsigned int file_version){
        ...
        BOOST_STATIC_ASSERT(0 == ::boost_kahypar::serialization::version<A>::value);
        ++count;
    }
public:
    unsigned int count;
...
BOOST_CLASS_IMPLEMENTATION(A, ::boost_kahypar::serialization::object_serializable)
BOOST_CLASS_TRACKING(A, ::boost_kahypar::serialization::track_never)
...
class B
{
    ...
    void serialize(Archive & /*ar*/, const unsigned int file_version){
        ...
        BOOST_CHECK(
            ...
            == ::boost_kahypar::serialization::version<B>::value
        );
        ++count;
    }
public:
...
BOOST_CLASS_IMPLEMENTATION(B, ::boost_kahypar::serialization::object_class_info)
BOOST_CLASS_TRACKING(B, boost_kahypar::serialization::track_always)
...
test_main( int /* argc */, char* /* argv */[] )
{
    ...
    B b;
    std::string filename;
    filename += boost_kahypar::archive::tmpdir();
    filename += '/';
