...
#include <boost_kahypar/serialization/hash_set.hpp>
...
test_hash_set(){
    ...
    ahash_set.insert(a1);
    {
        ...
        oa << boost_kahypar::serialization::make_nvp("ahash_set", ahash_set);
    }
    BOOST_STD_EXTENSION_NAMESPACE::hash_set<A> ahash_set1;
    {
        test_istream is(testfile, TEST_STREAM_FLAGS);
        test_iarchive ia(is, TEST_ARCHIVE_FLAGS);
        ia >> boost_kahypar::serialization::make_nvp("ahash_set", ahash_set1);
    }
...
test_hash_multiset(){
    ...
    ahash_multiset.insert(A());
    {
        test_ostream os(testfile, TEST_STREAM_FLAGS);
        test_oarchive oa(os, TEST_ARCHIVE_FLAGS);
        oa << boost_kahypar::serialization::make_nvp("ahash_multiset", ahash_multiset);
    }
    BOOST_STD_EXTENSION_NAMESPACE::hash_multiset<A> ahash_multiset1;
    {
        test_istream is(testfile, TEST_STREAM_FLAGS);
        test_iarchive ia(is, TEST_ARCHIVE_FLAGS);
        ia >> boost_kahypar::serialization::make_nvp("ahash_multiset", ahash_multiset1);
    }
