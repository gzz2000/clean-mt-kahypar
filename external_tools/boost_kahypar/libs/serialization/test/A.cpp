...
A::A() :
    b(true),
    #ifndef BOOST_NO_INT64_T
    f(static_cast<boost_kahypar::int64_t>(std::rand()) * static_cast<boost_kahypar::int64_t>(std::rand())),
    g(static_cast<boost_kahypar::uint64_t>(std::rand()) * static_cast<boost_kahypar::uint64_t>(std::rand())),
    #endif
