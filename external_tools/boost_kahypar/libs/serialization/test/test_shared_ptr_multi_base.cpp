...
boost_kahypar::shared_ptr<T> dynamic_pointer_cast(boost_kahypar::shared_ptr<U> const & u)
BOOST_NOEXCEPT
{
    return boost_kahypar::dynamic_pointer_cast<T>(u);
}
...
{
    bool result = true;
    result &= test<boost_kahypar::shared_ptr, boost_kahypar::weak_ptr>();
    #ifndef BOOST_NO_CXX11_SMART_PTR
