...
#include <boost_kahypar/archive/basic_binary_oprimitive.hpp>
#include <boost_kahypar/archive/detail/common_oarchive.hpp>
...
public:
    ...
    virtual const char *what( ) const throw( )
    {
        ...
        default:
            boost_kahypar::archive::archive_exception::what();
        }
        return msg;
    }
};
...
class portable_binary_oarchive :
    public boost_kahypar::archive::basic_binary_oprimitive<
        portable_binary_oarchive,
        std::ostream::char_type,
        std::ostream::traits_type
    >,
    public boost_kahypar::archive::detail::common_oarchive<
        portable_binary_oarchive
    >
{
    typedef boost_kahypar::archive::basic_binary_oprimitive<
        portable_binary_oarchive,
        std::ostream::char_type,
        std::ostream::traits_type
    > primitive_base_t;
    typedef boost_kahypar::archive::detail::common_oarchive<
        portable_binary_oarchive
    > archive_base_t;
...
public:
    ...
    friend class boost_kahypar::archive::detail::interface_oarchive<
        portable_binary_oarchive
    >;
...
protected:
    ...
    void save_impl(const boost_kahypar::intmax_t l, const char maxsize);
    ...
    typedef boost_kahypar::archive::detail::common_oarchive<portable_binary_oarchive>
    ...
    void save_override(
        const boost_kahypar::archive::class_id_optional_type & /* t */
    ){}
