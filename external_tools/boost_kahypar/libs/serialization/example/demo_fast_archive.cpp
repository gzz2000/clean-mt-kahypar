...
#include <boost_kahypar/archive/binary_oarchive_impl.hpp>
#include <boost_kahypar/archive/binary_iarchive_impl.hpp>
...
#include <boost_kahypar/archive/impl/basic_binary_oarchive.ipp>
#include <boost_kahypar/archive/impl/basic_binary_iarchive.ipp>

using namespace boost_kahypar::archive;
...
public:
#else
    friend class boost_kahypar::archive::detail::interface_oarchive<derived_t>;
    ...
    void save_override(T & t){
        ...
        BOOST_STATIC_ASSERT(! (boost_kahypar::is_array<T>::value) );
    }
    template<int N>
...
public:
#else
    friend class boost_kahypar::archive::detail::interface_iarchive<derived_t>;
