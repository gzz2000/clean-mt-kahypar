...
#include <istream>
#include <algorithm>
#include <boost_kahypar/config.hpp> // typename
...
// spirit stuff
#include <boost_kahypar/spirit/include/classic_operators.hpp>
#include <boost_kahypar/spirit/include/classic_actions.hpp>
#include <boost_kahypar/spirit/include/classic_numerics.hpp>
...
#include <boost_kahypar/archive/impl/basic_xml_grammar.hpp>
...
using namespace boost_kahypar::spirit::classic;
...
struct append_string {
    ...
    #if 0
        typedef boost_kahypar::archive::iterators::xml_unescape<Iterator> translator;
        contents.append(
...
bool basic_xml_grammar<CharType>::my_parse(
    ...
    parse_info<typename std::basic_string<CharType>::iterator> 
        result = boost_kahypar::spirit::classic::parse(arg.begin(), arg.end(), rule_);
    return result.hit;
}
