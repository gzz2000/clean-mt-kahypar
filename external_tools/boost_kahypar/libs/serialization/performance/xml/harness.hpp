...
#include <boost_kahypar/uuid/uuid.hpp>
#include <boost_kahypar/uuid/uuid_io.hpp>
#include <boost_kahypar/uuid/random_generator.hpp>
...
random (void) {
  using namespace boost_kahypar::uuids;
