...
#include <boost_kahypar/preprocessor.hpp>
...
// boost_kahypar::archive::xml::node macros
...
#define BSL_INST_BASE(Z, N, L)                                                 \
  T0 T0 ## _ ## N(BOOST_PP_ENUM_ ## Z(                                         \
    ...
    boost_kahypar::archive::xml::random<BSL_TYPE> BOOST_PP_LPAREN() BOOST_PP_RPAREN()  \
  ));                                                                          \
  /**/
...
#define BSL_TYPEDEF_NODES(Z, N, L)                                             \
  typedef boost_kahypar::archive::xml::node<                                           \
    BOOST_PP_ENUM_ ## Z(                                                       \
...
#define BSL_MAIN                                                               \
  int main (void) {                                                            \
    ...
    using namespace boost_kahypar::archive::xml;                                       \
                                                                               \
