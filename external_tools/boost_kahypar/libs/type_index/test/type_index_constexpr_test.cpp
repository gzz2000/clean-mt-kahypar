...
void strcmp_same() {
    using boost_kahypar::typeindex::detail::constexpr_strcmp;
...
void search_same() {
    using boost_kahypar::typeindex::detail::constexpr_search;
    BOOST_TEST(
...
BOOST_CXX14_CONSTEXPR bool in_namespace(const char (&ns)[N]) BOOST_NOEXCEPT {
    BOOST_CXX14_CONSTEXPR const char* name = boost_kahypar::typeindex::ctti_type_index::type_id<T>().raw_name();
...
BOOST_CXX14_CONSTEXPR bool is_boost_namespace() BOOST_NOEXCEPT {
    return in_namespace<T>("boost_kahypar::") || in_namespace<T>("class boost_kahypar::") || in_namespace<T>("struct boost_kahypar::");
}
