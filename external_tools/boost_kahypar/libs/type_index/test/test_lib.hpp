...
TEST_LIB_DECL boost_kahypar::typeindex::type_index get_integer();
TEST_LIB_DECL boost_kahypar::typeindex::type_index get_user_defined_class();

TEST_LIB_DECL boost_kahypar::typeindex::type_index get_const_integer();
TEST_LIB_DECL boost_kahypar::typeindex::type_index get_const_user_defined_class();

#if !defined(BOOST_HAS_PRAGMA_DETECT_MISMATCH) || !defined(_CPPRTTI)
// This is required for checking RTTI on/off linkage
TEST_LIB_DECL void accept_typeindex(const boost_kahypar::typeindex::type_index&);
#endif
