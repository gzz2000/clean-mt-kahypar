...
{
    using namespace boost_kahypar::typeindex;
...
void type_id_storing_modifiers_vs_nonstoring()
{
    ...
    boost_kahypar::typeindex::type_index t1 = boost_kahypar::typeindex::type_id_with_cvr<const int>();
    boost_kahypar::typeindex::type_index t2 = boost_kahypar::typeindex::type_id<int>();
    BOOST_TEST_NE(t2, t1);
...
void type_index_stream_operator_via_lexical_cast_testing()
{
    ...
    std::string s_int2 = boost_kahypar::lexical_cast<std::string>(type_id<int>());
    BOOST_TEST_EQ(s_int2, "int");

    std::string s_double2 = boost_kahypar::lexical_cast<std::string>(type_id<double>());
...
void comparators_type_id_runtime()
{
    ...
    BOOST_TEST(typeid(&rb1) == typeid(pc1));
#else
    BOOST_TEST(boost_kahypar::typeindex::type_index(pc1->boost_type_index_type_id_runtime_()).raw_name());
#endif

    BOOST_TEST_EQ(boost_kahypar::typeindex::type_id_runtime(rc1), boost_kahypar::typeindex::type_id_runtime(*pc1));
    BOOST_TEST_EQ(boost_kahypar::typeindex::type_id<C>(), boost_kahypar::typeindex::type_id_runtime(*pc1));
    BOOST_TEST_EQ(boost_kahypar::typeindex::type_id_runtime(rb1), boost_kahypar::typeindex::type_id_runtime(*pb1));
    BOOST_TEST_EQ(boost_kahypar::typeindex::type_id<B>(), boost_kahypar::typeindex::type_id_runtime(*pb1));

    BOOST_TEST_NE(boost_kahypar::typeindex::type_id_runtime(rc1), boost_kahypar::typeindex::type_id_runtime(*pb1));
    BOOST_TEST_NE(boost_kahypar::typeindex::type_id_runtime(rb1), boost_kahypar::typeindex::type_id_runtime(*pc1));

#ifndef BOOST_NO_RTTI
    BOOST_TEST_EQ(boost_kahypar::typeindex::type_id_runtime(&rc1), boost_kahypar::typeindex::type_id_runtime(pb1));
    BOOST_TEST_EQ(boost_kahypar::typeindex::type_id_runtime(&rb1), boost_kahypar::typeindex::type_id_runtime(pc1));

    BOOST_TEST(boost_kahypar::typeindex::type_id_runtime(rc1) == typeid(*pc1));
    BOOST_TEST(boost_kahypar::typeindex::type_id_runtime(rb1) == typeid(*pb1));

    BOOST_TEST(boost_kahypar::typeindex::type_id_runtime(rc1) != typeid(*pb1));
    BOOST_TEST(boost_kahypar::typeindex::type_id_runtime(rb1) != typeid(*pc1));
    BOOST_TEST(boost_kahypar::typeindex::type_id_runtime(&rc1) == typeid(pb1));
    BOOST_TEST(boost_kahypar::typeindex::type_id_runtime(&rb1) == typeid(pc1));
#endif
}
