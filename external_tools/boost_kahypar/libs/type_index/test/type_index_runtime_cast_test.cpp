...
// #include <boost_kahypar/type_index/runtime_cast.hpp>
// #include <boost_kahypar/type_index/runtime_reference_cast.hpp>

#include <boost_kahypar/type_index/runtime_cast.hpp>
#include <boost_kahypar/type_index/runtime_cast/boost_shared_ptr_cast.hpp>
#include <boost_kahypar/smart_ptr/make_shared.hpp>

#include <boost_kahypar/core/lightweight_test.hpp>

#if !defined(BOOST_NO_CXX11_SMART_PTR)
#  include <boost_kahypar/type_index/runtime_cast/std_shared_ptr_cast.hpp>
#endif
...
void reference_interface()
{
    ...
    catch(boost_kahypar::typeindex::bad_runtime_cast&) {
    }
    catch(...) {
        BOOST_TEST(!"should throw bad_runtime_cast");
    }
...
{
    using namespace boost_kahypar::typeindex;
    boost_kahypar::shared_ptr<single_derived> d = boost_kahypar::make_shared<single_derived>();
    boost_kahypar::shared_ptr<base> b = d;
    boost_kahypar::shared_ptr<single_derived> d2 = runtime_pointer_cast<single_derived>(b);
    BOOST_TEST_NE(d2, boost_kahypar::shared_ptr<single_derived>());
    BOOST_TEST_EQ(d2->name, "single_derived");
}
