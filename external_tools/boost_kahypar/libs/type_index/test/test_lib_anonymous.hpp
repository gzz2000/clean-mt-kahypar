...
TEST_LIB_DECL boost_kahypar::typeindex::type_index get_anonymous_user_defined_class();
TEST_LIB_DECL boost_kahypar::typeindex::type_index get_const_anonymous_user_defined_class();
