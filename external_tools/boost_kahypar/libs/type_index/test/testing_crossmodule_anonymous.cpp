...
{
    boost_kahypar::typeindex::type_index t_const_userdef = boost_kahypar::typeindex::type_id_with_cvr<const user_defined>();
    boost_kahypar::typeindex::type_index t_userdef = boost_kahypar::typeindex::type_id<user_defined>();
