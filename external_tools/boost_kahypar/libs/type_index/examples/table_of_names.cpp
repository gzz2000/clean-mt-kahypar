...
void print(const char* name) {
    boost_kahypar::typeindex::stl_type_index sti = boost_kahypar::typeindex::stl_type_index::type_id<T>();
    boost_kahypar::typeindex::ctti_type_index cti = boost_kahypar::typeindex::ctti_type_index::type_id<T>();
