...
int main() {
    ...
    if(C* cp = boost_kahypar::typeindex::runtime_cast<C*>(a)) {
    ...
    if(E* ce = boost_kahypar::typeindex::runtime_cast<E*>(a)) {
    ...
    E e;
    C* cp2 = &e;
    if(D* dp = boost_kahypar::typeindex::runtime_cast<D*>(cp2)) {
...
*/
    A* ap = &e;
    if(B* bp = boost_kahypar::typeindex::runtime_pointer_cast<B>(ap)) {
