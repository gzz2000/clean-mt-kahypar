...
/*`
    ...
    take a look at the `<boost_kahypar/type_index/ctti_type_index.hpp>` or `<boost_kahypar/type_index/stl_type_index.hpp>`
...
/*`
    ...
    `<boost_kahypar/container_hash/hash.hpp>`.
*/
...
class my_type_index: public boost_kahypar::typeindex::type_index_facade<my_type_index, detail::my_typeinfo> {
...
/*`
    Note that we have used the boost_kahypar::typeindex::type_index_facade class as base.
