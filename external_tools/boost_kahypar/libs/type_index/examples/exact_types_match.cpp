...
class type_erased_unary_function {
    void*                           function_ptr_;
    boost_kahypar::typeindex::type_index    exact_param_t_;
...
public:
    ...
    type_erased_unary_function(void(*ptr)(ParamT)) 
        ...
        , exact_param_t_(boost_kahypar::typeindex::type_id_with_cvr<ParamT>())
    {}

    template <class ParamT>
    void call(ParamT v) {
        if (exact_param_t_ != boost_kahypar::typeindex::type_id_with_cvr<ParamT>()) {
