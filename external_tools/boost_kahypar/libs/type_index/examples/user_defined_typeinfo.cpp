...
/*`
    There is an easy way to force `boost_kahypar::typeindex::type_id` to use your own type_index class.

    All we need to do is just define `BOOST_TYPE_INDEX_USER_TYPEINDEX` to the full path to header file
    of your type index class:
*/

// BOOST_TYPE_INDEX_USER_TYPEINDEX must be defined *BEFORE* first inclusion of <boost_kahypar/type_index.hpp>
#define BOOST_TYPE_INDEX_USER_TYPEINDEX <boost_kahypar/../libs/type_index/examples/user_defined_typeinfo.hpp>
...
*/
    boost_kahypar::typeindex::type_index worldwide = boost_kahypar::typeindex::type_id<my_classes>();
