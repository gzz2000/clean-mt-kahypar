...
{
    std::string s;
    s = boost_kahypar::any_cast<std::string>(returning_string1());
    s = boost_kahypar::any_cast<const std::string&>(returning_string1());

    s = boost_kahypar::any_cast<std::string>(returning_string2());
    s = boost_kahypar::any_cast<const std::string&>(returning_string2());
...
int main() {
    ...
    return any_tests::basic_tests<boost_kahypar::any>::run_tests();
}
