...
void test_move_construct_unique_ptr() {
    ...
    boost_kahypar::anys::unique_any a = std::move(ptr);
    BOOST_TEST(!ptr);
    BOOST_TEST(a.has_value());
    BOOST_TEST_EQ(boost_kahypar::any_cast<std::unique_ptr<int>&>(a).get(), raw_ptr);
}
...
void test_move_construct_unique_any() {
    ...
    BOOST_TEST(!a.has_value());
    BOOST_TEST_EQ(boost_kahypar::any_cast<std::unique_ptr<int>&>(b).get(), raw_ptr);
}
...
void test_move_any_cast_implicit() {
    ...
    boost_kahypar::anys::unique_any a = std::move(ptr);
    auto new_ptr = boost_kahypar::any_cast<std::unique_ptr<int>>(std::move(a));
