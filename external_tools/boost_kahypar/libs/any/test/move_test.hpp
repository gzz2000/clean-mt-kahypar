...
struct move_tests // test definitions
{
    static void test_move_construction()
    {
        ...
        BOOST_TEST(value.type() == boost_kahypar::typeindex::type_id<move_copy_conting_class>());
        BOOST_TEST(boost_kahypar::any_cast<move_copy_conting_class>(&value));
    ...
    static void test_cast_to_rv()
    {
        ...
        move_copy_conting_class value1 = boost_kahypar::any_cast<move_copy_conting_class&&>(value);
        ...
        move_copy_conting_class value2 = boost_kahypar::any_cast<const move_copy_conting_class&>(cvalue);
