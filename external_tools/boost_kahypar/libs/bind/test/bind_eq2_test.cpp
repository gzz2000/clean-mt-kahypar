...
//
//  bind_eq2_test.cpp - boost_kahypar::bind equality operator
//
...
int main()
{
    ...
    test_self_equal( boost_kahypar::bind( g, _1 ) );
    test_self_equal( boost_kahypar::bind( f, boost_kahypar::bind( g, _1 ) ) );
