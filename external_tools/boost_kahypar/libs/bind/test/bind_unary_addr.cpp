...
int main()
{
    test( boost_kahypar::bind<void>( X() ) );
    test( boost_kahypar::bind<void>( X(), 1 ) );
    test( boost_kahypar::bind<void>( X(), 1, 2 ) );
    test( boost_kahypar::bind<void>( X(), 1, 2, 3 ) );
    test( boost_kahypar::bind<void>( X(), 1, 2, 3, 4 ) );
    test( boost_kahypar::bind<void>( X(), 1, 2, 3, 4, 5 ) );
    test( boost_kahypar::bind<void>( X(), 1, 2, 3, 4, 5, 6 ) );
    test( boost_kahypar::bind<void>( X(), 1, 2, 3, 4, 5, 6, 7 ) );
    test( boost_kahypar::bind<void>( X(), 1, 2, 3, 4, 5, 6, 7, 8 ) );
    test( boost_kahypar::bind<void>( X(), 1, 2, 3, 4, 5, 6, 7, 8, 9 ) );
