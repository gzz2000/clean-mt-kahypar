...
//[identity_typeof
#include <boost_kahypar/typeof/std/string.hpp> // No need to register `boost_kahypar::function`.
//]
...
boost_kahypar::function<double (double)> identity_d = identity_d_impl; // Functor.
//]
