...
#include <boost_kahypar/unordered/unordered_flat_map.hpp>
#ifdef HAVE_ABSEIL
...
static void init_words()
{
    ...
    boost_kahypar::regex re( "[a-zA-Z]+");
    boost_kahypar::sregex_token_iterator it( in.begin(), in.end(), re, 0 ), end;
...
template<class Hash> BOOST_NOINLINE void test( char const* label )
{
    ...
    boost_kahypar::unordered_flat_map<std::string_view, std::size_t, Hash> map;
...
int main()
{
    ...
    test< boost_kahypar::hash<std::string_view> >( "boost_kahypar::hash" );
