...
struct Y2
{
    ...
    template<class T> friend
        typename boost_kahypar::enable_if_<boost_kahypar::is_same<T, Y2>::value, std::size_t>::type
        hash_value( T const& v )
    {
        std::size_t seed = 0;

        boost_kahypar::hash_combine( seed, v.a );
        boost_kahypar::hash_combine( seed, v.b );
...
namespace container_hash
{
    ...
    template<> struct is_tuple_like<user::Y2>: boost_kahypar::false_type {};
