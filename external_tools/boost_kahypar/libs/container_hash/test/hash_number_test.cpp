...
void numeric_extra_tests(typename
    boost_kahypar::enable_if_c<boost_kahypar::hash_detail::limits<T>::is_integer,
        void*>::type = 0)
{
    typedef boost_kahypar::hash_detail::limits<T> limits;

    if(limits::is_signed ||
        limits::digits <= boost_kahypar::hash_detail::limits<std::size_t>::digits)
    {
...
template <class T>
void numeric_extra_tests(typename
    boost_kahypar::disable_if_c<boost_kahypar::hash_detail::limits<T>::is_integer,
        void*>::type = 0)
{
}
...
int main()
{
    ...
    NUMERIC_TEST_NO_LIMITS(boost_kahypar::long_long_type, long_long)
    NUMERIC_TEST_NO_LIMITS(boost_kahypar::ulong_long_type, ulong_long)
#endif

#if defined(BOOST_HAS_INT128)
    NUMERIC_TEST_NO_LIMITS(boost_kahypar::int128_type, int128)
    NUMERIC_TEST_NO_LIMITS(boost_kahypar::uint128_type, uint128)
#endif
