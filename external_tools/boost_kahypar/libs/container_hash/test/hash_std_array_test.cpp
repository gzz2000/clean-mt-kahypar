...
void array_tests(T const& v) {
    boost_kahypar::hash<typename T::value_type> hf;
...
/*
    boost_kahypar::hash<std::array<int, 0> > empty_array_hash;
    std::array<int, 0> empty_array;
    BOOST_TEST(empty_array_hash(empty_array) == boost_kahypar::hash_value(empty_array));
*/
}
