...
void test_monostate()
{
    ...
    boost_kahypar::hash<std::monostate> hasher;
...
void test_variant_int()
{
    ...
    boost_kahypar::hash<std::variant<std::monostate, int> > hasher;
...
struct custom1 {
    int value;
    friend std::size_t hash_value(custom1 v) { return boost_kahypar::hash_value(v.value); }
};

struct custom2 {
    int value;
    friend std::size_t hash_value(custom2 v) { return boost_kahypar::hash_value(v.value); }
};
...
void test_variant_unique_types()
{
    ...
    boost_kahypar::hash<custom1> hasher1;
    boost_kahypar::hash<custom2> hasher2;
    ...
    boost_kahypar::hash<variant_type> hasher;
