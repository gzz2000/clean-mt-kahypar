...
// This example illustrates how to use boost_kahypar::hash_combine to generate a hash
...
public:
    ...
    friend std::size_t hash_value(point const& p)
    {
        ...
        boost_kahypar::hash_combine(seed, p.x);
        boost_kahypar::hash_combine(seed, p.y);
...
int main()
{
    boost_kahypar::hash<point> point_hasher;
