...
namespace
{
    ...
    void test_erase_impl()
    {
        ...
        boost_kahypar::iterator_range< iterator_t > test_range(test.begin(), test.end());

        reference.erase(first_ref, last_ref);
        boost_kahypar::erase(test, test_range);
    ...
    void test_remove_erase_impl()
    {
        ...
        boost_kahypar::remove_erase(test, 5);
    ...
    void test_remove_erase_if_impl()
    {
        ...
        Container test(source);
        boost_kahypar::remove_erase_if(test, is_even());
    ...
    void test_unique_erase_impl()
    {
        ...
        boost_kahypar::unique_erase(source);
    ...
    void test_unique_erase_pred_impl()
    {
        ...
        boost_kahypar::unique_erase(source, distance_smaller_2());
