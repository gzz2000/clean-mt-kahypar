...
namespace mock_std
{
    ...
    inline BOOST_DEDUCED_TYPENAME boost_kahypar::range_iterator<SinglePassRange>::type
    ...
    template<class SinglePassRange>
    inline BOOST_DEDUCED_TYPENAME boost_kahypar::range_iterator<const SinglePassRange>::type
...
namespace
{
    ...
    {
        boost_kahypar::MockTestBeginCollection c;
        const boost_kahypar::MockTestBeginCollection& const_c = c;
...
{
    boost_kahypar::unit_test::test_suite* test = BOOST_TEST_SUITE( "Range Test Suite - begin() ADL namespace barrier" );
