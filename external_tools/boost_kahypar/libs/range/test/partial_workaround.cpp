...
void check_partial_workaround()
{
    ...
    BOOST_STATIC_ASSERT(( boost_kahypar::is_same< boost_kahypar::range_detail::std_container_, 
                          boost_kahypar::range_detail::range< vector<int> >::type >::value ));
    BOOST_STATIC_ASSERT(( boost_kahypar::is_same< boost_kahypar::range_detail::std_pair_, 
                          boost_kahypar::range_detail::range< pair<int,int> >::type >::value ));
    BOOST_STATIC_ASSERT(( boost_kahypar::is_same< boost_kahypar::range_detail::array_, 
                          boost_kahypar::range_detail::range< int[42] >::type >::value ));
    BOOST_STATIC_ASSERT(( boost_kahypar::is_same< boost_kahypar::range_detail::char_ptr_, 
                          boost_kahypar::range_detail::range< char* >::type >::value ));
    BOOST_STATIC_ASSERT(( boost_kahypar::is_same< boost_kahypar::range_detail::const_char_ptr_, 
                          boost_kahypar::range_detail::range< const char* >::type >::value ));
    BOOST_STATIC_ASSERT(( boost_kahypar::is_same< boost_kahypar::range_detail::wchar_t_ptr_, 
                          boost_kahypar::range_detail::range< wchar_t* >::type >::value ));
    BOOST_STATIC_ASSERT(( boost_kahypar::is_same< boost_kahypar::range_detail::const_wchar_t_ptr_,
                          boost_kahypar::range_detail::range< const wchar_t* >::type >::value ));
    BOOST_STATIC_ASSERT(( boost_kahypar::is_same< boost_kahypar::range_detail::std_container_, 
                          boost_kahypar::range_detail::range< vector<int> >::type >::value ));
...
void check_partial_workaround()
{
    ...
    //
    std::size_t s = boost_kahypar::range_detail::array_size( "foo" );
