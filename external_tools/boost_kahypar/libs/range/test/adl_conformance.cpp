...
// to allow the test framework to use boost_kahypar::begin() etc. without
// violating the One Defintion Rule.
namespace boost_kahypar_test
{
...
void check_adl_conformance()
{
    ...
    BOOST_CHECK( boost_kahypar_test::begin( r )  != boost_namespace );
    BOOST_CHECK( boost_kahypar_test::begin( r2 ) != boost_namespace );
    BOOST_CHECK( boost_kahypar_test::begin( r3 ) != boost_namespace );
    BOOST_CHECK( boost_kahypar_test::begin( r4 ) != boost_namespace );
    BOOST_CHECK( boost_kahypar_test::begin( r5 ) != boost_namespace );
    BOOST_CHECK( boost_kahypar_test::begin( r6 ) != boost_namespace );

    BOOST_CHECK_EQUAL( boost_kahypar_test::begin( r ), templated_namespace ) ;
    BOOST_CHECK_EQUAL( boost_kahypar_test::begin( r2 ), templated_namespace );
    BOOST_CHECK_EQUAL( boost_kahypar_test::begin( r3 ), non_templated_namespace );
    BOOST_CHECK_EQUAL( boost_kahypar_test::begin( r4 ), non_templated_namespace );
    BOOST_CHECK_EQUAL( boost_kahypar_test::begin( r5 ), global_namespace );
    BOOST_CHECK_EQUAL( boost_kahypar_test::begin( r6 ), global_namespace );
}
