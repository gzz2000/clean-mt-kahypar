...
namespace
{
    ...
    {
        boost_kahypar::MockTestEndCollection c;
        const boost_kahypar::MockTestEndCollection& const_c = c;
...
{
    boost_kahypar::unit_test::test_suite* test = BOOST_TEST_SUITE( "Range Test Suite - end() ADL namespace barrier" );
