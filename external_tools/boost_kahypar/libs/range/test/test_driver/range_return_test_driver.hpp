    ...
    namespace range_test
    {
        ...
        struct check_results<return_begin_found>
        {
                ...
                )
            {
                ...
                BOOST_CHECK_EQUAL_COLLECTIONS(
                    ...
                    boost_kahypar::begin(test_rng), boost_kahypar::end(test_rng)
                    );
            }
        };
        ...
        struct check_results<return_begin_next>
        {
                ...
                )
            {
                ...
                {
                    BOOST_CHECK_EQUAL_COLLECTIONS(
                        reference.begin(), boost_kahypar::next(reference_it),
        ...
        struct check_results<return_begin_prior>
        {
                ...
                )
            {
                ...
                if (reference_it == reference.begin())
                {
                    BOOST_CHECK( boost_kahypar::end(test_rng) == test.begin() );
                }
                else
                {
                    BOOST_CHECK_EQUAL( std::distance(boost_kahypar::begin(test_rng), boost_kahypar::end(test_rng)) + 1,
                                       std::distance(reference.begin(), reference_it) );
                }
            }
        };
        ...
        struct check_results<return_found_end>
        {
                ...
                )
            {
                ...
                BOOST_CHECK_EQUAL(
                    std::distance(test.begin(), boost_kahypar::begin(test_rng)),
                    std::distance(reference.begin(), reference_it));

                BOOST_CHECK( boost_kahypar::end(test_rng) == test.end() );
            }
        };
        ...
        struct check_results<return_next_end>
        {
                ...
                )
            {
                ...
                {
                    BOOST_CHECK_EQUAL_COLLECTIONS(
                        boost_kahypar::next(reference_it), reference.end(),
                        test_rng.begin(), test_rng.end()
                        );
                }
            }
        ...
        struct check_results<return_prior_end>
        {
                ...
                )
            {
                ...
                {
                    BOOST_CHECK_EQUAL_COLLECTIONS(
                        boost_kahypar::prior(reference_it), reference.end(),
                        test_rng.begin(), test_rng.end()
                        );
                }
            }
