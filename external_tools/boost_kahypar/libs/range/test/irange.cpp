...
namespace boost_kahypar
{
    ...
    void test_irange_impl(Integer last)
    {
        ...
        boost_kahypar::push_back(test, boost_kahypar::irange(last));
    ...
    void test_irange_impl(Integer first, Integer last)
    {
        ...
        std::vector<Integer> test;
        boost_kahypar::push_back(test, boost_kahypar::irange(first, last));
    ...
    void test_irange_impl(IntegerInput first, IntegerInput last, int step)
    {
        ...
        std::vector<Integer> test;
        boost_kahypar::push_back(test, boost_kahypar::irange(first, last, step));
...
init_unit_test_suite(int argc, char* argv[])
{
    ...
    test->add(BOOST_TEST_CASE( &boost_kahypar::irange_unit_test ));
