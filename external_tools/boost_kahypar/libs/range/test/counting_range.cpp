...
#include <boost_kahypar/range/counting_range.hpp>
...
namespace boost_kahypar
{
    namespace
    {
        ...
        void counting_range_test_range()
        {
            ...
            std::vector<int> t;
            push_back(t, x | boost_kahypar::adaptors::indirected);
...
init_unit_test_suite(int argc, char* argv[])
{
    ...
    test->add( BOOST_TEST_CASE( &boost_kahypar::counting_range_test ) );
