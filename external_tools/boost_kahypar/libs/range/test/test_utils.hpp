...
{
    BOOST_RANGE_CONCEPT_ASSERT(( boost_kahypar::RandomAccessRangeConcept<RandomAccessRng> ));
}

template <class BidirectionalRng>
void check_bidirectional_range_concept(const BidirectionalRng& rng)
{
    BOOST_RANGE_CONCEPT_ASSERT(( boost_kahypar::BidirectionalRangeConcept<BidirectionalRng> ));
}
