...
#include <boost_kahypar/range/mfc.hpp> // can be placed first
...
{
    typedef typename boost_kahypar::range_iterator<MfcMapT>::type iter_t;
...
void test_CTypedPtrArray()
{
    ...
    boost_kahypar::function_requires< boost_kahypar::RandomAccessRangeConcept<rng_t> >();

    rng_t rng;
    int o1, o2, o3, o4, o5;
    int *data[] = { &o1, &o2, &o3, &o4, &o5 };
    BOOST_CHECK( brdm::test_init_array(rng, boost_kahypar::make_iterator_range(data, data+5)) );

    BOOST_CHECK( *(boost_kahypar::begin(rng) + 2) == &o3 );
    BOOST_CHECK( *(boost_kahypar::end(rng) - 1) == &o5 );        
...
void test_CTypedPtrList()
{
    ...
    boost_kahypar::range_iterator<rng_t>::type it = boost_kahypar::begin(rng);
    std::advance(it, 1);
    BOOST_CHECK( *it == &o2 );
    std::advance(it, 2);
    BOOST_CHECK( *it == &o4 );
...
void test_mfc()
{
    ...
    //
    {
        ...
        BOOST_FOREACH (CList<CString> *theList, myArray)
        {
            ...
            {
                boost_kahypar::to_upper(str);
                std::sort(boost_kahypar::begin(str), boost_kahypar::end(str));
                // ...
            }
        }
    }
    ...
    //
    {
        ...
        ::test_CByteArray(boost_kahypar::make_iterator_range(data, data+22));
    }

    {
        DWORD data[] = { 4,5,1,3,5,12,3,1,3,1,6,1,3,60,1,1,5,1,3,1,10 };

        test_CDWordArray(boost_kahypar::make_iterator_range(data, data+22));
    }

    {
        ...
        ::test_CObArray(boost_kahypar::make_iterator_range(data, data+5));
    }

    {
        ...
        ::test_CPtrArray(boost_kahypar::make_iterator_range(data, data+5));
    }

    {
        ...
        ::test_CStringArray(boost_kahypar::make_iterator_range(data, data+8));
    }

    {
        ...
        ::test_CUIntArray(boost_kahypar::make_iterator_range(data, data+22));
    }

    {
        ...
        ::test_CWordArray(boost_kahypar::make_iterator_range(data, data+22));
    }
    ...
    //
    {
        ...
        ::test_CObList(boost_kahypar::make_iterator_range(data, data+5));
    }

    {
        ...
        ::test_CPtrList(boost_kahypar::make_iterator_range(data, data+5));
    }

    {
        ...
        ::test_CStringList(boost_kahypar::make_iterator_range(data, data+8));
    }
