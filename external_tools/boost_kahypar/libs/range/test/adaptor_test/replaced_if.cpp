...
//
#include <boost_kahypar/range/adaptor/replaced_if.hpp>
...
namespace boost_kahypar
{
    namespace
    {
        ...
        void replaced_if_test_impl( Container& c )
        {
            ...
            boost_kahypar::push_back(test_result1, c | replaced_if(pred, replacement_value));

            std::vector< int > test_result2;
            boost_kahypar::push_back(test_result2, boost_kahypar::adaptors::replace_if(c, pred, replacement_value));
...
init_unit_test_suite(int argc, char* argv[])
{
    ...
    test->add( BOOST_TEST_CASE( &boost_kahypar::replaced_if_test ) );
