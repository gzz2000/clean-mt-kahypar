...
void mix_values()
{
    mix_values_driver<boost_kahypar::single_pass_traversal_tag >();
    mix_values_driver<boost_kahypar::forward_traversal_tag >();
    mix_values_driver<boost_kahypar::bidirectional_traversal_tag >();
    mix_values_driver<boost_kahypar::random_access_traversal_tag >();
}
...
init_unit_test_suite(int, char*[])
{
    ...
    test->add(BOOST_TEST_CASE(
            &boost_kahypar_range_adaptor_type_erased_test::mix_values));
