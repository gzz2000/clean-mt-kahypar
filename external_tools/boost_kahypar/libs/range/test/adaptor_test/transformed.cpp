...
namespace boost_kahypar
{
    namespace
    {
        ...
        void transformed_test_impl_core( Container& c, TransformFn fn )
        {
            ...
            boost_kahypar::push_back(test_result1, c | transformed(fn));

            std::vector< int > test_result2;
            boost_kahypar::push_back(test_result2, adaptors::transform(c, fn));
        ...
        void transformed_bind()
        {
            ...
            boost_kahypar::range::push_back(
                    output,
                    input | transformed(boost_kahypar::bind(&foo_bind::foo, _1)));
...
init_unit_test_suite(int argc, char* argv[])
{
    ...
    test->add(BOOST_TEST_CASE(&boost_kahypar::transformed_test));
    test->add(BOOST_TEST_CASE(&boost_kahypar::transformed_bind));
