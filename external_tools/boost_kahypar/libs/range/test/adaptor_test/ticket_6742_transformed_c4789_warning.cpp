...
//
#include <boost_kahypar/phoenix/core.hpp>
#include <boost_kahypar/phoenix/operator.hpp>
...
namespace
{
    ...
    {
        using namespace boost_kahypar::boost_kahyparphoenix::arg_names;
        ...
        boost_kahypar::push_back(output1, v | transformed((&arg1)->*& test_struct::x));

        std::vector<double> output2;
        boost_kahypar::push_back(output2, v | transformed(get_x()));
