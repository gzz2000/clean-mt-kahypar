...
namespace boost_kahypar
{
    namespace
    {
        ...
        void filtered_test_impl( Container& c, Pred pred )
        {
            ...
            boost_kahypar::push_back(test_result1, c | filtered(pred));

            // This is an alternative syntax preferred by some.
            std::vector< value_t > test_result2;
            boost_kahypar::push_back(test_result2, adaptors::filter(c, pred));
        ...
        void ticket_10988_single_pass()
        {
            ...
            boost_kahypar::push_back(v,
                boost_kahypar::make_iterator_range(
                    std::istream_iterator<int>(in),
                    std::istream_iterator<int>())
                | boost_kahypar::adaptors::filtered(is_even()));
...
init_unit_test_suite(int argc, char* argv[])
{
    ...
    test->add( BOOST_TEST_CASE( &boost_kahypar::filtered_test ) );
