...
namespace boost_kahypar
{
    namespace
    {
        ...
        void indirected_test_impl( Container& c )
        {
            ...
            boost_kahypar::push_back(test_result1, c | indirected);

            // This is an alternative syntax preferred by some.
            std::vector< int > test_result2;
            boost_kahypar::push_back(test_result2, adaptors::indirect(c));
        ...
        void indirected_test_impl()
        {
            ...
            c += boost_kahypar::shared_ptr<int>(new int(1));
            indirected_test_impl(c);
            ...
            {
                c += boost_kahypar::shared_ptr<int>(new int(*it));
            }
            indirected_test_impl(c);
        }
        ...
        {
            indirected_test_impl< std::vector< boost_kahypar::shared_ptr< int > > >();
        }
    }
}
...
init_unit_test_suite(int argc, char* argv[])
{
    ...
    test->add( BOOST_TEST_CASE( &boost_kahypar::indirected_test ) );
