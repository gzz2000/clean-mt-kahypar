...
void test_difference()
{
    ...
    BOOST_STATIC_ASSERT((
        boost_kahypar::is_same<
            ...
            boost_kahypar::range_difference<cont>::type
        >::value));

    BOOST_STATIC_ASSERT((
        boost_kahypar::is_same<
            cont::difference_type,
            boost_kahypar::range_difference<const cont>::type
        >::value));
...
boost_kahypar::unit_test::test_suite* init_unit_test_suite( int argc, char* argv[] )
{
    ...
    test->add(BOOST_TEST_CASE(&boost_kahypar_range_test::test_difference));
