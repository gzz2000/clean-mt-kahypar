...
#include <boost_kahypar/range/reverse_result_iterator.hpp>
...
void test_reverse_result_iterator()
{
    ...
    BOOST_STATIC_ASSERT((
        boost_kahypar::is_same<
            boost_kahypar::reverse_iterator<cont::iterator>,
            boost_kahypar::range_reverse_result_iterator<cont>::type
        >::value));

    BOOST_STATIC_ASSERT((
        boost_kahypar::is_same<
            boost_kahypar::reverse_iterator<cont::const_iterator>,
            boost_kahypar::range_reverse_result_iterator<const cont>::type
        >::value));
...
boost_kahypar::unit_test::test_suite* init_unit_test_suite( int argc, char* argv[] )
{
    ...
    test->add(BOOST_TEST_CASE(&boost_kahypar_range_test::test_reverse_result_iterator));
