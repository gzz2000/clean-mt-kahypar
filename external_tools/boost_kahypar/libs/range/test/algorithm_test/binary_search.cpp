...
namespace boost_kahypar
{
    namespace
    {
        ...
        void test(Container& cont)
        {
            ...
            bool test_result = boost_kahypar::binary_search(test, 5);

            BOOST_CHECK( reference_result == test_result );

            BOOST_CHECK( test_result == boost_kahypar::binary_search(boost_kahypar::make_iterator_range(test), 5) );
        ...
        void test_pred(Container& cont, BinaryPredicate pred)
        {
            ...
            bool test_result = boost_kahypar::binary_search(test, 5, pred);

            BOOST_CHECK( test_result == boost_kahypar::binary_search(boost_kahypar::make_iterator_range(test), 5, pred) );
...
init_unit_test_suite(int argc, char* argv[])
{
    ...
    test->add( BOOST_TEST_CASE( &boost_kahypar::test_binary_search ) );
