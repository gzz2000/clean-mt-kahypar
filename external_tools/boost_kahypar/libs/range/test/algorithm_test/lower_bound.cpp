...
namespace boost_kahypar_range_test_algorithm_lower_bound
{
    ...
    public:
        ...
        test_iter(Container& cont)
        {
            ...
            iter_t result = boost_kahypar::lower_bound(cont, 5);
            BOOST_CHECK( result == boost_kahypar::lower_bound(boost_kahypar::make_iterator_range(cont), 5) );
            return result;
        }
        ...
        struct test_range
        {
            ...
            operator()(Policy&, Container& cont)
            {
                ...
                result_t result = boost_kahypar::lower_bound<return_type>(cont, 5);
                BOOST_CHECK( result == boost_kahypar::lower_bound<return_type>(boost_kahypar::make_iterator_range(cont), 5) );
                return result;
            }
        };
    ...
    struct lower_bound_pred_policy
    {
        ...
        {
            typedef BOOST_DEDUCED_TYPENAME boost_kahypar::range_iterator<Container>::type iter_t;
            iter_t result = boost_kahypar::lower_bound(cont, 5, m_pred);
            BOOST_CHECK( result == boost_kahypar::lower_bound(
                                    boost_kahypar::make_iterator_range(cont), 5, m_pred) );
            return result;
        }
        ...
        struct test_range
        {
            ...
            {
                typedef BOOST_DEDUCED_TYPENAME boost_kahypar::range_return<Container,return_type>::type result_t;
                result_t result = boost_kahypar::lower_bound<return_type>(cont, 5, policy.pred());
                BOOST_CHECK( result == boost_kahypar::lower_bound<return_type>(
...
init_unit_test_suite(int argc, char* argv[])
{
    ...
    test->add( BOOST_TEST_CASE( &boost_kahypar_range_test_algorithm_lower_bound::test_lower_bound ) );
