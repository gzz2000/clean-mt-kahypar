...
namespace boost_kahypar
{
    namespace
    {
        ...
        void test(Container& cont)
        {
            ...
            pair_t test_result = boost_kahypar::equal_range(test, 5);

            check_result(reference, reference_result, test, test_result);

            pair_t test_result2 = boost_kahypar::equal_range(boost_kahypar::make_iterator_range(test), 5);
        ...
        void test_pred(Container& cont, BinaryPredicate pred)
        {
            ...
            pair_t test_result = boost_kahypar::equal_range(test, 5, BinaryPredicate());

            check_result(reference, reference_result, test, test_result);

            pair_t test_result2 = boost_kahypar::equal_range(boost_kahypar::make_iterator_range(test), 5, BinaryPredicate());
...
init_unit_test_suite(int argc, char* argv[])
{
    ...
    test->add( BOOST_TEST_CASE( &boost_kahypar::test_equal_range ) );
