...
namespace boost_kahypar_range_test_algorithm_max_element
{
    ...
    public:
        ...
        test_iter(Container& cont)
        {
            ...
            iter_t result = boost_kahypar::max_element(cont);
            BOOST_CHECK( result == boost_kahypar::max_element(
                                        boost_kahypar::make_iterator_range(cont)) );
            return result;
        }
        ...
        struct test_range
        {
            ...
            operator()(Policy&, Container& cont)
            {
                ...
                result_t result = boost_kahypar::max_element<return_type>(cont);
                BOOST_CHECK( result == boost_kahypar::max_element<return_type>(
                                            boost_kahypar::make_iterator_range(cont)) );
                return result;
            }
        };
    ...
    public:
        ...
        {
            typedef BOOST_DEDUCED_TYPENAME boost_kahypar::range_iterator<Container>::type iter_t;
            iter_t result = boost_kahypar::max_element(cont, Pred());
            BOOST_CHECK( result == boost_kahypar::max_element(
        ...
        struct test_range
        {
            ...
            {
                typedef BOOST_DEDUCED_TYPENAME boost_kahypar::range_return<Container,return_type>::type result_t;
                result_t result = boost_kahypar::max_element<return_type>(cont, policy.pred());
                BOOST_CHECK( result == boost_kahypar::max_element<return_type>(
...
init_unit_test_suite(int argc, char* argv[])
{
    ...
    test->add( BOOST_TEST_CASE( &boost_kahypar_range_test_algorithm_max_element::test_max_element ) );
