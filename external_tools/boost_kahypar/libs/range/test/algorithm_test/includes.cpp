...
namespace boost_kahypar
{
    namespace
    {
        ...
        void test(Container1& cont1, Container2& cont2)
        {
            ...
            bool test_result = boost_kahypar::includes(cont1, cont2);
            ...
            BOOST_CHECK( test_result == boost_kahypar::includes(boost_kahypar::make_iterator_range(cont1), cont2) );
            BOOST_CHECK( test_result == boost_kahypar::includes(cont1, boost_kahypar::make_iterator_range(cont2)) );
            BOOST_CHECK( test_result == boost_kahypar::includes(boost_kahypar::make_iterator_range(cont1), boost_kahypar::make_iterator_range(cont2)) );
        }
                       ...
                       BinaryPredicate pred)
        {
            ...
            bool test_result = boost_kahypar::includes(cont1, cont2, pred);
            ...
            BOOST_CHECK( test_result == boost_kahypar::includes(boost_kahypar::make_iterator_range(cont1), cont2, pred) );
            BOOST_CHECK( test_result == boost_kahypar::includes(cont1, boost_kahypar::make_iterator_range(cont2), pred) );
            BOOST_CHECK( test_result == boost_kahypar::includes(boost_kahypar::make_iterator_range(cont1), boost_kahypar::make_iterator_range(cont2), pred) );
        }
...
init_unit_test_suite(int argc, char* argv[])
{
    ...
    test->add( BOOST_TEST_CASE( &boost_kahypar::test_includes ) );
