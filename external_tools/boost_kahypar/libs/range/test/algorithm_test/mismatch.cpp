...
namespace boost_kahypar
{
    namespace
    {
                           ...
                           )
        {
            ...
            result_pair_t result = boost_kahypar::mismatch(cont1, cont2);
            BOOST_CHECK( result.first == ref_it1 );
            BOOST_CHECK( result.second == ref_it2 );
            
            result = boost_kahypar::mismatch(boost_kahypar::make_iterator_range(cont1),
                                     cont2);
            BOOST_CHECK( result.first == ref_it1 );
            BOOST_CHECK( result.second == ref_it2 );
            
            result = boost_kahypar::mismatch(cont1,
                           ...
                           )
        {
            ...
            result_pair_t result = boost_kahypar::mismatch(cont1, cont2, pred);
            BOOST_CHECK( result.first == ref_it1 );
            BOOST_CHECK( result.second == ref_it2 );
            ...
            result = boost_kahypar::mismatch(cont1,
                                     boost_kahypar::make_iterator_range(cont2), pred);
            BOOST_CHECK( result.first == ref_it1 );
            BOOST_CHECK( result.second == ref_it2 );
                           ...
                           const int ref2)
        {
            ...
            result = boost_kahypar::mismatch(boost_kahypar::make_iterator_range(cont1), cont2);
            BOOST_CHECK_EQUAL( ref1, *result.first );
            BOOST_CHECK_EQUAL( ref2, *result.second );
            
            result = boost_kahypar::mismatch(cont1, boost_kahypar::make_iterator_range(cont2));
            BOOST_CHECK_EQUAL( ref1, *result.first );
            BOOST_CHECK_EQUAL( ref2, *result.second );
        ...
        void test_mismatch_impl()
        {
            ...
            typedef BOOST_DEDUCED_TYPENAME boost_kahypar::remove_const<Container1>::type MutableContainer1;
            typedef BOOST_DEDUCED_TYPENAME boost_kahypar::remove_const<Container2>::type MutableContainer2;
...
init_unit_test_suite(int argc, char* argv[])
{
    ...
    test->add( BOOST_TEST_CASE( &boost_kahypar::test_mismatch ) );
