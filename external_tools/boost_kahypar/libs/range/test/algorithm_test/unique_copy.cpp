...
namespace
{
    ...
    void test_unique_copy_impl(Container& c)
    {
        ...
        test_append(
            boost_kahypar::unique_copy(c, std::back_inserter(test)),
            value_type()
            );
        ...
        test_append(
            boost_kahypar::unique_copy(boost_kahypar::make_iterator_range(c),
    ...
    void test_unique_copy_impl(Container& c, Pred pred)
    {
        ...
        test_append(
            boost_kahypar::unique_copy(c, std::back_inserter(test), pred),
            value_type()
            );
