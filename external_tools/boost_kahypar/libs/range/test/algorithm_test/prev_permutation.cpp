...
namespace boost_kahypar
{
    namespace
    {
        ...
        void test_prev_permutation_impl(const Container& cont)
        {
            ...
            const bool test_ret = boost_kahypar::prev_permutation(test);
            ...
            BOOST_CHECK( test_ret == boost_kahypar::prev_permutation(
                                             ...
                                             BinaryPredicate  pred)
        {
            ...
            const bool test_ret = boost_kahypar::prev_permutation(test, pred);
...
init_unit_test_suite(int argc, char* argv[])
{
    ...
    test->add( BOOST_TEST_CASE( &boost_kahypar::test_prev_permutation ) );
