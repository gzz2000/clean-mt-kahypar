...
namespace boost_kahypar_range_test_algorithm_find_if
{
    ...
    public:
        ...
        test_iter(Container& cont)
        {
            ...
            iter_t result = boost_kahypar::find_if(cont, m_pred);
            BOOST_CHECK( result == boost_kahypar::find_if(boost_kahypar::make_iterator_range(cont), m_pred) );
            return result;
        }
        ...
        struct test_range
        {
            ...
            operator()(find_if_test_policy& policy, Container& cont)
            {
                ...
                result_t result = boost_kahypar::find_if<return_type>(cont, policy.pred());
                BOOST_CHECK( result == boost_kahypar::find_if<return_type>(boost_kahypar::make_iterator_range(cont), policy.pred()) );
                return result;
            }
        };
...
init_unit_test_suite(int argc, char* argv[])
{
    ...
    test->add( BOOST_TEST_CASE( &boost_kahypar_range_test_algorithm_find_if::test_find_if ) );
