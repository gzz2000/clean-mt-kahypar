...
namespace boost_kahypar
{
    namespace
    {
        ...
        void test_random_shuffle_nogen_impl(Container& cont)
        {
            ...
            {
                Container test(cont);
                boost_kahypar::random_shuffle(test);
                ...
                boost_kahypar::random_shuffle(boost_kahypar::make_iterator_range(test2));
        ...
        void test_random_shuffle_gen_impl(Container& cont)
        {
            ...
            boost_kahypar::random_shuffle(cont, gen);
            ...
            boost_kahypar::random_shuffle(boost_kahypar::make_iterator_range(cont2), gen2);
        ...
        {
            Container old_cont(cont);
            boost_kahypar::random_shuffle(cont);
            test_shuffle_result(cont, old_cont);
        }
...
init_unit_test_suite(int argc, char* argv[])
{
    ...
    test->add( BOOST_TEST_CASE( &boost_kahypar::test_random_shuffle ) );
