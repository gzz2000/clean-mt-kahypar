    ...
    namespace
    {
        struct nth_element_policy
        {
            ...
            void test_nth_element(Container& cont, Iterator mid)
            {
                ...
                boost_kahypar::nth_element(cont, mid);
                ...
                boost_kahypar::nth_element(boost_kahypar::make_iterator_range(cont2), mid2);
        ...
        struct nth_element_pred_policy
        {
            ...
            void test_nth_element(Container& cont, Iterator mid)
            {
                ...
                boost_kahypar::nth_element(cont, mid, BinaryPredicate());
...
init_unit_test_suite(int argc, char* argv[])
{
    ...
    test->add( BOOST_TEST_CASE( &boost_kahypar::test_nth_element ) );
