...
namespace boost_kahypar
{
    namespace
    {
        ...
        void test(Container1& cont1, Container2& cont2)
        {
            ...
            iterator_t test_it
                = boost_kahypar::merge(cont1, cont2, test_target.begin());
            ...
            test_it = boost_kahypar::merge(boost_kahypar::make_iterator_range(cont1),
            ...
            test_it = boost_kahypar::merge(cont1, boost_kahypar::make_iterator_range(cont2),
                                   test_target.begin());
        ...
        void test_pred(Container1 cont1, Container2 cont2, BinaryPredicate pred)
        {
            ...
            iterator_t test_it
                = boost_kahypar::merge(cont1, cont2, test_target.begin(), pred);
            ...
            test_it = boost_kahypar::merge(boost_kahypar::make_iterator_range(cont1), cont2,
...
init_unit_test_suite(int argc, char* argv[])
{
    ...
    test->add( BOOST_TEST_CASE( &boost_kahypar::test_merge ) );
