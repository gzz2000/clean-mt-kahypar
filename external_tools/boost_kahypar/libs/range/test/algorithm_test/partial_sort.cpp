    ...
    namespace
    {
        struct partial_sort_policy
        {
            ...
            void test_partial_sort(Container& cont, Iterator mid)
            {
                ...
                boost_kahypar::partial_sort(cont, mid);
                ...
                boost_kahypar::partial_sort(cont2, mid2);
        ...
        struct partial_sort_pred_policy
        {
            ...
            void test_partial_sort(Container& cont, Iterator mid)
            {
                ...
                boost_kahypar::partial_sort(cont, mid, BinaryPredicate());
                
                const std::size_t index = std::distance(cont.begin(), mid);
                Container cont2(old_cont);
                Iterator mid2(cont2.begin());
                std::advance(mid2, index);
                boost_kahypar::partial_sort(cont2, mid2, BinaryPredicate());
...
init_unit_test_suite(int argc, char* argv[])
{
    ...
    test->add( BOOST_TEST_CASE( &boost_kahypar::test_partial_sort ) );
