...
//
#include <boost_kahypar/range/algorithm/swap_ranges.hpp>
...
namespace
{
    ...
    void test_swap_ranges_impl(const Container1& source1, const Container2& source2)
    {
        ...
        boost_kahypar::swap_ranges(test1, test2);
        ...
        test1 = source1;
        test2 = source2;
        boost_kahypar::swap_ranges(boost_kahypar::make_iterator_range(test1), test2);
        BOOST_CHECK_EQUAL_COLLECTIONS( reference1.begin(), reference1.end(),
                                       test1.begin(), test1.end() );
        BOOST_CHECK_EQUAL_COLLECTIONS( reference2.begin(), reference2.end(),
                                       test2.begin(), test2.end() );
        ...
        test1 = source1;
        test2 = source2;
        boost_kahypar::swap_ranges(test1, boost_kahypar::make_iterator_range(test2));
        BOOST_CHECK_EQUAL_COLLECTIONS( reference1.begin(), reference1.end(),
                                       test1.begin(), test1.end() );
        BOOST_CHECK_EQUAL_COLLECTIONS( reference2.begin(), reference2.end(),
                                       test2.begin(), test2.end() );
        ...
        test1 = source1;
        test2 = source2;
        boost_kahypar::swap_ranges(boost_kahypar::make_iterator_range(test1),
                           boost_kahypar::make_iterator_range(test2));
        BOOST_CHECK_EQUAL_COLLECTIONS( reference1.begin(), reference1.end(),
                                       test1.begin(), test1.end() );
        BOOST_CHECK_EQUAL_COLLECTIONS( reference2.begin(), reference2.end(),
                                       test2.begin(), test2.end() );
