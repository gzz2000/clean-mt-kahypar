    ...
    namespace
    {
        ...
        void test(Container1& cont1, Container2& cont2)
        {
            ...
            iterator_t test_result
                = boost_kahypar::set_difference(cont1, cont2, test_cont.begin());

            check_result(reference, reference_result,
                         test_cont, test_result);
                         
            test_result = boost_kahypar::set_difference(
                       ...
                       BinaryPredicate pred)
        {
            ...
            iterator_t test_result
                = boost_kahypar::set_difference(cont1, cont2, test_cont.begin(), pred);
...
init_unit_test_suite(int argc, char* argv[])
{
    ...
    test->add( BOOST_TEST_CASE( &boost_kahypar::test_set_difference ) );
