...
namespace
{
    ...
    void test_search_n_pred_impl(Container1& cont1, Value value, Pred pred)
    {
        ...
        {
            iterator1_t it = boost_kahypar::search_n(cont1, n, value, pred);
            BOOST_CHECK( it == boost_kahypar::search_n(boost_kahypar::make_iterator_range(cont1), n, value, pred) );
            BOOST_CHECK( it == reference_search_n(cont1.begin(), cont1.end(), n, value, pred) );

            const_iterator1_t cit = boost_kahypar::search_n(ccont1, n, value, pred);
            BOOST_CHECK( cit == boost_kahypar::search_n(boost_kahypar::make_iterator_range(ccont1), n, value, pred) );
    ...
    void test_search_n_impl(Container1& cont1, Value value)
    {
        ...
        for (std::size_t n = 0; n < cont1.size(); ++n)
        {
            iterator1_t it = boost_kahypar::search_n(cont1, n, value);
            BOOST_CHECK( it == boost_kahypar::search_n(boost_kahypar::make_iterator_range(cont1), n, value) );
            BOOST_CHECK( it == reference_search_n(cont1.begin(), cont1.end(), n, value) );

            const_iterator1_t cit = boost_kahypar::search_n(ccont1, n, value);
            BOOST_CHECK( cit == boost_kahypar::search_n(boost_kahypar::make_iterator_range(ccont1), n, value) );
