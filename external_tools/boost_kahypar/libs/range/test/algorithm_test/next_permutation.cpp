...
namespace boost_kahypar
{
    namespace
    {
        ...
        void test_next_permutation_impl(const Container& cont)
        {
            ...
            const bool test_ret = boost_kahypar::next_permutation(test);
            ...
            BOOST_CHECK( test_ret == boost_kahypar::next_permutation(boost_kahypar::make_iterator_range(test)) );
                                             ...
                                             BinaryPredicate  pred)
        {
            ...
            const bool test_ret
                = boost_kahypar::next_permutation(test, pred);
            ...
            BOOST_CHECK( test_ret == boost_kahypar::next_permutation(boost_kahypar::make_iterator_range(test), pred) );
...
init_unit_test_suite(int argc, char* argv[])
{
    ...
    test->add( BOOST_TEST_CASE( &boost_kahypar::test_next_permutation ) );
