...
namespace boost_kahypar
{
    namespace
    {
        ...
        void test(Container1& cont1, Container2& cont2)
        {
            ...
            boost_kahypar::inplace_merge(test_target,
            ...
            boost_kahypar::inplace_merge(boost_kahypar::make_iterator_range(test_target2),
...
init_unit_test_suite(int argc, char* argv[])
{
    ...
    test->add( BOOST_TEST_CASE( &boost_kahypar::test_inplace_merge ) );
