...
using boost_kahypar::math::fpc::close_at_tolerance;
using boost_kahypar::math::fpc::percent_tolerance;
...
struct account_test_suite : public test_suite {
    account_test_suite( double init_value ) : test_suite("account_test_suite") {
        ...
        boost_kahypar::shared_ptr<account_test> instance( new account_test( init_value ) );
...
init_unit_test_suite( int argc, char * argv[] ) {
    ...
    try {
        ...
        framework::master_test_suite().add( new account_test_suite( boost_kahypar::lexical_cast<double>( argv[1] ) ) );
    }
    catch( boost_kahypar::bad_lexical_cast const& ) {
