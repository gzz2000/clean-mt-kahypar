...
#include <boost_kahypar/test/prg_exec_monitor.hpp>
...
cpp_main( int argc , char *[] )
{
    ...
    catch ( boost_kahypar::execution_exception const& ex ) {
...
// this seems to come from the way clang handles floating point exceptions + UB.
    ...
    ex_mon.p_detect_fp_exceptions.value = boost_kahypar::fpe::BOOST_FPE_DIVBYZERO;
    ...
    ex_mon.p_detect_fp_exceptions.value = boost_kahypar::fpe::BOOST_FPE_ALL;
    ...
    ex_mon.p_detect_fp_exceptions.value = boost_kahypar::fpe::BOOST_FPE_OFF;
