...
//[example_code
#define BOOST_TEST_MODULE boost_kahypar_test_sequence_per_element
...
BOOST_AUTO_TEST_CASE( test_compare_c_arrays_element_wise )
{
  ...
  BOOST_TEST(a == b, boost_kahypar::test_tools::per_element());
  BOOST_TEST(a != b, boost_kahypar::test_tools::per_element());
  BOOST_TEST(a < b, boost_kahypar::test_tools::per_element());
  BOOST_TEST(b < c, boost_kahypar::test_tools::per_element());
  BOOST_TEST(c < a, boost_kahypar::test_tools::per_element());
}
//]
