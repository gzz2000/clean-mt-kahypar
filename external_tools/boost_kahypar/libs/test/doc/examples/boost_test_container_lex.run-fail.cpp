...
//[example_code
#define BOOST_TEST_MODULE boost_kahypar_test_container_lex
...
BOOST_AUTO_TEST_CASE( test_compare_c_arrays_lexicographic )
{
  ...
  // BOOST_TEST(a == b, boost_kahypar::test_tools::lexicographic()); // does not compile
  // BOOST_TEST(a != b, boost_kahypar::test_tools::lexicographic()); // does not compile
  BOOST_TEST(a < b, boost_kahypar::test_tools::lexicographic());
  BOOST_TEST(b < c, boost_kahypar::test_tools::lexicographic());
  BOOST_TEST(c < a, boost_kahypar::test_tools::lexicographic());
}
//]
