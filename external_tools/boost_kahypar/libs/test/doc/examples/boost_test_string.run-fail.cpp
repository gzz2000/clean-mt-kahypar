...
//[example_code
#define BOOST_TEST_MODULE boost_kahypar_test_strings
...
BOOST_AUTO_TEST_CASE( test_strings )
{
  ...
  BOOST_TEST(std::string("test1") < a, boost_kahypar::test_tools::per_element());
  BOOST_TEST(b < a, boost_kahypar::test_tools::lexicographic());
}
//]
