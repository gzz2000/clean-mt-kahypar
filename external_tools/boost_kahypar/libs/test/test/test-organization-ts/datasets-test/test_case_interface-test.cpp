...
{
  boost_kahypar::unit_test::test_case const& current_test_case = boost_kahypar::unit_test::framework::current_test_case();
...
BOOST_DATA_TEST_CASE(BoostDataTest
  , boost_kahypar::unit_test::data::make({ false, true, true, true, false, false }) ^
    boost_kahypar::unit_test::data::make(ExpectedValues)
  , value, expectedValue)
{
