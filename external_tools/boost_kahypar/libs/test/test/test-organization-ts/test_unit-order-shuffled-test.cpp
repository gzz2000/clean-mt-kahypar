...
void some_test() {}
#define TC( name )                                                      \
boost_kahypar::unit_test::make_test_case( boost_kahypar::function<void ()>(some_test),  \
...
struct test_tree {
    test_tree() {
        ...
        {
          tsuites.push_back(BOOST_TEST_SUITE( "ts1_" +  boost_kahypar::unit_test::utils::string_cast(s)));
        ...
        {
          tsuites.push_back(BOOST_TEST_SUITE( "ts2_" +  boost_kahypar::unit_test::utils::string_cast(s)));
        ...
        {
            ut::test_case* tc = boost_kahypar::unit_test::make_test_case(
                                    boost_kahypar::function<void ()>(some_test),
                                    "tc_" +  boost_kahypar::unit_test::utils::string_cast(s),
                                    __FILE__, __LINE__ );
