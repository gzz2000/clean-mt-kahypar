...
// BOOST
#include <boost_kahypar/mpl/range_c.hpp>
#include <boost_kahypar/mpl/list_c.hpp>
...
BOOST_AUTO_TEST_CASE( test0_only_2 )
{
    ...
    typedef boost_kahypar::mpl::list_c<int,2> only_2;
...
BOOST_AUTO_TEST_CASE( test0_one_to_ten )
{
    ...
    typedef boost_kahypar::mpl::range_c<int,0,10> one_to_ten;
...
BOOST_AUTO_TEST_CASE( test1_one_to_five )
{
    ...
    typedef boost_kahypar::mpl::range_c<int,1,5> one_to_five;
...
BOOST_AUTO_TEST_CASE( test2_one_to_three )
{
    ...
    typedef boost_kahypar::mpl::range_c<int,1,3> one_to_three;
...
typedef boost_kahypar::mpl::vector<int,int const, int volatile,int const volatile> test_types_ints_variations;
...
typedef boost_kahypar::mpl::vector<int,int*,int const*, int const volatile*, int const*const, int*&> test_types_ints_pointer_variations;
