...
namespace boost_kahypar { namespace unit_test { namespace data { namespace monomorphic {
  // registering fibonacci_dataset as a proper dataset
  template <>
  struct is_dataset< fibonacci_dataset<int> > : boost_kahypar::mpl::true_ {};

  template <>
  struct is_dataset< fibonacci_dataset<non_copyable_type> > : boost_kahypar::mpl::true_ {};
}}}}
