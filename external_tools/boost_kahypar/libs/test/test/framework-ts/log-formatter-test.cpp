...
#include <boost_kahypar/test/unit_test_suite.hpp>
#include <boost_kahypar/test/framework.hpp>
#include <boost_kahypar/test/unit_test_parameters.hpp>
#include <boost_kahypar/test/utils/nullstream.hpp>
#include <boost_kahypar/test/execution_monitor.hpp>

typedef boost_kahypar::onullstream onullstream_type;
...
void timeout_foo()
{
    using boost_kahypar::execution_exception;
...
struct guard {
    ~guard()
    {
        boost_kahypar::unit_test::unit_test_log.set_format( runtime_config::get<output_format>( runtime_config::btrt_log_format ) );
...
#line 249
    ...
    boost_kahypar::unit_test::runtime_config::init( argc, (char**)argv );
    boost_kahypar::unit_test::framework::impl::setup_for_execution( *ts_main );
    ...
    boost_kahypar::unit_test::runtime_config::init( argc2, (char**)argv2 );
    boost_kahypar::unit_test::framework::impl::setup_for_execution( *ts_account_failures );
