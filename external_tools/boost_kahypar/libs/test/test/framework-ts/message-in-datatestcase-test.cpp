...
#include <boost_kahypar/test/data/monomorphic.hpp>
...
BOOST_DATA_TEST_CASE(test_update,
                     boost_kahypar::unit_test::data::make(filenames))
{
...
#define PATTERN_FILE_NAME "messages-in-datasets-test.pattern"
    ...
    auto dataset = boost_kahypar::unit_test::data::make(filenames);

    test_unit_generator const& generator = boost_kahypar::unit_test::data::ds_detail::test_case_gen<test_updatecase, decltype(dataset)>(
        "fake_name",
        __FILE__,
        200,
