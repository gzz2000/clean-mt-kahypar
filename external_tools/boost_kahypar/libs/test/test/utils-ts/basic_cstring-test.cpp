...
#include <boost_kahypar/mpl/joint_view.hpp>
...
typedef mpl::transform<mutable_char_types,boost_kahypar::add_const<mpl::_1> >::type const_char_types;
...
struct string_literal {
    typedef typename boost_kahypar::remove_const<CharT>::type   mutable_char;
