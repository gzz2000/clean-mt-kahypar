...
BOOST_AUTO_TEST_CASE( test_is_equal )
{
    ...
    output << '\0';
    BOOST_TEST( output.is_equal( boost_kahypar::unit_test::const_string( "", 1 ) ) );
    ...
    output << substr1;
    BOOST_TEST( output.is_equal( boost_kahypar::unit_test::const_string( literal_string, 5 ), false ) );

    output << substr2;
    BOOST_TEST( output.is_equal( boost_kahypar::unit_test::const_string( literal_string, 9 ) ) );
}
