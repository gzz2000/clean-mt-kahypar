...
typedef boost_kahypar::mpl::list<float,double,long double> test_types;
...
BOOST_AUTO_TEST_CASE(test_strict_order_operations_ne,
                     * boost_kahypar::unit_test::tolerance(0.01)
                     * expected_failures( 1 ) )
{
    double x = 10.00;
...
BOOST_AUTO_TEST_CASE(test_strict_order_operations_lt_0,
                     * boost_kahypar::unit_test::tolerance(0.02)
                     * expected_failures( 3 ) )
{
    double x = 0.00;
    double y = 0.01;
...
namespace fpc = boost_kahypar::math::fpc;
...
BOOST_AUTO_TEST_CASE( test_comparison_if_one_is_FPV, * boost_kahypar::unit_test::tolerance(1E-6) )
{
