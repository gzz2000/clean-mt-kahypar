...
#include <boost_kahypar/test/utils/is_cstring.hpp>

BOOST_AUTO_TEST_CASE( check_is_cstring_concept )
{
  namespace bp = boost_kahypar::unit_test;
...
#ifndef BOOST_TEST_MACRO_LIMITED_SUPPORT
    BOOST_TEST( buf_ptr_cch == buf_ptr_cch, boost_kahypar::test_tools::per_element() );
    BOOST_TEST( buf_ptr_cch <= "abd" , boost_kahypar::test_tools::per_element() );
    BOOST_TEST( buf_ptr_cch >= "aba" , boost_kahypar::test_tools::per_element() );
    BOOST_TEST( buf_str == buf_ptr_cch , boost_kahypar::test_tools::per_element() );
    BOOST_TEST( buf_str <= "abd" , boost_kahypar::test_tools::per_element() );
    BOOST_TEST( buf_str >= "aba" , boost_kahypar::test_tools::per_element() );

    BOOST_TEST( buf_ptr_cch <= buf_ptr_cch, boost_kahypar::test_tools::lexicographic() );
    BOOST_TEST( buf_ptr_cch >= buf_ptr_cch, boost_kahypar::test_tools::lexicographic() );
    BOOST_TEST( buf_ptr_cch <= "abc" , boost_kahypar::test_tools::lexicographic() );
    BOOST_TEST( buf_ptr_cch < "abd" , boost_kahypar::test_tools::lexicographic() );
    BOOST_TEST( buf_ptr_cch < "abcd" , boost_kahypar::test_tools::lexicographic() );
    BOOST_TEST( buf_ptr_cch >= "abc" , boost_kahypar::test_tools::lexicographic() );
    BOOST_TEST( buf_ptr_cch > "aba" , boost_kahypar::test_tools::lexicographic() );
    BOOST_TEST( buf_ptr_cch > "abad" , boost_kahypar::test_tools::lexicographic() );
    BOOST_TEST( buf_str <= buf_ptr_cch , boost_kahypar::test_tools::lexicographic() );
    BOOST_TEST( buf_str >= buf_ptr_cch , boost_kahypar::test_tools::lexicographic() );
    BOOST_TEST( buf_str <= "abc" , boost_kahypar::test_tools::lexicographic() );
    BOOST_TEST( buf_str < "abd" , boost_kahypar::test_tools::lexicographic() );
    BOOST_TEST( buf_str > "aba" , boost_kahypar::test_tools::lexicographic() );
#endif
...
BOOST_AUTO_TEST_CASE( check_string_view_compare )
{
    ...
    BOOST_TEST_CHECK(str <= sv, boost_kahypar::test_tools::lexicographic());
    BOOST_TEST_CHECK(sv >= str, boost_kahypar::test_tools::lexicographic());
    BOOST_TEST_CHECK(str < sv, boost_kahypar::test_tools::lexicographic());
    BOOST_TEST_CHECK(sv > str, boost_kahypar::test_tools::lexicographic());
    ...
    BOOST_TEST_CHECK("str"sv <= sv, boost_kahypar::test_tools::lexicographic());
    BOOST_TEST_CHECK(sv >= "str"sv, boost_kahypar::test_tools::lexicographic());
    BOOST_TEST_CHECK("str"sv < sv, boost_kahypar::test_tools::lexicographic());
    BOOST_TEST_CHECK(sv > "str"sv, boost_kahypar::test_tools::lexicographic());

    // per element, left-right operand
    BOOST_TEST( "sv" <= sv , boost_kahypar::test_tools::per_element() );
    BOOST_TEST( "sv" >= sv , boost_kahypar::test_tools::per_element() );
    BOOST_TEST( "sv" == sv , boost_kahypar::test_tools::per_element() );
    ...
    BOOST_TEST( "rv" <= sv , boost_kahypar::test_tools::per_element() );
    BOOST_TEST( "tv" >= sv , boost_kahypar::test_tools::per_element() );
    BOOST_TEST( "tw" != sv , boost_kahypar::test_tools::per_element() );

    BOOST_TEST( sv <= "tv" , boost_kahypar::test_tools::per_element() );
    BOOST_TEST( sv >= "rv" , boost_kahypar::test_tools::per_element() );
    BOOST_TEST( sv != "ru" , boost_kahypar::test_tools::per_element() );
