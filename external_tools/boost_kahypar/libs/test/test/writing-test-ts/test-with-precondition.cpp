...
BOOST_AUTO_TEST_CASE(not_running,
                     *boost_kahypar::unit_test::precondition([](boost_kahypar::unit_test::test_unit_id){
...
BOOST_AUTO_TEST_SUITE(s1)
  ...
  BOOST_AUTO_TEST_CASE(test2, * boost_kahypar::unit_test::depends_on("not_running") )
  {
    BOOST_TEST(false);
  }
BOOST_AUTO_TEST_SUITE_END()

BOOST_AUTO_TEST_CASE(test5, * boost_kahypar::unit_test::depends_on("s1"))
{
  BOOST_TEST(true);
}
