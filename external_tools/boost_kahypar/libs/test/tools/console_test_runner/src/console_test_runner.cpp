...
// Boost.Runtime.Param
//#include <boost_kahypar/test/utils/runtime/cla/named_parameter.hpp>
#include <boost_kahypar/test/utils/named_params.hpp>
#include <boost_kahypar/test/utils/runtime/cla/parser.hpp>

namespace rt  = boost_kahypar::runtime;
namespace cla = boost_kahypar::runtime::cla;
...
int main( int argc, char* argv[] )
{
    try {
        ...
        int res = ::boost_kahypar::unit_test::unit_test_main( &load_test_lib, argc, argv );

        ::boost_kahypar::unit_test::framework::clear();
