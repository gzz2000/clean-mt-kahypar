...
#include <boost_kahypar/type.hpp>
...
template< typename T >
struct is_atomic :
    public boost_kahypar::false_type
{
};

template< typename T >
struct is_atomic< boost_kahypar::atomic< T > > :
    public boost_kahypar::true_type
{
};

template< typename T >
struct is_atomic< boost_kahypar::ipc_atomic< T > > :
    public boost_kahypar::true_type
{
};
...
template< typename T >
struct is_atomic_ref< boost_kahypar::atomic_ref< T > > :
    public boost_kahypar::true_type
{
};

template< typename T >
struct is_atomic_ref< boost_kahypar::ipc_atomic_ref< T > > :
    public boost_kahypar::true_type
{
};
...
template< typename T >
inline typename boost_kahypar::enable_if< is_atomic< T > >::type test_atomic_type_traits(boost_kahypar::type< T >)
{
    BOOST_TEST_GE(sizeof(T), sizeof(typename T::value_type));
}

template< typename T >
inline typename boost_kahypar::enable_if< is_atomic_ref< T > >::type test_atomic_type_traits(boost_kahypar::type< T >)
{
    if (T::is_always_lock_free)
    {
        BOOST_TEST_GE(T::required_alignment, boost_kahypar::alignment_of< typename T::value_type >::value);
    }
    else
    {
        // Lock-based implementation should not require alignment higher than alignof(T)
        BOOST_TEST_EQ(T::required_alignment, boost_kahypar::alignment_of< typename T::value_type >::value);
    }
}
...
{
    test_atomic_type_traits(boost_kahypar::type< typename Wrapper<T>::atomic_type >());
...

    {
        Wrapper<T> wrapper(value1);
        typename Wrapper<T>::atomic_reference_type a = wrapper.a;
        BOOST_TEST_EQ( a.load(boost_kahypar::memory_order_relaxed), value1 );
    }
...

    {
        Wrapper<T> wrapper(value1);
        typename Wrapper<T>::atomic_reference_type a = wrapper.a;
        a.store(value2, boost_kahypar::memory_order_relaxed);
        BOOST_TEST_EQ( a.load(boost_kahypar::memory_order_relaxed), value2 );
    }
...
//! Tests whether boost_kahypar::atomic supports constexpr constructor. Note that boost_kahypar::atomic_ref (as std::atomic_ref) does not support constexpr constructor.
template< typename T >
void test_constexpr_ctor()
{
    ...
    constexpr boost_kahypar::atomic<T> tester_default;
    BOOST_TEST_EQ(tester_default.load(boost_kahypar::memory_order_relaxed), value);

    constexpr boost_kahypar::atomic<T> tester_init(value);
    BOOST_TEST_EQ(tester_init.load(boost_kahypar::memory_order_relaxed), value);
#endif
}

//! The type traits provides max and min values of type D that can be added/subtracted to T(0) without signed overflow
template< typename T, typename D, bool IsSigned = boost_kahypar::is_signed< D >::value >
struct distance_limits
{
    //! Difference type D promoted to the width of type T
    typedef typename boost_kahypar::conditional<
        IsSigned,
        boost_kahypar::make_signed< T >,
        boost_kahypar::make_unsigned< T >
...
struct distance_limits< T, boost_kahypar::int128_type, IsSigned >
{
    //! Difference type D promoted to the width of type T
    typedef boost_kahypar::int128_type promoted_difference_type;

    static boost_kahypar::int128_type min BOOST_PREVENT_MACRO_SUBSTITUTION () BOOST_NOEXCEPT
    {
        return -(max)() - 1;
    }
    static boost_kahypar::int128_type max BOOST_PREVENT_MACRO_SUBSTITUTION () BOOST_NOEXCEPT
    {
        return static_cast< boost_kahypar::int128_type >((~static_cast< boost_kahypar::uint128_type >(0u)) >> 1);
    }
};

template< typename T, bool IsSigned >
struct distance_limits< T, boost_kahypar::uint128_type, IsSigned >
{
    //! Difference type D promoted to the width of type T
    typedef boost_kahypar::uint128_type promoted_difference_type;

    static boost_kahypar::uint128_type min BOOST_PREVENT_MACRO_SUBSTITUTION () BOOST_NOEXCEPT
    {
        return 0u;
    }
    static boost_kahypar::uint128_type max BOOST_PREVENT_MACRO_SUBSTITUTION () BOOST_NOEXCEPT
    {
        return ~static_cast< boost_kahypar::uint128_type >(0u);
    }
};
...
void test_additive_operators_with_type_and_test()
{
    ...
    if (boost_kahypar::is_pointer< AddType >::value)
        return;
#endif
    ...
    typedef typename boost_kahypar::make_unsigned< promoted_difference_type >::type unsigned_promoted_difference_type;
...
template< template< typename > class Wrapper, typename T >
void do_test_integral_api(boost_kahypar::false_type)
{
...
template< template< typename > class Wrapper, typename T >
void do_test_integral_api(boost_kahypar::true_type)
{
    do_test_integral_api< Wrapper, T >(boost_kahypar::false_type());
...
{
    do_test_integral_api< Wrapper, T >(boost_kahypar::is_unsigned<T>());

    if (boost_kahypar::is_signed<T>::value)
        test_negation< Wrapper, T >();
}

template< template< typename > class Wrapper, typename T >
inline void test_lock_free_integral_api(boost_kahypar::true_type)
{
    test_integral_api< Wrapper, T >();
}

template< template< typename > class Wrapper, typename T >
inline void test_lock_free_integral_api(boost_kahypar::false_type)
{
}
...
{
    test_lock_free_integral_api< Wrapper, T >(boost_kahypar::integral_constant< bool, Wrapper< T >::atomic_type::is_always_lock_free >());
}
...
template< template< typename > class Wrapper, typename T >
inline void test_lock_free_floating_point_api(boost_kahypar::true_type)
{
    test_floating_point_api< Wrapper, T >();
}

template< template< typename > class Wrapper, typename T >
inline void test_lock_free_floating_point_api(boost_kahypar::false_type)
{
}
...
{
    test_lock_free_floating_point_api< Wrapper, T >(boost_kahypar::integral_constant< bool, Wrapper< T >::atomic_type::is_always_lock_free >());
}
...
void test_pointer_api(void)
{
    ...
    Wrapper<boost_kahypar::intptr_t> wrapper_integral;
    typename Wrapper<boost_kahypar::intptr_t>::atomic_reference_type integral = wrapper_integral.a;
...
template< template< typename > class Wrapper, typename T >
inline void test_lock_free_pointer_api(boost_kahypar::true_type)
{
    test_pointer_api< Wrapper, T >();
}

template< template< typename > class Wrapper, typename T >
inline void test_lock_free_pointer_api(boost_kahypar::false_type)
{
}
...
{
    test_lock_free_pointer_api< Wrapper, T >(boost_kahypar::integral_constant< bool, Wrapper< T >::atomic_type::is_always_lock_free >());
}
...
template< template< typename > class Wrapper >
inline void test_lock_free_enum_api(boost_kahypar::true_type)
{
    test_enum_api< Wrapper >();
}

template< template< typename > class Wrapper >
inline void test_lock_free_enum_api(boost_kahypar::false_type)
{
}
...
{
    test_lock_free_enum_api< Wrapper >(boost_kahypar::integral_constant< bool, Wrapper< test_enum >::atomic_type::is_always_lock_free >());
}
