...
int main(int, char *[])
{
    test_flag_api< boost_kahypar::atomic_flag >();
    ...
    test_integral_api< atomic_wrapper, boost_kahypar::uint8_t >();
    test_integral_api< atomic_wrapper, boost_kahypar::int8_t >();
    test_integral_api< atomic_wrapper, short >();
    test_integral_api< atomic_wrapper, unsigned short >();
    test_integral_api< atomic_wrapper, boost_kahypar::uint16_t >();
    test_integral_api< atomic_wrapper, boost_kahypar::int16_t >();
    test_integral_api< atomic_wrapper, int >();
    test_integral_api< atomic_wrapper, unsigned int >();
    test_integral_api< atomic_wrapper, boost_kahypar::uint32_t >();
    test_integral_api< atomic_wrapper, boost_kahypar::int32_t >();
    test_integral_api< atomic_wrapper, long >();
    test_integral_api< atomic_wrapper, unsigned long >();
    test_integral_api< atomic_wrapper, boost_kahypar::uint64_t >();
    test_integral_api< atomic_wrapper, boost_kahypar::int64_t >();
    ...
    test_integral_api< atomic_wrapper, boost_kahypar::int128_type >();
    test_integral_api< atomic_wrapper, boost_kahypar::uint128_type >();
#endif
    ...
    test_floating_point_api< atomic_wrapper, boost_kahypar::float128_type >();
#endif
#endif
    ...
    test_struct_api< atomic_wrapper, test_struct< boost_kahypar::uint8_t > >();
    test_struct_api< atomic_wrapper, test_struct< boost_kahypar::uint16_t > >();
    test_struct_api< atomic_wrapper, test_struct< boost_kahypar::uint32_t > >();
    test_struct_api< atomic_wrapper, test_struct< boost_kahypar::uint64_t > >();
#if defined(BOOST_HAS_INT128)
    test_struct_api< atomic_wrapper, test_struct< boost_kahypar::uint128_type > >();
#endif

    // https://svn.boost.org/trac/boost/ticket/10994
    test_struct_x2_api< atomic_wrapper, test_struct_x2< boost_kahypar::uint64_t > >();
    ...
    // Test that boost_kahypar::atomic<T> only requires T to be trivially copyable.
    ...
    boost_kahypar::atomic_thread_fence(boost_kahypar::memory_order_seq_cst);
    boost_kahypar::atomic_signal_fence(boost_kahypar::memory_order_seq_cst);
