...
struct test_clock
{
    ...
    typedef boost_kahypar::winapi::ULONGLONG_ rep;
#else
    typedef boost_kahypar::winapi::DWORD_ rep;
#endif
    ...
    {
#if BOOST_USE_WINAPI_VERSION >= BOOST_WINAPI_VERSION_WIN6
        rep ticks = boost_kahypar::winapi::GetTickCount64();
#else
        rep ticks = boost_kahypar::winapi::GetTickCount();
#endif
