...
struct test_stream_type
{
    ...
    test_stream_type const& operator<< (boost_kahypar::int128_type const& v) const
    {
        std::cerr << static_cast< long long >(v);
        return *this;
    }
    test_stream_type const& operator<< (boost_kahypar::uint128_type const& v) const
    {
    ...
    test_stream_type const& operator<< (boost_kahypar::float128_type const& v) const
    {
