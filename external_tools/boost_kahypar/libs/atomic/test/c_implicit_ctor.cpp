...
int main(int, char *[])
{
    static_assert(std::is_convertible< int, boost_kahypar::atomic< int > >::value, "boost_kahypar::atomic<T> does not have an implicit constructor from T");

    boost_kahypar::atomic< short > a = 10;
    (void)a;
