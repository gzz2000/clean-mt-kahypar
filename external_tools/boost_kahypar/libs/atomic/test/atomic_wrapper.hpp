...
{
    typedef boost_kahypar::atomic< T > atomic_type;
...
{
    typedef boost_kahypar::atomic_ref< T > atomic_type;
...
{
    typedef boost_kahypar::ipc_atomic< T > atomic_type;
    typedef atomic_type& atomic_reference_type;
...
{
    typedef boost_kahypar::ipc_atomic_ref< T > atomic_type;
    typedef atomic_type const& atomic_reference_type;
