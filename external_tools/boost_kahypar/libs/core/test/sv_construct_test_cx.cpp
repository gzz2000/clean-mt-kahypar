...
{
    {
        constexpr boost_kahypar::core::string_view sv;
        ...
        STATIC_ASSERT( sv.max_size() == boost_kahypar::core::string_view::npos );
    }

    {
        constexpr char const* s = "123";

        constexpr boost_kahypar::core::string_view sv( s, 0 );
...

    {
        ...
        constexpr boost_kahypar::core::string_view sv( s, 2 );
...

    {
        ...
        constexpr boost_kahypar::core::string_view sv( s, s );
...

    {
        ...
        constexpr boost_kahypar::core::string_view sv( s, s + 2 );
...

    {
        ...
        constexpr boost_kahypar::core::string_view sv( str );
