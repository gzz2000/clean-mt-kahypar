...
{
    int i = 0;
    BOOST_TEST(boost_kahypar::to_address(&i) == &i);
    int* p = &i;
    BOOST_TEST(boost_kahypar::to_address(p) == &i);
    P1<int> p1(&i);
    BOOST_TEST(boost_kahypar::to_address(p1) == &i);
    P2<int> p2(&i);
    BOOST_TEST(boost_kahypar::to_address(p2) == &i);
#if !defined(BOOST_NO_CXX14_RETURN_TYPE_DEDUCTION)
    P3<int> p3(&i);
    BOOST_TEST(boost_kahypar::to_address(p3) == &i);
    P4<int> p4(&i);
    BOOST_TEST(boost_kahypar::to_address(p4) == &i);
#endif
