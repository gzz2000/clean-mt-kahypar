...
#define TEST(...) BOOST_TEST_EQ((boost_kahypar::core::type_name<__VA_ARGS__>()), std::string(#__VA_ARGS__))
...
int main()
{
    ...
    boost_kahypar::core::type_name<int A::*>();
    boost_kahypar::core::type_name<int const B::*>();
    ...
    boost_kahypar::core::type_name<void(A::*)()>();
    boost_kahypar::core::type_name<void(A::*)() const>();
    boost_kahypar::core::type_name<void(A::*)() volatile>();
    boost_kahypar::core::type_name<void(A::*)() const volatile>();
