...
#include <boost_kahypar/core/memory_resource.hpp>
...
struct R1: public boost_kahypar::core::memory_resource
{
...
struct R2: public boost_kahypar::core::memory_resource
{
    void* do_allocate( std::size_t bytes, std::size_t /*alignment*/ )
    {
        return ::operator new( bytes );
...
{
    {
        ...
        BOOST_TEST_EQ( do_allocate_alignment, boost_kahypar::core::max_align );
        ...
        BOOST_TEST_EQ( do_deallocate_alignment, boost_kahypar::core::max_align );
    }
