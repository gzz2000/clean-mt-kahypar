...
public:
    ...
    ~exception_watcher2() { m_count = boost_kahypar::core::uncaught_exceptions(); }
};
...
public:
    ...
    ~exception_watcher1()
    {
        m_count1 = boost_kahypar::core::uncaught_exceptions();
        try
        {
...
{
    const unsigned int root_count = boost_kahypar::core::uncaught_exceptions();
