...
{
    T y = boost_kahypar::core::bit_floor( x );
...
{
    {
        ...
        test_bit_floor( static_cast<boost_kahypar::ulong_long_type>( 0 ) );
    }
    ...
    for( int i = 0; i < 1000; ++i )
    {
        ...
        test_bit_floor( static_cast<boost_kahypar::ulong_long_type>( x ) );
    }
