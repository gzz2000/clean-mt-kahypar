...
int main()
{
...

    {
        ...
        BOOST_TEST_EQ( sv.find_last_not_of( boost_kahypar::core::string_view() ), npos );
        BOOST_TEST_EQ( sv.find_last_not_of( boost_kahypar::core::string_view(), 1 ), npos );

        BOOST_TEST_EQ( sv.find_last_not_of( boost_kahypar::core::string_view( "" ) ), npos );
        BOOST_TEST_EQ( sv.find_last_not_of( boost_kahypar::core::string_view( "" ), 1 ), npos );

        BOOST_TEST_EQ( sv.find_last_not_of( boost_kahypar::core::string_view( "1" ) ), npos );
        BOOST_TEST_EQ( sv.find_last_not_of( boost_kahypar::core::string_view( "1" ), 1 ), npos );
...

    {
        ...
        BOOST_TEST_EQ( sv.find_last_not_of( boost_kahypar::core::wstring_view() ), npos );
        BOOST_TEST_EQ( sv.find_last_not_of( boost_kahypar::core::wstring_view(), 1 ), npos );

        BOOST_TEST_EQ( sv.find_last_not_of( boost_kahypar::core::wstring_view( L"" ) ), npos );
        BOOST_TEST_EQ( sv.find_last_not_of( boost_kahypar::core::wstring_view( L"" ), 1 ), npos );

        BOOST_TEST_EQ( sv.find_last_not_of( boost_kahypar::core::wstring_view( L"1" ) ), npos );
        BOOST_TEST_EQ( sv.find_last_not_of( boost_kahypar::core::wstring_view( L"1" ), 1 ), npos );
...

    {
        ...
        BOOST_TEST_EQ( sv.find_last_not_of( boost_kahypar::core::string_view(), 0 ), 0 );
        BOOST_TEST_EQ( sv.find_last_not_of( boost_kahypar::core::string_view(), 1 ), 1 );
        BOOST_TEST_EQ( sv.find_last_not_of( boost_kahypar::core::string_view(), 2 ), 2 );
        BOOST_TEST_EQ( sv.find_last_not_of( boost_kahypar::core::string_view(), 3 ), 3 );
        BOOST_TEST_EQ( sv.find_last_not_of( boost_kahypar::core::string_view(), 4 ), 4 );
        BOOST_TEST_EQ( sv.find_last_not_of( boost_kahypar::core::string_view(), 5 ), 5 );
        BOOST_TEST_EQ( sv.find_last_not_of( boost_kahypar::core::string_view(), 6 ), 5 );
        BOOST_TEST_EQ( sv.find_last_not_of( boost_kahypar::core::string_view(), 7 ), 5 );
        BOOST_TEST_EQ( sv.find_last_not_of( boost_kahypar::core::string_view() ), 5 );
        ...
        BOOST_TEST_EQ( sv.find_last_not_of( boost_kahypar::core::string_view( "1" ), 0 ), npos );
        BOOST_TEST_EQ( sv.find_last_not_of( boost_kahypar::core::string_view( "1" ), 1 ), 1 );
        BOOST_TEST_EQ( sv.find_last_not_of( boost_kahypar::core::string_view( "1" ), 2 ), 2 );
        BOOST_TEST_EQ( sv.find_last_not_of( boost_kahypar::core::string_view( "1" ), 3 ), 2 );
        BOOST_TEST_EQ( sv.find_last_not_of( boost_kahypar::core::string_view( "1" ), 4 ), 4 );
        BOOST_TEST_EQ( sv.find_last_not_of( boost_kahypar::core::string_view( "1" ), 5 ), 5 );
        BOOST_TEST_EQ( sv.find_last_not_of( boost_kahypar::core::string_view( "1" ), 6 ), 5 );
        BOOST_TEST_EQ( sv.find_last_not_of( boost_kahypar::core::string_view( "1" ), 7 ), 5 );
        BOOST_TEST_EQ( sv.find_last_not_of( boost_kahypar::core::string_view( "1" ) ), 5 );

        BOOST_TEST_EQ( sv.find_last_not_of( boost_kahypar::core::string_view( "4" ), 0 ), 0 );
        BOOST_TEST_EQ( sv.find_last_not_of( boost_kahypar::core::string_view( "4" ), 1 ), 1 );
        BOOST_TEST_EQ( sv.find_last_not_of( boost_kahypar::core::string_view( "4" ), 2 ), 2 );
        BOOST_TEST_EQ( sv.find_last_not_of( boost_kahypar::core::string_view( "4" ), 3 ), 3 );
        BOOST_TEST_EQ( sv.find_last_not_of( boost_kahypar::core::string_view( "4" ), 4 ), 4 );
        BOOST_TEST_EQ( sv.find_last_not_of( boost_kahypar::core::string_view( "4" ), 5 ), 5 );
        BOOST_TEST_EQ( sv.find_last_not_of( boost_kahypar::core::string_view( "4" ), 6 ), 5 );
        BOOST_TEST_EQ( sv.find_last_not_of( boost_kahypar::core::string_view( "4" ), 7 ), 5 );
        BOOST_TEST_EQ( sv.find_last_not_of( boost_kahypar::core::string_view( "4" ) ), 5 );

        BOOST_TEST_EQ( sv.find_last_not_of( boost_kahypar::core::string_view( "23" ), 0 ), 0 );
        BOOST_TEST_EQ( sv.find_last_not_of( boost_kahypar::core::string_view( "23" ), 1 ), 0 );
        BOOST_TEST_EQ( sv.find_last_not_of( boost_kahypar::core::string_view( "23" ), 2 ), 0 );
        BOOST_TEST_EQ( sv.find_last_not_of( boost_kahypar::core::string_view( "23" ), 3 ), 3 );
        BOOST_TEST_EQ( sv.find_last_not_of( boost_kahypar::core::string_view( "23" ), 4 ), 3 );
        BOOST_TEST_EQ( sv.find_last_not_of( boost_kahypar::core::string_view( "23" ), 5 ), 3 );
        BOOST_TEST_EQ( sv.find_last_not_of( boost_kahypar::core::string_view( "23" ), 6 ), 3 );
        BOOST_TEST_EQ( sv.find_last_not_of( boost_kahypar::core::string_view( "23" ), 7 ), 3 );
        BOOST_TEST_EQ( sv.find_last_not_of( boost_kahypar::core::string_view( "23" ) ), 3 );
...

    {
        ...
        BOOST_TEST_EQ( sv.find_last_not_of( boost_kahypar::core::wstring_view(), 0 ), 0 );
        BOOST_TEST_EQ( sv.find_last_not_of( boost_kahypar::core::wstring_view(), 1 ), 1 );
        BOOST_TEST_EQ( sv.find_last_not_of( boost_kahypar::core::wstring_view(), 2 ), 2 );
        BOOST_TEST_EQ( sv.find_last_not_of( boost_kahypar::core::wstring_view(), 3 ), 3 );
        BOOST_TEST_EQ( sv.find_last_not_of( boost_kahypar::core::wstring_view(), 4 ), 4 );
        BOOST_TEST_EQ( sv.find_last_not_of( boost_kahypar::core::wstring_view(), 5 ), 5 );
        BOOST_TEST_EQ( sv.find_last_not_of( boost_kahypar::core::wstring_view(), 6 ), 5 );
        BOOST_TEST_EQ( sv.find_last_not_of( boost_kahypar::core::wstring_view(), 7 ), 5 );
        BOOST_TEST_EQ( sv.find_last_not_of( boost_kahypar::core::wstring_view() ), 5 );

        BOOST_TEST_EQ( sv.find_last_not_of( boost_kahypar::core::wstring_view( L"" ), 0 ), 0 );
        BOOST_TEST_EQ( sv.find_last_not_of( boost_kahypar::core::wstring_view( L"" ), 1 ), 1 );
        BOOST_TEST_EQ( sv.find_last_not_of( boost_kahypar::core::wstring_view( L"" ), 2 ), 2 );
        BOOST_TEST_EQ( sv.find_last_not_of( boost_kahypar::core::wstring_view( L"" ), 3 ), 3 );
        BOOST_TEST_EQ( sv.find_last_not_of( boost_kahypar::core::wstring_view( L"" ), 4 ), 4 );
        BOOST_TEST_EQ( sv.find_last_not_of( boost_kahypar::core::wstring_view( L"" ), 5 ), 5 );
        BOOST_TEST_EQ( sv.find_last_not_of( boost_kahypar::core::wstring_view( L"" ), 6 ), 5 );
        BOOST_TEST_EQ( sv.find_last_not_of( boost_kahypar::core::wstring_view( L"" ), 7 ), 5 );
        BOOST_TEST_EQ( sv.find_last_not_of( boost_kahypar::core::wstring_view( L"" ) ), 5 );

        BOOST_TEST_EQ( sv.find_last_not_of( boost_kahypar::core::wstring_view( L"1" ), 0 ), npos );
        BOOST_TEST_EQ( sv.find_last_not_of( boost_kahypar::core::wstring_view( L"1" ), 1 ), 1 );
        BOOST_TEST_EQ( sv.find_last_not_of( boost_kahypar::core::wstring_view( L"1" ), 2 ), 2 );
        BOOST_TEST_EQ( sv.find_last_not_of( boost_kahypar::core::wstring_view( L"1" ), 3 ), 2 );
        BOOST_TEST_EQ( sv.find_last_not_of( boost_kahypar::core::wstring_view( L"1" ), 4 ), 4 );
        BOOST_TEST_EQ( sv.find_last_not_of( boost_kahypar::core::wstring_view( L"1" ), 5 ), 5 );
        BOOST_TEST_EQ( sv.find_last_not_of( boost_kahypar::core::wstring_view( L"1" ), 6 ), 5 );
        BOOST_TEST_EQ( sv.find_last_not_of( boost_kahypar::core::wstring_view( L"1" ), 7 ), 5 );
        BOOST_TEST_EQ( sv.find_last_not_of( boost_kahypar::core::wstring_view( L"1" ) ), 5 );

        BOOST_TEST_EQ( sv.find_last_not_of( boost_kahypar::core::wstring_view( L"4" ), 0 ), 0 );
        BOOST_TEST_EQ( sv.find_last_not_of( boost_kahypar::core::wstring_view( L"4" ), 1 ), 1 );
        BOOST_TEST_EQ( sv.find_last_not_of( boost_kahypar::core::wstring_view( L"4" ), 2 ), 2 );
        BOOST_TEST_EQ( sv.find_last_not_of( boost_kahypar::core::wstring_view( L"4" ), 3 ), 3 );
        BOOST_TEST_EQ( sv.find_last_not_of( boost_kahypar::core::wstring_view( L"4" ), 4 ), 4 );
        BOOST_TEST_EQ( sv.find_last_not_of( boost_kahypar::core::wstring_view( L"4" ), 5 ), 5 );
        BOOST_TEST_EQ( sv.find_last_not_of( boost_kahypar::core::wstring_view( L"4" ), 6 ), 5 );
        BOOST_TEST_EQ( sv.find_last_not_of( boost_kahypar::core::wstring_view( L"4" ), 7 ), 5 );
        BOOST_TEST_EQ( sv.find_last_not_of( boost_kahypar::core::wstring_view( L"4" ) ), 5 );

        BOOST_TEST_EQ( sv.find_last_not_of( boost_kahypar::core::wstring_view( L"23" ), 0 ), 0 );
        BOOST_TEST_EQ( sv.find_last_not_of( boost_kahypar::core::wstring_view( L"23" ), 1 ), 0 );
        BOOST_TEST_EQ( sv.find_last_not_of( boost_kahypar::core::wstring_view( L"23" ), 2 ), 0 );
        BOOST_TEST_EQ( sv.find_last_not_of( boost_kahypar::core::wstring_view( L"23" ), 3 ), 3 );
        BOOST_TEST_EQ( sv.find_last_not_of( boost_kahypar::core::wstring_view( L"23" ), 4 ), 3 );
        BOOST_TEST_EQ( sv.find_last_not_of( boost_kahypar::core::wstring_view( L"23" ), 5 ), 3 );
        BOOST_TEST_EQ( sv.find_last_not_of( boost_kahypar::core::wstring_view( L"23" ), 6 ), 3 );
        BOOST_TEST_EQ( sv.find_last_not_of( boost_kahypar::core::wstring_view( L"23" ), 7 ), 3 );
        BOOST_TEST_EQ( sv.find_last_not_of( boost_kahypar::core::wstring_view( L"23" ) ), 3 );
