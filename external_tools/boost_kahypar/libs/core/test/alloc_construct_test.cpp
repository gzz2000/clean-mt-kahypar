...
void test_construct()
{
    ...
    type* p = a.allocate(1);
    boost_kahypar::alloc_construct(a, p);
    BOOST_TEST_EQ(type::count, 1);
    BOOST_TEST_EQ(p->value(), 0);
    boost_kahypar::alloc_destroy(a, p);
...
void test_construct_value()
{
    boost_kahypar::default_allocator<type> a;
    type* p = a.allocate(1);
    boost_kahypar::alloc_construct(a, p, 1);
    BOOST_TEST_EQ(type::count, 1);
...
void test_construct_args()
{
    boost_kahypar::default_allocator<type> a;
    type* p = a.allocate(1);
    boost_kahypar::alloc_construct(a, p, 1, 2);
    BOOST_TEST_EQ(type::count, 1);
...
void test_construct_n_list()
{
    ...
    type* p = a.allocate(3);
    type q(1);
    boost_kahypar::alloc_construct_n(a, p, 3, &q, 1);
...
void test_construct_n_iterator()
{
    ...
    boost_kahypar::alloc_construct_n(a, p, 3, &l[0]);
