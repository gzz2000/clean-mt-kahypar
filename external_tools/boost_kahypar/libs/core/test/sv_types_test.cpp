...
int main()
{
    typedef boost_kahypar::core::basic_string_view<Ch> ch_string_view;
    ...
    BOOST_TEST_TRAIT_SAME(boost_kahypar::core::string_view, boost_kahypar::core::basic_string_view<char>);
    BOOST_TEST_TRAIT_SAME(boost_kahypar::core::wstring_view, boost_kahypar::core::basic_string_view<wchar_t>);
#if !defined(BOOST_NO_CXX11_CHAR16_T)
    BOOST_TEST_TRAIT_SAME(boost_kahypar::core::u16string_view, boost_kahypar::core::basic_string_view<char16_t>);
#endif
#if !defined(BOOST_NO_CXX11_CHAR32_T)
    BOOST_TEST_TRAIT_SAME(boost_kahypar::core::u32string_view, boost_kahypar::core::basic_string_view<char32_t>);
#endif
#if defined(__cpp_char8_t) && __cpp_char8_t >= 201811L
    BOOST_TEST_TRAIT_SAME(boost_kahypar::core::u8string_view, boost_kahypar::core::basic_string_view<char8_t>);
#endif
