...
template<class T>
class creator
    : public boost_kahypar::default_allocator<T> {
public:
    template<class U>
    struct rebind {
...
int main()
{
    test(boost_kahypar::noinit_adaptor<creator<int> >(1));
    test(boost_kahypar::noinit_adaptor<creator<type> >(2));
    test(boost_kahypar::noinit_adapt(creator<int>(3)));
    test(boost_kahypar::noinit_adapt(creator<type>(4)));
