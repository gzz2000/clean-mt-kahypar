 ...
 * \date   06.12.2022
 *
 * This file contains tests for \c boost_kahypar::core::snprintf.
 */
...
void test_snprintf()
{
    ...
    int res = boost_kahypar::core::snprintf(buf, buf_size, "%s", "0123");
    BOOST_TEST_EQ(res, 4);
    ...
    res = boost_kahypar::core::snprintf(buf, buf_size, "%s", str);
    ...
    res = boost_kahypar::core::snprintf(buf, 0, "%s", str);
    BOOST_TEST_GE(res, 0);
...
void test_swprintf()
{
    ...
    int res = boost_kahypar::core::swprintf(buf, buf_size, L"%ls", L"0123");
    BOOST_TEST_EQ(res, 4);
    ...
    res = boost_kahypar::core::swprintf(buf, buf_size, L"%ls", str);
    BOOST_TEST_LT(res, 0);
    ...
    res = boost_kahypar::core::swprintf(buf, 0, L"%ls", str);
    BOOST_TEST_LT(res, 0);
