...
{
    BOOST_TEST( boost_kahypar::core::isfinite( x ) );
    BOOST_TEST( !boost_kahypar::core::isinf( x ) );
    BOOST_TEST( !boost_kahypar::core::isnan( x ) );
    BOOST_TEST( boost_kahypar::core::isnormal( x ) );

    BOOST_TEST_EQ( boost_kahypar::core::fpclassify( x ), boost_kahypar::core::fp_normal );

    BOOST_TEST( !boost_kahypar::core::signbit( x ) );

    BOOST_TEST_EQ( boost_kahypar::core::copysign( T(+2), x ), T(+2) );
    BOOST_TEST_EQ( boost_kahypar::core::copysign( T(-2), x ), T(+2) );
}
...
template<class T> void test_positive_zero( T x )
{
    ...
    BOOST_TEST_EQ( boost_kahypar::core::fpclassify( x ), boost_kahypar::core::fp_zero );
...
template<class T> void test_positive_infinity( T x )
{
    ...
    BOOST_TEST_EQ( boost_kahypar::core::fpclassify( x ), boost_kahypar::core::fp_infinite );
...
template<class T> void test_positive_nan( T x )
{
    ...
    BOOST_TEST_EQ( boost_kahypar::core::fpclassify( x ), boost_kahypar::core::fp_nan );
...
template<class T> void test_positive_subnormal( T x )
{
    ...
    BOOST_TEST_EQ( boost_kahypar::core::fpclassify( x ), boost_kahypar::core::fp_subnormal );
...
template<class T> void test_positive_normal_( T x )
{
    ...
    test_positive_normal( boost_kahypar::core::copysign( x, T(+1) ) );
    test_negative_normal( boost_kahypar::core::copysign( x, T(-1) ) );
}
...
template<class T> void test_positive_zero_( T x )
{
    ...
    test_positive_zero( boost_kahypar::core::copysign( x, T(+1) ) );
    test_negative_zero( boost_kahypar::core::copysign( x, T(-1) ) );
}
...
template<class T> void test_positive_infinity_( T x )
{
    ...
    test_positive_infinity( boost_kahypar::core::copysign( x, T(+1) ) );
    test_negative_infinity( boost_kahypar::core::copysign( x, T(-1) ) );
}
...
{
    test_positive_nan( x );
    test_positive_nan( boost_kahypar::core::copysign( x, T(+1) ) );
    test_negative_nan( boost_kahypar::core::copysign( x, T(-1) ) );
}
...
template<class T> void test_positive_subnormal_( T x )
{
    ...
    test_positive_subnormal( boost_kahypar::core::copysign( x, T(+1) ) );
    test_negative_subnormal( boost_kahypar::core::copysign( x, T(-1) ) );
}
...
int main()
{
    ...
    test_negative_nan_( boost_kahypar::core::copysign( std::numeric_limits<float>::quiet_NaN(), -1.0f ) );
    ...
    test_negative_nan_( boost_kahypar::core::copysign( std::numeric_limits<double>::quiet_NaN(), -1.0 ) );
    ...
    test_negative_nan_( boost_kahypar::core::copysign( std::numeric_limits<long double>::quiet_NaN(), -1.0l ) );
