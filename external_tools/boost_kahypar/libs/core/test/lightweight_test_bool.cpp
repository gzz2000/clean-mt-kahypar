...
int main()
{
    ...
    BOOST_TEST( BOOST_TEST_ALL_WITH(v1.begin(), v1.end(), v1.begin(), v1.end(), boost_kahypar::detail::lw_test_eq()) );
    BOOST_TEST_NOT( BOOST_TEST_ALL_WITH(v1.begin(), v1.end(), v2.begin(), v2.end(), boost_kahypar::detail::lw_test_eq()) );
    ...
    return boost_kahypar::report_errors() == 14? 0: 1;
}
