...
{
    std::string s1("a");
    BOOST_TEST(boost_kahypar::identity()(s1) == s1);
    BOOST_TEST(&boost_kahypar::identity()(s1) == &s1);
    BOOST_TEST(test(boost_kahypar::identity()(s1)));
    const std::string s2("a");
    BOOST_TEST(boost_kahypar::identity()(s2) == s2);
    BOOST_TEST(&boost_kahypar::identity()(s2) == &s2);
    BOOST_TEST(test(boost_kahypar::identity()(s2)));
}
