...
int main()
{
    std::size_t const npos = boost_kahypar::core::string_view::npos;

    {
        boost_kahypar::core::string_view sv( "" );

        BOOST_TEST_EQ( sv.find_first_not_of( boost_kahypar::core::string_view() ), npos );
        BOOST_TEST_EQ( sv.find_first_not_of( boost_kahypar::core::string_view(), 1 ), npos );

        BOOST_TEST_EQ( sv.find_first_not_of( boost_kahypar::core::string_view( "" ) ), npos );
        BOOST_TEST_EQ( sv.find_first_not_of( boost_kahypar::core::string_view( "" ), 1 ), npos );

        BOOST_TEST_EQ( sv.find_first_not_of( boost_kahypar::core::string_view( "1" ) ), npos );
        BOOST_TEST_EQ( sv.find_first_not_of( boost_kahypar::core::string_view( "1" ), 1 ), npos );
    ...
    {
        boost_kahypar::core::wstring_view sv( L"" );

        BOOST_TEST_EQ( sv.find_first_not_of( boost_kahypar::core::wstring_view() ), npos );
        BOOST_TEST_EQ( sv.find_first_not_of( boost_kahypar::core::wstring_view(), 1 ), npos );

        BOOST_TEST_EQ( sv.find_first_not_of( boost_kahypar::core::wstring_view( L"" ) ), npos );
        BOOST_TEST_EQ( sv.find_first_not_of( boost_kahypar::core::wstring_view( L"" ), 1 ), npos );

        BOOST_TEST_EQ( sv.find_first_not_of( boost_kahypar::core::wstring_view( L"1" ) ), npos );
        BOOST_TEST_EQ( sv.find_first_not_of( boost_kahypar::core::wstring_view( L"1" ), 1 ), npos );
    ...
    {
        boost_kahypar::core::string_view sv( "123123" );

        BOOST_TEST_EQ( sv.find_first_not_of( boost_kahypar::core::string_view() ), 0 );
        BOOST_TEST_EQ( sv.find_first_not_of( boost_kahypar::core::string_view(), 0 ), 0 );
        BOOST_TEST_EQ( sv.find_first_not_of( boost_kahypar::core::string_view(), 1 ), 1 );
        BOOST_TEST_EQ( sv.find_first_not_of( boost_kahypar::core::string_view(), 2 ), 2 );
        BOOST_TEST_EQ( sv.find_first_not_of( boost_kahypar::core::string_view(), 3 ), 3 );
        BOOST_TEST_EQ( sv.find_first_not_of( boost_kahypar::core::string_view(), 4 ), 4 );
        BOOST_TEST_EQ( sv.find_first_not_of( boost_kahypar::core::string_view(), 5 ), 5 );
        BOOST_TEST_EQ( sv.find_first_not_of( boost_kahypar::core::string_view(), 6 ), npos );
        BOOST_TEST_EQ( sv.find_first_not_of( boost_kahypar::core::string_view(), 7 ), npos );
        ...
        BOOST_TEST_EQ( sv.find_first_not_of( boost_kahypar::core::string_view( "1" ) ), 1 );
        BOOST_TEST_EQ( sv.find_first_not_of( boost_kahypar::core::string_view( "1" ), 0 ), 1 );
        BOOST_TEST_EQ( sv.find_first_not_of( boost_kahypar::core::string_view( "1" ), 1 ), 1 );
        BOOST_TEST_EQ( sv.find_first_not_of( boost_kahypar::core::string_view( "1" ), 2 ), 2 );
        BOOST_TEST_EQ( sv.find_first_not_of( boost_kahypar::core::string_view( "1" ), 3 ), 4 );
        BOOST_TEST_EQ( sv.find_first_not_of( boost_kahypar::core::string_view( "1" ), 4 ), 4 );
        BOOST_TEST_EQ( sv.find_first_not_of( boost_kahypar::core::string_view( "1" ), 5 ), 5 );
        BOOST_TEST_EQ( sv.find_first_not_of( boost_kahypar::core::string_view( "1" ), 6 ), npos );
        BOOST_TEST_EQ( sv.find_first_not_of( boost_kahypar::core::string_view( "1" ), 7 ), npos );

        BOOST_TEST_EQ( sv.find_first_not_of( boost_kahypar::core::string_view( "4" ) ), 0 );
        BOOST_TEST_EQ( sv.find_first_not_of( boost_kahypar::core::string_view( "4" ), 0 ), 0 );
        BOOST_TEST_EQ( sv.find_first_not_of( boost_kahypar::core::string_view( "4" ), 1 ), 1 );
        BOOST_TEST_EQ( sv.find_first_not_of( boost_kahypar::core::string_view( "4" ), 2 ), 2 );
        BOOST_TEST_EQ( sv.find_first_not_of( boost_kahypar::core::string_view( "4" ), 3 ), 3 );
        BOOST_TEST_EQ( sv.find_first_not_of( boost_kahypar::core::string_view( "4" ), 4 ), 4 );
        BOOST_TEST_EQ( sv.find_first_not_of( boost_kahypar::core::string_view( "4" ), 5 ), 5 );
        BOOST_TEST_EQ( sv.find_first_not_of( boost_kahypar::core::string_view( "4" ), 6 ), npos );
        BOOST_TEST_EQ( sv.find_first_not_of( boost_kahypar::core::string_view( "4" ), 7 ), npos );

        BOOST_TEST_EQ( sv.find_first_not_of( boost_kahypar::core::string_view( "23" ) ), 0 );
        BOOST_TEST_EQ( sv.find_first_not_of( boost_kahypar::core::string_view( "23" ), 0 ), 0 );
        BOOST_TEST_EQ( sv.find_first_not_of( boost_kahypar::core::string_view( "23" ), 1 ), 3 );
        BOOST_TEST_EQ( sv.find_first_not_of( boost_kahypar::core::string_view( "23" ), 2 ), 3 );
        BOOST_TEST_EQ( sv.find_first_not_of( boost_kahypar::core::string_view( "23" ), 3 ), 3 );
        BOOST_TEST_EQ( sv.find_first_not_of( boost_kahypar::core::string_view( "23" ), 4 ), npos );
        BOOST_TEST_EQ( sv.find_first_not_of( boost_kahypar::core::string_view( "23" ), 5 ), npos );
        BOOST_TEST_EQ( sv.find_first_not_of( boost_kahypar::core::string_view( "23" ), 6 ), npos );
        BOOST_TEST_EQ( sv.find_first_not_of( boost_kahypar::core::string_view( "23" ), 7 ), npos );
    ...
    {
        boost_kahypar::core::wstring_view sv( L"123123" );

        BOOST_TEST_EQ( sv.find_first_not_of( boost_kahypar::core::wstring_view() ), 0 );
        BOOST_TEST_EQ( sv.find_first_not_of( boost_kahypar::core::wstring_view(), 0 ), 0 );
        BOOST_TEST_EQ( sv.find_first_not_of( boost_kahypar::core::wstring_view(), 1 ), 1 );
        BOOST_TEST_EQ( sv.find_first_not_of( boost_kahypar::core::wstring_view(), 2 ), 2 );
        BOOST_TEST_EQ( sv.find_first_not_of( boost_kahypar::core::wstring_view(), 3 ), 3 );
        BOOST_TEST_EQ( sv.find_first_not_of( boost_kahypar::core::wstring_view(), 4 ), 4 );
        BOOST_TEST_EQ( sv.find_first_not_of( boost_kahypar::core::wstring_view(), 5 ), 5 );
        BOOST_TEST_EQ( sv.find_first_not_of( boost_kahypar::core::wstring_view(), 6 ), npos );
        BOOST_TEST_EQ( sv.find_first_not_of( boost_kahypar::core::wstring_view(), 7 ), npos );

        BOOST_TEST_EQ( sv.find_first_not_of( boost_kahypar::core::wstring_view( L"" ) ), 0 );
        BOOST_TEST_EQ( sv.find_first_not_of( boost_kahypar::core::wstring_view( L"" ), 0 ), 0 );
        BOOST_TEST_EQ( sv.find_first_not_of( boost_kahypar::core::wstring_view( L"" ), 1 ), 1 );
        BOOST_TEST_EQ( sv.find_first_not_of( boost_kahypar::core::wstring_view( L"" ), 2 ), 2 );
        BOOST_TEST_EQ( sv.find_first_not_of( boost_kahypar::core::wstring_view( L"" ), 3 ), 3 );
        BOOST_TEST_EQ( sv.find_first_not_of( boost_kahypar::core::wstring_view( L"" ), 4 ), 4 );
        BOOST_TEST_EQ( sv.find_first_not_of( boost_kahypar::core::wstring_view( L"" ), 5 ), 5 );
        BOOST_TEST_EQ( sv.find_first_not_of( boost_kahypar::core::wstring_view( L"" ), 6 ), npos );
        BOOST_TEST_EQ( sv.find_first_not_of( boost_kahypar::core::wstring_view( L"" ), 7 ), npos );

        BOOST_TEST_EQ( sv.find_first_not_of( boost_kahypar::core::wstring_view( L"1" ) ), 1 );
        BOOST_TEST_EQ( sv.find_first_not_of( boost_kahypar::core::wstring_view( L"1" ), 0 ), 1 );
        BOOST_TEST_EQ( sv.find_first_not_of( boost_kahypar::core::wstring_view( L"1" ), 1 ), 1 );
        BOOST_TEST_EQ( sv.find_first_not_of( boost_kahypar::core::wstring_view( L"1" ), 2 ), 2 );
        BOOST_TEST_EQ( sv.find_first_not_of( boost_kahypar::core::wstring_view( L"1" ), 3 ), 4 );
        BOOST_TEST_EQ( sv.find_first_not_of( boost_kahypar::core::wstring_view( L"1" ), 4 ), 4 );
        BOOST_TEST_EQ( sv.find_first_not_of( boost_kahypar::core::wstring_view( L"1" ), 5 ), 5 );
        BOOST_TEST_EQ( sv.find_first_not_of( boost_kahypar::core::wstring_view( L"1" ), 6 ), npos );
        BOOST_TEST_EQ( sv.find_first_not_of( boost_kahypar::core::wstring_view( L"1" ), 7 ), npos );

        BOOST_TEST_EQ( sv.find_first_not_of( boost_kahypar::core::wstring_view( L"4" ) ), 0 );
        BOOST_TEST_EQ( sv.find_first_not_of( boost_kahypar::core::wstring_view( L"4" ), 0 ), 0 );
        BOOST_TEST_EQ( sv.find_first_not_of( boost_kahypar::core::wstring_view( L"4" ), 1 ), 1 );
        BOOST_TEST_EQ( sv.find_first_not_of( boost_kahypar::core::wstring_view( L"4" ), 2 ), 2 );
        BOOST_TEST_EQ( sv.find_first_not_of( boost_kahypar::core::wstring_view( L"4" ), 3 ), 3 );
        BOOST_TEST_EQ( sv.find_first_not_of( boost_kahypar::core::wstring_view( L"4" ), 4 ), 4 );
        BOOST_TEST_EQ( sv.find_first_not_of( boost_kahypar::core::wstring_view( L"4" ), 5 ), 5 );
        BOOST_TEST_EQ( sv.find_first_not_of( boost_kahypar::core::wstring_view( L"4" ), 6 ), npos );
        BOOST_TEST_EQ( sv.find_first_not_of( boost_kahypar::core::wstring_view( L"4" ), 7 ), npos );

        BOOST_TEST_EQ( sv.find_first_not_of( boost_kahypar::core::wstring_view( L"23" ) ), 0 );
        BOOST_TEST_EQ( sv.find_first_not_of( boost_kahypar::core::wstring_view( L"23" ), 0 ), 0 );
        BOOST_TEST_EQ( sv.find_first_not_of( boost_kahypar::core::wstring_view( L"23" ), 1 ), 3 );
        BOOST_TEST_EQ( sv.find_first_not_of( boost_kahypar::core::wstring_view( L"23" ), 2 ), 3 );
        BOOST_TEST_EQ( sv.find_first_not_of( boost_kahypar::core::wstring_view( L"23" ), 3 ), 3 );
        BOOST_TEST_EQ( sv.find_first_not_of( boost_kahypar::core::wstring_view( L"23" ), 4 ), npos );
        BOOST_TEST_EQ( sv.find_first_not_of( boost_kahypar::core::wstring_view( L"23" ), 5 ), npos );
        BOOST_TEST_EQ( sv.find_first_not_of( boost_kahypar::core::wstring_view( L"23" ), 6 ), npos );
        BOOST_TEST_EQ( sv.find_first_not_of( boost_kahypar::core::wstring_view( L"23" ), 7 ), npos );
    ...
    {
        boost_kahypar::core::wstring_view sv( L"\x101\x102\x103\x101\x102\x103" );
    ...
    {
        boost_kahypar::core::string_view sv( "123a123B123c" );
    ...
    {
        boost_kahypar::core::wstring_view sv( L"123a123B123c" );
    ...
    {
        boost_kahypar::core::string_view sv( "abc1abc2abc3" );
    ...
    {
        boost_kahypar::core::wstring_view sv( L"abc1abc2abc3" );
...

    {
        ...
        boost_kahypar::core::string_view sv( str, 256 );
...

    {
        ...
        boost_kahypar::core::wstring_view sv( str, 256 );
    ...
    {
        boost_kahypar::core::u8string_view sv( u8"123123" );
    ...
    {
        boost_kahypar::core::u8string_view sv( u8"123a123B123c" );
    ...
    {
        boost_kahypar::core::u8string_view sv( u8"abc1abc2abc3" );
