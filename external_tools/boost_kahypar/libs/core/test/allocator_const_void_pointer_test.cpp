...
int main()
{
    BOOST_TEST_TRAIT_TRUE((boost_kahypar::core::detail::is_same<int*,
        boost_kahypar::allocator_const_void_pointer<A1<char> >::type>));
    BOOST_TEST_TRAIT_TRUE((boost_kahypar::core::detail::is_same<const void*,
        boost_kahypar::allocator_const_void_pointer<A2<int> >::type>));
