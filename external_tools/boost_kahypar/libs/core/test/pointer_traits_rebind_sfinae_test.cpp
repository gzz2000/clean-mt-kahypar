...
int main()
{
    BOOST_TEST((!has_rebind<boost_kahypar::pointer_traits<P1>, char>::value));
    BOOST_TEST((!has_rebind<boost_kahypar::pointer_traits<P2>, char>::value));
    BOOST_TEST((has_rebind<boost_kahypar::pointer_traits<P3>, char>::value));
    BOOST_TEST((has_rebind<boost_kahypar::pointer_traits<P4>, char>::value));
    BOOST_TEST((has_rebind<boost_kahypar::pointer_traits<int*>, char>::value));
