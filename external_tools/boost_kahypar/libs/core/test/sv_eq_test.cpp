...
{
    {
        boost_kahypar::core::string_view sv1( "" );
        boost_kahypar::core::string_view sv2( "" );
        boost_kahypar::core::string_view sv3( "123" );
        boost_kahypar::core::string_view sv4( "123" );
        boost_kahypar::core::string_view sv5( "12345" );
        boost_kahypar::core::string_view sv6( "12345" );
