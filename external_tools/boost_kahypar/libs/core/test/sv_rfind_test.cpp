...
int main()
{
...

    {
        ...
        BOOST_TEST_EQ( sv.rfind( boost_kahypar::core::string_view() ), 0 );
        BOOST_TEST_EQ( sv.rfind( boost_kahypar::core::string_view(), 1 ), 0 );
        BOOST_TEST_EQ( sv.rfind( boost_kahypar::core::string_view(), 0 ), 0 );

        BOOST_TEST_EQ( sv.rfind( boost_kahypar::core::string_view( "" ) ), 0 );
        BOOST_TEST_EQ( sv.rfind( boost_kahypar::core::string_view( "" ), 1 ), 0 );
        BOOST_TEST_EQ( sv.rfind( boost_kahypar::core::string_view( "" ), 0 ), 0 );

        BOOST_TEST_EQ( sv.rfind( boost_kahypar::core::string_view( "1" ) ), npos );
        BOOST_TEST_EQ( sv.rfind( boost_kahypar::core::string_view( "1" ), 1 ), npos );
        BOOST_TEST_EQ( sv.rfind( boost_kahypar::core::string_view( "1" ), 0 ), npos );
...

    {
        ...
        BOOST_TEST_EQ( sv.rfind( boost_kahypar::core::string_view() ), 6 );
        BOOST_TEST_EQ( sv.rfind( boost_kahypar::core::string_view(), 7 ), 6 );
        BOOST_TEST_EQ( sv.rfind( boost_kahypar::core::string_view(), 6 ), 6 );
        BOOST_TEST_EQ( sv.rfind( boost_kahypar::core::string_view(), 5 ), 5 );
        BOOST_TEST_EQ( sv.rfind( boost_kahypar::core::string_view(), 1 ), 1 );
        BOOST_TEST_EQ( sv.rfind( boost_kahypar::core::string_view(), 0 ), 0 );
        ...
        BOOST_TEST_EQ( sv.rfind( boost_kahypar::core::string_view( "1" ) ), 3 );
        BOOST_TEST_EQ( sv.rfind( boost_kahypar::core::string_view( "1" ), 7 ), 3 );
        BOOST_TEST_EQ( sv.rfind( boost_kahypar::core::string_view( "1" ), 6 ), 3 );
        BOOST_TEST_EQ( sv.rfind( boost_kahypar::core::string_view( "1" ), 5 ), 3 );
        BOOST_TEST_EQ( sv.rfind( boost_kahypar::core::string_view( "1" ), 4 ), 3 );
        BOOST_TEST_EQ( sv.rfind( boost_kahypar::core::string_view( "1" ), 3 ), 3 );
        BOOST_TEST_EQ( sv.rfind( boost_kahypar::core::string_view( "1" ), 2 ), 0 );
        BOOST_TEST_EQ( sv.rfind( boost_kahypar::core::string_view( "1" ), 1 ), 0 );
        BOOST_TEST_EQ( sv.rfind( boost_kahypar::core::string_view( "1" ), 0 ), 0 );

        BOOST_TEST_EQ( sv.rfind( boost_kahypar::core::string_view( "23" ) ), 4 );
        BOOST_TEST_EQ( sv.rfind( boost_kahypar::core::string_view( "23" ), 7 ), 4 );
        BOOST_TEST_EQ( sv.rfind( boost_kahypar::core::string_view( "23" ), 6 ), 4 );
        BOOST_TEST_EQ( sv.rfind( boost_kahypar::core::string_view( "23" ), 5 ), 4 );
        BOOST_TEST_EQ( sv.rfind( boost_kahypar::core::string_view( "23" ), 4 ), 4 );
        BOOST_TEST_EQ( sv.rfind( boost_kahypar::core::string_view( "23" ), 3 ), 1 );
        BOOST_TEST_EQ( sv.rfind( boost_kahypar::core::string_view( "23" ), 2 ), 1 );
        BOOST_TEST_EQ( sv.rfind( boost_kahypar::core::string_view( "23" ), 1 ), 1 );
        BOOST_TEST_EQ( sv.rfind( boost_kahypar::core::string_view( "23" ), 0 ), npos );
