...
private:
    ...
    {
        boost_kahypar::core::load_construct_data_adl( ar, &x1, v );
        ar >> x1;

        boost_kahypar::core::load_construct_data_adl( ar, &x2, v );
        ar >> x2;
    }

    template<class Ar> void save( Ar& ar, unsigned v ) const
    {
        boost_kahypar::core::save_construct_data_adl( ar, &x1, v );
        ar << x1;

        boost_kahypar::core::save_construct_data_adl( ar, &x2, v );
        ar << x2;
    }
