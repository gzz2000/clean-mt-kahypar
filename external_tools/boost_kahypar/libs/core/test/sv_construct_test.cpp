...
{
    {
        ...
        BOOST_TEST_EQ( sv.max_size(), boost_kahypar::core::string_view::npos );
    }

    {
        char const* s = "";

        boost_kahypar::core::string_view sv( s );
...

    {
        ...
        boost_kahypar::core::string_view sv( s, 0 );
...

    {
        ...
        boost_kahypar::core::string_view sv( s, 2 );
...

    {
        ...
        boost_kahypar::core::string_view sv( s, s );
...

    {
        ...
        boost_kahypar::core::string_view sv( s, s + 2 );
...

    {
        ...
        boost_kahypar::core::string_view sv( str );
