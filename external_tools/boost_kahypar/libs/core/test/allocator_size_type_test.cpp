...
int main()
{
    BOOST_TEST_TRAIT_TRUE((boost_kahypar::is_same<int,
        boost_kahypar::allocator_size_type<A1<char> >::type>));
#if !defined(BOOST_NO_CXX11_ALLOCATOR)
    BOOST_TEST_TRAIT_TRUE((boost_kahypar::is_same<
        boost_kahypar::make_unsigned<std::ptrdiff_t>::type,
        boost_kahypar::allocator_size_type<A2<int> >::type>));
#endif
