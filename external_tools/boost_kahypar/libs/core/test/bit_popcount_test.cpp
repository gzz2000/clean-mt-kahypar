...
template<class T> void test_popcount( T x )
{
    ...
    BOOST_TEST_EQ( boost_kahypar::core::popcount( x ), k ) || ( std::cerr << "x: " << +x << std::endl );
}
...
{
    {
        ...
        test_popcount( static_cast<boost_kahypar::ulong_long_type>( 0 ) );
    }
    ...
    for( int i = 0; i < 1000; ++i )
    {
        ...
        test_popcount( static_cast<boost_kahypar::ulong_long_type>( x ) );
    }
