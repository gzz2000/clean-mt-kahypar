...
void test_int()
{
    const boost_kahypar::empty_value<int> v1(boost_kahypar::empty_init_t(), 7);
    BOOST_TEST(v1.get() == 7);
    boost_kahypar::empty_value<int> v2 = boost_kahypar::empty_init_t();
    BOOST_TEST(v2.get() == 0);
    v2 = v1;
    BOOST_TEST(v2.get() == 7);
    v2.get() = 8;
...
void test_type()
{
    const boost_kahypar::empty_value<type> v1(boost_kahypar::empty_init_t(), 2);
