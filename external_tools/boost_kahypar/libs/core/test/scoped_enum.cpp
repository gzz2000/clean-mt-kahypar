...
void check_switch_case()
{
    ...
    switch (boost_kahypar::native_value(str.get_color()))
    {
...
void check_native_type()
{
    ...
    BOOST_TEST(my_trait< boost_kahypar::native_type< namespace_enum2 >::type >::value != 0);

    namespace_enum2 enum1 = namespace_enum2::value0;
    native_type_helper(boost_kahypar::native_value(enum1));
}

void check_underlying_cast()
{
    namespace_enum2 enum1 = namespace_enum2::value1;
    BOOST_TEST(boost_kahypar::underlying_cast< unsigned char >(enum1) == 20);
}
