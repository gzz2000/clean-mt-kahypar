...
int main()
{
...

    {
        ...
        BOOST_TEST_EQ( sv.find_first_of( boost_kahypar::core::string_view() ), npos );
        BOOST_TEST_EQ( sv.find_first_of( boost_kahypar::core::string_view(), 1 ), npos );

        BOOST_TEST_EQ( sv.find_first_of( boost_kahypar::core::string_view( "" ) ), npos );
        BOOST_TEST_EQ( sv.find_first_of( boost_kahypar::core::string_view( "" ), 1 ), npos );

        BOOST_TEST_EQ( sv.find_first_of( boost_kahypar::core::string_view( "1" ) ), npos );
        BOOST_TEST_EQ( sv.find_first_of( boost_kahypar::core::string_view( "1" ), 1 ), npos );
...

    {
        ...
        BOOST_TEST_EQ( sv.find_first_of( boost_kahypar::core::wstring_view() ), npos );
        BOOST_TEST_EQ( sv.find_first_of( boost_kahypar::core::wstring_view(), 1 ), npos );

        BOOST_TEST_EQ( sv.find_first_of( boost_kahypar::core::wstring_view( L"" ) ), npos );
        BOOST_TEST_EQ( sv.find_first_of( boost_kahypar::core::wstring_view( L"" ), 1 ), npos );

        BOOST_TEST_EQ( sv.find_first_of( boost_kahypar::core::wstring_view( L"1" ) ), npos );
        BOOST_TEST_EQ( sv.find_first_of( boost_kahypar::core::wstring_view( L"1" ), 1 ), npos );
...

    {
        ...
        BOOST_TEST_EQ( sv.find_first_of( boost_kahypar::core::string_view() ), npos );
        BOOST_TEST_EQ( sv.find_first_of( boost_kahypar::core::string_view(), 1 ), npos );
        BOOST_TEST_EQ( sv.find_first_of( boost_kahypar::core::string_view(), 6 ), npos );
        BOOST_TEST_EQ( sv.find_first_of( boost_kahypar::core::string_view(), 7 ), npos );
        ...
        BOOST_TEST_EQ( sv.find_first_of( boost_kahypar::core::string_view( "1" ) ), 0 );
        BOOST_TEST_EQ( sv.find_first_of( boost_kahypar::core::string_view( "1" ), 1 ), 3 );
        BOOST_TEST_EQ( sv.find_first_of( boost_kahypar::core::string_view( "1" ), 2 ), 3 );
        BOOST_TEST_EQ( sv.find_first_of( boost_kahypar::core::string_view( "1" ), 3 ), 3 );
        BOOST_TEST_EQ( sv.find_first_of( boost_kahypar::core::string_view( "1" ), 4 ), npos );
        BOOST_TEST_EQ( sv.find_first_of( boost_kahypar::core::string_view( "1" ), 5 ), npos );
        BOOST_TEST_EQ( sv.find_first_of( boost_kahypar::core::string_view( "1" ), 6 ), npos );
        BOOST_TEST_EQ( sv.find_first_of( boost_kahypar::core::string_view( "1" ), 7 ), npos );

        BOOST_TEST_EQ( sv.find_first_of( boost_kahypar::core::string_view( "4" ) ), npos );
        BOOST_TEST_EQ( sv.find_first_of( boost_kahypar::core::string_view( "4" ), 1 ), npos );
        BOOST_TEST_EQ( sv.find_first_of( boost_kahypar::core::string_view( "4" ), 6 ), npos );
        BOOST_TEST_EQ( sv.find_first_of( boost_kahypar::core::string_view( "4" ), 7 ), npos );

        BOOST_TEST_EQ( sv.find_first_of( boost_kahypar::core::string_view( "23" ) ), 1 );
        BOOST_TEST_EQ( sv.find_first_of( boost_kahypar::core::string_view( "23" ), 1 ), 1 );
        BOOST_TEST_EQ( sv.find_first_of( boost_kahypar::core::string_view( "23" ), 2 ), 2 );
        BOOST_TEST_EQ( sv.find_first_of( boost_kahypar::core::string_view( "23" ), 3 ), 4 );
        BOOST_TEST_EQ( sv.find_first_of( boost_kahypar::core::string_view( "23" ), 4 ), 4 );
        BOOST_TEST_EQ( sv.find_first_of( boost_kahypar::core::string_view( "23" ), 5 ), 5 );
        BOOST_TEST_EQ( sv.find_first_of( boost_kahypar::core::string_view( "23" ), 6 ), npos );
        BOOST_TEST_EQ( sv.find_first_of( boost_kahypar::core::string_view( "23" ), 7 ), npos );
...

    {
        ...
        BOOST_TEST_EQ( sv.find_first_of( boost_kahypar::core::wstring_view() ), npos );
        BOOST_TEST_EQ( sv.find_first_of( boost_kahypar::core::wstring_view(), 1 ), npos );
        BOOST_TEST_EQ( sv.find_first_of( boost_kahypar::core::wstring_view(), 6 ), npos );
        BOOST_TEST_EQ( sv.find_first_of( boost_kahypar::core::wstring_view(), 7 ), npos );

        BOOST_TEST_EQ( sv.find_first_of( boost_kahypar::core::wstring_view( L"" ) ), npos );
        BOOST_TEST_EQ( sv.find_first_of( boost_kahypar::core::wstring_view( L"" ), 1 ), npos );
        BOOST_TEST_EQ( sv.find_first_of( boost_kahypar::core::wstring_view( L"" ), 6 ), npos );
        BOOST_TEST_EQ( sv.find_first_of( boost_kahypar::core::wstring_view( L"" ), 7 ), npos );

        BOOST_TEST_EQ( sv.find_first_of( boost_kahypar::core::wstring_view( L"1" ) ), 0 );
        BOOST_TEST_EQ( sv.find_first_of( boost_kahypar::core::wstring_view( L"1" ), 1 ), 3 );
        BOOST_TEST_EQ( sv.find_first_of( boost_kahypar::core::wstring_view( L"1" ), 2 ), 3 );
        BOOST_TEST_EQ( sv.find_first_of( boost_kahypar::core::wstring_view( L"1" ), 3 ), 3 );
        BOOST_TEST_EQ( sv.find_first_of( boost_kahypar::core::wstring_view( L"1" ), 4 ), npos );
        BOOST_TEST_EQ( sv.find_first_of( boost_kahypar::core::wstring_view( L"1" ), 5 ), npos );
        BOOST_TEST_EQ( sv.find_first_of( boost_kahypar::core::wstring_view( L"1" ), 6 ), npos );
        BOOST_TEST_EQ( sv.find_first_of( boost_kahypar::core::wstring_view( L"1" ), 7 ), npos );

        BOOST_TEST_EQ( sv.find_first_of( boost_kahypar::core::wstring_view( L"4" ) ), npos );
        BOOST_TEST_EQ( sv.find_first_of( boost_kahypar::core::wstring_view( L"4" ), 1 ), npos );
        BOOST_TEST_EQ( sv.find_first_of( boost_kahypar::core::wstring_view( L"4" ), 6 ), npos );
        BOOST_TEST_EQ( sv.find_first_of( boost_kahypar::core::wstring_view( L"4" ), 7 ), npos );

        BOOST_TEST_EQ( sv.find_first_of( boost_kahypar::core::wstring_view( L"23" ) ), 1 );
        BOOST_TEST_EQ( sv.find_first_of( boost_kahypar::core::wstring_view( L"23" ), 1 ), 1 );
        BOOST_TEST_EQ( sv.find_first_of( boost_kahypar::core::wstring_view( L"23" ), 2 ), 2 );
        BOOST_TEST_EQ( sv.find_first_of( boost_kahypar::core::wstring_view( L"23" ), 3 ), 4 );
        BOOST_TEST_EQ( sv.find_first_of( boost_kahypar::core::wstring_view( L"23" ), 4 ), 4 );
        BOOST_TEST_EQ( sv.find_first_of( boost_kahypar::core::wstring_view( L"23" ), 5 ), 5 );
        BOOST_TEST_EQ( sv.find_first_of( boost_kahypar::core::wstring_view( L"23" ), 6 ), npos );
        BOOST_TEST_EQ( sv.find_first_of( boost_kahypar::core::wstring_view( L"23" ), 7 ), npos );
