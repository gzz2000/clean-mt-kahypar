...
int main()
{
...

    {
        ...
        BOOST_TEST_EQ( sv.find( boost_kahypar::core::string_view() ), 0 );
        BOOST_TEST_EQ( sv.find( boost_kahypar::core::string_view(), 1 ), npos );

        BOOST_TEST_EQ( sv.find( boost_kahypar::core::string_view( "" ) ), 0 );
        BOOST_TEST_EQ( sv.find( boost_kahypar::core::string_view( "" ), 1 ), npos );

        BOOST_TEST_EQ( sv.find( boost_kahypar::core::string_view( "1" ) ), npos );
        BOOST_TEST_EQ( sv.find( boost_kahypar::core::string_view( "1" ), 1 ), npos );
...

    {
        ...
        BOOST_TEST_EQ( sv.find( boost_kahypar::core::string_view() ), 0 );
        BOOST_TEST_EQ( sv.find( boost_kahypar::core::string_view(), 1 ), 1 );
        BOOST_TEST_EQ( sv.find( boost_kahypar::core::string_view(), 6 ), 6 );
        BOOST_TEST_EQ( sv.find( boost_kahypar::core::string_view(), 7 ), npos );
        ...
        BOOST_TEST_EQ( sv.find( boost_kahypar::core::string_view( "1" ) ), 0 );
        BOOST_TEST_EQ( sv.find( boost_kahypar::core::string_view( "1" ), 1 ), 3 );
        BOOST_TEST_EQ( sv.find( boost_kahypar::core::string_view( "1" ), 3 ), 3 );
        BOOST_TEST_EQ( sv.find( boost_kahypar::core::string_view( "1" ), 4 ), npos );
        BOOST_TEST_EQ( sv.find( boost_kahypar::core::string_view( "1" ), 6 ), npos );
        BOOST_TEST_EQ( sv.find( boost_kahypar::core::string_view( "1" ), 7 ), npos );

        BOOST_TEST_EQ( sv.find( boost_kahypar::core::string_view( "23" ) ), 1 );
        BOOST_TEST_EQ( sv.find( boost_kahypar::core::string_view( "23" ), 1 ), 1 );
        BOOST_TEST_EQ( sv.find( boost_kahypar::core::string_view( "23" ), 2 ), 4 );
        BOOST_TEST_EQ( sv.find( boost_kahypar::core::string_view( "23" ), 4 ), 4 );
        BOOST_TEST_EQ( sv.find( boost_kahypar::core::string_view( "23" ), 5 ), npos );
        BOOST_TEST_EQ( sv.find( boost_kahypar::core::string_view( "23" ), 6 ), npos );
        BOOST_TEST_EQ( sv.find( boost_kahypar::core::string_view( "23" ), 7 ), npos );
