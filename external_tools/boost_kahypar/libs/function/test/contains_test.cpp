...
static void equal_test()
{
  ...
  boost_kahypar::function<int(void)> g;
...
static void ref_equal_test()
{
  {
    ReturnInt ri(17);
    boost_kahypar::function0<int> f = boost_kahypar::ref(ri);

    // References and values are equal
    BOOST_CHECK(f == boost_kahypar::ref(ri));
    BOOST_CHECK(f == ri);
    BOOST_CHECK(boost_kahypar::ref(ri) == f);
    BOOST_CHECK(!(f != boost_kahypar::ref(ri)));
    BOOST_CHECK(!(f != ri));
    BOOST_CHECK(!(boost_kahypar::ref(ri) != f));
    BOOST_CHECK(ri == f);
    ...
    ReturnInt ri2(17);
    BOOST_CHECK(f == ri2);
    BOOST_CHECK(f != boost_kahypar::ref(ri2));
    BOOST_CHECK(boost_kahypar::ref(ri2) != f);
    BOOST_CHECK(!(f != ri2));
    BOOST_CHECK(!(f == boost_kahypar::ref(ri2)));
    BOOST_CHECK(!(boost_kahypar::ref(ri2) == f));
    BOOST_CHECK(ri2 == f);
  ...
  {
    ReturnInt ri(17);
    boost_kahypar::function<int(void)> f = boost_kahypar::ref(ri);
