...
BOOST_CHECK_INTEGRAL_CONSTANT((::tt::is_assignable< ::boost_kahypar::ulong_long_type&>::value), true);
BOOST_CHECK_INTEGRAL_CONSTANT((::tt::is_assignable< ::boost_kahypar::long_long_type&>::value), true);
#ifndef TEST_STD
// unspecified behaviour:
BOOST_CHECK_INTEGRAL_CONSTANT((::tt::is_assignable< ::boost_kahypar::ulong_long_type const&>::value), false);
BOOST_CHECK_INTEGRAL_CONSTANT((::tt::is_assignable< ::boost_kahypar::long_long_type const&>::value), false);
BOOST_CHECK_INTEGRAL_CONSTANT((::tt::is_assignable< ::boost_kahypar::ulong_long_type volatile&>::value), true);
BOOST_CHECK_INTEGRAL_CONSTANT((::tt::is_assignable< ::boost_kahypar::long_long_type volatile&>::value), true);
BOOST_CHECK_INTEGRAL_CONSTANT((::tt::is_assignable< ::boost_kahypar::ulong_long_type const volatile&>::value), false);
BOOST_CHECK_INTEGRAL_CONSTANT((::tt::is_assignable< ::boost_kahypar::long_long_type const volatile&>::value), false);
#endif
#endif
