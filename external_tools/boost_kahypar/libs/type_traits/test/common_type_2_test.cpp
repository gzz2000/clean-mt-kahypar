...
BOOST_TT_PROC void proc2(typename boost_kahypar::common_type<A, C>::type const& ) {}

template <typename C, typename A, typename B>
BOOST_TT_PROC void proc3(typename boost_kahypar::common_type<C, A, B>::type const& ) {}

template <typename C, typename A>
BOOST_TT_PROC void assignation_2() {
typedef typename boost_kahypar::common_type<A, C>::type AC;
    A a;
    C c;
    AC ac;
    ac=a;
...
typedef typename boost_kahypar::common_type<C, A, B>::type ABC;
    A a;
    B b;
    C c;
    ABC abc;
...
TT_TEST_BEGIN(common_type)
{
    ...
    BOOST_CHECK_TYPE3(tt::common_type<char, boost_kahypar::long_long_type>::type, boost_kahypar::long_long_type);
    BOOST_CHECK_TYPE3(tt::common_type<char, boost_kahypar::ulong_long_type>::type, boost_kahypar::ulong_long_type);
#endif
...
#ifndef BOOST_NO_LONG_LONG
    BOOST_CHECK_TYPE3(tt::common_type<unsigned char, boost_kahypar::long_long_type>::type, boost_kahypar::long_long_type);
    BOOST_CHECK_TYPE3(tt::common_type<unsigned char, boost_kahypar::ulong_long_type>::type, boost_kahypar::ulong_long_type);
#endif
...
#ifndef BOOST_NO_LONG_LONG
    BOOST_CHECK_TYPE3(tt::common_type<short, boost_kahypar::long_long_type>::type, boost_kahypar::long_long_type);
    BOOST_CHECK_TYPE3(tt::common_type<short, boost_kahypar::ulong_long_type>::type, boost_kahypar::ulong_long_type);
#endif
...
#ifndef BOOST_NO_LONG_LONG
    BOOST_CHECK_TYPE3(tt::common_type<unsigned short, boost_kahypar::long_long_type>::type, boost_kahypar::long_long_type);
    BOOST_CHECK_TYPE3(tt::common_type<unsigned short, boost_kahypar::ulong_long_type>::type, boost_kahypar::ulong_long_type);
#endif
...
#ifndef BOOST_NO_LONG_LONG
    BOOST_CHECK_TYPE3(tt::common_type<int, boost_kahypar::long_long_type>::type, boost_kahypar::long_long_type);
    BOOST_CHECK_TYPE3(tt::common_type<int, boost_kahypar::ulong_long_type>::type, boost_kahypar::ulong_long_type);
#endif
...
#ifndef BOOST_NO_LONG_LONG
    BOOST_CHECK_TYPE3(tt::common_type<unsigned int, boost_kahypar::long_long_type>::type, boost_kahypar::long_long_type);
    BOOST_CHECK_TYPE3(tt::common_type<unsigned int, boost_kahypar::ulong_long_type>::type, boost_kahypar::ulong_long_type);
#endif
    BOOST_CHECK_TYPE3(tt::common_type<unsigned int, double>::type, double);

#ifndef BOOST_NO_LONG_LONG
    BOOST_CHECK_TYPE3(tt::common_type<boost_kahypar::long_long_type, char>::type, boost_kahypar::long_long_type);
    BOOST_CHECK_TYPE3(tt::common_type<boost_kahypar::long_long_type, unsigned char>::type, boost_kahypar::long_long_type);
    BOOST_CHECK_TYPE3(tt::common_type<boost_kahypar::long_long_type, short>::type, boost_kahypar::long_long_type);
    BOOST_CHECK_TYPE3(tt::common_type<boost_kahypar::long_long_type, unsigned short>::type, boost_kahypar::long_long_type);
    BOOST_CHECK_TYPE3(tt::common_type<boost_kahypar::long_long_type, int>::type, boost_kahypar::long_long_type);
    BOOST_CHECK_TYPE3(tt::common_type<boost_kahypar::long_long_type, unsigned int>::type, boost_kahypar::long_long_type);
    BOOST_CHECK_TYPE3(tt::common_type<boost_kahypar::long_long_type, boost_kahypar::long_long_type>::type, boost_kahypar::long_long_type);
    BOOST_CHECK_TYPE3(tt::common_type<boost_kahypar::long_long_type, boost_kahypar::ulong_long_type>::type, boost_kahypar::ulong_long_type);
    BOOST_CHECK_TYPE3(tt::common_type<boost_kahypar::long_long_type, double>::type, double);
#endif
...
#ifndef BOOST_NO_LONG_LONG
    BOOST_CHECK_TYPE3(tt::common_type<double, boost_kahypar::long_long_type>::type, double);
    BOOST_CHECK_TYPE3(tt::common_type<double, boost_kahypar::ulong_long_type>::type, double);
#endif
    BOOST_CHECK_TYPE3(tt::common_type<double, double>::type, double);
    
    BOOST_CHECK_TYPE4(tt::common_type<double, char, int>::type, double);
#ifndef BOOST_NO_LONG_LONG
    BOOST_CHECK_TYPE4(tt::common_type<unsigned, char, boost_kahypar::long_long_type>::type, boost_kahypar::long_long_type);
#endif
}
TT_TEST_END
