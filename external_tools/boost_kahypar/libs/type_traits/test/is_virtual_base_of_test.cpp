...
BOOST_CHECK_INTEGRAL_CONSTANT((::tt::is_virtual_base_of<boost_kahypar::noncopyable,virtual_inherit4>::value), true);
BOOST_CHECK_INTEGRAL_CONSTANT((::tt::is_virtual_base_of<virtual_inherit4,boost_kahypar::noncopyable>::value), false);
