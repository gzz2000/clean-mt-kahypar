...
BOOST_CHECK_TYPE(::tt::make_signed<boost_kahypar::long_long_type>::type, boost_kahypar::long_long_type);
...
#ifdef BOOST_HAS_LONG_LONG
BOOST_CHECK_TYPE(::tt::make_signed<const boost_kahypar::long_long_type>::type, const boost_kahypar::long_long_type);
#elif defined(BOOST_HAS_MS_INT64)
...
#ifdef BOOST_HAS_LONG_LONG
BOOST_CHECK_TYPE(::tt::make_signed<volatile boost_kahypar::long_long_type>::type, volatile boost_kahypar::long_long_type);
#elif defined(BOOST_HAS_MS_INT64)
...
#ifdef BOOST_HAS_LONG_LONG
BOOST_CHECK_TYPE(::tt::make_signed<const volatile boost_kahypar::long_long_type>::type, const volatile boost_kahypar::long_long_type);
#elif defined(BOOST_HAS_MS_INT64)
...
#ifdef BOOST_HAS_LONG_LONG
BOOST_CHECK_TYPE(::tt::make_signed<boost_kahypar::ulong_long_type>::type, boost_kahypar::long_long_type);
#elif defined(BOOST_HAS_MS_INT64)
...
#ifdef BOOST_HAS_LONG_LONG
BOOST_CHECK_TYPE(::tt::make_signed<const boost_kahypar::ulong_long_type>::type, const boost_kahypar::long_long_type);
#elif defined(BOOST_HAS_MS_INT64)
...
#ifdef BOOST_HAS_LONG_LONG
BOOST_CHECK_TYPE(::tt::make_signed<volatile boost_kahypar::ulong_long_type>::type, volatile boost_kahypar::long_long_type);
#elif defined(BOOST_HAS_MS_INT64)
...
#ifdef BOOST_HAS_LONG_LONG
BOOST_CHECK_TYPE(::tt::make_signed<const volatile boost_kahypar::ulong_long_type>::type, const volatile boost_kahypar::long_long_type);
#elif defined(BOOST_HAS_MS_INT64)
...
BOOST_CHECK_TYPE(::tt::make_signed<boost_kahypar::int128_type>::type, boost_kahypar::int128_type);
BOOST_CHECK_TYPE(::tt::make_signed<boost_kahypar::uint128_type>::type, boost_kahypar::int128_type);
#endif
