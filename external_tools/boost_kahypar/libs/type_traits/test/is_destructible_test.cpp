...
BOOST_CHECK_INTEGRAL_CONSTANT(::tt::is_destructible< ::boost_kahypar::ulong_long_type>::value, true);
BOOST_CHECK_INTEGRAL_CONSTANT(::tt::is_destructible< ::boost_kahypar::long_long_type>::value, true);
BOOST_CHECK_INTEGRAL_CONSTANT(::tt::is_destructible< ::boost_kahypar::ulong_long_type const>::value, true);
BOOST_CHECK_INTEGRAL_CONSTANT(::tt::is_destructible< ::boost_kahypar::long_long_type const>::value, true);
BOOST_CHECK_INTEGRAL_CONSTANT(::tt::is_destructible< ::boost_kahypar::ulong_long_type volatile>::value, true);
BOOST_CHECK_INTEGRAL_CONSTANT(::tt::is_destructible< ::boost_kahypar::long_long_type volatile>::value, true);
BOOST_CHECK_INTEGRAL_CONSTANT(::tt::is_destructible< ::boost_kahypar::ulong_long_type const volatile>::value, true);
BOOST_CHECK_INTEGRAL_CONSTANT(::tt::is_destructible< ::boost_kahypar::long_long_type const volatile>::value, true);
