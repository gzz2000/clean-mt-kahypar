...
struct has_not: public boost_kahypar::noncopyable {
    typedef boost_kahypar::noncopyable base_t;
    has_not() : base_t() {}
};
...
struct has_not4: private boost_kahypar::noncopyable {
    typedef boost_kahypar::noncopyable base_t;
    has_not4() : base_t() {}
private:
...
BOOST_CHECK_INTEGRAL_CONSTANT(::tt::is_copy_assignable< ::boost_kahypar::ulong_long_type>::value, true);
BOOST_CHECK_INTEGRAL_CONSTANT(::tt::is_copy_assignable< ::boost_kahypar::ulong_long_type const>::value, false);
BOOST_CHECK_INTEGRAL_CONSTANT(::tt::is_copy_assignable< ::boost_kahypar::long_long_type>::value, true);
BOOST_CHECK_INTEGRAL_CONSTANT(::tt::is_copy_assignable< ::boost_kahypar::long_long_type const>::value, false);

BOOST_CHECK_INTEGRAL_CONSTANT(::tt::is_copy_assignable< ::boost_kahypar::ulong_long_type volatile>::value, true);
BOOST_CHECK_INTEGRAL_CONSTANT(::tt::is_copy_assignable< ::boost_kahypar::ulong_long_type const volatile>::value, false);
BOOST_CHECK_INTEGRAL_CONSTANT(::tt::is_copy_assignable< ::boost_kahypar::long_long_type volatile>::value, true);
BOOST_CHECK_INTEGRAL_CONSTANT(::tt::is_copy_assignable< ::boost_kahypar::long_long_type const volatile>::value, false);
