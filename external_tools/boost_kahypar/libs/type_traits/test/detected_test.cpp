...
#include <type_traits>
#else
#include <boost_kahypar/type_traits/detected.hpp>
#endif
...
BOOST_CHECK_TYPE3(::tt::detected_t<type_t, int>, boost_kahypar::nonesuch);
BOOST_CHECK_TYPE3(::tt::detected_t<type_t, has_type>, char);
BOOST_CHECK_TYPE3(::tt::detected_t<type_t, no_type>, boost_kahypar::nonesuch);
