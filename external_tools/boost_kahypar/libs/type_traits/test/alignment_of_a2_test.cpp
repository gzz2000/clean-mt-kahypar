...
{
public:
    // The issue is gone if the type is not a boost_kahypar::function. The signature doesn't matter.
    typedef boost_kahypar::function0< void > function_type;
...
BOOST_CHECK_INTEGRAL_CONSTANT(::tt::alignment_of< ::boost_kahypar::long_long_type>::value, ALIGNOF(::boost_kahypar::long_long_type));
#endif
