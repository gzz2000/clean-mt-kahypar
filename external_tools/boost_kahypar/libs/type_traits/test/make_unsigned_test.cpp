...
BOOST_CHECK_TYPE(::tt::make_unsigned<boost_kahypar::long_long_type>::type, boost_kahypar::ulong_long_type);
...
#ifdef BOOST_HAS_LONG_LONG
BOOST_CHECK_TYPE(::tt::make_unsigned<const boost_kahypar::long_long_type>::type, const boost_kahypar::ulong_long_type);
#elif defined(BOOST_HAS_MS_INT64)
...
#ifdef BOOST_HAS_LONG_LONG
BOOST_CHECK_TYPE(::tt::make_unsigned<volatile boost_kahypar::long_long_type>::type, volatile boost_kahypar::ulong_long_type);
#elif defined(BOOST_HAS_MS_INT64)
...
#ifdef BOOST_HAS_LONG_LONG
BOOST_CHECK_TYPE(::tt::make_unsigned<const volatile boost_kahypar::long_long_type>::type, const volatile boost_kahypar::ulong_long_type);
#elif defined(BOOST_HAS_MS_INT64)
...
#ifdef BOOST_HAS_LONG_LONG
BOOST_CHECK_TYPE(::tt::make_unsigned<boost_kahypar::ulong_long_type>::type, boost_kahypar::ulong_long_type);
#elif defined(BOOST_HAS_MS_INT64)
...
#ifdef BOOST_HAS_LONG_LONG
BOOST_CHECK_TYPE(::tt::make_unsigned<const boost_kahypar::ulong_long_type>::type, const boost_kahypar::ulong_long_type);
#elif defined(BOOST_HAS_MS_INT64)
...
#ifdef BOOST_HAS_LONG_LONG
BOOST_CHECK_TYPE(::tt::make_unsigned<volatile boost_kahypar::ulong_long_type>::type, volatile boost_kahypar::ulong_long_type);
#elif defined(BOOST_HAS_MS_INT64)
...
#ifdef BOOST_HAS_LONG_LONG
BOOST_CHECK_TYPE(::tt::make_unsigned<const volatile boost_kahypar::ulong_long_type>::type, const volatile boost_kahypar::ulong_long_type);
#elif defined(BOOST_HAS_MS_INT64)
...
BOOST_CHECK_TYPE(::tt::make_unsigned<boost_kahypar::int128_type>::type, boost_kahypar::uint128_type);
BOOST_CHECK_TYPE(::tt::make_unsigned<boost_kahypar::uint128_type>::type, boost_kahypar::uint128_type);
#endif
