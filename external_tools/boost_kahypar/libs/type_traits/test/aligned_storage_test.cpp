...
BOOST_TT_PROC void do_check(const T&)
{
   ...
   BOOST_CHECK(::tt::alignment_of<t3>::value == ::tt::alignment_of< ::boost_kahypar::detail::max_align>::value);
...
do_check(tt::integral_constant<std::size_t,::tt::alignment_of< ::boost_kahypar::long_long_type>::value>());
#endif
...
do_check(tt::integral_constant<std::size_t,::tt::alignment_of<boost_kahypar::detail::max_align>::value>());
