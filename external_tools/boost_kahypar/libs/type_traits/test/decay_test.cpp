...
//     std::pair<std::string, int>        p2 = boost_kahypar::make_pair( "foo", 1 );
//                                                                      ^
...
TT_TEST_BEGIN(decay)
   ...
   //
   std::pair<std::string,std::string> p  = boost_kahypar::make_pair( "foo", "bar" );
   std::pair<std::string, int>        p2 = boost_kahypar::make_pair( "foo", 1 );
#ifndef BOOST_NO_STD_WSTRING
   std::pair<std::wstring,std::string> p3  = boost_kahypar::make_pair( L"foo", "bar" );
   std::pair<std::wstring, int>        p4  = boost_kahypar::make_pair( L"foo", 1 );
#endif
#endif
#endif
   //
   ...
   /*
   int array[10];
   std::pair<int*,int*> p5 = boost_kahypar::make_pair( array, array );
#ifndef BOOST_BORLANDC
   std::pair<int(*)(void), int(*)(int)> p6 = boost_kahypar::make_pair(boost_kahypar::proc1, boost_kahypar::proc2);
   p6.first();
   p6.second(1);
#endif
   */
