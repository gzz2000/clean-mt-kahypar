...
BOOST_CHECK_INTEGRAL_CONSTANT(::tt::is_signed<boost_kahypar::int128_type>::value, true);
BOOST_CHECK_INTEGRAL_CONSTANT(::tt::is_signed<boost_kahypar::uint128_type>::value, false);
#endif
