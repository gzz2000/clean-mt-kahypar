...
BOOST_CHECK_INTEGRAL_CONSTANT(::tt::is_unsigned<boost_kahypar::int128_type>::value, false);
BOOST_CHECK_INTEGRAL_CONSTANT(::tt::is_unsigned<boost_kahypar::uint128_type>::value, true);
#endif
