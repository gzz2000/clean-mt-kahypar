...
{
    template<typename A>
    test_bug_4530(A&&, typename boost_kahypar::enable_if_< ::tt::is_convertible<A&&, T>::value >::type* =0);
};
...
BOOST_CHECK_INTEGRAL_CONSTANT((::tt::is_convertible<boost_kahypar::long_long_type,int>::value), true);
BOOST_CHECK_INTEGRAL_CONSTANT((::tt::is_convertible<boost_kahypar::long_long_type,char>::value), true);
BOOST_CHECK_INTEGRAL_CONSTANT((::tt::is_convertible<boost_kahypar::long_long_type,float>::value), true);
