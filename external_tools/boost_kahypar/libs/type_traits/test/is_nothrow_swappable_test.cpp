...
BOOST_CHECK_INTEGRAL_CONSTANT(::tt::is_nothrow_swappable<boost_kahypar::type_traits_is_nothrow_swappable_test::swappable>::value, true);
BOOST_CHECK_INTEGRAL_CONSTANT(::tt::is_nothrow_swappable<boost_kahypar::type_traits_is_nothrow_swappable_test::swappable const>::value, false);
BOOST_CHECK_INTEGRAL_CONSTANT(::tt::is_nothrow_swappable<boost_kahypar::type_traits_is_nothrow_swappable_test::swappable volatile>::value, false);
BOOST_CHECK_INTEGRAL_CONSTANT(::tt::is_nothrow_swappable<boost_kahypar::type_traits_is_nothrow_swappable_test::swappable const volatile>::value, false);

BOOST_CHECK_INTEGRAL_CONSTANT(::tt::is_nothrow_swappable<boost_kahypar::type_traits_is_nothrow_swappable_test::swappable[2]>::value, true);
BOOST_CHECK_INTEGRAL_CONSTANT(::tt::is_nothrow_swappable<boost_kahypar::type_traits_is_nothrow_swappable_test::swappable const[2]>::value, false);
BOOST_CHECK_INTEGRAL_CONSTANT(::tt::is_nothrow_swappable<boost_kahypar::type_traits_is_nothrow_swappable_test::swappable volatile[2]>::value, false);
BOOST_CHECK_INTEGRAL_CONSTANT(::tt::is_nothrow_swappable<boost_kahypar::type_traits_is_nothrow_swappable_test::swappable const volatile[2]>::value, false);
