...
#ifdef TEST_STD
#  include <type_traits>
#  include <boost_kahypar/type_traits/type_with_alignment.hpp> // max_align and long_long_type
#else
...
namespace
{
    ...
    {
        boost_kahypar::detail::aligned_storage::aligned_storage_imp<N,Alignment> type;
    ...
    struct alignment_implementation2 : 
       ...
       public
#endif
       boost_kahypar::detail::aligned_storage::aligned_storage_imp<N,Alignment>
    {
        typedef boost_kahypar::detail::aligned_storage::aligned_storage_imp<N,Alignment> type;
...
do_check<boost_kahypar::long_long_type>();
#endif
...
do_check<empty_UDT>();
do_check<union_UDT>();
do_check<boost_kahypar::detail::max_align>();
