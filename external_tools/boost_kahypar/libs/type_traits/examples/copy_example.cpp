...
I2 copy_imp(I1 first, I1 last, I2 out, const boost_kahypar::integral_constant<bool, b>&)
{
   while(first != last)
   {
      *out = *first;
...
template<typename T>
T* copy_imp(const T* first, const T* last, T* out, const boost_kahypar::true_type&)
{
...
inline I2 copy(I1 first, I1 last, I2 out)
{
   ...
   return detail::copy_imp(first, last, out, boost_kahypar::has_trivial_assign<value_type>());
}
...
inline I2 copy(I1 first, I1 last, I2 out)
{
   return opt::detail::copy_imp(first, last, out, boost_kahypar::false_type());
}
