...
// Force boost_kahypar::result_of use decltype, even on compilers that don't support N3276.
...
int main()
{
    ...
    copy(
        boost_kahypar::make_function_input_iterator(ones_generator, 0),
        boost_kahypar::make_function_input_iterator(ones_generator, 10),
    ...
    copy(
        boost_kahypar::make_function_input_iterator(&ones_function, 0),
        boost_kahypar::make_function_input_iterator(&ones_function, 10),
        back_inserter(generated)
        );
    ...
    vector<int>().swap(generated);
    copy(
        boost_kahypar::make_function_input_iterator(counter_generator, 0),
        boost_kahypar::make_function_input_iterator(counter_generator, 10),
        back_inserter(generated)
        );
    ...
    {
        typedef boost_kahypar::iterators::function_input_iterator<counter, int> function_counter_iterator_t;
    ...
    vector<int>().swap(generated);
    copy(
        boost_kahypar::make_function_input_iterator(lambda_generator, 0),
        boost_kahypar::make_function_input_iterator(lambda_generator, 10),
        back_inserter(generated)
        );
