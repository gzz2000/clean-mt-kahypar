...
void iterop_test()
{
    typedef boost_kahypar::permutation_iterator< double*, int const* > permutation_type;
    typedef boost_kahypar::permutation_iterator< double const*, int const* > permutation_const_type;

    BOOST_CONCEPT_ASSERT((
      boost_kahypar_concepts::InteroperableIteratorConcept<
           permutation_type
...
void permutation_test()
{
  ...
  typedef boost_kahypar::permutation_iterator< element_range_type::iterator, index_type::iterator > permutation_type;
  permutation_type begin = boost_kahypar::make_permutation_iterator( elements.begin(), indices.begin() );
  permutation_type it = begin;
  permutation_type end = boost_kahypar::make_permutation_iterator( elements.begin(), indices.end() );
