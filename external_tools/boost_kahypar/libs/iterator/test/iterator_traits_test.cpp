...
struct my_iterator1
    : boost_kahypar::forward_iterator_helper<my_iterator1, char, long, const char*, const char&>
{
...
// iterator.
struct my_iterator2
    : boost_kahypar::equality_comparable<my_iterator2
    , boost_kahypar::incrementable<my_iterator2
    , boost_kahypar::dereferenceable<my_iterator2,const char*> > >
{
...
struct assert_same
    : assertion<(::boost_kahypar::is_same<T,U>::value)>
{
};
