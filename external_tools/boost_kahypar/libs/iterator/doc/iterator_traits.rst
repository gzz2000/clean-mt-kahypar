...
:abstract: Header ``<boost_kahypar/iterator/iterator_traits.hpp>`` provides
...
metaprogramming context.  ``<boost_kahypar/iterator/iterator_traits.hpp>``
provides access to these types using a standard metafunctions_.

Summary
=======

Header ``<boost_kahypar/iterator/iterator_traits.hpp>``::
