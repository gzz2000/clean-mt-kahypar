...
class node_iter
  : public boost_kahypar::iterator_adaptor<
      ...
      , Value*                          // Base
      , boost_kahypar::use_default              // Value
      , boost_kahypar::forward_traversal_tag    // CategoryOrTraversal
    >
{
 private:
    ...
    typedef boost_kahypar::iterator_adaptor<
        node_iter<Value>, Value*, boost_kahypar::use_default, boost_kahypar::forward_traversal_tag
    > super_t;
...
# ifndef BOOST_NO_SFINAE
      , typename boost_kahypar::enable_if<
            boost_kahypar::is_convertible<OtherValue*,Value*>
          , enabler
        >::type = enabler()
# endif
    )
