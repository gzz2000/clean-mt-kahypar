...
int main(int, char*[])
{
  ...
  boost_kahypar::reverse_iterator<base_iterator>
  ...
  std::copy(boost_kahypar::make_reverse_iterator(reverse_letters_last),
            boost_kahypar::make_reverse_iterator(reverse_letters_first),
            std::ostream_iterator<char>(std::cout));
  std::cout << std::endl;
