...
namespace boost_kahypar { namespace detail {
    ...
    /* Internal function to actually perform conversion.
       ...
       function will pass functional objects created with boost_kahypar::bind.
    ...
    */
        ...
        
    {
        ...
        while(from != from_end) {
            ...
            // Need variable because boost_kahypar::bind doesn't work with rvalues.
...
namespace boost_kahypar {
               ...
               const std::codecvt<wchar_t, char, std::mbstate_t>& cvt)
    {
        return detail::convert<wchar_t>(
            s,                 
            boost_kahypar::bind(&std::codecvt<wchar_t, char, mbstate_t>::in,
                        &cvt,
             ...
             const std::codecvt<wchar_t, char, std::mbstate_t>& cvt)
    {
        return detail::convert<char>(
            s,                 
            boost_kahypar::bind(&codecvt<wchar_t, char, mbstate_t>::out,
                        &cvt,
                        _1, _2, _3, _4, _5, _6, _7));
    }
    ...
    namespace {
        boost_kahypar::program_options::detail::utf8_codecvt_facet
            utf8_facet;
    }
