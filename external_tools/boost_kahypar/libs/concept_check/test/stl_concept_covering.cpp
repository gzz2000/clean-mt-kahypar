...
boost_kahypar::detail::dummy_constructor dummy_cons;
...
public:
  ...
  operator=(const mutually_convertible_archetype&)
    { return *this; }
  mutually_convertible_archetype(boost_kahypar::detail::dummy_constructor) { }
...
namespace accum
{
  typedef boost_kahypar::sgi_assignable_archetype<> Ret;
  struct T {
    T(const Ret&) { }
    T(boost_kahypar::detail::dummy_constructor x) { }
  };
  typedef boost_kahypar::null_archetype<> Tin;
...
{
  typedef boost_kahypar::sgi_assignable_archetype<> RetAdd;
  typedef boost_kahypar::sgi_assignable_archetype<> RetMult;
  struct T {
    T(const RetAdd&) { }
    T(boost_kahypar::detail::dummy_constructor x) { }
  };
  typedef boost_kahypar::null_archetype<int> Tin1;
  typedef boost_kahypar::null_archetype<char> Tin2;
}

namespace boost_kahypar { // so Koenig lookup will find
...
namespace power_stuff {
  struct monoid_archetype {
    monoid_archetype(boost_kahypar::detail::dummy_constructor x) { }  
  };
  
  boost_kahypar::multipliable_archetype<monoid_archetype>
  identity_element
  (std::multiplies< boost_kahypar::multipliable_archetype<monoid_archetype> >) 
  {
    return boost_kahypar::multipliable_archetype<monoid_archetype>(dummy_cons);
  }
}
