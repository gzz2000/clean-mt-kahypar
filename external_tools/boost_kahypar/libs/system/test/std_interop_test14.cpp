...
class my_category_impl: public boost_kahypar::system::error_category
{
public:
...
boost_kahypar::system::error_category const& my_category()
{
...
{
    {
        boost_kahypar::system::error_code e1( 5, my_category() );
