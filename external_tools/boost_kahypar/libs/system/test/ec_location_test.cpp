...
int main()
{
...

    {
        ...
        boost_kahypar::system::error_code ec( val, cat, &loc );
...

    {
        ...
        BOOST_TEST_EQ( &ec.category(), &boost_kahypar::system::system_category() );
        ...
        ec = boost_kahypar::system::error_code( val, cat, &loc );
