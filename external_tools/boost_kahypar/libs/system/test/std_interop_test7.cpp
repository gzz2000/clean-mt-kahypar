...
{
    {
        boost_kahypar::system::error_code e1 = make_error_code( boost_kahypar::system::errc::bad_address );

        BOOST_TEST( e1 == boost_kahypar::system::errc::bad_address );
        BOOST_TEST_NOT( e1 != boost_kahypar::system::errc::bad_address );
    ...
    {
        boost_kahypar::system::error_code e1 = make_error_code( std::errc::bad_address );
