...
#include <boost_kahypar/ratio/config.hpp>
...
# define BOOST_SYSTEM_CLOCK_DURATION boost_kahypar::chrono::duration<boost_kahypar::int_least64_t, ratio<BOOST_RATIO_INTMAX_C(1), BOOST_RATIO_INTMAX_C(10000000)> >
#else
# define BOOST_SYSTEM_CLOCK_DURATION boost_kahypar::chrono::nanoseconds
#endif
...
#else
#include <boost_kahypar/chrono/detail/inlined/chrono.hpp>
#endif
