...
#include <boost_kahypar/ratio/detail/is_evenly_divisible_by.hpp>
...
namespace chrono_detail {
  ...
  struct is_evenly_divisible_by : public boost_kahypar::ratio_detail::is_evenly_divisible_by<R1, R2>
  {};
