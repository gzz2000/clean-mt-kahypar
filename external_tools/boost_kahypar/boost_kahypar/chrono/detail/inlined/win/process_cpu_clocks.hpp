...
#include <boost_kahypar/winapi/get_current_process.hpp>
#if BOOST_PLAT_WINDOWS_DESKTOP
#include <boost_kahypar/winapi/get_process_times.hpp>
#endif
...
process_user_cpu_clock::time_point process_user_cpu_clock::now() BOOST_NOEXCEPT
{
    ...
    if ( boost_kahypar::winapi::GetProcessTimes(
            boost_kahypar::winapi::GetCurrentProcess(), &creation, &exit,
        ...
        system::error_code & ec)
{
    ...
    {
        boost_kahypar::winapi::DWORD_ cause = boost_kahypar::winapi::GetLastError();
        if (::boost_kahypar::chrono::is_throws(ec))
        {
            boost_kahypar::throw_exception(
                    system::system_error(
