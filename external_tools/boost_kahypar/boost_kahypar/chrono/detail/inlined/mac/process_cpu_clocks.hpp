  ...
  namespace chrono
  {
    ...
    process_real_cpu_clock::time_point process_real_cpu_clock::now(system::error_code & ec)
    {
      ...
      if (c == clock_t(-1)) // error
      {
        ...
        {
          boost_kahypar::throw_exception(system::system_error(errno, ::boost_kahypar::system::system_category(), "chrono::process_real_cpu_clock"));
        } else
        {
          ec.assign(errno, ::boost_kahypar::system::system_category());
          return time_point();
        }
      } else
      {
    ...
    process_user_cpu_clock::time_point process_user_cpu_clock::now(system::error_code & ec)
    {
      ...
      if (c == clock_t(-1)) // error
      {
        if (::boost_kahypar::chrono::is_throws(ec))
        {
          boost_kahypar::throw_exception(system::system_error(errno, ::boost_kahypar::system::system_category(), "chrono::process_user_cpu_clock"));
        } else
        {
          ec.assign(errno, ::boost_kahypar::system::system_category());
          return time_point();
    ...
    process_system_cpu_clock::time_point process_system_cpu_clock::now(system::error_code & ec)
    {
      ...
      if (c == clock_t(-1)) // error
      {
        if (::boost_kahypar::chrono::is_throws(ec))
        {
          boost_kahypar::throw_exception(system::system_error(errno, ::boost_kahypar::system::system_category(), "chrono::process_system_cpu_clock"));
        } else
        {
          ec.assign(errno, ::boost_kahypar::system::system_category());
          return time_point();
    ...
    process_cpu_clock::time_point process_cpu_clock::now(system::error_code & ec)
    {
      ...
      if (c == clock_t(-1)) // error
      {
        if (::boost_kahypar::chrono::is_throws(ec))
        {
          boost_kahypar::throw_exception(system::system_error(errno, ::boost_kahypar::system::system_category(), "chrono::process_clock"));
        } else
        {
          ec.assign(errno, ::boost_kahypar::system::system_category());
          return time_point();
