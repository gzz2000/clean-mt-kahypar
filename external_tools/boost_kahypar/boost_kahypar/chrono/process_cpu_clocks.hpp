...
#include <boost_kahypar/chrono/clock_string.hpp>

#ifndef BOOST_CHRONO_HEADER_ONLY
#include <boost_kahypar/config/abi_prefix.hpp> // must be the last #include
#endif

namespace boost_kahypar { namespace chrono {
...
namespace chrono
{
  ...
  typedef process_times<nanoseconds::rep> process_cpu_clock_times;
    ...
    public:
        ...
        typedef boost_kahypar::chrono::duration<times,  nano>                duration;
        typedef duration::rep                       rep;
        typedef duration::period                    period;
...
namespace std {
    ...
    template <typename Rep>
    struct numeric_limits<boost_kahypar::chrono::process_times<Rep> >
    {
        typedef boost_kahypar::chrono::process_times<Rep> Res;
...
#else
#include <boost_kahypar/chrono/detail/inlined/process_cpu_clocks.hpp>
#endif
#endif
