...
#include <boost_kahypar/ratio/ratio_io.hpp>
#include <boost_kahypar/chrono/io/duration_style.hpp>
#include <boost_kahypar/chrono/io/ios_base_state.hpp>
#include <boost_kahypar/chrono/io/duration_put.hpp>
#include <boost_kahypar/chrono/io/duration_get.hpp>
#include <boost_kahypar/chrono/io/utility/manip_base.hpp>
...
namespace boost_kahypar
{
  namespace chrono
  {
    ...
    typename boost_kahypar::enable_if_c< ! duration_put_enabled<Rep>::value, std::basic_ostream<CharT, Traits>& >::type
