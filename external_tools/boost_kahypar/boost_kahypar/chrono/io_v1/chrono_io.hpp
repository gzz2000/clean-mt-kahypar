...
#include <boost_kahypar/integer/common_factor_rt.hpp>
#include <boost_kahypar/chrono/detail/scan_keyword.hpp>
#include <boost_kahypar/core/enable_if.hpp>
#include <boost_kahypar/chrono/detail/no_warning/signed_unsigned_cmp.hpp>
...
private:
    ...
    template <class Period>
        string_type short_name(Period) const
            {return ::boost_kahypar::ratio_string<Period, CharT>::symbol() + short_seconds_;}
    ...
    template <class Period>
        string_type long_name(Period) const
            {return ::boost_kahypar::ratio_string<Period, CharT>::prefix() + long_seconds_;}
