...
#include <boost_kahypar/mpl/logical.hpp>
#include <boost_kahypar/ratio/ratio.hpp>
#include <boost_kahypar/ratio/detail/is_ratio.hpp>
...
#define BOOST_CHRONO_SECOND_TEMPLATE_PARAMETER_OF_DURATION_MUST_BE_A_STD_RATIO "Second template parameter of duration must be a boost_kahypar::ratio"
#define BOOST_CHRONO_DURATION_PERIOD_MUST_BE_POSITIVE "duration period must be positive"
#define BOOST_CHRONO_SECOND_TEMPLATE_PARAMETER_OF_TIME_POINT_MUST_BE_A_BOOST_CHRONO_DURATION "Second template parameter of time_point must be a boost_kahypar::chrono::duration"
#endif

#ifndef BOOST_CHRONO_HEADER_ONLY
// this must occur after all of the includes and before any code appears:
#include <boost_kahypar/config/abi_prefix.hpp> // must be the last #include
#endif
...
namespace chrono {
    ...
    template <class Duration, class Rep2,
        bool = (
                    ((boost_kahypar::is_convertible<typename Duration::rep,
                        typename common_type<typename Duration::rep, Rep2>::type>::value))
                &&  ((boost_kahypar::is_convertible<Rep2,
                        typename common_type<typename Duration::rep, Rep2>::type>::value))
                )
        >
...
///
    ...
    template <class Rep, class Duration,
        bool = (
                ...
                &&  ((boost_kahypar::is_convertible<Rep,
                        typename common_type<typename Duration::rep, Rep>::type>::value))
                )
        >
...
namespace chrono {
    ...
    typedef duration<boost_kahypar::int_least64_t, nano> nanoseconds;    // at least 64 bits needed
    typedef duration<boost_kahypar::int_least64_t, micro> microseconds;  // at least 55 bits needed
    typedef duration<boost_kahypar::int_least64_t, milli> milliseconds;  // at least 45 bits needed
    typedef duration<boost_kahypar::int_least64_t> seconds;              // at least 35 bits needed
    typedef duration<boost_kahypar::int_least32_t, ratio< 60> > minutes; // at least 29 bits needed
    typedef duration<boost_kahypar::int_least32_t, ratio<3600> > hours;  // at least 23 bits needed
...
//----------------------------------------------------------------------------//
    ...
    template <class Rep>
    struct treat_as_floating_point : boost_kahypar::is_floating_point<Rep> {};
                   ...
                   chrono::duration<Rep2, Period2> >
{
  typedef chrono::duration<typename common_type<Rep1, Rep2>::type,
                      typename boost_kahypar::ratio_gcd<Period1, Period2>::type> type;
};
...
namespace chrono {
    ...
    {
    //BOOST_CHRONO_STATIC_ASSERT(boost_kahypar::is_integral<Rep>::value, BOOST_CHRONO_A_DURATION_REPRESENTATION_MUST_BE_INTEGRAL, ());
    BOOST_CHRONO_STATIC_ASSERT(!boost_kahypar::chrono::detail::is_duration<Rep>::value,
            BOOST_CHRONO_A_DURATION_REPRESENTATION_CAN_NOT_BE_A_DURATION, ());
    BOOST_CHRONO_STATIC_ASSERT(boost_kahypar::ratio_detail::is_ratio<typename Period::type>::value,
    ...
    public:
        ...
        , typename boost_kahypar::enable_if <
                    mpl::and_ <
                        boost_kahypar::is_convertible<Rep2, rep>,
                        mpl::or_ <
...
//----------------------------------------------------------------------------//
    ...
    typename boost_kahypar::enable_if <
        mpl::and_ <
        boost_kahypar::is_convertible<Rep1, typename common_type<Rep1, Rep2>::type>,
        boost_kahypar::is_convertible<Rep2, typename common_type<Rep1, Rep2>::type>
        >,
    ...
    template <class Rep1, class Period, class Rep2>
    inline BOOST_CONSTEXPR
    typename boost_kahypar::disable_if <boost_kahypar::chrono::detail::is_duration<Rep2>,
      typename boost_kahypar::chrono::detail::duration_divide_result<
    ...
    template <class Rep1, class Rep2, class Period>
    inline BOOST_CONSTEXPR
    typename boost_kahypar::disable_if <boost_kahypar::chrono::detail::is_duration<Rep1>,
      typename boost_kahypar::chrono::detail::duration_divide_result2<
    ...
    inline BOOST_CONSTEXPR
    typename boost_kahypar::disable_if <boost_kahypar::chrono::detail::is_duration<Rep2>,
      typename boost_kahypar::chrono::detail::duration_modulo_result<
        duration<Rep1, Period>, Rep2>::type
    >::type
    operator%(const duration<Rep1, Period>& d, const Rep2& s)
    {
...
namespace detail
{
    ...
    operator==(const duration<Rep1, Period1>& lhs,
          const duration<Rep2, Period2>& rhs)
    {
        return boost_kahypar::chrono::detail::duration_eq<
    ...
    operator< (const duration<Rep1, Period1>& lhs,
          const duration<Rep2, Period2>& rhs)
    {
        return boost_kahypar::chrono::detail::duration_lt<
          duration<Rep1, Period1>, duration<Rep2, Period2> >()(lhs, rhs);
    }
...
//----------------------------------------------------------------------------//
    ...
    inline BOOST_CONSTEXPR
    typename boost_kahypar::enable_if <
      boost_kahypar::chrono::detail::is_duration<ToDuration>, ToDuration>::type
    duration_cast(const duration<Rep, Period>& fd)
    {
        return boost_kahypar::chrono::detail::duration_cast<
...
#include <boost_kahypar/config/abi_suffix.hpp> // pops abi_prefix.hpp pragmas
#endif
