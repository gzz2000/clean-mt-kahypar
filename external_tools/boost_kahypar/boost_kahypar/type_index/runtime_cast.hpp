...
///
/// boost_kahypar::typeindex::runtime_cast is a drop in replacement for dynamic_cast
/// that can be used in situations where traditional rtti is either unavailable
/// or undesirable.

#include <boost_kahypar/type_index/runtime_cast/register_runtime_class.hpp>
#include <boost_kahypar/type_index/runtime_cast/pointer_cast.hpp>
#include <boost_kahypar/type_index/runtime_cast/reference_cast.hpp>
