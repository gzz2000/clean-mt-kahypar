...
/// \brief Contains boost_kahypar::typeindex::stl_type_index class.
///
/// boost_kahypar::typeindex::stl_type_index class can be used as a drop-in replacement 
/// for std::type_index.
///
...
/// is defined boost_kahypar::typeindex::ctti is usually used instead of boost_kahypar::typeindex::stl_type_index.
...
inline std::string stl_type_index::pretty_name() const {
    static const char cvr_saver_name[] = "boost_kahypar::typeindex::detail::cvr_saver<";
    ...
    const boost_kahypar::core::scoped_demangled_name demangled_name(data_->name());

    const char* begin = demangled_name.get();
    if (!begin) {
        boost_kahypar::throw_exception(std::runtime_error("Type name demangling failed"));
    }
