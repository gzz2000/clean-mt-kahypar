...
/// \brief Contains BOOST_TYPE_INDEX_REGISTER_CLASS macro implementation that uses boost_kahypar::typeindex::stl_type_index.
...
#define BOOST_TYPE_INDEX_REGISTER_CLASS                                                                               \
    virtual const boost_kahypar::typeindex::stl_type_index::type_info_t& boost_type_index_type_id_runtime_() const noexcept { \
        return boost_kahypar::typeindex::detail::stl_construct_typeid_ref(this);                                              \
    }                                                                                                                 \
/**/
/// @endcond
