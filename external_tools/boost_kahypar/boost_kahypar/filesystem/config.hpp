...
#include <boost_kahypar/system/api_config.hpp> // for BOOST_POSIX_API or BOOST_WINDOWS_API
...
//  throw an exception  ----------------------------------------------------------------//
//
//  Exceptions were originally thrown via boost_kahypar::throw_exception().
...
//
#define BOOST_LIB_NAME boost_kahypar_filesystem
//
