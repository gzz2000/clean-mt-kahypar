...
struct space_info
{
    ...
    boost_kahypar::uintmax_t capacity;
    boost_kahypar::uintmax_t free;      // <= capacity
    boost_kahypar::uintmax_t available; // <= free
};
...
BOOST_FILESYSTEM_DECL
boost_kahypar::uintmax_t file_size(path const& p, system::error_code* ec = nullptr);
BOOST_FILESYSTEM_DECL
boost_kahypar::uintmax_t hard_link_count(path const& p, system::error_code* ec = nullptr);
BOOST_FILESYSTEM_DECL
...
BOOST_FILESYSTEM_DECL
boost_kahypar::uintmax_t remove_all(path const& p, system::error_code* ec = nullptr);
BOOST_FILESYSTEM_DECL
...
inline boost_kahypar::uintmax_t file_size(path const& p)
{
    return detail::file_size(p);
}

inline boost_kahypar::uintmax_t file_size(path const& p, system::error_code& ec) noexcept
{
    return detail::file_size(p, &ec);
}

inline boost_kahypar::uintmax_t hard_link_count(path const& p)
{
    return detail::hard_link_count(p);
}

inline boost_kahypar::uintmax_t hard_link_count(path const& p, system::error_code& ec) noexcept
{
...
inline boost_kahypar::uintmax_t remove_all(path const& p)
{
    return detail::remove_all(p);
}

inline boost_kahypar::uintmax_t remove_all(path const& p, system::error_code& ec) noexcept
{
