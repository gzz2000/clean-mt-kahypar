...
#include <boost_kahypar/io/quoted.hpp>
#include <boost_kahypar/functional/hash_fwd.hpp>
#include <boost_kahypar/filesystem/detail/path_traits.hpp>
#include <boost_kahypar/filesystem/detail/type_traits/negation.hpp>
...
private:
    ...
    friend class boost_kahypar::filesystem::path;
    friend class path_reverse_iterator;
    friend struct boost_kahypar::filesystem::detail::path_algorithms;
...
//    use boost_kahypar::io::quoted() to handle spaces in paths
...
{
    return os << boost_kahypar::io::quoted(p.template string< std::basic_string< Char > >(), static_cast< Char >('&'));
}
...
operator>>(std::basic_istream< Char, Traits >& is, path& p)
{
    ...
    is >> boost_kahypar::io::quoted(str, static_cast< Char >('&'));
    p = str;
    return is;
}
