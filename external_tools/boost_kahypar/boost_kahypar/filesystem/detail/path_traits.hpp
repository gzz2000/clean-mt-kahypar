...
#include <boost_kahypar/filesystem/detail/type_traits/conjunction.hpp>
#if defined(BOOST_FILESYSTEM_DETAIL_CXX23_STRING_VIEW_HAS_IMPLICIT_RANGE_CTOR)
#include <boost_kahypar/filesystem/detail/type_traits/disjunction.hpp>
#endif
...
template< >
struct path_source_traits< boost_kahypar::container::basic_string< char, std::char_traits< char >, void > >
{
...
template< >
struct path_source_traits< boost_kahypar::container::basic_string< wchar_t, std::char_traits< wchar_t >, void > >
{
    typedef boost_container_string_tag tag_type;
    typedef wchar_t char_type;
    static BOOST_CONSTEXPR_OR_CONST bool is_native = false;
...
template< >
struct path_source_traits< boost_kahypar::basic_string_view< char, std::char_traits< char > > >
{
...
template< >
struct path_source_traits< boost_kahypar::basic_string_view< wchar_t, std::char_traits< wchar_t > > >
{
    typedef boost_string_view_tag tag_type;
    typedef wchar_t char_type;
    static BOOST_CONSTEXPR_OR_CONST bool is_native = false;
...
struct is_path_source_iterator :
    public std::integral_constant<
        bool,
        detail::conjunction<
            boost_kahypar::iterators::is_iterator< Iterator >,
...
yes_type check_convertible(boost_kahypar::container::basic_string< char, std::char_traits< char >, void > const&);
yes_type check_convertible(boost_kahypar::container::basic_string< wchar_t, std::char_traits< wchar_t >, void > const&);
#if !defined(BOOST_NO_CXX17_HDR_STRING_VIEW)
yes_type check_convertible(std::string_view const&);
yes_type check_convertible(std::wstring_view const&);
#endif
yes_type check_convertible(boost_kahypar::basic_string_view< char, std::char_traits< char > > const&);
yes_type check_convertible(boost_kahypar::basic_string_view< wchar_t, std::char_traits< wchar_t > > const&);
...
(
    boost_kahypar::container::basic_string< char, std::char_traits< char >, void > const& source,
    Callback cb,
    const codecvt_type* cvt
)
{
    typedef typename path_traits::make_dependent< boost_kahypar::container::basic_string< char, std::char_traits< char >, void >, Source >::type source_t;
    return path_traits::dispatch(static_cast< source_t const& >(source), cb, cvt);
}
...
BOOST_FORCEINLINE typename Callback::result_type dispatch_convertible_impl
(
    boost_kahypar::container::basic_string< wchar_t, std::char_traits< wchar_t >, void > const& source,
    Callback cb,
    const codecvt_type* cvt
)
{
    typedef typename path_traits::make_dependent< boost_kahypar::container::basic_string< wchar_t, std::char_traits< wchar_t >, void >, Source >::type source_t;
    return path_traits::dispatch(static_cast< source_t const& >(source), cb, cvt);
}
...
BOOST_FORCEINLINE typename Callback::result_type dispatch_convertible_impl
(
    boost_kahypar::basic_string_view< char, std::char_traits< char > > const& source,
    Callback cb,
    const codecvt_type* cvt
)
{
    typedef typename path_traits::make_dependent< boost_kahypar::basic_string_view< char, std::char_traits< char > >, Source >::type source_t;
    return path_traits::dispatch(static_cast< source_t const& >(source), cb, cvt);
}
...
BOOST_FORCEINLINE typename Callback::result_type dispatch_convertible_impl
(
    boost_kahypar::basic_string_view< wchar_t, std::char_traits< wchar_t > > const& source,
    Callback cb,
    const codecvt_type* cvt
)
{
    typedef typename path_traits::make_dependent< boost_kahypar::basic_string_view< wchar_t, std::char_traits< wchar_t > >, Source >::type source_t;
    return path_traits::dispatch(static_cast< source_t const& >(source), cb, cvt);
}
