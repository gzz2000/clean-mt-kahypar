...
namespace detail {
    ...
    struct is_basic_any<boost_kahypar::anys::basic_any<OptimizeForSize, OptimizeForAlignment> > : public std::true_type {};

    template <class T>
    struct is_some_any: public is_basic_any<T> {};

    template <>
    struct is_some_any<boost_kahypar::any>: public std::true_type {};

    template <>
    struct is_some_any<boost_kahypar::anys::unique_any>: public std::true_type {};
