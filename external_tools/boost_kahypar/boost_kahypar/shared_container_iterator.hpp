...
#include "boost_kahypar/iterator_adaptors.hpp"
...
class shared_container_iterator : public iterator_adaptor<
  ...
  typedef boost_kahypar::shared_ptr<Container> container_ref_t;
...
make_shared_container_iterator(typename Container::iterator iter,
                               boost_kahypar::shared_ptr<Container> const& container) {
...
inline std::pair<
  shared_container_iterator<Container>,
  shared_container_iterator<Container> >
make_shared_container_range(boost_kahypar::shared_ptr<Container> const& container) {
  return
    std::make_pair(
