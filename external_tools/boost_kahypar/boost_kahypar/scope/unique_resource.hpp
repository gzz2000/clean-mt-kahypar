...
#include <boost_kahypar/scope/unique_resource_fwd.hpp>
#include <boost_kahypar/scope/detail/config.hpp>
#include <boost_kahypar/scope/detail/compact_storage.hpp>
#include <boost_kahypar/scope/detail/move_or_copy_assign_ref.hpp>
#include <boost_kahypar/scope/detail/move_or_copy_construct_ref.hpp>
#include <boost_kahypar/scope/detail/is_nonnull_default_constructible.hpp>
#include <boost_kahypar/scope/detail/type_traits/is_swappable.hpp>
#include <boost_kahypar/scope/detail/type_traits/is_nothrow_swappable.hpp>
#include <boost_kahypar/scope/detail/type_traits/is_nothrow_invocable.hpp>
#include <boost_kahypar/scope/detail/type_traits/negation.hpp>
#include <boost_kahypar/scope/detail/type_traits/conjunction.hpp>
#include <boost_kahypar/scope/detail/type_traits/disjunction.hpp>
...
public:
    ...
    ref_wrapper(T& value) noexcept :
        m_value(boost_kahypar::addressof(value))
    {
    }
...
public:
    ...
    {
        internal_resource_type* p = boost_kahypar::addressof(m_resource);
...
private:
    ...
    {
        boost_kahypar::core::invoke_swap(get_internal_resource(), that.get_internal_resource());
        boost_kahypar::core::invoke_swap(get_internal_deleter(), that.get_internal_deleter());
    }
...
private:
    ...
    void swap_impl(unique_resource_data& that, std::true_type, std::true_type) noexcept
    {
        boost_kahypar::core::invoke_swap(get_internal_resource(), that.get_internal_resource());
        boost_kahypar::core::invoke_swap(get_internal_deleter(), that.get_internal_deleter());
        boost_kahypar::core::invoke_swap(m_allocated, that.m_allocated);
    }
