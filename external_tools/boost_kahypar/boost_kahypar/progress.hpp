...
BOOST_HEADER_DEPRECATED( "the facilities in <boost_kahypar/timer/timer.hpp> or <boost_kahypar/timer/progress_display.hpp>" )

#include <boost_kahypar/timer.hpp>
#include <boost_kahypar/cstdint.hpp>  // for uintmax_t
...
// NOTE: (Jan 12, 2001) Tried to change unsigned long to boost_kahypar::uintmax_t, but
