...
namespace iterators {
  ...
  using boost_kahypar::use_default;
...
namespace iterators {
  ...
  // meta functions like boost_kahypar::is_convertible do not return false positives,
  ...
  //
  // The operators implementation relies on boost_kahypar::is_convertible not returning
...
#  if defined(BOOST_NO_IS_CONVERTIBLE) || defined(BOOST_NO_SFINAE)
  ...
  {
      typedef boost_kahypar::iterators::detail::enable_type type;
  };
...
#  elif BOOST_WORKAROUND(_MSC_FULL_VER, BOOST_TESTED_AT(13102292))
  ...
  struct enable_if_convertible
    : iterators::enable_if<
        ...
        >
      , boost_kahypar::iterators::detail::enable_type
    >
  {};
...
# ifdef BOOST_ITERATOR_REF_CONSTNESS_KILLS_WRITABILITY
          , typename boost_kahypar::iterators::detail::ia_dflt_help<
                Value
              , mpl::eval_if<
...
# endif
  ...
  class iterator_adaptor
    : public boost_kahypar::iterators::detail::iterator_adaptor_base<
      ...
      >::type
  {
   ...
   protected:
      typedef typename boost_kahypar::iterators::detail::iterator_adaptor_base<
          Derived, Base, Value, Traversal, Reference, Difference
      >::type super_t;
   public:
      iterator_adaptor() {}
...
# define BOOST_ITERATOR_ADAPTOR_ASSERT_TRAVERSAL(cat) \
      boost_kahypar::iterators::detail::iterator_adaptor_assert_traversal<my_traversal, cat>();
