...
namespace iterators {
  ...
  private:
    ...
    public:
      ...
      template <class T>
      typename boost_kahypar::disable_if_c<
        boost_kahypar::is_same< typename boost_kahypar::remove_cv< T >::type, output_proxy >::value,
        output_proxy&
      ...
      template <class T>
      typename boost_kahypar::disable_if_c<
        boost_kahypar::is_same< typename boost_kahypar::remove_cv< typename boost_kahypar::remove_reference< T >::type >::type, output_proxy >::value,
        output_proxy&
