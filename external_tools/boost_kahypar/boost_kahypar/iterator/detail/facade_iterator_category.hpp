...
# include <boost_kahypar/mpl/or.hpp>  // used in iterator_tag inheritance logic
...
# include <boost_kahypar/iterator/detail/config_def.hpp> // try to keep this last

# ifdef BOOST_ITERATOR_REF_CONSTNESS_KILLS_WRITABILITY
#  include <boost_kahypar/detail/indirect_traits.hpp>
# endif
...
# ifdef BOOST_ITERATOR_REF_CONSTNESS_KILLS_WRITABILITY // Adding Thomas' logic?
  : mpl::or_<
        is_const<Reference>
      , boost_kahypar::detail::indirect_traits::is_reference_to_const<Reference>
      , is_const<ValueParam>
    >
# else
  : is_const<ValueParam>
...
}}} // namespace boost_kahypar::iterators::detail
