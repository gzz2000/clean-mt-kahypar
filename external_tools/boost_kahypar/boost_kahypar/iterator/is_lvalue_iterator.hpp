...
#include <boost_kahypar/iterator/detail/any_conversion_eater.hpp>
...
#undef BOOST_LVALUE_PRESERVER
  ...
  {
      template <class It>
      struct rebind : boost_kahypar::mpl::false_
      {};
  };
...
: public ::boost_kahypar::integral_constant<bool,::boost_kahypar::iterators::detail::is_readable_lvalue_iterator_impl<T>::value>
{
public:
...
: public ::boost_kahypar::integral_constant<bool,::boost_kahypar::iterators::detail::is_non_const_lvalue_iterator_impl<T>::value>
{
public:
