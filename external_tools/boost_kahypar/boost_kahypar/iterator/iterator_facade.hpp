...
#include <boost_kahypar/iterator/detail/facade_iterator_category.hpp>
#include <boost_kahypar/iterator/detail/enable_if.hpp>
...
#include <boost_kahypar/iterator/detail/config_def.hpp> // this goes last
...
namespace iterators {
  ...
  namespace detail
  {
    ...
    struct is_traversal_at_least :
        public boost_kahypar::is_convertible< typename iterator_category_to_traversal< CategoryOrTraversal >::type, Required >
    {};
    ...
    struct enable_if_interoperable :
        public boost_kahypar::iterators::enable_if<
    ...
    struct iterator_facade_types
    {
        ...
        typedef typename mpl::eval_if<
            boost_kahypar::iterators::detail::iterator_writability_disabled<ValueParam,Reference>
...
# endif
    ...
    class postfix_increment_proxy
    {
     ...
     public:
        ...
        value_type* operator->() const
        {
            return boost_kahypar::addressof(stored_value);
        }
    ...
    class writable_postfix_increment_proxy
    {
     ...
     public:
        ...
        value_type* operator->() const
        {
            return boost_kahypar::addressof(dereference_proxy.stored_value);
        }
...
# endif
    ...
    struct operator_arrow_dispatch // proxy references
    {
        struct proxy
        {
            ...
            Reference* operator->() { return boost_kahypar::addressof(m_ref); }
            // This function is needed for MWCW and BCC, which won't call
            // operator-> again automatically per 13.3.1.2 para 8
            operator Reference*() { return boost_kahypar::addressof(m_ref); }
            Reference m_ref;
        };
    ...
    struct operator_arrow_dispatch<T&, Pointer> // "real" references
    {
        ...
        {
            return boost_kahypar::addressof(x);
        }
    };
    ...
    struct use_operator_brackets_proxy
      : mpl::not_<
            mpl::and_<
                ...
                boost_kahypar::is_POD<ValueType>
...
#  define BOOST_ITERATOR_FACADE_INTEROP_HEAD(prefix, op, result_type)       \
    BOOST_ITERATOR_FACADE_INTEROP_HEAD_IMPL(prefix, op, result_type, boost_kahypar::iterators::detail::enable_if_interoperable)

#  define BOOST_ITERATOR_FACADE_INTEROP_RANDOM_ACCESS_HEAD(prefix, op, result_type)       \
    BOOST_ITERATOR_FACADE_INTEROP_HEAD_IMPL(prefix, op, result_type, boost_kahypar::iterators::detail::enable_if_interoperable_and_random_access_traversal)

#  define BOOST_ITERATOR_FACADE_PLUS_HEAD(prefix,args)              \
    template <class Derived, class V, class TC, class R, class D>   \
    prefix typename boost_kahypar::iterators::enable_if<                    \
        boost_kahypar::iterators::detail::is_traversal_at_least< TC, boost_kahypar::iterators::random_access_traversal_tag >,  \
        Derived                                                     \
    >::type operator+ args
...
#  define BOOST_ITERATOR_FACADE_RELATION(op)                                \
      BOOST_ITERATOR_FACADE_INTEROP_HEAD(friend,op, boost_kahypar::iterators::detail::always_bool2);
...
#  define BOOST_ITERATOR_FACADE_RANDOM_ACCESS_RELATION(op)                                \
      BOOST_ITERATOR_FACADE_INTEROP_RANDOM_ACCESS_HEAD(friend,op, boost_kahypar::iterators::detail::always_bool2);
...
#  undef BOOST_ITERATOR_FACADE_RANDOM_ACCESS_RELATION
      ...
      BOOST_ITERATOR_FACADE_INTEROP_RANDOM_ACCESS_HEAD(
          friend, -, boost_kahypar::iterators::detail::choose_difference_type)
      ;
...
# ifdef BOOST_ITERATOR_FACADE_NEEDS_ITERATOR_BASE
        : public boost_kahypar::iterators::detail::iterator_facade_types<
...
# endif
    {
    private:
        typedef boost_kahypar::iterators::detail::iterator_facade_types<
            Value, CategoryOrTraversal, Reference, Difference
        > associated_types;

        typedef boost_kahypar::iterators::detail::operator_arrow_dispatch<
            Reference
    ...
    public:
        typename boost_kahypar::iterators::detail::operator_brackets_result<Derived, Value, reference>::type
        operator[](difference_type n) const
        {
            typedef boost_kahypar::iterators::detail::use_operator_brackets_proxy<Value, Reference> use_proxy;

            return boost_kahypar::iterators::detail::make_operator_brackets_result<Derived>(
                this->derived() + n
              , use_proxy()
            );
        }
  ...
  template <class I, class V, class TC, class R, class D>
  inline typename boost_kahypar::iterators::detail::postfix_increment_result<I,V,R,TC>::type
  operator++(
      iterator_facade<I,V,TC,R,D>& i
    , int
  )
  {
      typename boost_kahypar::iterators::detail::postfix_increment_result<I,V,R,TC>::type
          tmp(*static_cast<I*>(&i));
  ...
  // (aka. enable_if) and boost_kahypar::is_convertible is required.
  //
...
# define BOOST_ITERATOR_FACADE_RELATION(op, return_prefix, base_op) \
  BOOST_ITERATOR_FACADE_INTEROP(                                    \
      op                                                            \
    , boost_kahypar::iterators::detail::always_bool2                                   \
    , return_prefix                                                 \
    , base_op                                                       \
  )
...
# define BOOST_ITERATOR_FACADE_INTEROP_RANDOM_ACCESS(op, result_type, return_prefix, base_op) \
  ...
  {                                                                             \
      ...
      BOOST_STATIC_ASSERT((                                                     \
          is_interoperable< Derived1, Derived2 >::value &&                      \
          boost_kahypar::iterators::detail::is_traversal_at_least< typename iterator_category< Derived1 >::type, random_access_traversal_tag >::value && \
          boost_kahypar::iterators::detail::is_traversal_at_least< typename iterator_category< Derived2 >::type, random_access_traversal_tag >::value \
      ));                                                                       \
      return_prefix iterator_core_access::base_op(                              \
          *static_cast<Derived1 const*>(&lhs)                                   \
        , *static_cast<Derived2 const*>(&rhs)                                   \
...
# undef BOOST_ITERATOR_FACADE_RANDOM_ACCESS_RELATION
  ...
  BOOST_ITERATOR_FACADE_INTEROP_RANDOM_ACCESS(
      -
    , boost_kahypar::iterators::detail::choose_difference_type
    , return
    , distance_from
  )
