...
# include <boost_kahypar/detail/numeric_traits.hpp>
...
namespace detail
{
  ...
  struct is_numeric_impl
  {
      ...
      BOOST_STATIC_ASSERT(::boost_kahypar::is_integral<char>::value);
...
#  if !BOOST_WORKAROUND(BOOST_BORLANDC, BOOST_TESTED_AT(0x551))
      BOOST_STATIC_CONSTANT(
          bool, value = (
              boost_kahypar::is_convertible<int,T>::value
           && boost_kahypar::is_convertible<T,int>::value
      ));
#  else
      BOOST_STATIC_CONSTANT(bool, value = ::boost_kahypar::is_arithmetic<T>::value);
#  endif
...
# endif
  ...
  template <class T>
  struct is_numeric
    : boost_kahypar::integral_constant<bool, ::boost_kahypar::iterators::detail::is_numeric_impl<T>::value>
  {};

#  if defined(BOOST_HAS_LONG_LONG)
  template <>
  struct is_numeric<boost_kahypar::long_long_type>
    : boost_kahypar::true_type {};

  template <>
  struct is_numeric<boost_kahypar::ulong_long_type>
    : boost_kahypar::true_type {};
#  endif

#  if defined(BOOST_HAS_INT128)
  template <>
  struct is_numeric<boost_kahypar::int128_type>
    : boost_kahypar::true_type {};

  template <>
  struct is_numeric<boost_kahypar::uint128_type>
    : boost_kahypar::true_type {};
#  endif
  ...
  {
      typedef typename boost_kahypar::detail::numeric_traits<T>::difference_type type;
  };

#  if defined(BOOST_HAS_INT128)
  // std::numeric_limits, which is used by numeric_traits, is not specialized for __int128 in some standard libraries
  template <>
  struct numeric_difference<boost_kahypar::int128_type>
  {
      typedef boost_kahypar::int128_type type;
  };

  template <>
  struct numeric_difference<boost_kahypar::uint128_type>
  {
      typedef boost_kahypar::int128_type type;
  };
#  endif
  ...
  struct counting_iterator_base
  {
      typedef typename detail::ia_dflt_help<
        ...
        , typename boost_kahypar::conditional<
            ...
            , boost_kahypar::type_identity<random_access_traversal_tag>
...
# endif
  ...
  struct number_distance
  {
      static Difference distance(Incrementable1 x, Incrementable2 y)
      {
          return boost_kahypar::detail::numeric_distance(x, y);
      }
  };
}
