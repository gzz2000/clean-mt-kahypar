...
//  <boost_kahypar/bind/bind.hpp> and then imports the placeholders _1, _2,
//  _3, ... into the global namespace. Definitions in the global
//  namespace are not a good practice and this use is deprecated.
//  Please switch to including <boost_kahypar/bind/bind.hpp> directly,
...
BOOST_PRAGMA_MESSAGE(
  ...
  "<boost_kahypar/bind/bind.hpp> + using namespace boost_kahypar::placeholders, "
