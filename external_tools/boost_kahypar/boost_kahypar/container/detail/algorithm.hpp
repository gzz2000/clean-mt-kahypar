...
#include <boost_kahypar/intrusive/detail/algorithm.hpp>

namespace boost_kahypar {
namespace container {

using boost_kahypar::intrusive::algo_equal;
using boost_kahypar::intrusive::algo_lexicographical_compare;
...
{	return boost_kahypar::container::binder1st<Func>(func, arg);  }
...
{
   return (boost_kahypar::container::binder2nd<Func>(func, arg));
}
...
{
   return boost_kahypar::container::unary_negate<Func>(func);
}
