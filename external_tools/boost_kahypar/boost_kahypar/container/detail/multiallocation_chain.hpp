...
#include <boost_kahypar/intrusive/detail/twin.hpp>
// move
...
class basic_multiallocation_chain
{
   ...
   typedef typename boost_kahypar::intrusive::
      pointer_traits<char_ptr>::difference_type             difference_type;

   typedef bi::slist< node
                    , bi::linear<true>
                    , bi::cache_last<true>
                    , bi::size_type<typename boost_kahypar::container::dtl::make_unsigned<difference_type>::type>
                    > slist_impl_t;
   ...
   {  return *static_cast<node*>(static_cast<void*>(boost_kahypar::movelib::to_raw_pointer(p)));  }
   ...
   typedef boost_kahypar::intrusive::twin<void_pointer> pointer_pair;
   ...
   basic_multiallocation_chain(BOOST_RV_REF(basic_multiallocation_chain) other)
      :  slist_impl_(::boost_kahypar::move(other.slist_impl_))
   {}
   ...
   {
      typedef typename boost_kahypar::intrusive::pointer_traits<char_ptr> char_pointer_traits;
      ...
      if(num_units){
         ...
         for(size_type i = 0; i != num_units-1u; ++i, elem += difference_type(unit_bytes)){
            ::new (boost_kahypar::movelib::to_raw_pointer(prev_elem), boost_container_new_t()) void_pointer(elem);
            prev_elem = elem;
         }
...
class multialloc_iterator
   : public boost_kahypar::container::iterator
      ...
      >
{
   ...
   inline T* operator->() const
   {  return static_cast<T*>(static_cast<void*>(boost_kahypar::movelib::iterator_to_raw_pointer(m_it)));   }
   ...
   {  boost_kahypar::container::iterator_advance(m_it, n); }

   inline typename Iterator::difference_type distance_to(const multialloc_iterator &other)const
   {  return boost_kahypar::container::iterator_distance(other.m_it, m_it); }
};
   ...
   : public MultiallocationChain
{
   ...
   typedef boost_kahypar::intrusive::twin<pointer>               pointer_pair;
   ...
   transform_multiallocation_chain(BOOST_RV_REF(transform_multiallocation_chain) other)
      : MultiallocationChain(::boost_kahypar::move(static_cast<MultiallocationChain&>(other)))
   {}
   ...
   transform_multiallocation_chain& operator=(BOOST_RV_REF(transform_multiallocation_chain) other)
   {
      return static_cast<MultiallocationChain&>
         (this->MultiallocationChain::operator=(::boost_kahypar::move(static_cast<MultiallocationChain&>(other))));
   }
