...
//Define this to use std exception types instead of boost_kahypar::container's own exception types
...
#define BOOST_CONTAINER_STATIC_ASSERT(B) \
         typedef ::boost_kahypar::container::dtl::static_assert_test<\
            (unsigned)sizeof(::boost_kahypar::container::dtl::STATIC_ASSERTION_FAILURE<bool(B)>)>\
