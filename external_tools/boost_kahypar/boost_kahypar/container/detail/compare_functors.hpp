...
#include <boost_kahypar/intrusive/detail/ebo_functor_holder.hpp>
...
struct key_node_pred
   :  public boost_kahypar::intrusive::detail::ebo_functor_holder<KeyPred>
{
   ...
   typedef boost_kahypar::intrusive::detail::ebo_functor_holder<KeyPred> base_t;
