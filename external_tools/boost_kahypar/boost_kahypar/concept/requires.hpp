...
struct Requires_ : ::boost_kahypar::ccheck_aux::unaryfunptr_arg_type<Result>
{
};

# if BOOST_WORKAROUND(BOOST_INTEL_WIN, BOOST_TESTED_AT(1010))
#  define BOOST_CONCEPT_REQUIRES_(r,data,t) | (::boost_kahypar::_requires_<void(*)t>::value)
# else 
#  define BOOST_CONCEPT_REQUIRES_(r,data,t) + (::boost_kahypar::_requires_<void(*)t>::value)
# endif
...
# define BOOST_CONCEPT_REQUIRES(models, result)                                        \
    typename ::boost_kahypar::Requires_<                                                       \
      (0 BOOST_PP_SEQ_FOR_EACH(BOOST_CONCEPT_REQUIRES_, ~, models)),                   \
      void(*)result                                                                 \
    >::type
...
} // namespace boost_kahypar::concept_check
