...
namespace boost_kahypar
{
    ...
    class unary_negate
        : public boost_kahypar::functional::detail::unary_function<typename unary_traits<Predicate>::argument_type,bool>
    {
      public:
    ...
    template <class Predicate>
    class binary_negate
        : public boost_kahypar::functional::detail::binary_function<
    ...
    template <class Operation>
    class binder1st
        : public boost_kahypar::functional::detail::unary_function<
    ...
    class mem_fun_t : public boost_kahypar::functional::detail::unary_function<T*, S>
    {
      public:
    ...
    class mem_fun1_t : public boost_kahypar::functional::detail::binary_function<T*, A, S>
    {
      public:   
    ...
    template <class S, class T>
    class const_mem_fun_t : public boost_kahypar::functional::detail::unary_function<const T*, S>
    {
      public:
    ...
    template <class S, class T, class A>
    class const_mem_fun1_t : public boost_kahypar::functional::detail::binary_function<const T*, A, S>
    {
      public:
    ...
    // --------------------------------------------------------------------------
    template <class S, class T>
    class mem_fun_ref_t : public boost_kahypar::functional::detail::unary_function<T&, S>
    {
      public:
    ...
    template <class S, class T, class A>
    class mem_fun1_ref_t : public boost_kahypar::functional::detail::binary_function<T&, A, S>
    {
      public:
    ...
    template <class S, class T>
    class const_mem_fun_ref_t : public boost_kahypar::functional::detail::unary_function<const T&, S>
    {
      public:
    ...
    template <class S, class T, class A>
    class const_mem_fun1_ref_t : public boost_kahypar::functional::detail::binary_function<const T&, A, S>
    {
      public:
    ...
    class pointer_to_unary_function : public boost_kahypar::functional::detail::unary_function<Arg,Result>
    {
      public:
    ...
    class pointer_to_binary_function : public boost_kahypar::functional::detail::binary_function<Arg1,Arg2,Result>
    {
      public:
