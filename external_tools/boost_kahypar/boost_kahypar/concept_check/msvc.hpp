...
#  include <boost_kahypar/concept_check/has_constraints.hpp>
...
# define BOOST_CONCEPT_ASSERT( ModelInParens )                          \
  enum { BOOST_PP_CAT(boost_concept_check,__LINE__) =                   \
         sizeof(::boost_kahypar::concept_check<void(*) ModelInParens>)          \
  }
...
# define BOOST_CONCEPT_ASSERT( ModelInParens )                          \
  enum { BOOST_PP_CAT(boost_concept_check,__LINE__) =                   \
         sizeof(::boost_kahypar::concept_check_((void(*) ModelInParens)0))      \
  }
