...
namespace boost_kahypar {
  ...
  namespace dynamic_bitset_impl {
    ...
    template <>
    BOOST_FORCEINLINE std::size_t popcount<boost_kahypar::ulong_long_type>(boost_kahypar::ulong_long_type value) BOOST_NOEXCEPT
    {
        ...
        BOOST_NOEXCEPT
    {
        ...
        typename boost_kahypar::allocator_size_type<allocator_type>::type alloc_max =
            boost_kahypar::allocator_max_size(alloc);
...
#   define BOOST_dynamic_bitset_is_numeric(x)       \
    ...
    BOOST_dynamic_bitset_is_numeric(::boost_kahypar::long_long_type);
    BOOST_dynamic_bitset_is_numeric(::boost_kahypar::ulong_long_type);
#endif
