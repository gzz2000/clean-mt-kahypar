...
#include <boost_kahypar/describe/modifiers.hpp>
#include <boost_kahypar/describe/detail/pp_for_each.hpp>
#include <boost_kahypar/describe/detail/pp_utilities.hpp>
...
{ return boost_kahypar::describe::detail::member_descriptor_fn_impl<boost_kahypar::describe::mod_public>( 0 BOOST_DESCRIBE_PP_FOR_EACH(BOOST_DESCRIBE_MEMBER_IMPL, C, __VA_ARGS__) ); }

#define BOOST_DESCRIBE_PROTECTED_MEMBERS(C, ...) inline auto boost_protected_member_descriptor_fn( C** ) \
{ return boost_kahypar::describe::detail::member_descriptor_fn_impl<boost_kahypar::describe::mod_protected>( 0 BOOST_DESCRIBE_PP_FOR_EACH(BOOST_DESCRIBE_MEMBER_IMPL, C, __VA_ARGS__) ); }

#define BOOST_DESCRIBE_PRIVATE_MEMBERS(C, ...) inline auto boost_private_member_descriptor_fn( C** ) \
{ return boost_kahypar::describe::detail::member_descriptor_fn_impl<boost_kahypar::describe::mod_private>( 0 BOOST_DESCRIBE_PP_FOR_EACH(BOOST_DESCRIBE_MEMBER_IMPL, C, __VA_ARGS__) ); }
