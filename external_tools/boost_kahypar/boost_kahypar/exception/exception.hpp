...
#include  <memory>
namespace boost_kahypar { namespace exception_detail { using std::shared_ptr; } }
#else
namespace boost_kahypar { template <class T> class shared_ptr; }
namespace boost_kahypar { namespace exception_detail { using boost_kahypar::shared_ptr; } }
#endif
...
boost_kahypar
    ...
    exception_detail
        ...
        boost_kahypar::source_location get_exception_throw_location( exception const & );
        }
    ...
    exception
...
#ifdef __HP_aCC
        //On HP aCC, this protected copy constructor prevents throwing boost_kahypar::exception.
        ...
        friend boost_kahypar::source_location exception_detail::get_exception_throw_location( exception const & );
    ...
    exception_detail
        ...
        inline boost_kahypar::source_location get_exception_throw_location( exception const & x )
            {
