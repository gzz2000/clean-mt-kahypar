...
// std::string boost_kahypar::core::type_name<T>()
//
...
{
    std::string r = boost_kahypar::core::demangle( n );
...
template<> struct tn_holder<boost_kahypar::long_long_type>
{
    static std::string type_name( std::string const& suffix )
    {
...
template<> struct tn_holder<boost_kahypar::ulong_long_type>
{
    static std::string type_name( std::string const& suffix )
    {
...
template<> struct tn_holder<boost_kahypar::int128_type>
{
    static std::string type_name( std::string const& suffix )
    {
...
template<> struct tn_holder<boost_kahypar::uint128_type>
{
    static std::string type_name( std::string const& suffix )
    {
