...
inline void* operator new( std::size_t, void* p, boost_kahypar::core::detail::placement_new_tag )
{
    return p;
}

inline void operator delete( void*, void*, boost_kahypar::core::detail::placement_new_tag )
{
}
