...
{
    return boost_kahypar::core::isnormal( static_cast<double>( x ) );
}
...
inline int fpclassify( float x )
{
    ...
    default:
        ...
        return boost_kahypar::core::isnormal( x )? fp_normal: fp_subnormal;
    }
}
...
{
    return boost_kahypar::core::fpclassify( static_cast<double>( x ) );
}
...
template<class T> T copysign( T x, T y )
{
    return boost_kahypar::core::detail::copysign_impl( x, y );
}
