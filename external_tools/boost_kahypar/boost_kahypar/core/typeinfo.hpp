...
{
    static boost_kahypar::core::typeinfo ti_;
...
template<class T> boost_kahypar::core::typeinfo core_typeid_< T >::ti_( core_typeid_< T >::name(), &core_typeid_lib_id );
...
#define BOOST_CORE_TYPEID(T) (boost_kahypar::detail::core_typeid_<T>::ti_)
