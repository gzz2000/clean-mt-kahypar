...
addressof(T& o) BOOST_NOEXCEPT
{
    ...
    return boost_kahypar::detail::addrof<T>::get(o, 0);
#else
    return boost_kahypar::detail::addrof<T>::get(boost_kahypar::detail::addrof_ref<T>(o), 0);
#endif
}
...
BOOST_FORCEINLINE typename boost_kahypar::detail::addrof_result<T[N]>::type
...
addressof(T& o) BOOST_NOEXCEPT
{
    return boost_kahypar::detail::addressof(o);
}
#endif
