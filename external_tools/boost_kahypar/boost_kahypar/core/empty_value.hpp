...
template<class T, unsigned N = 0,
    bool E = boost_kahypar::use_empty_value_base<T>::value>
class empty_value {
public:
    typedef T type;
    ...
    BOOST_CONSTEXPR empty_value(boost_kahypar::empty_init_t)
        : value_() { }

#if !defined(BOOST_NO_CXX11_RVALUE_REFERENCES)
#if !defined(BOOST_NO_CXX11_VARIADIC_TEMPLATES)
    template<class U, class... Args>
    BOOST_CONSTEXPR empty_value(boost_kahypar::empty_init_t, U&& value, Args&&... args)
        : value_(std::forward<U>(value), std::forward<Args>(args)...) { }
#else
    template<class U>
    BOOST_CONSTEXPR empty_value(boost_kahypar::empty_init_t, U&& value)
        : value_(std::forward<U>(value)) { }
#endif
#else
    template<class U>
    BOOST_CONSTEXPR empty_value(boost_kahypar::empty_init_t, const U& value)
        : value_(value) { }
