...
struct allocator_traits {
    ...
    static pointer allocate(A& a, size_type n) {
        return boost_kahypar::allocator_allocate(a, n);
    }

    static pointer allocate(A& a, size_type n, const_void_pointer h) {
        return boost_kahypar::allocator_allocate(a, n, h);
    }

    static void deallocate(A& a, pointer p, size_type n) {
        return boost_kahypar::allocator_deallocate(a, p, n);
    }
    ...
    static void construct(A& a, T* p, V&& v, Args&&... args) {
        boost_kahypar::allocator_construct(a, p, std::forward<V>(v),
    ...
    static void construct(A& a, T* p, const V& v) {
        boost_kahypar::allocator_construct(a, p, v);
    }
    ...
    static size_type max_size(const A& a) BOOST_NOEXCEPT {
        return boost_kahypar::allocator_max_size(a);
    }

    static A select_on_container_copy_construction(const A& a) {
        return boost_kahypar::allocator_select_on_container_copy_construction(a);
    }
};
