...
/// as a boost_kahypar::typeindex::type_index and boost_kahypar::typeindex::type_info.
...
#   include <boost_kahypar/type_index/stl_type_index.hpp>
#   if defined(BOOST_NO_RTTI) || defined(BOOST_TYPE_INDEX_FORCE_NO_RTTI_COMPATIBILITY)
#       include <boost_kahypar/type_index/detail/stl_register_class.hpp>
#       ifdef BOOST_HAS_PRAGMA_DETECT_MISMATCH
...
#   include <boost_kahypar/type_index/detail/ctti_register_class.hpp>
#   ifdef BOOST_HAS_PRAGMA_DETECT_MISMATCH
...
/// BOOST_TYPE_INDEX_FUNCTION_SIGNATURE is used by boost_kahypar::typeindex::ctti_type_index class to
/// deduce the name of a type. If your compiler is not recognized
/// by the TypeIndex library and you wish to work with boost_kahypar::typeindex::ctti_type_index, you may
...
/// then a compile-time error will arise at any attempt to use boost_kahypar::typeindex::ctti_type_index classes.
///
...
/// \code boost_kahypar::typeindex::ctti_type_index::type_id<int>().pretty_name() \endcode
/// returns the following string:
/// \code "static const char *boost_kahypar::detail::ctti<int>::n() [T = int]" \endcode
/// and \code boost_kahypar::typeindex::ctti_type_index::type_id<short>().pretty_name() \endcode returns the following:
/// \code "static const char *boost_kahypar::detail::ctti<short>::n() [T = short]" \endcode
///
/// As we may see first 39 characters are "static const char *boost_kahypar::detail::ctti<" and they do not depend on
...
/// for `boost_kahypar::typeindex::ctti_type_index::type_id<int>().pretty_name()` and \code "short>::n() [T = short" \endcode
/// for `boost_kahypar::typeindex::ctti_type_index::type_id<short>().pretty_name()`.
///
...
#define BOOST_TYPE_INDEX_CTTI_USER_DEFINED_PARSING (0, 0, false, "")
    ...
    /// as a default boost_kahypar::typeindex::type_index.
    ///
    /// Could be a boost_kahypar::typeindex::stl_type_index, boost_kahypar::typeindex::ctti_type_index or 
    /// user defined type_index class.
    ///
    /// \b See boost_kahypar::typeindex::type_index_facade for a full description of type_index functions.
    typedef platform_specific type_index;
#elif defined(BOOST_TYPE_INDEX_USER_TYPEINDEX)
    // Nothing to do
#elif (!defined(BOOST_NO_RTTI) && !defined(BOOST_TYPE_INDEX_FORCE_NO_RTTI_COMPATIBILITY)) || defined(BOOST_MSVC)
    typedef boost_kahypar::typeindex::stl_type_index type_index;
#else 
    typedef boost_kahypar::typeindex::ctti_type_index type_index;
#endif

/// Depending on a compiler flags, optimal implementation of type_info will be used 
/// as a default boost_kahypar::typeindex::type_info.
///
/// Could be a std::type_info, boost_kahypar::typeindex::detail::ctti_data or 
...
/// C c1;
/// A* pc1 = &c1;
/// assert(boost_kahypar::typeindex::type_id<C>() == boost_kahypar::typeindex::type_id_runtime(*pc1));
/// \endcode
...
/// Function to get boost_kahypar::typeindex::type_index for a type T.
...
/// \throw Nothing.
/// \return boost_kahypar::typeindex::type_index with information about the specified type T.
template <class T>
inline type_index type_id() noexcept {
    return type_index::type_id<T>();
}

/// Function for constructing boost_kahypar::typeindex::type_index instance for type T. 
...
/// Function that works exactly like C++ typeid(rtti_val) call, but returns boost_kahypar::type_index.
///
...
/// \throw Nothing.
/// \return boost_kahypar::typeindex::type_index with information about the specified variable.
template <class T>
