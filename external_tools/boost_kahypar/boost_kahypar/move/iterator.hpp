...
class move_iterator
{
   ...
   typedef typename boost_kahypar::movelib::iterator_traits<iterator_type>::value_type        value_type;
   #if !defined(BOOST_NO_CXX11_RVALUE_REFERENCES) || defined(BOOST_MOVE_DOXYGEN_INVOKED)
   typedef value_type &&                                                   reference;
   #else
   typedef typename ::boost_kahypar::move_detail::if_
      < ::boost_kahypar::has_move_emulation_enabled<value_type>
      , ::boost_kahypar::rv<value_type>&
      , value_type & >::type                                               reference;
   #endif
   typedef It                                                              pointer;
   typedef typename boost_kahypar::movelib::iterator_traits<iterator_type>::difference_type   difference_type;
   typedef typename boost_kahypar::movelib::iterator_traits<iterator_type>::iterator_category iterator_category;
   ...
   inline reference operator*() const
   {
      ...
      return *m_it;
      #else
      return ::boost_kahypar::move(*m_it);
      #endif
   }
   ...
   inline reference operator[](difference_type n) const
   {
      ...
      return m_it[n];
      #else
      return ::boost_kahypar::move(m_it[n]);
      #endif
   }
...
template <class I>
struct is_move_iterator< ::boost_kahypar::move_iterator<I> >
{
...
class back_move_insert_iterator
{
   ...
   { container_m->push_back(boost_kahypar::move(x)); return *this; }
...
public:
   ...
   { container_m->push_front(boost_kahypar::move(x)); return *this; }
...
class move_insert_iterator
{
   ...
   {
      pos_ = container_m->insert(pos_, ::boost_kahypar::move(x));
      ++pos_;
      return *this;
   }
