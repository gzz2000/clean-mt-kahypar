...
#include <boost_kahypar/move/detail/meta_utils_core.hpp>
...
//Forward declare boost_kahypar::rv
...
struct has_move_emulation_enabled_impl
   : is_convertible< T, ::boost_kahypar::rv<T>& >
{};
...
template<class T>
struct has_move_emulation_enabled_impl< ::boost_kahypar::rv<T> >
{  static const bool value = false;  };
...
template< class T >
struct is_rvalue_reference< boost_kahypar::rv<T>& >
{  static const bool value = true;  };

template< class T >
struct is_rvalue_reference< const boost_kahypar::rv<T>& >
{  static const bool value = true;  };
...
namespace detail_add_rvalue_reference
{
   ...
   struct add_rvalue_reference_impl< T, true, rv > { typedef ::boost_kahypar::rv<T>& type; };
} // namespace detail_add_rvalue_reference
