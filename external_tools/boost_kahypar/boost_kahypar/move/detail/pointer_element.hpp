...
{
   typedef typename boost_kahypar::movelib::detail::first_param<Ptr>::type type;
};
...
{
   typedef typename ::boost_kahypar::movelib::detail::pointer_element_impl<Ptr>::type type;
};
