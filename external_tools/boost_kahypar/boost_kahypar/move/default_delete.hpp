...
namespace bmupmu = ::boost_kahypar::move_upmu;
...
template<class T, class U>
struct missing_virtual_destructor< ::boost_kahypar::movelib::default_delete<T>, U >
...
namespace bmupd = boost_kahypar::move_upd;
namespace bmupmu = ::boost_kahypar::move_upmu;
