...
/// \file boost/any.hpp
/// \brief \copybrief boost_kahypar::any

// what:  variant type boost_kahypar::any
...
namespace boost_kahypar
{
    ...
    public:
            ...
            >(value))
        {
            static_assert(
                ...
                "boost_kahypar::any shall not be constructed from boost_kahypar::anys::basic_any"
            );
        }
    ...
    public: // modifiers
        ...
        any & operator=(ValueType&& rhs)
        {
            static_assert(
                !anys::detail::is_basic_any<typename std::decay<ValueType>::type>::value,
                "boost_kahypar::anys::basic_any shall not be assigned into boost_kahypar::any"
            );
    ...
    private: // types
        /// @cond
        class BOOST_SYMBOL_VISIBLE placeholder: public boost_kahypar::anys::detail::placeholder
        {
        public:
        ...
        public: // queries
            ...
            {
                return boost_kahypar::typeindex::type_id<ValueType>().type_info();
            }
    ...
    private: // representation
        ...
        friend class boost_kahypar::anys::unique_any;
    ...
    {
        return boost_kahypar::unsafe_any_cast<ValueType>(const_cast<any *>(operand));
    }
    /// @endcond
    ...
    {
        return operand && operand->type() == boost_kahypar::typeindex::type_id<ValueType>()
            ? boost_kahypar::unsafe_any_cast<typename std::remove_cv<ValueType>::type>(operand)
            : 0;
    }
    ...
    {
        return boost_kahypar::any_cast<ValueType>(const_cast<any *>(operand));
    }
    ...
    ValueType any_cast(any & operand)
    {
        ...
        nonref * result = boost_kahypar::any_cast<nonref>(std::addressof(operand));
        if(!result)
...
#   pragma warning(pop)
    ...
    {
        typedef typename std::remove_reference<ValueType>::type nonref;
        return boost_kahypar::any_cast<const nonref &>(const_cast<any &>(operand));
    }
    ...
    inline ValueType any_cast(any&& operand)
    {
        ...
        return boost_kahypar::any_cast<ValueType>(operand);
    }
}
