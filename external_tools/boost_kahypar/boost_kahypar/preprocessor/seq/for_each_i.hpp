...
# include <boost_kahypar/preprocessor/repetition/for.hpp>
# include <boost_kahypar/preprocessor/seq/seq.hpp>
# include <boost_kahypar/preprocessor/seq/size.hpp>
# include <boost_kahypar/preprocessor/seq/detail/is_empty.hpp>
