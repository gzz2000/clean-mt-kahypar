...
namespace boost_kahypar
{
...
#endif
        inline
        typename boost_kahypar::make_unsigned<T>::type lcast_to_unsigned(const T value) noexcept {
            typedef typename boost_kahypar::make_unsigned<T>::type result_type;
            return value < 0
    ...
    namespace detail // lcast_put_unsigned
    {
        ...
        class lcast_put_unsigned: boost_kahypar::noncopyable {
    ...
    {
        template <class Traits, class T, class CharT>
        class lcast_ret_unsigned: boost_kahypar::noncopyable {
        ...
        public:
                ...
                : m_multiplier_overflowed(false), m_multiplier(1), m_value(value), m_begin(begin), m_end(end)
            {
                ...
                static_assert(std::numeric_limits<T>::is_specialized,
                    "std::numeric_limits are not specialized for integral type passed to boost_kahypar::lexical_cast"
                );
#endif
            }
