...
#include <boost_kahypar/lexical_cast/detail/widest_char.hpp>
...
#include <boost_kahypar/lexical_cast/detail/converter_lexical_streams.hpp>
...
namespace boost_kahypar {
    ...
    namespace detail // stream_char_common<T>
    {
        ...
        struct stream_char_common: public boost_kahypar::conditional<
            boost_kahypar::detail::is_character< Type >::value,
            Type,
            boost_kahypar::detail::deduce_character_type_later< Type >
        > {};

        template < typename Char >
        struct stream_char_common< Char* >: public boost_kahypar::conditional<
            boost_kahypar::detail::is_character< Char >::value,
            Char,
            boost_kahypar::detail::deduce_character_type_later< Char* >
        > {};

        template < typename Char >
        struct stream_char_common< const Char* >: public boost_kahypar::conditional<
            boost_kahypar::detail::is_character< Char >::value,
            Char,
            boost_kahypar::detail::deduce_character_type_later< const Char* >
        > {};

        template < typename Char >
        struct stream_char_common< boost_kahypar::conversion::detail::buffer_view< Char > >
        {
            typedef Char type;
        };

        template < typename Char >
        struct stream_char_common< boost_kahypar::iterator_range< Char* > >: public boost_kahypar::conditional<
            boost_kahypar::detail::is_character< Char >::value,
            Char,
            boost_kahypar::detail::deduce_character_type_later< boost_kahypar::iterator_range< Char* > >
        > {};

        template < typename Char >
        struct stream_char_common< boost_kahypar::iterator_range< const Char* > >: public boost_kahypar::conditional<
            boost_kahypar::detail::is_character< Char >::value,
            Char,
            boost_kahypar::detail::deduce_character_type_later< boost_kahypar::iterator_range< const Char* > >
        > {};
        ...
        template < class Char, class Traits, class Alloc >
        struct stream_char_common< boost_kahypar::container::basic_string< Char, Traits, Alloc > >
        {
            typedef Char type;
        };

        template < typename Char, std::size_t N >
        struct stream_char_common< boost_kahypar::array< Char, N > >: public boost_kahypar::conditional<
            boost_kahypar::detail::is_character< Char >::value,
            Char,
            boost_kahypar::detail::deduce_character_type_later< boost_kahypar::array< Char, N > >
        > {};

        template < typename Char, std::size_t N >
        struct stream_char_common< boost_kahypar::array< const Char, N > >: public boost_kahypar::conditional<
            boost_kahypar::detail::is_character< Char >::value,
            Char,
            boost_kahypar::detail::deduce_character_type_later< boost_kahypar::array< const Char, N > >
        > {};

#ifndef BOOST_NO_CXX11_HDR_ARRAY
        template < typename Char, std::size_t N >
        struct stream_char_common< std::array<Char, N > >: public boost_kahypar::conditional<
            boost_kahypar::detail::is_character< Char >::value,
            Char,
            boost_kahypar::detail::deduce_character_type_later< std::array< Char, N > >
        > {};

        template < typename Char, std::size_t N >
        struct stream_char_common< std::array< const Char, N > >: public boost_kahypar::conditional<
            boost_kahypar::detail::is_character< Char >::value,
            Char,
            boost_kahypar::detail::deduce_character_type_later< std::array< const Char, N > >
        > {};
#endif
...
#endif
        template < class Char, class Traits >
        struct stream_char_common< boost_kahypar::basic_string_view< Char, Traits > >
        {
            typedef Char type;
        };

#ifdef BOOST_HAS_INT128
        template <> struct stream_char_common< boost_kahypar::int128_type >: public boost_kahypar::type_identity< char > {};
        template <> struct stream_char_common< boost_kahypar::uint128_type >: public boost_kahypar::type_identity< char > {};
#endif
    ...
    namespace detail // deduce_source_char_impl<T>
    {
        ...
        {
            typedef typename boost_kahypar::detail::normalize_single_byte_char< Char >::type type;
        };
    ...
    {
        // If type T is `deduce_character_type_later` type, then tries to deduce
        // character type using boost_kahypar::has_right_shift<T> metafunction.
        // Otherwise supplied type T is a character type, that must be normalized
        // using normalize_single_byte_char<Char>.
        // Executed at Stage 2  (See deduce_source_char<T> and deduce_target_char<T>)
        template < class Char >
    ...
    namespace detail // lcast_src_length
    {
        ...
        // <boost_kahypar/limits.hpp> doesn't add missing specialization for
        // numeric_limits<T> for some integral type T.
        // When is_specialized is false, the whole expression is 0.
        template <class Source>
        struct lcast_src_length<
                    Source, typename boost_kahypar::enable_if<boost_kahypar::is_integral<Source> >::type
                >
        {
        ...
        template<class Source>
        struct lcast_src_length<
                Source, typename boost_kahypar::enable_if<boost_kahypar::is_float<Source> >::type
            >
        {
            static_assert(
    ...
    namespace detail // lexical_cast_stream_traits<Source, Target>
    {
        ...
        struct lexical_cast_stream_traits {
            ...
            typedef typename boost_kahypar::remove_cv<src>::type            no_cv_src;

            typedef boost_kahypar::detail::deduce_source_char<no_cv_src>                           deduce_src_char_metafunc;
            typedef typename deduce_src_char_metafunc::type           src_char_t;
            typedef typename boost_kahypar::detail::deduce_target_char<Target>::type target_char_t;

            typedef typename boost_kahypar::detail::widest_char<
                target_char_t, src_char_t
            >::type char_type;

#if !defined(BOOST_NO_CXX11_CHAR16_T) && defined(BOOST_NO_CXX11_UNICODE_LITERALS)
            static_assert(!boost_kahypar::is_same<char16_t, src_char_t>::value
                                        && !boost_kahypar::is_same<char16_t, target_char_t>::value,
                "Your compiler does not have full support for char16_t" );
#endif
#if !defined(BOOST_NO_CXX11_CHAR32_T) && defined(BOOST_NO_CXX11_UNICODE_LITERALS)
            static_assert(!boost_kahypar::is_same<char32_t, src_char_t>::value
                                        && !boost_kahypar::is_same<char32_t, target_char_t>::value,
                "Your compiler does not have full support for char32_t" );
#endif

            typedef std::char_traits<char_type> traits;

            typedef boost_kahypar::detail::lcast_src_length<no_cv_src> len_t;
        };
    }
