...
bool ios_numeric_comparer_float(Source x, Source y) noexcept {
    return x == y
        || (boost_kahypar::core::isnan(x) && boost_kahypar::core::isnan(y))
...
typename boost_kahypar::enable_if_c<
    !boost_kahypar::is_floating_point<Source>::value && !boost_kahypar::is_floating_point<Target>::value, bool
...
struct lexical_cast_dynamic_num_not_ignoring_minus
{
    ...
    static inline bool try_convert(Source arg, Target& result) noexcept {
        return boost_kahypar::detail::noexcept_numeric_convert<Target, Source >(arg, result);
    }
};
...
struct lexical_cast_dynamic_num_ignoring_minus
{
    ...
    static inline bool try_convert(Source arg, Target& result) noexcept {
        typedef typename boost_kahypar::conditional<
                boost_kahypar::is_float<Source>::value,
                boost_kahypar::type_identity<Source>,
                boost_kahypar::make_unsigned<Source>
        >::type usource_lazy_t;
        typedef typename usource_lazy_t::type usource_t;

        if (arg < 0) {
            const bool res = boost_kahypar::detail::noexcept_numeric_convert<Target, usource_t>(
                static_cast<usource_t>(0u - static_cast<usource_t>(arg)), result
            );
            result = static_cast<Target>(0u - result);
            return res;
        } else {
            return boost_kahypar::detail::noexcept_numeric_convert<Target, usource_t>(arg, result);
        }
    }
};
 ...
 *
 *
 * Rule 2) required because boost_kahypar::lexical_cast has the behavior of
...
struct dynamic_num_converter_impl
{
    static inline bool try_convert(Source arg, Target& result) noexcept {
        typedef typename boost_kahypar::conditional<
            boost_kahypar::is_unsigned<Target>::value &&
            (boost_kahypar::is_signed<Source>::value || boost_kahypar::is_float<Source>::value) &&
            !(boost_kahypar::is_same<Source, bool>::value) &&
            !(boost_kahypar::is_same<Target, bool>::value),
