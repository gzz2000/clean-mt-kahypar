...
template < typename T >
using is_character = boost_kahypar::integral_constant<
    bool,
    boost_kahypar::is_same< T, char >::value ||
#if !defined(BOOST_NO_STRINGSTREAM) && !defined(BOOST_NO_STD_WSTRING)
    boost_kahypar::is_same< T, wchar_t >::value ||
#endif
#ifndef BOOST_NO_CXX11_CHAR16_T
    boost_kahypar::is_same< T, char16_t >::value ||
#endif
#ifndef BOOST_NO_CXX11_CHAR32_T
    boost_kahypar::is_same< T, char32_t >::value ||
#endif
    boost_kahypar::is_same< T, unsigned char >::value ||
    boost_kahypar::is_same< T, signed char >::value
>;
