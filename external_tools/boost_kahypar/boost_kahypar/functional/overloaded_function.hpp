...
#       include <boost_kahypar/functional/overloaded_function/detail/base.hpp>
#       include <boost_kahypar/functional/overloaded_function/detail/function_type.hpp>
#       include <boost_kahypar/functional/overloaded_function/config.hpp>
...
#       include <boost_kahypar/preprocessor/control/expr_iif.hpp>
#       include <boost_kahypar/preprocessor/control/expr_if.hpp>
#       include <boost_kahypar/preprocessor/comparison/greater.hpp>
#       include <boost_kahypar/preprocessor/comparison/less.hpp>
#       include <boost_kahypar/preprocessor/cat.hpp>
#       include <boost_kahypar/preprocessor/arithmetic/add.hpp>
#       include <boost_kahypar/preprocessor/arithmetic/sub.hpp>
#       include <boost_kahypar/preprocessor/tuple/eat.hpp>
#       include <boost_kahypar/preprocessor/logical/and.hpp>
#       include <boost_kahypar/preprocessor/logical/not.hpp>
#       include <boost_kahypar/preprocessor/facilities/expand.hpp>
...
#define BOOST_FUNCTIONAL_base(z, n, unused) \
    ::boost_kahypar::overloaded_function_detail::base< \
...
#define BOOST_FUNCTIONAL_function_type(z, n, unused) \
    typename ::boost_kahypar::overloaded_function_detail::function_type< \
        BOOST_FUNCTIONAL_f_type(z, n, ~) \
    >::type
...
#       define BOOST_PP_ITERATION_PARAMS_1 \
            ...
            "boost_kahypar/functional/overloaded_function.hpp"))
...
BOOST_TYPEOF_REGISTER_TEMPLATE(boost_kahypar::overloaded_function,
...
public:
    ...
    that can be converted to a <c>boost_kahypar::function</c> function object can be
    ...
    */
    overloaded_function(const boost_kahypar::function<F1>&,
            const boost_kahypar::function<F2>&, ...);
    ...
    the constructor.
    */
    typename boost_kahypar::function_traits<F1>::result_type operator()(
            typename boost_kahypar::function_traits<F1>::arg1_type,
            typename boost_kahypar::function_traits<F1>::arg2_type,
            ...) const;
    ...
    documentation).
    */
    typename boost_kahypar::function_traits<F2>::result_type operator()(
            typename boost_kahypar::function_traits<F2>::arg1_type,
            typename boost_kahypar::function_traits<F2>::arg2_type,
            ...) const;
};
