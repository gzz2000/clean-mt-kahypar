...
#       define BOOST_PP_ITERATION_PARAMS_1 \
                ...
                "boost_kahypar/functional/overloaded_function/detail/base.hpp"))
...
public:
    /* implicit */ inline base(
            ...
            // a boost_kahypar::function<> functor.
            boost_kahypar::function< BOOST_FUNCTIONAL_DETAIL_f > const& f): f_(f)
    {}
...
private:
    boost_kahypar::function< BOOST_FUNCTIONAL_DETAIL_f > const f_;
};
