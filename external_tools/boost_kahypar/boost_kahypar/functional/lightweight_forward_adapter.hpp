...
namespace boost_kahypar 
{
    ...
    namespace detail
    {
        ...
        struct lightweight_forward_adapter_result
        {
            ...
            template< typename T > struct x< boost_kahypar::reference_wrapper<T> >
            { typedef T& t; };
...
#   define BOOST_TMP_MACRO(f,fn,fc) \
        boost_kahypar::detail::lightweight_forward_adapter_impl< \
    ...
    namespace detail
    {
        ...
        struct lightweight_forward_adapter_impl_zero<MD, F, FC,
            typename lightweight_forward_adapter_sfinae<typename boost_kahypar::result_of< FC() >::type>::type>
            : lightweight_forward_adapter_result
        {
...
#       define  BOOST_PP_FILENAME_1 \
            <boost_kahypar/functional/lightweight_forward_adapter.hpp>
...
#       include BOOST_PP_ITERATE()
    ...
    struct result_of<boost_kahypar::lightweight_forward_adapter<F,A0,A1> const ()>
        : boost_kahypar::detail::lightweight_forward_adapter_result::template apply<
            boost_kahypar::lightweight_forward_adapter<F,A0,A1> const () >
    { };
    template<class F, int A0, int A1>
    struct result_of<boost_kahypar::lightweight_forward_adapter<F,A0,A1>()>
        : boost_kahypar::detail::lightweight_forward_adapter_result::template apply<
            boost_kahypar::lightweight_forward_adapter<F,A0,A1>() >
    { };
    template<class F, int A0, int A1>
    struct result_of<boost_kahypar::lightweight_forward_adapter<F,A0,A1> const& ()>
        : boost_kahypar::detail::lightweight_forward_adapter_result::template apply<
...
#     define N BOOST_PP_ITERATION() 
            ...
            : lightweight_forward_adapter_result
        {
            ...
            inline typename boost_kahypar::result_of< F(BOOST_PP_ENUM_BINARY_PARAMS(N,
