...
#include <boost_kahypar/function/function_fwd.hpp>
...
namespace boost_kahypar {
  namespace detail {
    namespace function {
       ...
       * boost_kahypar::function. It is a union containing function pointers,
      ...
      union function_buffer_members
      {
        ...
        struct type_t {
          ...
          const boost_kahypar::core::typeinfo* type;
...
# pragma warning(pop)
      ...
      /**
       * Determine if boost_kahypar::function can use the small-object
...
public:
  ...
  /** Retrieve the type of the stored function object, or type_id<void>()
      if this is empty. */
  const boost_kahypar::core::typeinfo& target_type() const
  {
...
#endif
/**
 * The bad_function_call exception class is thrown when a boost_kahypar::function
 * object is invoked
 */
class BOOST_SYMBOL_VISIBLE bad_function_call : public std::runtime_error
{
public:
  bad_function_call() : std::runtime_error("call to empty boost_kahypar::function") {}
};
#if defined(BOOST_CLANG)
...
// Comparisons between boost_kahypar::function objects and arbitrary function
// objects.
