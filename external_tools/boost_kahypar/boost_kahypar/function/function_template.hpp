...
#include <boost_kahypar/function/function_base.hpp>
    ...
    namespace function {
      ...
      struct member_invoker
      {
...

        {
          ...
          return boost_kahypar::mem_fn(*f)(static_cast<T&&>(a)...);
        }
      };
      ...
      struct void_member_invoker
      {
...

        {
          MemberPtr* f =
            reinterpret_cast<MemberPtr*>(function_obj_ptr.data);
          boost_kahypar::mem_fn(*f)(static_cast<T&&>(a)...);
        }
      };
      ...
      /**
       * vtable for a specific boost_kahypar::function instance. This
       * structure must be an aggregate so that we can use static
       * initialization in boost_kahypar::function's assign_to and assign_to_a
...
# pragma GCC diagnostic pop
      ...
      private:
        ...
        bool assign_to(MemberPtr f, function_buffer& functor, member_ptr_tag) const
        {
          ...
          if (f) {
            this->assign_to(boost_kahypar::mem_fn(f), functor);
            return true;
          } else {
            return false;
          }
        ...
        bool assign_to_a(MemberPtr f, function_buffer& functor, Allocator a, member_ptr_tag) const
        {
          ...
          // right target_type() values.
          if (f) {
            this->assign_to_a(boost_kahypar::mem_fn(f), functor, a);
            return true;
          } else {
            return false;
          }
        ...
        {
          if (!boost_kahypar::detail::function::has_empty_target(boost_kahypar::addressof(f))) {
  ...
  private:
    typedef boost_kahypar::detail::function::basic_vtable<
              R, T...>
      vtable_type;
  ...
  public:
    // add signature for boost_kahypar::lambda
    ...
    {
      if (this->empty())
        boost_kahypar::throw_exception(bad_function_call());
...
#           endif
#         endif
          std::memcpy(this->functor.data, f.functor.data, sizeof(boost_kahypar::detail::function::function_buffer));
#         if defined(BOOST_GCC) && (BOOST_GCC >= 40700)
#           pragma GCC diagnostic pop
#         endif
        } else
          get_vtable()->base.manager(f.functor, this->functor,
                                     boost_kahypar::detail::function::clone_functor_tag);
      }
    }
    ...
    {
      using boost_kahypar::detail::function::vtable_base;

      typedef typename boost_kahypar::detail::function::get_function_tag<Functor>::type tag;
      typedef boost_kahypar::detail::function::get_invoker<tag> get_invoker;
      ...
      if (stored_vtable.assign_to(std::move(f), functor)) {
        ...
        if (boost_kahypar::detail::function::is_trivially_copyable<Functor>::value &&
            boost_kahypar::detail::function::function_allows_small_object_optimization<Functor>::value)
          value |= static_cast<std::size_t>(0x01);
        vtable = reinterpret_cast<boost_kahypar::detail::function::vtable_base *>(value);
      } else
        vtable = 0;
    }
...
#endif
            get_vtable()->base.manager(f.functor, this->functor,
                                     boost_kahypar::detail::function::move_functor_tag);
#if defined(BOOST_GCC) && (__GNUC__ >= 11)
# pragma GCC diagnostic pop
#endif
          f.vtable = 0;
...
// Poison comparisons between boost_kahypar::function objects of the same type.
template<typename R, typename... T>
