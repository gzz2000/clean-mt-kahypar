...
#include <boost_kahypar/config.hpp>   // for BOOST_STATIC_CONSTANT
#include <boost_kahypar/integer.hpp>  // for boost_kahypar::uint_t
...
#ifdef BOOST_MSVC
#pragma warning(push)
#pragma warning(disable:4245)  // 'initializing' : conversion from 'int' to 'const boost_kahypar::low_bits_mask_t<8>::least', signed/unsigned mismatch
#endif
...
BOOST_LOW_BITS_MASK_SPECIALIZE( unsigned long );
    ...
    BOOST_LOW_BITS_MASK_SPECIALIZE( boost_kahypar::ulong_long_type );
    #endif
