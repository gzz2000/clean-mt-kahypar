...
namespace boost_kahypar { namespace integer {
...
template<class Z>
typename boost_kahypar::enable_if_c< std::numeric_limits< Z >::is_signed, euclidean_result_t< Z > >::type
extended_euclidean(Z m, Z n)
{
    ...
    {
        swapped = true;
        boost_kahypar::core::invoke_swap(m, n);
    }
    Z u0 = m;
    Z u1 = 1;
    Z u2 = 0;
