...
template<typename FPT>
struct fpt_limits : boost_kahypar::conditional<std::numeric_limits<FPT>::is_specialized,
 ...
 * by the @ref boost_kahypar::math::fpc::strength given at construction.
 *
 ...
 *
 * Serves the same purpose as boost_kahypar::math::fpc::close_at_tolerance, but used when one
