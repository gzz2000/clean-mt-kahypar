...
// Boost.Test
#include <boost_kahypar/test/tools/assertion.hpp>

#include <boost_kahypar/test/utils/is_forward_iterable.hpp>
...
namespace boost_kahypar { namespace test_tools { namespace assertion {  \
template<>                                                      \
...
inline
typename boost_kahypar::enable_if_c<
...
inline assertion_result
compare_collections( Lhs const& lhs, Rhs const& rhs, boost_kahypar::type<op::EQ<L, R> >*, mpl::true_ )
{
...
template <typename Lhs, typename Rhs, typename L, typename R>
inline assertion_result
compare_collections( Lhs const& lhs, Rhs const& rhs, boost_kahypar::type<op::EQ<L, R> >*, mpl::false_ )
{
    return lhs == rhs;
}
...
template <typename Lhs, typename Rhs, typename L, typename R>
inline assertion_result
compare_collections( Lhs const& lhs, Rhs const& rhs, boost_kahypar::type<op::NE<L, R> >*, mpl::true_ )
{
...
template <typename Lhs, typename Rhs, typename L, typename R>
inline assertion_result
compare_collections( Lhs const& lhs, Rhs const& rhs, boost_kahypar::type<op::NE<L, R> >*, mpl::false_ )
{
    return lhs != rhs;
}
...
inline assertion_result
compare_collections( Lhs const& lhs, Rhs const& rhs, boost_kahypar::type<OP>*, mpl::true_ )
{
...
template <typename Lhs, typename Rhs, typename L, typename R>
inline assertion_result
compare_collections( Lhs const& lhs, Rhs const& rhs, boost_kahypar::type<op::LT<L, R> >*, mpl::false_ )
{
    return lhs < rhs;
}
...
template <typename Lhs, typename Rhs, typename L, typename R>
inline assertion_result
compare_collections( Lhs const& lhs, Rhs const& rhs, boost_kahypar::type<op::LE<L, R> >*, mpl::false_ )
{
    return lhs <= rhs;
}
...
template <typename Lhs, typename Rhs, typename L, typename R>
inline assertion_result
compare_collections( Lhs const& lhs, Rhs const& rhs, boost_kahypar::type<op::GT<L, R> >*, mpl::false_ )
{
    return lhs > rhs;
}
...
template <typename Lhs, typename Rhs, typename L, typename R>
inline assertion_result
compare_collections( Lhs const& lhs, Rhs const& rhs, boost_kahypar::type<op::GE<L, R> >*, mpl::false_ )
{
    return lhs >= rhs;
}
...
template<typename Lhs,typename Rhs>                                 \
struct name<Lhs,Rhs,typename boost_kahypar::enable_if_c<                    \
