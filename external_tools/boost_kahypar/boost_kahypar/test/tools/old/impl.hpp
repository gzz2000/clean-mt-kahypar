...
#include <boost_kahypar/test/tools/floating_point_comparison.hpp>
...
#include <boost_kahypar/numeric/conversion/conversion_traits.hpp> // for numeric::conversion_traits
...
#define ARG_INFO( z, m, dummy )                                                     \
 ...
 , &static_cast<const unit_test::lazy_ostream&>(unit_test::lazy_ostream::instance() \
        << ::boost_kahypar::test_tools::tt_detail::print_helper( BOOST_JOIN( arg, m ) ))    \
/**/
        ...
        for( ; left_begin != left_end && right_begin != right_end; ++left_begin, ++right_begin, ++pos ) {
            if( *left_begin != *right_begin ) {
                ...
                pr.message() << "\nMismatch at position " << pos << ": "
                  << ::boost_kahypar::test_tools::tt_detail::print_helper(*left_begin)
                  << " != "
                  << ::boost_kahypar::test_tools::tt_detail::print_helper(*right_begin);
            }
        }
