...
#include <boost_kahypar/test/tree/auto_registration.hpp>
#include <boost_kahypar/test/tree/test_case_template.hpp>
...
boost_kahypar::unit_test::make_test_case( boost_kahypar::function<void ()>(test_function), \
                                  test_name ,                              \
                                  __FILE__, __LINE__ )
...
boost_kahypar::unit_test::make_test_case( (test_function),                         \
...
( new boost_kahypar::unit_test::test_suite( testsuite_name, __FILE__, __LINE__ ) )
...
BOOST_TEST_DECORATOR( * boost_kahypar::unit_test::expected_failures( n ) )      \
/**/
...
BOOST_AUTO_TU_REGISTRAR( test_name )(                                   \
    boost_kahypar::unit_test::make_test_case(                                   \
...
struct BOOST_AUTO_TC_INVOKER( test_name ) {                             \
    ...
    static void run( boost_kahypar::type<TestType>* = 0 )                       \
    {                                                                   \
        BOOST_TEST_CHECKPOINT('"' << #test_name << "\" fixture ctor");  \
        ...
        BOOST_TEST_CHECKPOINT('"' << #test_name << "\" fixture dtor");  \
                                                                        ...
                                                                        \
BOOST_AUTO_TU_REGISTRAR( test_name )(                                   \
    boost_kahypar::unit_test::ut_detail::template_test_case_gen<                \
...
#define BOOST_TEST_CASE_TEMPLATE( name, typelist )                      \
    boost_kahypar::unit_test::ut_detail::template_test_case_gen<name,typelist>( \
...
template<typename type_name>                                            \
void BOOST_JOIN( name, _impl )( boost_kahypar::type<type_name>* );              \
                                                                        \
struct name {                                                           \
    template<typename TestType>                                         \
    static void run( boost_kahypar::type<TestType>* frwrd = 0 )                 \
    {                                                                   \
...
static boost_kahypar::unit_test::ut_detail::global_configuration_impl<F> BOOST_JOIN( gf_, F ) \
/**/
...
static boost_kahypar::unit_test::ut_detail::global_fixture_impl<F> BOOST_JOIN( gf_, F ) \
/**/
...
static boost_kahypar::unit_test::decorator::collector_t const&                  \
...
namespace boost_kahypar { namespace unit_test { namespace ut_detail {
...
typedef ::boost_kahypar::unit_test::ut_detail::nil_t BOOST_AUTO_TEST_CASE_FIXTURE;
...
static boost_kahypar::unit_test::ut_detail::auto_test_unit_registrar       \
...
static const boost_kahypar::unit_test::framework::impl::master_test_suite_name_setter mtsetter(BOOST_TEST_STRINGIZE( BOOST_TEST_MODULE ).trim( "\"" ));
#endif
