...
#include <boost_kahypar/test/output/xml_log_formatter.hpp>
...
typedef ::boost_kahypar::io::ios_base_all_saver io_saver_type;
...
struct unit_test_log_data_helper_impl {
  typedef boost_kahypar::shared_ptr<unit_test_log_formatter> formatter_ptr;
  typedef boost_kahypar::shared_ptr<io_saver_type>           saver_ptr;
