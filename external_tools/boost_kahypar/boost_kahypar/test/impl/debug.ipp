...
#include <boost_kahypar/test/debug_config.hpp>
...
{
    boost_kahypar::ignore_unused( on_off );
...
#else
    boost_kahypar::ignore_unused( report_file );
...
{
    boost_kahypar::ignore_unused( mem_alloc_order_num );
