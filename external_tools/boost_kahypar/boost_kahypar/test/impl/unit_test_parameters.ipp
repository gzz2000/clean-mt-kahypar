...
#include <boost_kahypar/test/utils/basic_cstring/basic_cstring.hpp>
...
// Boost.Runtime.Param
#include <boost_kahypar/test/utils/runtime/parameter.hpp>
#include <boost_kahypar/test/utils/runtime/argument.hpp>
#include <boost_kahypar/test/utils/runtime/finalize.hpp>
#include <boost_kahypar/test/utils/runtime/cla/parser.hpp>
#include <boost_kahypar/test/utils/runtime/env/fetch.hpp>
...
namespace rt = boost_kahypar::runtime;
...
register_parameters( rt::parameters_store& store )
{
    rt::option auto_start_dbg( btrt_auto_start_dbg, (
        ...
        rt::help = "Specifies whether Boost.Test should attempt "
                   ...
                   "Boost.Test debug API, specifically the function boost_kahypar::debug::set_debugger."
    ));
...
init( int& argc, char** argv )
{
    ...
    BOOST_TEST_I_TRY {
        ...
        if( runtime_config::get<bool>( btrt_version ) ) {
            ...
            BOOST_TEST_I_THROW( framework::nothing_to_test( boost_kahypar::exit_success ) );
        }
