...
unit_test_main( init_unit_test_func init_func, int argc, char* argv[] )
{
    ...
    boost_kahypar::ignore_unused(shutdown_helper);
    ...
    BOOST_TEST_I_CATCH( framework::internal_error, ex ) {
        ...
        result_code = boost_kahypar::exit_exception_failure;
    }
...
main( int argc, char* argv[] )
{
    ...
    boost_kahypar::unit_test::init_unit_test_func init_func = &init_unit_test;
#else
    extern ::boost_kahypar::unit_test::test_suite* init_unit_test_suite( int argc, char* argv[] );

    boost_kahypar::unit_test::init_unit_test_func init_func = &init_unit_test_suite;
#endif

    return ::boost_kahypar::unit_test::unit_test_main( init_func, argc, argv );
}
