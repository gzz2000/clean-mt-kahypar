...
#include <boost_kahypar/test/execution_monitor.hpp> // execution_aborted
...
using ::boost_kahypar::unit_test::lazy_ostream;
...
context_frame::context_frame( ::boost_kahypar::unit_test::lazy_ostream const& context_descr )
