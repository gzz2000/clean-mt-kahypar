...
test_case::test_case( const_string name, boost_kahypar::function<void ()> const& test_func )
...
test_case::test_case( const_string name, const_string file_name, std::size_t line_num, boost_kahypar::function<void ()> const& test_func )
...
void
test_suite::add( boost_kahypar::shared_ptr<test_unit_generator> gen_ptr, decorator::collector_t& decorators )
{
    std::pair<boost_kahypar::shared_ptr<test_unit_generator>, std::vector<decorator::base_ptr> > tmp_p(gen_ptr, decorators.get_lazy_decorators() );
...
test_suite::generate( )
{
    typedef std::pair<boost_kahypar::shared_ptr<test_unit_generator>, std::vector<decorator::base_ptr> > element_t;
...
auto_test_unit_registrar::auto_test_unit_registrar( boost_kahypar::shared_ptr<test_unit_generator> tc_gen, decorator::collector_t& decorators )
{
    framework::current_auto_test_suite().add( tc_gen, decorators );
}
