...
public:
    ...
    /// @returns
    ///   - @c boost_kahypar::exit_success on success,
    ///   - @c boost_kahypar::exit_exception_failure in case test unit
    ///     was aborted for any reason (including uncaught exception)
    ///   - and @c boost_kahypar::exit_test_failure otherwise
...
/// of the test tree.
///
/// @see boost_kahypar::unit_test::test_observer
