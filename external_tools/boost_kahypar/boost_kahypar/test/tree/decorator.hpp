...
class base;
typedef boost_kahypar::shared_ptr<base> base_ptr;
...
inline fixture_t
fixture( boost_kahypar::function<void()> const& setup, boost_kahypar::function<void()> const& teardown = boost_kahypar::function<void()>() )
{
...
public:
    typedef boost_kahypar::function<test_tools::assertion_result (test_unit_id)>   predicate_t;
