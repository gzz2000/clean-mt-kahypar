...
//
/// @file
/// Defines @ref boost_kahypar::unit_test::test_unit "test_unit", @ref boost_kahypar::unit_test::test_case "test_case",
/// @ref boost_kahypar::unit_test::test_suite "test_suite" and @ref boost_kahypar::unit_test::master_test_suite_t "master_test_suite_t"
// ***************************************************************************
...
#include <boost_kahypar/test/tree/decorator.hpp>
#include <boost_kahypar/test/tree/fixture.hpp>
#include <boost_kahypar/test/framework.hpp>

#include <boost_kahypar/test/tools/assertion_result.hpp>

#include <boost_kahypar/test/utils/class_properties.hpp>

// Boost
#include <boost_kahypar/function/function0.hpp>
#include <boost_kahypar/function/function1.hpp>
...
public:
    ...
    typedef boost_kahypar::function<test_tools::assertion_result (test_unit_id)>    precondition_t;
...
public:
    ...
    // Constructor
    test_case( const_string tc_name, boost_kahypar::function<void ()> const& test_func );
    test_case( const_string tc_name, const_string tc_file, std::size_t tc_line, boost_kahypar::function<void ()> const& test_func );

    // Public property
    typedef BOOST_READONLY_PROPERTY(boost_kahypar::function<void ()>,(test_case))  test_func;
...
public:
    ...
    /// @overload
    void            add( boost_kahypar::shared_ptr<test_unit_generator> gen_ptr, decorator::collector_t& decorators );
...
protected:
    ...
    std::vector< std::pair<boost_kahypar::shared_ptr<test_unit_generator>, std::vector<decorator::base_ptr> > > m_generators; /// lazy evaluation
};
...
public:
    ...
    friend BOOST_TEST_DECL master_test_suite_t& boost_kahypar::unit_test::framework::master_test_suite();
};
...
inline test_case*
make_test_case( boost_kahypar::function<void ()> const& test_func, const_string tc_name, const_string tc_file, std::size_t tc_line )
{
...
make_test_case( void (UserTestCase::*           test_method )(),
                ...
                std::size_t                     tc_line,
                boost_kahypar::shared_ptr<InstanceType> user_test_case )
{
