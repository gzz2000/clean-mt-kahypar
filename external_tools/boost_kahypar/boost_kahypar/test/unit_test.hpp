...
#  define BOOST_LIB_NAME boost_kahypar_unit_test_framework
...
namespace boost_kahypar { namespace unit_test {
...
{
    return ::boost_kahypar::unit_test::unit_test_main( &init_unit_test, argc, argv );
}
