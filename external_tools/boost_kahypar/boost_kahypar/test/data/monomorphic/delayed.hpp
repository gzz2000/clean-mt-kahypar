...
#include <boost_kahypar/test/data/index_sequence.hpp>
...
private:
  ...
  dataset_t& get() const {
      if(!m_dataset) {
          m_dataset = create(boost_kahypar::unit_test::data::index_sequence_for<Args...>());
      }
      return *m_dataset;
  }
  ...
  create(boost_kahypar::unit_test::data::index_sequence<I...>) const
  {
...
template <class dataset_t, class ...Args>
struct is_dataset< delayed_dataset<dataset_t, Args...> > : boost_kahypar::mpl::true_ {};
