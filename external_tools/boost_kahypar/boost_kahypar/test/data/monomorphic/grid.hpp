...
#include <boost_kahypar/test/data/monomorphic/fwd.hpp>
#include <boost_kahypar/test/data/monomorphic/sample_merge.hpp>
...
class grid {
    typedef typename boost_kahypar::decay<DataSet1>::type   dataset1_decay;
    typedef typename boost_kahypar::decay<DataSet2>::type   dataset2_decay;
...
public:
    static const int arity = boost_kahypar::decay<DataSet1>::type::arity + boost_kahypar::decay<DataSet2>::type::arity;
...
//! Grid operation
template<typename DataSet1, typename DataSet2>
inline typename boost_kahypar::lazy_enable_if_c<is_dataset<DataSet1>::value && is_dataset<DataSet2>::value,
...
//! @overload boost_kahypar::unit_test::data::operator*
template<typename DataSet1, typename DataSet2>
inline typename boost_kahypar::lazy_enable_if_c<is_dataset<DataSet1>::value && !is_dataset<DataSet2>::value,
