...
//! @overload boost_kahypar::unit_test::data::make()
template<typename T, std::size_t size>
inline monomorphic::array<typename boost_kahypar::remove_const<T>::type>
make( T (&a)[size] )
{
    return monomorphic::array<typename boost_kahypar::remove_const<T>::type>( a, size );
}
