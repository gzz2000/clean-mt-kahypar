...
#include <boost_kahypar/test/data/monomorphic/generators/keywords.hpp>
#include <boost_kahypar/test/data/monomorphic/generate.hpp>
 ...
 *
 * This class implements the generator concept (see @ref boost_kahypar::unit_test::data::monomorphic::generated_by) for implementing
...
template<typename SampleType, typename StepType=SampleType>
struct make_xrange {
    static StepType    abs( StepType s, boost_kahypar::true_type* )   { return s; }
    static StepType    abs( StepType s, boost_kahypar::false_type* )  { return std::abs(s); }
    ...
    _( Params const& params )
    {
        ...
        if( !end_val.is_initialized() )
            ...
            StepType    abs_step        = make_xrange::abs(step_val, (typename boost_kahypar::is_unsigned<StepType>::type*)0 );
...
/// @overload boost_kahypar::unit_test::data::xrange()
