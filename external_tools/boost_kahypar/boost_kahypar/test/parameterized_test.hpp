...
boost_kahypar::unit_test::make_test_case( function,                                \
...
public:
    param_test_case_generator( boost_kahypar::function<void (ParamType)> const& test_func,
    ...
    virtual test_unit* next() const
    {
        ...
        test_unit* res = new test_case( m_tc_name + "_" + utils::string_cast(m_index), m_tc_file, m_tc_line, boost_kahypar::bind( m_test_func, *m_par_begin ) );
...
private:
    // Data members
    boost_kahypar::function<void (ParamType)>    m_test_func;
...
make_test_case( boost_kahypar::function<void (ParamType)> const& test_func,
                const_string                             tc_name,
                const_string                             tc_file,
                std::size_t                              tc_line,
                ParamIter                                par_begin,
...
make_test_case( void (UserTestCase::*test_method )( ParamType ),
                ...
                const_string                           tc_file,
                std::size_t                            tc_line,
                boost_kahypar::shared_ptr<UserTestCase> const& user_test_case,
                ParamIter                              par_begin,
                ParamIter                              par_end )
{
    typedef BOOST_DEDUCED_TYPENAME remove_const<BOOST_DEDUCED_TYPENAME remove_reference<ParamType>::type>::type param_value_type;
