...
public:
    ...
    // access methods
    arrow_res_t     operator->() const      { return boost_kahypar::addressof( base_prop::value ); }
};
...
#define BOOST_READONLY_PROPERTY( property_type, friends ) boost_kahypar::unit_test::readwrite_property<property_type >
...
: public boost_kahypar::unit_test::readonly_property<property_type > {                      \
    typedef boost_kahypar::unit_test::readonly_property<property_type > base_prop;          \
...
public:
    ...
    arrow_res_t     operator->()            { return boost_kahypar::addressof( base_prop::value ); }
    const_arrow_res_t operator->() const    { return boost_kahypar::addressof( base_prop::value ); }
