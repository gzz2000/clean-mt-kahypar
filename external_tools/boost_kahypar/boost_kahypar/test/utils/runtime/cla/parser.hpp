...
#include <boost_kahypar/test/utils/runtime/modifier.hpp>
#include <boost_kahypar/test/utils/runtime/parameter.hpp>

#include <boost_kahypar/test/utils/runtime/cla/argv_traverser.hpp>
...
#include <boost_kahypar/algorithm/cxx11/all_of.hpp> // !! ?? unnecessary after cxx11
...
typedef std::vector<boost_kahypar::reference_wrapper<parameter_cla_id const> > param_cla_id_list;
