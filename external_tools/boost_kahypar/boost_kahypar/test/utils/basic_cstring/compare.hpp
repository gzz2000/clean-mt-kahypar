...
template<class CharT>
inline bool
operator <( boost_kahypar::unit_test::basic_cstring<CharT> const& x,
            boost_kahypar::unit_test::basic_cstring<CharT> const& y )
{
    typedef typename boost_kahypar::unit_test::basic_cstring<CharT>::traits_type traits_type;
    return x.size() != y.size()
            ? x.size() < y.size()
