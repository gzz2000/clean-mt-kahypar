...
inline RefType
deref( static_any_t cur, C&, ::boost_kahypar::type<RefType>, mpl::false_ )
{
    return *static_any_cast<BOOST_DEDUCED_TYPENAME C::iterator>( cur );
}
...
template<class RefType,typename C>
inline RefType
deref( static_any_t cur, C const&, ::boost_kahypar::type<RefType>, mpl::true_ )
{
    return *static_any_cast<BOOST_DEDUCED_TYPENAME C::const_iterator>( cur );
}
...
#define BOOST_TEST_FE_ANY                   ::boost_kahypar::unit_test::for_each::static_any_t
#define BOOST_TEST_FE_IS_CONST( COL )       ::boost_kahypar::unit_test::for_each::is_const_coll( COL )

#define BOOST_TEST_FE_BEG( COL )            \
    ::boost_kahypar::unit_test::for_each::begin(    \
        COL,                                \
        BOOST_TEST_FE_IS_CONST( COL ) )     \
/**/

#define BOOST_TEST_FE_END( COL )            \
    ::boost_kahypar::unit_test::for_each::end(      \
        COL,                                \
        BOOST_TEST_FE_IS_CONST( COL ) )     \
/**/

#define BOOST_TEST_FE_DONE( COL )           \
    ::boost_kahypar::unit_test::for_each::done(     \
...
#define BOOST_TEST_FE_NEXT( COL )           \
    ::boost_kahypar::unit_test::for_each::next(     \
        BOOST_TEST_FE_CUR_VAR,              \
        COL,                                \
        BOOST_TEST_FE_IS_CONST( COL ) )     \
/**/
...
#define BOOST_TEST_FE_PREV( COL )           \
    ::boost_kahypar::unit_test::for_each::prev(     \
        BOOST_TEST_FE_CUR_VAR,              \
        COL,                                \
        BOOST_TEST_FE_IS_CONST( COL ) )     \
/**/
...
#define BOOST_TEST_FE_DEREF( COL, RefType ) \
    ::boost_kahypar::unit_test::for_each::deref(    \
        BOOST_TEST_FE_CUR_VAR,              \
        COL,                                \
        ::boost_kahypar::type<RefType >(),          \
        BOOST_TEST_FE_IS_CONST( COL ) )     \
/**/
