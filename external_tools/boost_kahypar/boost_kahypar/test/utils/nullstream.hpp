...
// Boost
#include <boost_kahypar/utility/base_from_member.hpp>
...
template< typename CharType, class CharTraits = ::std::char_traits<CharType> >
class basic_onullstream : private boost_kahypar::base_from_member<basic_nullbuf<CharType, CharTraits> >
                        , public ::std::basic_ostream<CharType, CharTraits> {
    typedef boost_kahypar::base_from_member<basic_nullbuf<CharType, CharTraits> >   pbase_type;
