...
#include <boost_kahypar/random/detail/sobol_table.hpp>
#include <boost_kahypar/random/detail/gray_coded_qrng.hpp>
  ...
  void resize(std::size_t dimension)
  {
    ...
    for (std::size_t dim = 1; dim < dimension; ++dim)
    {
      ...
      if (poly > (std::numeric_limits<value_type>::max)()) {
        boost_kahypar::throw_exception( std::range_error("sobol: polynomial value outside the given value type range") );
      }
...
public:
  ...
  /** @copydoc boost_kahypar::random::niederreiter_base2_engine::min() */
  static BOOST_CONSTEXPR result_type min BOOST_PREVENT_MACRO_SUBSTITUTION ()
  { return (base_t::min)(); }

  /** @copydoc boost_kahypar::random::niederreiter_base2_engine::max() */
  static BOOST_CONSTEXPR result_type max BOOST_PREVENT_MACRO_SUBSTITUTION ()
  { return (base_t::max)(); }

  /** @copydoc boost_kahypar::random::niederreiter_base2_engine::dimension() */
  std::size_t dimension() const { return base_t::dimension(); }

  /** @copydoc boost_kahypar::random::niederreiter_base2_engine::seed() */
  void seed()
  {
    base_t::seed();
  }

  /** @copydoc boost_kahypar::random::niederreiter_base2_engine::seed(UIntType) */
  void seed(UIntType init)
  {
    base_t::seed(init);
  }

  /** @copydoc boost_kahypar::random::niederreiter_base2_engine::operator()() */
  result_type operator()()
  {
    return base_t::operator()();
  }

  /** @copydoc boost_kahypar::random::niederreiter_base2_engine::discard(boost_kahypar::uintmax_t) */
 ...
 */
typedef sobol_engine<boost_kahypar::uint_least64_t, 64u, default_sobol_table> sobol;
