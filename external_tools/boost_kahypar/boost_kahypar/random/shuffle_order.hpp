...
public:
    ...
    result_type operator()() {
        ...
        typedef typename boost_kahypar::random::traits::make_unsigned<result_type>::type base_unsigned;
        ...
        if(k == 1) {
            ...
            boost_kahypar::uintmax_t divisor =
                static_cast<boost_kahypar::uintmax_t>(brange) + 1;
