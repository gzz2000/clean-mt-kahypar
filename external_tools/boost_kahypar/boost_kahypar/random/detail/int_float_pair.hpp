...
inline typename boost_kahypar::make_unsigned<typename Engine::result_type>::type
generate_one_digit(Engine& eng, std::size_t bits)
{
    typedef typename Engine::result_type base_result;
    typedef typename boost_kahypar::make_unsigned<base_result>::type base_unsigned;
...
std::pair<RealType, int> generate_int_float_pair(Engine& eng, boost_kahypar::true_type)
{
    typedef typename Engine::result_type base_result;
    typedef typename boost_kahypar::make_unsigned<base_result>::type base_unsigned;
...
template<class RealType, std::size_t w, class Engine>
inline std::pair<RealType, int> generate_int_float_pair(Engine& eng, boost_kahypar::false_type)
{
...
inline std::pair<RealType, int> generate_int_float_pair(Engine& eng)
{
    ...
    return generate_int_float_pair<RealType, w>(eng,
        boost_kahypar::is_integral<base_result>());
}
