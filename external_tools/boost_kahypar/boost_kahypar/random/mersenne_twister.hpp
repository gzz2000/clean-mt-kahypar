...
#include <boost_kahypar/random/detail/ptr_helper.hpp>
...
#include <boost_kahypar/random/detail/polynomial.hpp>
...
private:
     ...
     */
    void discard_many(boost_kahypar::uintmax_t z)
    {
...
BOOST_RANDOM_PTR_HELPER_SPEC(boost_kahypar::mt11213b)
BOOST_RANDOM_PTR_HELPER_SPEC(boost_kahypar::mt19937)
BOOST_RANDOM_PTR_HELPER_SPEC(boost_kahypar::mt19937_64)
