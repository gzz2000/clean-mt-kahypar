...
#include <boost_kahypar/random/detail/uniform_int_float.hpp>
...
T generate_uniform_int(
    ...
    boost_kahypar::true_type /** is_integral<Engine::result_type> */)
{
    typedef T result_type;
    typedef typename boost_kahypar::random::traits::make_unsigned_or_unbounded<T>::type range_type;
    typedef typename Engine::result_type base_result;
    // ranges are always unsigned or unbounded
    typedef typename boost_kahypar::random::traits::make_unsigned_or_unbounded<base_result>::type base_unsigned;
...
inline T generate_uniform_int(
    Engine& eng, T min_value, T max_value,
    boost_kahypar::false_type /** is_integral<Engine::result_type> */)
{
    uniform_int_float<Engine> wrapper(eng);
    return generate_uniform_int(wrapper, min_value, max_value, boost_kahypar::true_type());
}
...
inline T generate_uniform_int(Engine& eng, T min_value, T max_value)
{
    ...
    return generate_uniform_int(eng, min_value, max_value,
        boost_kahypar::random::traits::is_integral<base_result>());
}
