...
#include <boost_kahypar/config/no_tr1/cmath.hpp>      // std::exp, std::sqrt
#include <cassert>
#include <iosfwd>
#include <istream>
 ...
 * boost_kahypar::lognormal_distribution.  A backwards compatible
 * version is provided in namespace boost_kahypar.
 * @endxmlwarning
 */
