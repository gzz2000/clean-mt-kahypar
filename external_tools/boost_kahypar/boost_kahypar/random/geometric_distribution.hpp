...
#include <boost_kahypar/config/no_tr1/cmath.hpp>          // std::log
#include <iosfwd>
#include <ios>
 ...
 * boost_kahypar::geometric_distribution.  A backwards compatible
 * wrapper is provided in namespace boost_kahypar.
 * @endxmlwarning
 */
...
public:
    ...
    result_type operator()(Engine& eng) const
    {
        using std::log;
        using std::floor;
        RealType x = RealType(1) - boost_kahypar::uniform_01<RealType>()(eng);
