...
public:
    ...
    { return max_imp(boost_kahypar::is_integral<UIntType>()); }
    ...
    {
        for(boost_kahypar::uintmax_t i = 0; i < z; ++i) {
            (*this)();
        }
    }
...
private:
    ...
    /// \cond show_private
    typedef typename boost_kahypar::random::traits::make_unsigned<base_result_type>::type base_unsigned;

    static BOOST_CONSTEXPR UIntType max_imp(const boost_kahypar::true_type&)
    {
       return boost_kahypar::low_bits_mask_t<w>::sig_bits;
    }
    static UIntType max_imp(const boost_kahypar::false_type&)
    {
