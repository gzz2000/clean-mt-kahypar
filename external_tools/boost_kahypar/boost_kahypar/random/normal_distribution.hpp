...
#include <boost_kahypar/random/detail/int_float_pair.hpp>
...
struct unit_normal_distribution
{
    ...
    RealType generate_tail(Engine& eng) {
        ...
        boost_kahypar::random::exponential_distribution<RealType> exp_x(tail_start);
        boost_kahypar::random::exponential_distribution<RealType> exp_y;
        for(;;) {
