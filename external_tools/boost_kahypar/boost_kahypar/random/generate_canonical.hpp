...
RealType generate_canonical_impl(URNG& g, boost_kahypar::true_type /*is_integral*/)
{
    using std::pow;
...
template<class RealType, std::size_t bits, class URNG>
RealType generate_canonical_impl(URNG& g, boost_kahypar::false_type /*is_integral*/)
{
    using std::pow;
    using std::floor;
...
RealType generate_canonical(URNG& g)
{
    RealType result = detail::generate_canonical_impl<RealType, bits>(
        g, boost_kahypar::random::traits::is_integral<typename URNG::result_type>());
