 ...
 * (to-be-invented) @c boost_kahypar::bigfloat class with random bits efficiently.
...
{
  typedef boost_kahypar::random::detail::ptr_helper<UniformRandomNumberGenerator> traits;
public:
