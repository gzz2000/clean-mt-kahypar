...
struct subtract_with_carry_discard
{
    ...
    static void apply(Engine& eng, boost_kahypar::uintmax_t z)
    {
...
public:
                                        ...
                                        IntType, value)
    {
        ...
        gen_t intgen(static_cast<boost_kahypar::uint32_t>(value == 0 ? default_seed : value));
    ...
    { return boost_kahypar::low_bits_mask_t<w>::sig_bits; }
...
public:
    ...
    BOOST_STATIC_CONSTANT(std::size_t, long_lag = r);
    BOOST_STATIC_CONSTANT(std::size_t, short_lag = s);
    BOOST_STATIC_CONSTANT(boost_kahypar::uint32_t, default_seed = 19780503u);
...
class subtract_with_carry :
    public subtract_with_carry_engine<IntType,
        boost_kahypar::static_log2<m>::value, s, r>
{
    typedef subtract_with_carry_engine<IntType,
        boost_kahypar::static_log2<m>::value, s, r> base_type;
public:
    subtract_with_carry() {}
