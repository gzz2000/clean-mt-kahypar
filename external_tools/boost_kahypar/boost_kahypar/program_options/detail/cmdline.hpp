...
#include <boost_kahypar/program_options/cmdline.hpp>
#include <boost_kahypar/program_options/option.hpp>
...
#   pragma warning (push)
#   pragma warning (disable:4251) // class 'std::vector<_Ty>' needs to have dll-interface to be used by clients of class 'boost_kahypar::program_options::positional_options_description'
#endif
...
namespace boost_kahypar { namespace program_options { namespace detail {
    ...
    */
    ...
    public:
        ...
        typedef ::boost_kahypar::program_options::command_line_style::style_t style_t;
