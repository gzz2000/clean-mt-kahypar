...
#   pragma warning (push)
#   pragma warning (disable:4251) // class 'std::vector<_Ty>' needs to have dll-interface to be used by clients of class 'boost_kahypar::program_options::basic_parsed_options<wchar_t>'
#endif
...
#include "boost_kahypar/program_options/detail/parsers.hpp"
