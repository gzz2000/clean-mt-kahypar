...
#   pragma warning (push)
#   pragma warning (disable:4251) // 'boost_kahypar::program_options::variable_value::v' : class 'boost_kahypar::any' needs to have dll-interface to be used by clients of class 'boost_kahypar::program_options::variable_value
#endif
...
namespace boost_kahypar { namespace program_options {
    ...
    */
    ...
    public:
        ...
        variable_value(const boost_kahypar::any& xv, bool xdefaulted)
        : v(xv), m_defaulted(xdefaulted)
        {}

        /** If stored value if of type T, returns that value. Otherwise,
            throws boost_kahypar::bad_any_cast exception. */
       template<class T>
       const T& as() const {
           return boost_kahypar::any_cast<const T&>(v);
       }
       /** @overload */
       template<class T>
       T& as() {
           return boost_kahypar::any_cast<T&>(v);
       }
        ...
        const boost_kahypar::any& value() const;
