...
#include <boost_kahypar/smart_ptr/detail/atomic_count.hpp>
...
{
    typedef boost_kahypar::detail::atomic_count type;

    static unsigned int load(boost_kahypar::detail::atomic_count const& counter) BOOST_SP_NOEXCEPT
    {
        return static_cast< unsigned int >(static_cast< long >(counter));
    }

    static void increment(boost_kahypar::detail::atomic_count& counter) BOOST_SP_NOEXCEPT
    {
        ++counter;
    }

    static unsigned int decrement(boost_kahypar::detail::atomic_count& counter) BOOST_SP_NOEXCEPT
    {
