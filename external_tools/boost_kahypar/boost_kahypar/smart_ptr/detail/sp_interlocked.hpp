...
# define BOOST_SP_INTERLOCKED_INCREMENT ::boost_kahypar::detail::InterlockedIncrement
# define BOOST_SP_INTERLOCKED_DECREMENT ::boost_kahypar::detail::InterlockedDecrement
# define BOOST_SP_INTERLOCKED_COMPARE_EXCHANGE ::boost_kahypar::detail::InterlockedCompareExchange
# define BOOST_SP_INTERLOCKED_EXCHANGE ::boost_kahypar::detail::InterlockedExchange
# define BOOST_SP_INTERLOCKED_EXCHANGE_ADD ::boost_kahypar::detail::InterlockedExchangeAdd
