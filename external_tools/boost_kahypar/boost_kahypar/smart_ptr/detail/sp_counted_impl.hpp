...
#include <boost_kahypar/smart_ptr/detail/quick_allocator.hpp>
#endif
...
public:
    ...
    {
#if defined(BOOST_SP_ENABLE_DEBUG_HOOKS)
        boost_kahypar::sp_scalar_constructor_hook( px, sizeof(X), this );
#endif
    }
    ...
    {
#if defined(BOOST_SP_ENABLE_DEBUG_HOOKS)
        boost_kahypar::sp_scalar_destructor_hook( px_, sizeof(X), this );
#endif
        boost_kahypar::checked_delete( px_ );
    }
...
public:
    ...
    {
        return ti == BOOST_SP_TYPEID_(D)? boost_kahypar::detail::get_local_deleter( boost_kahypar::addressof( del ) ): 0;
    }
...
public:
    ...
    void * get_local_deleter( sp_typeinfo_ const & ti ) BOOST_SP_NOEXCEPT BOOST_OVERRIDE
    {
        return ti == BOOST_SP_TYPEID_( D )? boost_kahypar::detail::get_local_deleter( boost_kahypar::addressof( d_ ) ): 0;
    }
