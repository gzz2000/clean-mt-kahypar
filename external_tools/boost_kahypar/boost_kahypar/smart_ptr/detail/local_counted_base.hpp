...
public:
    ...
    virtual boost_kahypar::detail::shared_count local_cb_get_shared_count() const BOOST_SP_NOEXCEPT = 0;
...
public:
    ...
    boost_kahypar::detail::shared_count local_cb_get_shared_count() const BOOST_SP_NOEXCEPT BOOST_OVERRIDE
    {
        return pn_;
    }
};
