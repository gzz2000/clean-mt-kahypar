...
#include <boost_kahypar/archive/detail/iserializer.hpp>
#include <boost_kahypar/archive/detail/interface_iarchive.hpp>
...
public:
    ...
    virtual void load(boost_kahypar::long_long_type & t) = 0;
    virtual void load(boost_kahypar::ulong_long_type & t) = 0;
    ...
    template<class T>
    void load_override(
        const boost_kahypar::serialization::nvp< T > & t
    ){
        load_start(t.name());
...
public:
    ...
    virtual void set_library_version(
        boost_kahypar::serialization::library_version_type archive_library_version
    ) = 0;
    virtual boost_kahypar::serialization::library_version_type get_library_version() const = 0;
...
// required by export
BOOST_SERIALIZATION_REGISTER_ARCHIVE(boost_kahypar::archive::polymorphic_iarchive)
