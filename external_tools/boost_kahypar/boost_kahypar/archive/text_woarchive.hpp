...
#include <boost_kahypar/archive/basic_text_oarchive.hpp>
...
protected:
    ...
    void save(const boost_kahypar::serialization::item_version_type & t){
        save(static_cast<unsigned int>(t));
    }
...
// required by export
BOOST_SERIALIZATION_REGISTER_ARCHIVE(boost_kahypar::archive::text_woarchive)
