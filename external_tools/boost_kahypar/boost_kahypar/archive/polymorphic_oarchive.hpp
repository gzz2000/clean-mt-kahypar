...
#include <boost_kahypar/archive/detail/oserializer.hpp>
#include <boost_kahypar/archive/detail/interface_oarchive.hpp>
...
public:
    ...
    virtual void save(const boost_kahypar::long_long_type t) = 0;
    virtual void save(const boost_kahypar::ulong_long_type t) = 0;
...
// required by export
BOOST_SERIALIZATION_REGISTER_ARCHIVE(boost_kahypar::archive::polymorphic_oarchive)
