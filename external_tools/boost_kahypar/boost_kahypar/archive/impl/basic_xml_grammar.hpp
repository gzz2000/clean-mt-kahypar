...
#include <boost_kahypar/spirit/include/classic_rule.hpp>
#include <boost_kahypar/spirit/include/classic_chset.hpp>
...
private:
    ...
    typedef typename boost_kahypar::spirit::classic::chset<CharType> chset_t;
    typedef typename boost_kahypar::spirit::classic::chlit<CharType> chlit_t;
    typedef typename boost_kahypar::spirit::classic::scanner<
        typename  std::basic_string<CharType>::iterator
    > scanner_t;
    typedef typename boost_kahypar::spirit::classic::rule<scanner_t> rule_t;
