...
#include <boost_kahypar/archive/basic_binary_iarchive.hpp>
...
basic_binary_iarchive<Archive>::init() {
    ...
    * this->This() >> file_signature;
    ...
    boost_kahypar::serialization::library_version_type input_library_version;
    //* this->This() >> input_library_version;
    {
        ...
        if(v == 0)
            v = this->This()->m_sb.sbumpc();
        #endif
        input_library_version = static_cast<boost_kahypar::serialization::library_version_type>(v);
    }
