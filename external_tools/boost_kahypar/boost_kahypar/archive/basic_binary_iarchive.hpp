...
protected:
    ...
    void load_override(tracking_type & t, int /*version*/){
        boost_kahypar::serialization::library_version_type lv = this->get_library_version();
        if(boost_kahypar::serialization::library_version_type(6) < lv){
            int_least8_t x=0;
            * this->This() >> x;
            t = boost_kahypar::archive::tracking_type(x);
        }
        else{
            bool x=0;
            * this->This() >> x;
    ...
    void load_override(class_id_type & t){
         ...
         */
        if(boost_kahypar::serialization::library_version_type (7) < lv){
            this->detail_common_iarchive::load_override(t);
        }
        else{
            int_least16_t x=0;
            * this->This() >> x;
            t = boost_kahypar::archive::class_id_type(x);
        }
    }
    ...
    void load_override(version_type & t){
        ...
        if(boost_kahypar::serialization::library_version_type(6) < lv){
            uint_least8_t x=0;
            * this->This() >> x;
            t = boost_kahypar::archive::version_type(x);
        }
        else
        if(boost_kahypar::serialization::library_version_type(5) < lv){
            uint_least16_t x=0;
            * this->This() >> x;
            t = boost_kahypar::archive::version_type(x);
        }
        else
        if(boost_kahypar::serialization::library_version_type(2) < lv){
            // upto 255 versions
            unsigned char x=0;
            * this->This() >> x;
            t = version_type(x);
    ...
    void load_override(boost_kahypar::serialization::item_version_type & t){
        boost_kahypar::serialization::library_version_type lv = this->get_library_version();
//        if(boost_kahypar::serialization::library_version_type(7) < lvt){
        if(boost_kahypar::serialization::library_version_type(6) < lv){
            this->detail_common_iarchive::load_override(t);
        }
        else
        if(boost_kahypar::serialization::library_version_type(6) < lv){
            uint_least16_t x=0;
            * this->This() >> x;
            t = boost_kahypar::serialization::item_version_type(x);
        }
        else{
            unsigned int x=0;
            * this->This() >> x;
    ...
    void load_override(serialization::collection_size_type & t){
        if(boost_kahypar::serialization::library_version_type(5) < this->get_library_version()){
            this->detail_common_iarchive::load_override(t);
        }
        else{
            unsigned int x=0;
