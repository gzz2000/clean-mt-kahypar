...
class escape :
    public boost_kahypar::iterator_adaptor<
        Derived,
        Base,
        typename boost_kahypar::iterator_value<Base>::type,
        single_pass_traversal_tag,
        typename boost_kahypar::iterator_value<Base>::type
    >
{
    typedef typename boost_kahypar::iterator_value<Base>::type base_value_type;
    typedef typename boost_kahypar::iterator_reference<Base>::type reference_type;
