...
private:
    ...
    void set_library_version(boost_kahypar::serialization::library_version_type archive_library_version) BOOST_OVERRIDE {
        ArchiveImplementation::set_library_version(archive_library_version);
    }
    boost_kahypar::serialization::library_version_type get_library_version() const BOOST_OVERRIDE {
    ...
    void load(boost_kahypar::long_long_type & t) BOOST_OVERRIDE {
        ArchiveImplementation::load(t);
    }
    void load(boost_kahypar::ulong_long_type & t) BOOST_OVERRIDE {
        ArchiveImplementation::load(t);
    }
