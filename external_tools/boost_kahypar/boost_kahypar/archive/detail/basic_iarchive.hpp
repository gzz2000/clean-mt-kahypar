...
#include <boost_kahypar/archive/detail/helper_collection.hpp>
...
class BOOST_SYMBOL_VISIBLE basic_iarchive :
    ...
    public boost_kahypar::archive::detail::helper_collection
{
    friend class basic_iarchive_impl;
    // hide implementation of this class to minimize header conclusion
    boost_kahypar::scoped_ptr<basic_iarchive_impl> pimpl;
...
protected:
    ...
    boost_kahypar::archive::detail::helper_collection &
...
public:
    ...
    set_library_version(boost_kahypar::serialization::library_version_type archive_library_version);
