    ...
    public boost_kahypar::archive::detail::helper_collection
{
    ...
    boost_kahypar::scoped_ptr<basic_oarchive_impl> pimpl;
...
protected:
    ...
    BOOST_ARCHIVE_DECL boost_kahypar::archive::detail::helper_collection &
...
public:
    ...
    BOOST_ARCHIVE_DECL boost_kahypar::serialization::library_version_type get_library_version() const;
