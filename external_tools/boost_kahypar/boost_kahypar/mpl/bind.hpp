...
#   include <boost_kahypar/mpl/bind_fwd.hpp>
#   include <boost_kahypar/mpl/placeholders.hpp>
#   include <boost_kahypar/mpl/next.hpp>
#   include <boost_kahypar/mpl/protect.hpp>
#   include <boost_kahypar/mpl/apply_wrap.hpp>
#   include <boost_kahypar/mpl/limits/arity.hpp>
#   include <boost_kahypar/mpl/aux_/na.hpp>
#   include <boost_kahypar/mpl/aux_/arity_spec.hpp>
...
#include <boost_kahypar/mpl/aux_/config/bind.hpp>
...
#   include <boost_kahypar/mpl/aux_/preprocessor/params.hpp>
#   include <boost_kahypar/mpl/aux_/preprocessor/default_params.hpp>
#   include <boost_kahypar/mpl/aux_/preprocessor/def_params_tail.hpp>
#   include <boost_kahypar/mpl/aux_/preprocessor/partial_spec_params.hpp>
#   include <boost_kahypar/mpl/aux_/preprocessor/ext_params.hpp>
#   include <boost_kahypar/mpl/aux_/preprocessor/repeat.hpp>
#   include <boost_kahypar/mpl/aux_/preprocessor/enum.hpp>
#   include <boost_kahypar/mpl/aux_/preprocessor/add.hpp>
#   include <boost_kahypar/mpl/aux_/config/dmc_ambiguous_ctps.hpp>
#   include <boost_kahypar/mpl/aux_/config/ctps.hpp>
#   include <boost_kahypar/mpl/aux_/config/ttp.hpp>
...
template< typename T > struct is_bind_template
    : is_bind_template_impl< ::boost_kahypar::detail::is_reference_impl<T>::value >
        ::template result_<T>
{
};
...
#define BOOST_PP_ITERATION_PARAMS_1 \
    (3,(0, BOOST_MPL_LIMIT_METAFUNCTION_ARITY, <boost_kahypar/mpl/bind.hpp>))
...
#   define BOOST_PP_ITERATION_PARAMS_1 (3,(3, 3, <boost_kahypar/mpl/bind.hpp>))
#   include BOOST_PP_ITERATE()
...
#include <boost_kahypar/mpl/aux_/count_args.hpp>
}
...
#       define BOOST_PP_ITERATION_PARAMS_2 (3,(1, i_, <boost_kahypar/mpl/bind.hpp>))
#       include BOOST_PP_ITERATE()
