...
#   define AUX778076_INCLUDE_STRING BOOST_PP_STRINGIZE(boost_kahypar/mpl/list/AUX778076_HEADER)
#   include AUX778076_INCLUDE_STRING
#   undef AUX778076_INCLUDE_STRING
#else
#   include BOOST_PP_STRINGIZE(boost_kahypar/mpl/list/AUX778076_HEADER)
#endif
