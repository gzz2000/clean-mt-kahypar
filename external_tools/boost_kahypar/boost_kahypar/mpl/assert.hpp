...
#include <boost_kahypar/mpl/aux_/yes_no.hpp>
#include <boost_kahypar/mpl/aux_/na.hpp>
#include <boost_kahypar/mpl/aux_/adl_barrier.hpp>

#include <boost_kahypar/mpl/aux_/config/nttp.hpp>
#include <boost_kahypar/mpl/aux_/config/dtp.hpp>
#include <boost_kahypar/mpl/aux_/config/gcc.hpp>
...
#include <boost_kahypar/mpl/aux_/config/pp_counter.hpp>
#include <boost_kahypar/mpl/aux_/config/workaround.hpp>

#include <boost_kahypar/preprocessor/cat.hpp>

#include <boost_kahypar/config.hpp> // make sure 'size_t' is placed into 'std'
#include <cstddef>
...
boost_kahypar::mpl::aux::weighted_tag<1>::type operator==( assert_, assert_ );
boost_kahypar::mpl::aux::weighted_tag<2>::type operator!=( assert_, assert_ );
boost_kahypar::mpl::aux::weighted_tag<3>::type operator>(  assert_, assert_ );
boost_kahypar::mpl::aux::weighted_tag<4>::type operator>=( assert_, assert_ );
boost_kahypar::mpl::aux::weighted_tag<5>::type operator<( assert_, assert_ );
boost_kahypar::mpl::aux::weighted_tag<6>::type operator<=( assert_, assert_ );
...
struct eval_assert {
    ...
    typedef typename ::boost_kahypar::mpl::if_c<p_type::value,
...
struct eval_assert_not {
    ...
    typedef typename ::boost_kahypar::mpl::if_c<!p_type::value,
        AUX778076_ASSERT_ARG(assert<false>),
        failed ************ ::boost_kahypar::mpl::not_<P>::************
    >::type type;
};
...
template< typename Pred >
failed ************ (boost_kahypar::mpl::not_<Pred>::************
...
template< typename Pred >
typename assert_arg_type< boost_kahypar::mpl::not_<Pred> >::type 
...
BOOST_MPL_AUX_ASSERT_CONSTANT( \
    ...
    , BOOST_PP_CAT(mpl_assertion_in_line_,BOOST_MPL_AUX_PP_COUNTER()) = sizeof( \
          boost_kahypar::mpl::assertion_failed<false>( \
              boost_kahypar::mpl::make_assert_arg< \
                  typename boost_kahypar::mpl::eval_assert<void pred>::type \
                >() \
            ) \
        ) \
    ) \
...
BOOST_MPL_AUX_ASSERT_CONSTANT( \
    ...
    , BOOST_PP_CAT(mpl_assertion_in_line_,BOOST_MPL_AUX_PP_COUNTER()) = sizeof( \
          boost_kahypar::mpl::assertion_failed<false>( \
              boost_kahypar::mpl::make_assert_arg< \
                  typename boost_kahypar::mpl::eval_assert_not<void pred>::type \
                >() \
            ) \
        ) \
    ) \
...
BOOST_MPL_AUX_ASSERT_CONSTANT( \
    ...
    , BOOST_PP_CAT(mpl_assertion_in_line_,BOOST_MPL_AUX_PP_COUNTER()) = sizeof( \
          boost_kahypar::mpl::assertion_failed<false>( \
              boost_kahypar::mpl::assert_arg( (void (*) pred)BOOST_NULLPTR, 1 ) \
            ) \
        ) \
    ) \
/**/
...
enum { \
      BOOST_PP_CAT(mpl_assertion_in_line_,BOOST_MPL_AUX_PP_COUNTER()) = sizeof( \
          boost_kahypar::mpl::assertion<false>::failed( \
              boost_kahypar::mpl::assert_not_arg( (void (*) pred)BOOST_NULLPTR, 1 ) \
            ) \
        ) \
}\
/**/
...
BOOST_MPL_AUX_ASSERT_CONSTANT( \
    ...
    , BOOST_PP_CAT(mpl_assertion_in_line_,counter) = sizeof( \
        boost_kahypar::mpl::assertion_failed<BOOST_PP_CAT(mpl_assert_rel_value,counter)>( \
            (boost_kahypar::mpl::failed ************ ( boost_kahypar::mpl::assert_relation< \
                  boost_kahypar::mpl::assert_::relations( sizeof( \
                      boost_kahypar::mpl::assert_::arg rel boost_kahypar::mpl::assert_::arg \
                    ) ) \
                , x \
                , y \
                >::************)) 0 ) \
...
BOOST_MPL_AUX_ASSERT_CONSTANT( \
    ...
    , BOOST_PP_CAT(mpl_assertion_in_line_,counter) = sizeof( \
        boost_kahypar::mpl::assertion_failed<BOOST_PP_CAT(mpl_assert_rel_value,counter)>( \
              boost_kahypar::mpl::assert_rel_arg( boost_kahypar::mpl::assert_relation< \
                  boost_kahypar::mpl::assert_::relations(BOOST_PP_CAT(mpl_assert_rel,counter)) \
                , x \
                , y \
                >() ) \
            ) \
...
BOOST_MPL_AUX_ASSERT_CONSTANT( \
      std::size_t \
    , BOOST_PP_CAT(mpl_assertion_in_line_,BOOST_MPL_AUX_PP_COUNTER()) = sizeof( \
        boost_kahypar::mpl::assertion_failed<(x rel y)>( boost_kahypar::mpl::assert_rel_arg( \
              boost_kahypar::mpl::BOOST_MPL_AUX_ASSERT_RELATION(x,y,(&boost_kahypar::mpl::operator rel))() \
            ) ) \
        ) \
    ) \
/**/
...
BOOST_MPL_AUX_ASSERT_CONSTANT( \
      std::size_t \
    , BOOST_PP_CAT(mpl_assertion_in_line_,BOOST_MPL_AUX_PP_COUNTER()) = sizeof( \
        boost_kahypar::mpl::assertion_failed<(x rel y)>( (boost_kahypar::mpl::failed ************ ( \
            boost_kahypar::mpl::BOOST_MPL_AUX_ASSERT_RELATION(x,y,(&boost_kahypar::mpl::operator rel))::************))0 ) \
        ) \
    ) \
/**/
#   endif
...
struct msg; \
typedef struct BOOST_PP_CAT(msg,counter) : boost_kahypar::mpl::assert_ \
{ \
    using boost_kahypar::mpl::assert_::types; \
    static boost_kahypar::mpl::failed ************ (msg::************ assert_arg()) types_ \
    { return 0; } \
} BOOST_PP_CAT(mpl_assert_arg,counter); \
BOOST_MPL_AUX_ASSERT_CONSTANT( \
      std::size_t \
    , BOOST_PP_CAT(mpl_assertion_in_line_,counter) = sizeof( \
        boost_kahypar::mpl::assertion<(c)>::failed( BOOST_PP_CAT(mpl_assert_arg,counter)::assert_arg() ) \
        ) \
    ) \
/**/
#else
...
BOOST_MPL_AUX_ASSERT_CONSTANT( \
      std::size_t \
    , BOOST_PP_CAT(mpl_assertion_in_line_,counter) = sizeof( \
        boost_kahypar::mpl::assertion_failed<(c)>( BOOST_PP_CAT(mpl_assert_arg,counter)::assert_arg() ) \
        ) \
    ) \
/**/
#endif
