...
#include <boost_kahypar/mpl/aux_/config/adl.hpp>
...
namespace boost_kahypar { namespace mpl { using namespace BOOST_MPL_AUX_ADL_BARRIER_NAMESPACE; 
...
#   define BOOST_MPL_AUX_ADL_BARRIER_NAMESPACE boost_kahypar::mpl
#   define BOOST_MPL_AUX_ADL_BARRIER_NAMESPACE_OPEN namespace boost_kahypar { namespace mpl {
#   define BOOST_MPL_AUX_ADL_BARRIER_NAMESPACE_CLOSE }}
#   define BOOST_MPL_AUX_ADL_BARRIER_DECL(type) /**/
