...
#   include <boost_kahypar/mpl/aux_/preprocessor/sub.hpp>
...
#   include <boost_kahypar/preprocessor/dec.hpp>
...
#define BOOST_PP_ITERATION_PARAMS_1 \
    (3,( BOOST_PP_DEC(AUX778076_OP_ARITY), 2, <boost_kahypar/mpl/aux_/numeric_op.hpp> ))
