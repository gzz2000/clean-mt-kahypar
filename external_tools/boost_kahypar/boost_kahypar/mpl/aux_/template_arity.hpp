...
#include <boost_kahypar/mpl/aux_/config/lambda.hpp>

#if !defined(BOOST_MPL_PREPROCESSING_MODE)
#   include <boost_kahypar/mpl/aux_/template_arity_fwd.hpp>
...
#   endif
#   else
#       include <boost_kahypar/mpl/aux_/has_rebind.hpp>
#   endif
#endif
...
#   include <boost_kahypar/mpl/aux_/preprocessor/range.hpp>
...
#   include <boost_kahypar/preprocessor/seq/fold_left.hpp>
...
#   define BOOST_PP_FILENAME_1 <boost_kahypar/mpl/aux_/template_arity.hpp>
...
{
    BOOST_STATIC_CONSTANT(int, value = 
          sizeof(::boost_kahypar::mpl::aux::arity_helper(type_wrapper<F>(),arity_tag<N>())) - 1
        );
};
...
template< typename F >
struct template_arity
    : template_arity_impl< ::boost_kahypar::mpl::aux::has_rebind<F>::value >
        ::template result_<F>
{
};
