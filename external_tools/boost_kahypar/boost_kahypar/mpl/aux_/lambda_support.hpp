...
#   include <boost_kahypar/mpl/aux_/na_fwd.hpp>
...
#   include <boost_kahypar/preprocessor/tuple/to_list.hpp>
#   include <boost_kahypar/preprocessor/list/for_each_i.hpp>
...
template< BOOST_MPL_PP_PARAMS(i,typename T) > \
::boost_kahypar::mpl::aux::yes_tag operator|( \
      ::boost_kahypar::mpl::aux::has_rebind_tag<int> \
    , name<BOOST_MPL_PP_PARAMS(i,T)>* \
    ); \
::boost_kahypar::mpl::aux::no_tag operator|( \
      ::boost_kahypar::mpl::aux::has_rebind_tag<int> \
    , name< BOOST_MPL_PP_ENUM(i,::boost_kahypar::mpl::na) >* \
    ); \
/**/
...
::boost_kahypar::mpl::aux::yes_tag operator|( \
      ::boost_kahypar::mpl::aux::has_rebind_tag<int> \
    , ::boost_kahypar::mpl::aux::has_rebind_tag< name<BOOST_MPL_PP_PARAMS(i,T)> >* \
    ); \
/**/
#else
#   define BOOST_MPL_AUX_LAMBDA_SUPPORT_HAS_REBIND(i, name, params) /**/
