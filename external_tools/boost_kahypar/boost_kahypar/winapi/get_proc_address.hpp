...
#endif // _WIN64
}} // namespace boost_kahypar::winapi

extern "C" {
#if !defined(UNDER_CE)
BOOST_WINAPI_IMPORT boost_kahypar::winapi::FARPROC_ BOOST_WINAPI_WINAPI_CC
GetProcAddress(boost_kahypar::winapi::HMODULE_ hModule, boost_kahypar::winapi::LPCSTR_ lpProcName);
#else
...
BOOST_WINAPI_IMPORT_EXCEPT_WM boost_kahypar::winapi::FARPROC_ BOOST_WINAPI_WINAPI_CC
GetProcAddressA(boost_kahypar::winapi::HMODULE_ hModule, boost_kahypar::winapi::LPCSTR_ lpProcName);
BOOST_WINAPI_IMPORT_EXCEPT_WM boost_kahypar::winapi::FARPROC_ BOOST_WINAPI_WINAPI_CC
GetProcAddressW(boost_kahypar::winapi::HMODULE_ hModule, boost_kahypar::winapi::LPCWSTR_ lpProcName);
#endif
} // extern "C"
