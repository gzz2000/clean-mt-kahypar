...
#include <boost_kahypar/winapi/detail/cast_ptr.hpp>
...
BOOST_WINAPI_IMPORT_EXCEPT_WM boost_kahypar::winapi::VOID_ BOOST_WINAPI_WINAPI_CC
InitializeCriticalSection(boost_kahypar::winapi::detail::winsdk_critical_section* lpCriticalSection);
#endif

BOOST_WINAPI_IMPORT_EXCEPT_WM boost_kahypar::winapi::VOID_ BOOST_WINAPI_WINAPI_CC
EnterCriticalSection(boost_kahypar::winapi::detail::winsdk_critical_section* lpCriticalSection);

BOOST_WINAPI_IMPORT_EXCEPT_WM boost_kahypar::winapi::VOID_ BOOST_WINAPI_WINAPI_CC
LeaveCriticalSection(boost_kahypar::winapi::detail::winsdk_critical_section* lpCriticalSection);

#if BOOST_USE_WINAPI_VERSION >= 0x0403
#if BOOST_WINAPI_PARTITION_APP_SYSTEM
BOOST_WINAPI_IMPORT boost_kahypar::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC
InitializeCriticalSectionAndSpinCount(
    boost_kahypar::winapi::detail::winsdk_critical_section* lpCriticalSection,
    boost_kahypar::winapi::DWORD_ dwSpinCount);
...
InitializeCriticalSectionEx(
    boost_kahypar::winapi::detail::winsdk_critical_section* lpCriticalSection,
    boost_kahypar::winapi::DWORD_ dwSpinCount,
    boost_kahypar::winapi::DWORD_ Flags);
#endif
#endif

#if BOOST_USE_WINAPI_VERSION >= BOOST_WINAPI_VERSION_NT4
BOOST_WINAPI_IMPORT_EXCEPT_WM boost_kahypar::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC
TryEnterCriticalSection(boost_kahypar::winapi::detail::winsdk_critical_section* lpCriticalSection);
#endif

BOOST_WINAPI_IMPORT_EXCEPT_WM boost_kahypar::winapi::VOID_ BOOST_WINAPI_WINAPI_CC
DeleteCriticalSection(boost_kahypar::winapi::detail::winsdk_critical_section* lpCriticalSection);

#else // defined( BOOST_WINAPI_IS_MINGW )

BOOST_WINAPI_IMPORT_EXCEPT_WM boost_kahypar::winapi::VOID_ BOOST_WINAPI_WINAPI_CC
InitializeCriticalSection(boost_kahypar::winapi::detail::winapi_critical_section* lpCriticalSection);

BOOST_WINAPI_IMPORT_EXCEPT_WM boost_kahypar::winapi::VOID_ BOOST_WINAPI_WINAPI_CC
EnterCriticalSection(boost_kahypar::winapi::detail::winapi_critical_section* lpCriticalSection);

BOOST_WINAPI_IMPORT_EXCEPT_WM boost_kahypar::winapi::VOID_ BOOST_WINAPI_WINAPI_CC
LeaveCriticalSection(boost_kahypar::winapi::detail::winapi_critical_section* lpCriticalSection);

#if BOOST_USE_WINAPI_VERSION >= 0x0403
BOOST_WINAPI_IMPORT boost_kahypar::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC
InitializeCriticalSectionAndSpinCount(
    boost_kahypar::winapi::detail::winapi_critical_section* lpCriticalSection,
    boost_kahypar::winapi::DWORD_ dwSpinCount);
...
#if BOOST_USE_WINAPI_VERSION >= BOOST_WINAPI_VERSION_NT4
BOOST_WINAPI_IMPORT_EXCEPT_WM boost_kahypar::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC
TryEnterCriticalSection(boost_kahypar::winapi::detail::winapi_critical_section* lpCriticalSection);
#endif

BOOST_WINAPI_IMPORT_EXCEPT_WM boost_kahypar::winapi::VOID_ BOOST_WINAPI_WINAPI_CC
DeleteCriticalSection(boost_kahypar::winapi::detail::winapi_critical_section* lpCriticalSection);
