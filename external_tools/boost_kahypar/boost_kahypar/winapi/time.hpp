...
BOOST_WINAPI_IMPORT boost_kahypar::winapi::VOID_ BOOST_WINAPI_WINAPI_CC
...
BOOST_WINAPI_IMPORT boost_kahypar::winapi::ULONGLONG_ BOOST_WINAPI_WINAPI_CC
...
{
    boost_kahypar::winapi::SYSTEMTIME_ st;
    boost_kahypar::winapi::GetSystemTime(&st);
    boost_kahypar::winapi::SystemTimeToFileTime(&st, lpFileTime);
}
#endif
