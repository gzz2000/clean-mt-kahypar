...
BOOST_WINAPI_IMPORT boost_kahypar::winapi::HMODULE_ BOOST_WINAPI_WINAPI_CC
LoadLibraryA(boost_kahypar::winapi::LPCSTR_ lpFileName);

BOOST_WINAPI_IMPORT boost_kahypar::winapi::HMODULE_ BOOST_WINAPI_WINAPI_CC
LoadLibraryExA(
    boost_kahypar::winapi::LPCSTR_ lpFileName,
    boost_kahypar::winapi::HANDLE_ hFile,
    boost_kahypar::winapi::DWORD_ dwFlags
);

BOOST_WINAPI_IMPORT boost_kahypar::winapi::HMODULE_ BOOST_WINAPI_WINAPI_CC
GetModuleHandleA(boost_kahypar::winapi::LPCSTR_ lpFileName);

BOOST_WINAPI_IMPORT boost_kahypar::winapi::DWORD_ BOOST_WINAPI_WINAPI_CC
GetModuleFileNameA(
    boost_kahypar::winapi::HMODULE_ hModule,
    boost_kahypar::winapi::LPSTR_ lpFilename,
    boost_kahypar::winapi::DWORD_ nSize
);
#endif

BOOST_WINAPI_IMPORT_EXCEPT_WM boost_kahypar::winapi::HMODULE_ BOOST_WINAPI_WINAPI_CC
LoadLibraryW(boost_kahypar::winapi::LPCWSTR_ lpFileName);

BOOST_WINAPI_IMPORT_EXCEPT_WM boost_kahypar::winapi::HMODULE_ BOOST_WINAPI_WINAPI_CC
LoadLibraryExW(
    boost_kahypar::winapi::LPCWSTR_ lpFileName,
    boost_kahypar::winapi::HANDLE_ hFile,
    boost_kahypar::winapi::DWORD_ dwFlags
);

BOOST_WINAPI_IMPORT_EXCEPT_WM boost_kahypar::winapi::HMODULE_ BOOST_WINAPI_WINAPI_CC
GetModuleHandleW(boost_kahypar::winapi::LPCWSTR_ lpFileName);

BOOST_WINAPI_IMPORT_EXCEPT_WM boost_kahypar::winapi::DWORD_ BOOST_WINAPI_WINAPI_CC
GetModuleFileNameW(
    boost_kahypar::winapi::HMODULE_ hModule,
    boost_kahypar::winapi::LPWSTR_ lpFilename,
    boost_kahypar::winapi::DWORD_ nSize
);
...
BOOST_WINAPI_IMPORT_EXCEPT_WM boost_kahypar::winapi::SIZE_T_ BOOST_WINAPI_WINAPI_CC
VirtualQuery(
    boost_kahypar::winapi::LPCVOID_ lpAddress,
    ::_MEMORY_BASIC_INFORMATION* lpBuffer,
    boost_kahypar::winapi::SIZE_T_ dwLength
);
...
VirtualQuery(
    boost_kahypar::winapi::LPCVOID_ lpAddress,
    ::_MEMORY_BASIC_INFORMATION* lpBuffer,
    boost_kahypar::winapi::DWORD_ dwLength
);
...
FreeLibrary(boost_kahypar::winapi::HMODULE_ hModule);
}
#endif
