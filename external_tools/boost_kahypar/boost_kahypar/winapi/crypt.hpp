...
CryptEnumProvidersA(
    boost_kahypar::winapi::DWORD_ dwIndex,
    boost_kahypar::winapi::DWORD_ *pdwReserved,
    boost_kahypar::winapi::DWORD_ dwFlags,
    boost_kahypar::winapi::DWORD_ *pdwProvType,
    boost_kahypar::winapi::LPSTR_ szProvName,
    boost_kahypar::winapi::DWORD_ *pcbProvName);

BOOST_WINAPI_IMPORT boost_kahypar::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC
CryptAcquireContextA(
    boost_kahypar::winapi::HCRYPTPROV_ *phProv,
    boost_kahypar::winapi::LPCSTR_ pszContainer,
    boost_kahypar::winapi::LPCSTR_ pszProvider,
    boost_kahypar::winapi::DWORD_ dwProvType,
    boost_kahypar::winapi::DWORD_ dwFlags);
...
CryptEnumProvidersW(
    ...
    boost_kahypar::winapi::DWORD_ dwFlags,
    boost_kahypar::winapi::DWORD_ *pdwProvType,
    boost_kahypar::winapi::LPWSTR_ szProvName,
    boost_kahypar::winapi::DWORD_ *pcbProvName);

BOOST_WINAPI_IMPORT boost_kahypar::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC
CryptAcquireContextW(
    boost_kahypar::winapi::HCRYPTPROV_ *phProv,
    boost_kahypar::winapi::LPCWSTR_ szContainer,
    boost_kahypar::winapi::LPCWSTR_ szProvider,
    boost_kahypar::winapi::DWORD_ dwProvType,
    boost_kahypar::winapi::DWORD_ dwFlags);

BOOST_WINAPI_IMPORT boost_kahypar::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC
CryptGenRandom(
    boost_kahypar::winapi::HCRYPTPROV_ hProv,
    boost_kahypar::winapi::DWORD_ dwLen,
    boost_kahypar::winapi::BYTE_ *pbBuffer);
...
CryptReleaseContext(
    boost_kahypar::winapi::HCRYPTPROV_ hProv,
    boost_kahypar::winapi::ULONG_PTR_ dwFlags);
#else
BOOST_WINAPI_IMPORT boost_kahypar::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC
CryptReleaseContext(
    boost_kahypar::winapi::HCRYPTPROV_ hProv,
