...
#include <boost_kahypar/preprocessor/arithmetic/inc.hpp>
...
struct remove_cv_ref
{
    typedef typename ::boost_kahypar::remove_cv<typename
     ::boost_kahypar::remove_reference<T>::type>::type  type;

};  // boost_kahypar::detail::remove_cv_ref
...
struct is_related
    : public ::boost_kahypar::is_same<
     typename ::boost_kahypar::detail::remove_cv_ref<T>::type,
     typename ::boost_kahypar::detail::remove_cv_ref<U>::type >
{};
...
struct enable_if_unrelated
    : public ::boost_kahypar::enable_if_c<true>
{};

template<typename T, typename U, typename ...U2>
struct enable_if_unrelated<T, U, U2...>
    : public ::boost_kahypar::disable_if< ::boost_kahypar::detail::is_related<T, U> >
{};
#endif
...
protected:
    ...
    template <typename ...T, typename EnableIf = typename
     ::boost_kahypar::detail::enable_if_unrelated<base_from_member, T...>::type>
...
};  // boost_kahypar::base_from_member
