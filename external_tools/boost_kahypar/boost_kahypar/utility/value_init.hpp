...
// Note: The implementation of boost_kahypar::value_initialized had to deal with the
// fact that various compilers haven't fully implemented value-initialization.
// The constructor of boost_kahypar::value_initialized<T> works around these compiler
// issues, by clearing the bytes of T, before constructing the T object it
// contains. More details on these issues are at libs/utility/value_init.htm

#include <boost_kahypar/config.hpp> // For BOOST_NO_COMPLETE_VALUE_INITIALIZATION.
...
#endif
{
  ...
  public :
    ...
    {
      ::boost_kahypar::core::invoke_swap( this->data(), arg.data() );
    }
