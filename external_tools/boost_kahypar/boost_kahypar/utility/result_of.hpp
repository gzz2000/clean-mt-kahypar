...
#  include <boost_kahypar/preprocessor/repetition/enum_shifted_params.hpp>
...
template<class T> struct result_of_has_result_type_impl
{
    ...
    typedef boost_kahypar::integral_constant<bool, sizeof(f<T>(0)) == sizeof(result_of_yes_type)> type;
};
...
#  include <boost_kahypar/utility/detail/result_of_variadic.hpp>
#else
#  define BOOST_PP_ITERATION_PARAMS_1 (3,(0,BOOST_RESULT_OF_NUM_ARGS,<boost_kahypar/utility/detail/result_of_iterate.hpp>))
#  include BOOST_PP_ITERATE()
#endif

#if 0
// inform dependency trackers, as they can't see through macro includes
#include <boost_kahypar/utility/detail/result_of_iterate.hpp>
#endif
