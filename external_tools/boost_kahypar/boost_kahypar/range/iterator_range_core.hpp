...
#include <boost_kahypar/config.hpp> // Define __STL_CONFIG_H, if appropriate.
...
#include <boost_kahypar/range/detail/safe_bool.hpp>
...
namespace boost_kahypar
{
    namespace iterator_range_detail
    {
        ...
        struct iterator_range_impl {
            ...
            {
                return IteratorT( boost_kahypar::begin( r ) );
            }

            template< class ForwardRange >
            static IteratorT adl_end( ForwardRange& r )
            {
                return IteratorT( boost_kahypar::end( r ) );
            }
        };
        ...
        {
            return std::lexicographical_compare( boost_kahypar::begin(l),
                                                 boost_kahypar::end(l),
                                                 boost_kahypar::begin(r),
                                                 boost_kahypar::end(r) );
        }
        ...
        {
            return boost_kahypar::equal(l, r);
        }
...
incrementable_t test_traversal_tag(boost_kahypar::incrementable_traversal_tag);
bidirectional_t test_traversal_tag(boost_kahypar::bidirectional_traversal_tag);
random_access_t test_traversal_tag(boost_kahypar::random_access_traversal_tag);

template<std::size_t S>
struct pure_iterator_traversal_impl
{
    typedef boost_kahypar::incrementable_traversal_tag type;
};

template<>
struct pure_iterator_traversal_impl<sizeof(bidirectional_t)>
{
    typedef boost_kahypar::bidirectional_traversal_tag type;
};

template<>
struct pure_iterator_traversal_impl<sizeof(random_access_t)>
{
    typedef boost_kahypar::random_access_traversal_tag type;
};
...
public:
    ...
    reference back() const
    {
        ...
        return *boost_kahypar::prior(this->m_End);
    }
...
public:
    typedef BOOST_DEDUCED_TYPENAME
        boost_kahypar::mpl::if_<
            boost_kahypar::mpl::or_<
                boost_kahypar::is_abstract<
                    BOOST_DEDUCED_TYPENAME base_type::value_type
                >,
                boost_kahypar::is_array<
                    BOOST_DEDUCED_TYPENAME base_type::value_type
                >,
                boost_kahypar::is_function<
                    BOOST_DEDUCED_TYPENAME base_type::value_type
                >
            >,
...
//  iterator range template class -----------------------------------------//
        ...
        /*!
            ...
            \code
                boost_kahypar::tolower( find( s, "UPPERCASE STRING" ) );
            \endcode
...
//  iterator range free-standing operators ---------------------------//
        ...
        inline BOOST_DEDUCED_TYPENAME boost_kahypar::enable_if<
        ...
        template< class IteratorT, class ForwardRange >
        inline BOOST_DEDUCED_TYPENAME boost_kahypar::enable_if<
            mpl::not_<boost_kahypar::is_base_and_derived<iterator_range_detail::iterator_range_tag, ForwardRange> >,
            bool
        >::type
        operator!=( const ForwardRange& l, const iterator_range<IteratorT>& r )
        {
...
//  iterator range utilities -----------------------------------------//
        ...
        */
        ...
        {
            return iterator_range<IteratorT>(first, boost_kahypar::next(first, n));
        }
        ...
        namespace iterator_range_detail
        {
                             ...
                             BOOST_DEDUCED_TYPENAME range_difference<Range>::type advance_end )
            {
                ...
                BOOST_DEDUCED_TYPENAME range_iterator<Range>::type
                    new_begin = boost_kahypar::begin( r ),
                    new_end   = boost_kahypar::end( r );
        ...
        */
        ...
        {
            return SeqT( boost_kahypar::begin( r ), boost_kahypar::end( r ) );
        }
