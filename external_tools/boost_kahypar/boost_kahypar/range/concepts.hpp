...
#include <boost_kahypar/range/detail/misc_concept.hpp>
...
// during the search for black listed compilers.
    ...
    #define BOOST_RANGE_CONCEPT_ASSERT( x )
        ...
        // use case is the combination of the boost_kahypar::adaptors::filtered
        // class with a boost_kahypar::lambda::bind generated functor.
            ...
            , EqualityComparable<Iterator>
        {
            ...
            {
                Iterator i2(++i);
                boost_kahypar::ignore_unused_variable_warning(i2);
                ...
                boost_kahypar::ignore_unused_variable_warning(r1);

                BOOST_DEDUCED_TYPENAME std::iterator_traits<Iterator>::reference r2(*(++i));
                boost_kahypar::ignore_unused_variable_warning(r2);
            }
        private:
            Iterator i;
#endif
    ...
    struct SinglePassRangeConcept
    {
        ...
        BOOST_CONCEPT_USAGE(SinglePassRangeConcept)
        {
            ...
            iterator i1 = boost_kahypar::begin(*m_range);
            iterator i2 = boost_kahypar::end(*m_range);

            boost_kahypar::ignore_unused_variable_warning(i1);
            boost_kahypar::ignore_unused_variable_warning(i2);
    ...
    private:
        ...
        {
            const_iterator ci1 = boost_kahypar::begin(const_range);
            const_iterator ci2 = boost_kahypar::end(const_range);

            boost_kahypar::ignore_unused_variable_warning(ci1);
            boost_kahypar::ignore_unused_variable_warning(ci2);
        }
