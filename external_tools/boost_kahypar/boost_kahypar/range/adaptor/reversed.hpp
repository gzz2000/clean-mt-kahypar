    ...
    namespace range_detail
    {
        ...
        struct reversed_range : 
            public boost_kahypar::iterator_range< 
                      boost_kahypar::reverse_iterator<
        ...
        public:
            typedef boost_kahypar::reverse_iterator<BOOST_DEDUCED_TYPENAME range_iterator<R>::type> iterator;

            explicit reversed_range( R& r ) 
                : base( iterator(boost_kahypar::end(r)), iterator(boost_kahypar::begin(r)) )
            { }
        };
