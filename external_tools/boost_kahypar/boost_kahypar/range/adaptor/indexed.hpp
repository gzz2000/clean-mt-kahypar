...
#include <boost_kahypar/range/traversal.hpp>
...
public:
    ...
    index_type index()
    {
        return boost_kahypar::tuples::get<0>(*this);
    }
    ...
    value_type value()
    {
        return boost_kahypar::tuples::get<1>(*this);
    }
...
{
    typedef ::boost_kahypar::range::index_value<
    ...
    >
{
    ...
    BOOST_RANGE_CONCEPT_ASSERT((
        boost_kahypar::SinglePassRangeConcept<SinglePassRange>));
public:
    ...
    indexed_range(
        ...
        : base_t(iterator(boost_kahypar::begin(r), i),
                 iterator(boost_kahypar::end(r), i))
    {
    }
    ...
    indexed_range(
        ...
        : base_t(iterator(boost_kahypar::begin(r), i),
                 iterator(boost_kahypar::end(r), i + boost_kahypar::size(r)))
    {
    }
};
...
{
    BOOST_RANGE_CONCEPT_ASSERT((
        boost_kahypar::SinglePassRangeConcept<const SinglePassRange>
    ));
...
struct tuple_element<N, boost_kahypar::range::index_value<T, Indexable>>:
    boost_kahypar::tuples::element<N, boost_kahypar::range::index_value<T, Indexable>> {};

template<class T, class Indexable>
struct tuple_size<boost_kahypar::range::index_value<T, Indexable>>:
