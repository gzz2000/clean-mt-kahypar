...
namespace boost_kahypar
{
    namespace range_detail
    {
        ...
        operator|( const StdPairRng& r, map_keys_forwarder )
        {
            ...
            return operator|( r,
                boost_kahypar::adaptors::transformed( select_first<StdPairRng>() ) );
        }
        ...
        operator|( StdPairRng& r, map_values_forwarder )
        {
            ...
            return operator|( r,
                boost_kahypar::adaptors::transformed( select_second_mutable<StdPairRng>() ) );
        }
        ...
        operator|( const StdPairRng& r, map_values_forwarder )
        {
            ...
            return operator|( r,
                boost_kahypar::adaptors::transformed( select_second_const<StdPairRng>() ) );
        }
