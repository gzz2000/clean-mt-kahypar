...
#include <boost_kahypar/range/detail/default_constructible_unary_fn.hpp>
...
namespace boost_kahypar
{
    namespace range_detail
    {
        ...
        private:
            ...
            typedef boost_kahypar::iterator_range<transform_iter_t> base;
        ...
        public:
            ...
            transformed_range(transform_fn_type f, R& r)
                : base(transform_iter_t(boost_kahypar::begin(r), f),
                       transform_iter_t(boost_kahypar::end(r), f))
            {
            }
        };
