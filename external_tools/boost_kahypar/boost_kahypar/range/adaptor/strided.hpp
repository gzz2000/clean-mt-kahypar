...
namespace boost_kahypar
{
    namespace range_detail
    {
        ...
        public:
            ...
            typedef typename super_t::reference reference;
            typedef BaseIterator base_iterator;
            typedef typename boost_kahypar::make_unsigned<difference_type>::type
                        size_type;
            ...
            forward_traversal_tag)
        {
            return strided_iterator<
                typename range_iterator<Rng>::type,
                forward_traversal_tag
            >(boost_kahypar::begin(rng), boost_kahypar::end(rng), stride);
        }
            ...
            forward_traversal_tag)
        {
            return strided_iterator<
                typename range_iterator<Rng>::type,
                forward_traversal_tag
            >(boost_kahypar::end(rng), boost_kahypar::end(rng), stride);
        }
            ...
            bidirectional_traversal_tag)
        {
            ...
            return strided_iterator<
                typename range_iterator<Rng>::type,
                bidirectional_traversal_tag
            >(boost_kahypar::begin(rng), difference_type(), stride);
        }
            ...
            bidirectional_traversal_tag)
        {
            return strided_iterator<
                typename range_iterator<Rng>::type,
                bidirectional_traversal_tag
            >(boost_kahypar::end(rng), boost_kahypar::size(rng), stride);
        }
            ...
            random_access_traversal_tag)
        {
            return strided_iterator<
                typename range_iterator<Rng>::type,
                random_access_traversal_tag
            >(boost_kahypar::begin(rng), boost_kahypar::begin(rng), stride);
        }
