...
#include <boost_kahypar/range/detail/str_types.hpp>
...
namespace boost_kahypar
{
    ...
    as_array( R& r )
    {
        return boost_kahypar::make_iterator_range( r );
    }

    template< class Range >
    inline boost_kahypar::iterator_range< BOOST_DEDUCED_TYPENAME range_iterator<const Range>::type > 
