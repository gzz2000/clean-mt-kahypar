...
// Default collection traits -----------------------------------------------------------------
            ...
            */
            ...
            struct default_container_traits
            {
                ...
                typedef typename
                    ::boost_kahypar::mpl::if_< ::boost_kahypar::is_const<ContainerT>,
                        const_iterator,
                        iterator 
...
// Array container traits ---------------------------------------------------------------
            ...
            */
            ...
            public:
                ...
                typedef typename
                    ::boost_kahypar::mpl::if_< ::boost_kahypar::is_const<T>,
                        const_iterator,
                        iterator 
                    >::type result_iterator;
            ...
            private:
                // resolve array size
                typedef typename
                    ::boost_kahypar::remove_cv<value_type>::type char_type;
                typedef typename
...
// Pointer container traits ---------------------------------------------------------------
            ...
            {
                typedef typename
                    ::boost_kahypar::remove_pointer<T>::type value_type;
