...
#include <boost_kahypar/range/detail/demote_iterator_traversal_tag.hpp>
...
public:
    ...
    join_iterator(Range1& r1, Range2& r2, join_iterator_begin_tag)
        : m_section(boost_kahypar::empty(r1) ? 1u : 0u)
        , m_it(boost_kahypar::empty(r1) ? 1u : 0u, boost_kahypar::begin(r1), boost_kahypar::begin(r2))
        , m_link(link_t(boost_kahypar::end(r1), boost_kahypar::begin(r2)))
    {
    }
    ...
    join_iterator(const Range1& r1, const Range2& r2, join_iterator_begin_tag)
        : m_section(boost_kahypar::empty(r1) ? 1u : 0u)
        , m_it(boost_kahypar::empty(r1) ? 1u : 0u, boost_kahypar::const_begin(r1), boost_kahypar::const_begin(r2))
        , m_link(link_t(boost_kahypar::const_end(r1), boost_kahypar::const_begin(r2)))
    {
    }
    ...
    join_iterator(Range1& r1, Range2& r2, join_iterator_end_tag)
        : m_section(1u)
        , m_it(1u, boost_kahypar::end(r1), boost_kahypar::end(r2))
        , m_link(link_t(boost_kahypar::end(r1), boost_kahypar::begin(r2)))
    {
    }
    ...
    join_iterator(const Range1& r1, const Range2& r2, join_iterator_end_tag)
        : m_section(1u)
        , m_it(1u, boost_kahypar::const_end(r1), boost_kahypar::const_end(r2))
        , m_link(link_t(boost_kahypar::const_end(r1), boost_kahypar::const_begin(r2)))
    {
    }
...
private:
    ...
    void decrement()
    {
        if (m_section)
        {
            ...
            {
                m_it.it1() = boost_kahypar::prior(m_link.last1);
                m_section = 0u;
            }
            else
                --m_it.it2();
