...
// Implementation
#include <boost_kahypar/range/detail/collection_traits_detail.hpp>
...
//  collection_traits template class -----------------------------------------//
        ...
        */
        ...
        {
        private:
            typedef typename ::boost_kahypar::mpl::eval_if<
                    ::boost_kahypar::algorithm::detail::is_pair<T>, 
                        detail::pair_container_traits_selector<T>,
                        typename ::boost_kahypar::mpl::eval_if<
                        ::boost_kahypar::is_array<T>, 
                            detail::array_container_traits_selector<T>,
                            typename ::boost_kahypar::mpl::eval_if<
                            ::boost_kahypar::is_pointer<T>,
