...
#include <boost_kahypar/range/detail/common.hpp>
...
namespace boost_kahypar 
{
    ...
    {        
        ...
        struct range_difference_type_<std_pair_>
        {
            ...
            struct pts
            {
                typedef BOOST_RANGE_DEDUCED_TYPENAME boost_kahypar::iterator_difference< BOOST_DEDUCED_TYPENAME P::first_type>::type type;                
            };
        };
