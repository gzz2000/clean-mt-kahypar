...
struct demote_iterator_traversal_tag
    : inner_demote_iterator_traversal_tag<
        typename boost_kahypar::iterators::pure_traversal_tag< IteratorTraversalTag1 >::type,
        typename boost_kahypar::iterators::pure_traversal_tag< IteratorTraversalTag2 >::type
      >
{
};
