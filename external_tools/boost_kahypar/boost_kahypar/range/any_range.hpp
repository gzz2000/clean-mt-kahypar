...
#include <boost_kahypar/range/detail/any_iterator.hpp>
...
namespace boost_kahypar
{
    namespace range_detail
    {
        ...
        // values when the user specified boost_kahypar::use_default as a template
        // parameter.
        template<
            class T,
            class Default
...
# endif
        ...
        public:
            ...
            : base_type(boost_kahypar::begin(wrapped_range),
                        boost_kahypar::end(wrapped_range))
            {
            }
            ...
            any_range(const any_range<
                              ...
                              , Buffer
                            >& other)
            : base_type(boost_kahypar::begin(other), boost_kahypar::end(other))
            {
            }
