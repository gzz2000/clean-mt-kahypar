                     ...
                     const SinglePassRange2& rng2)
{
    ...
    return std::includes(boost_kahypar::begin(rng1),boost_kahypar::end(rng1),
                                ...
                                OutputIterator          out)
{
    BOOST_RANGE_CONCEPT_ASSERT(( SinglePassRangeConcept<const SinglePassRange1> ));
    BOOST_RANGE_CONCEPT_ASSERT(( SinglePassRangeConcept<const SinglePassRange2> ));
    return std::set_union(boost_kahypar::begin(rng1), boost_kahypar::end(rng1),
                                       ...
                                       OutputIterator          out)
{
    BOOST_RANGE_CONCEPT_ASSERT(( SinglePassRangeConcept<const SinglePassRange1> ));
    BOOST_RANGE_CONCEPT_ASSERT(( SinglePassRangeConcept<const SinglePassRange2> ));
    return std::set_intersection(boost_kahypar::begin(rng1), boost_kahypar::end(rng1),
                                 boost_kahypar::begin(rng2), boost_kahypar::end(rng2), out);
}
                                     ...
                                     OutputIterator out)
{
    BOOST_RANGE_CONCEPT_ASSERT(( SinglePassRangeConcept<const SinglePassRange1> ));
    BOOST_RANGE_CONCEPT_ASSERT(( SinglePassRangeConcept<const SinglePassRange2> ));
    return std::set_difference(boost_kahypar::begin(rng1), boost_kahypar::end(rng1),
                               boost_kahypar::begin(rng2), boost_kahypar::end(rng2), out);
}
                         ...
                         OutputIterator          out)
{
    BOOST_RANGE_CONCEPT_ASSERT(( SinglePassRangeConcept<const SinglePassRange1> ));
    BOOST_RANGE_CONCEPT_ASSERT(( SinglePassRangeConcept<const SinglePassRange2> ));
    return std::set_symmetric_difference(boost_kahypar::begin(rng1), boost_kahypar::end(rng1),
                                         boost_kahypar::begin(rng2), boost_kahypar::end(rng2), out);
}
