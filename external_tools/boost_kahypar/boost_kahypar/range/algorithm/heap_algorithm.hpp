...
inline RandomAccessRange& push_heap(RandomAccessRange& rng)
{
    ...
    std::push_heap(boost_kahypar::begin(rng), boost_kahypar::end(rng));
    return rng;
}
...
{
    BOOST_RANGE_CONCEPT_ASSERT(( RandomAccessRangeConcept<RandomAccessRange> ));
    std::push_heap(boost_kahypar::begin(rng), boost_kahypar::end(rng), comp_pred);
    return rng;
}
...
{
    BOOST_RANGE_CONCEPT_ASSERT(( RandomAccessRangeConcept<RandomAccessRange> ));
    std::pop_heap(boost_kahypar::begin(rng), boost_kahypar::end(rng));
    return rng;
}
...
{
    BOOST_RANGE_CONCEPT_ASSERT(( RandomAccessRangeConcept<RandomAccessRange> ));
    std::pop_heap(boost_kahypar::begin(rng), boost_kahypar::end(rng), comp_pred);
    return rng;
}
...
{
    BOOST_RANGE_CONCEPT_ASSERT(( RandomAccessRangeConcept<RandomAccessRange> ));
    std::make_heap(boost_kahypar::begin(rng), boost_kahypar::end(rng));
    return rng;
}
...
{
    BOOST_RANGE_CONCEPT_ASSERT(( RandomAccessRangeConcept<RandomAccessRange> ));
    std::make_heap(boost_kahypar::begin(rng), boost_kahypar::end(rng), comp_pred);
    return rng;
}
...
{
    BOOST_RANGE_CONCEPT_ASSERT(( RandomAccessRangeConcept<RandomAccessRange> ));
    std::sort_heap(boost_kahypar::begin(rng), boost_kahypar::end(rng));
    return rng;
}
...
{
    BOOST_RANGE_CONCEPT_ASSERT(( RandomAccessRangeConcept<RandomAccessRange> ));
    std::sort_heap(boost_kahypar::begin(rng), boost_kahypar::end(rng), comp_pred);
    return rng;
}
