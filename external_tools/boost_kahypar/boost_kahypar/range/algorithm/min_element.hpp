...
#include <boost_kahypar/range/detail/less.hpp>
...
min_element(ForwardRange& rng)
{
    ...
    return detail::min_element(boost_kahypar::begin(rng), boost_kahypar::end(rng), detail::less());
}
...
{
    BOOST_RANGE_CONCEPT_ASSERT(( ForwardRangeConcept<ForwardRange> ));
    return detail::min_element(boost_kahypar::begin(rng), boost_kahypar::end(rng), pred);
}
...
min_element(ForwardRange& rng)
{
    ...
    return range_return<ForwardRange,re>::pack(
        detail::min_element(boost_kahypar::begin(rng), boost_kahypar::end(rng), detail::less()),
        rng);
}
...
min_element(ForwardRange& rng, BinaryPredicate pred)
{
    BOOST_RANGE_CONCEPT_ASSERT(( ForwardRangeConcept<ForwardRange> ));
    return range_return<ForwardRange,re>::pack(
        detail::min_element(boost_kahypar::begin(rng), boost_kahypar::end(rng), pred),
        rng);
}
