...
search_n(ForwardRange& rng, Integer count, const Value& value)
{
    ...
    return range_detail::search_n_impl(boost_kahypar::begin(rng),boost_kahypar::end(rng), count, value);
}
         ...
         BinaryPredicate binary_pred)
{
    ...
    return range_detail::search_n_pred_impl(boost_kahypar::begin(rng), boost_kahypar::end(rng),
...
search_n(ForwardRange& rng, Integer count, const Value& value)
{
    ...
    return range_return<ForwardRange,re>::
        pack(range_detail::search_n_impl(boost_kahypar::begin(rng),boost_kahypar::end(rng),
                           count, value),
             rng);
}
         ...
         BinaryPredicate pred)
{
    ...
    BOOST_RANGE_CONCEPT_ASSERT((BinaryPredicateConcept<BinaryPredicate,
        ...
        const Value&>));
    return range_return<ForwardRange,re>::
        pack(range_detail::search_n_pred_impl(boost_kahypar::begin(rng),
