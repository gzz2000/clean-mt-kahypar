...
max_element(ForwardRange& rng)
{
    ...
    return detail::max_element(boost_kahypar::begin(rng), boost_kahypar::end(rng), detail::less());
}
...
{
    BOOST_RANGE_CONCEPT_ASSERT(( ForwardRangeConcept<ForwardRange> ));
    return detail::max_element(boost_kahypar::begin(rng), boost_kahypar::end(rng), pred);
}
...
max_element(ForwardRange& rng)
{
    ...
    return range_return<ForwardRange,re>::pack(
        detail::max_element(boost_kahypar::begin(rng), boost_kahypar::end(rng), detail::less()),
        rng);
}
...
max_element(ForwardRange& rng, BinaryPredicate pred)
{
    BOOST_RANGE_CONCEPT_ASSERT(( ForwardRangeConcept<ForwardRange> ));
    return range_return<ForwardRange,re>::pack(
        detail::max_element(boost_kahypar::begin(rng), boost_kahypar::end(rng), pred),
        rng);
}
