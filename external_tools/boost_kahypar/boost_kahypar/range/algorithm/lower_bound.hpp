...
lower_bound( ForwardRange& rng, const Value& val )
{
    ...
    return std::lower_bound(boost_kahypar::begin(rng), boost_kahypar::end(rng), val);
}
...
{
    BOOST_RANGE_CONCEPT_ASSERT(( ForwardRangeConcept<ForwardRange> ));
    return std::lower_bound(boost_kahypar::begin(rng), boost_kahypar::end(rng), val, pred);
}
...
lower_bound( ForwardRange& rng, const Value& val )
{
    ...
    return range_return<ForwardRange,re>::
        pack(std::lower_bound(boost_kahypar::begin(rng), boost_kahypar::end(rng), val),
             rng);
}
...
lower_bound( ForwardRange& rng, const Value& val, SortPredicate pred )
{
    BOOST_RANGE_CONCEPT_ASSERT(( ForwardRangeConcept<ForwardRange> ));
    return range_return<ForwardRange,re>::
        pack(std::lower_bound(boost_kahypar::begin(rng), boost_kahypar::end(rng), val, pred),
             rng);
}
