...
adjacent_find(ForwardRange & rng)
{
    ...
    return std::adjacent_find(boost_kahypar::begin(rng),boost_kahypar::end(rng));
}
...
adjacent_find(ForwardRange & rng, BinaryPredicate pred)
{
    ...
    BOOST_RANGE_CONCEPT_ASSERT((BinaryPredicateConcept<BinaryPredicate,
        ...
        typename range_value<ForwardRange>::type>));
    return std::adjacent_find(boost_kahypar::begin(rng),boost_kahypar::end(rng),pred);
}
...
adjacent_find(ForwardRange & rng)
{
    ...
    return range_return<ForwardRange,re>::
        pack(std::adjacent_find(boost_kahypar::begin(rng),boost_kahypar::end(rng)),
             rng);
}
...
adjacent_find(ForwardRange& rng, BinaryPredicate pred)
{
    ...
    BOOST_RANGE_CONCEPT_ASSERT((BinaryPredicateConcept<BinaryPredicate,
        ...
        typename range_value<ForwardRange>::type>));
    return range_return<ForwardRange,re>::
        pack(std::adjacent_find(boost_kahypar::begin(rng),boost_kahypar::end(rng),pred),
             rng);
}
