...
namespace boost_kahypar { namespace range_detail_microsoft {
...
#endif
    {
        ...
        Iterator begin(X& x)
        {
            return Iterator(boost_kahypar::make_tuple(x.m_aKey, x.m_aVal));
        }

        template< class Iterator, class X >
        Iterator end(X& x)
        {
            return Iterator(boost_kahypar::make_tuple(x.m_aKey + x.GetSize(), x.m_aVal + x.GetSize()));
        }
    };
...
//
    ...
    BOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TEMPLATE(
        boost_kahypar::range_detail_microsoft::atl_rb_tree_tag,
    ...
    #if !defined(BOOST_RANGE_ATL_HAS_OLD_CSIMPLESTRING)
        BOOST_RANGE_DETAIL_MICROSOFT_CUSTOMIZATION_TEMPLATE(
            boost_kahypar::range_detail_microsoft::atl_string_tag,
