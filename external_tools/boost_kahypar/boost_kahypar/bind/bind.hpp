...
#include <boost_kahypar/bind/mem_fn.hpp>
#include <boost_kahypar/bind/arg.hpp>
#include <boost_kahypar/bind/std_placeholders.hpp>
#include <boost_kahypar/bind/detail/result_traits.hpp>
#include <boost_kahypar/bind/detail/tuple_for_each.hpp>
#include <boost_kahypar/bind/detail/integer_sequence.hpp>
#include <boost_kahypar/visit_each.hpp>
...
public:
    ...
    template<int I> typename std::tuple_element<I-1, args_type>::type&& operator[] ( boost_kahypar::arg<I> ) const
    {
...
public:
    ...
    template<class V> void accept( V & v ) const
    {
        using boost_kahypar::visit_each;
        visit_each( v, f_, 0 );
        l_.accept( v );
    }
...
{
    typedef boost_kahypar::arg<I> type;
};
...
{
    typedef typename add_value_2< T, boost_kahypar::is_placeholder< T >::value >::type type;
};
...
// g++ 4.x (and some 5.x) consider boost_kahypar::bind<void>( &X::f )
...
template<class R, class F, class... A>
    _bi::bind_t<R, F, typename _bi::list_av<A...>::type>
    BOOST_BIND( boost_kahypar::type<R>, F f, A... a )
{
    typedef typename _bi::list_av<A...>::type list_type;
    return _bi::bind_t<R, F, list_type>( std::move(f), list_type( a... ) );
}
...
#include <boost_kahypar/bind/detail/bind_cc.hpp>
...
#include <boost_kahypar/bind/detail/bind_mf_cc.hpp>
#include <boost_kahypar/bind/detail/bind_mf2_cc.hpp>
