...
#include <boost_kahypar/regex/v5/unicode_iterator.hpp>
...
private:
   ...
   std::shared_ptr< ::boost_kahypar::BOOST_REGEX_DETAIL_NS::icu_regex_traits_implementation> m_pimpl;
};
...
#include <boost_kahypar/regex/v5/u32regex_iterator.hpp>
#include <boost_kahypar/regex/v5/u32regex_token_iterator.hpp>
