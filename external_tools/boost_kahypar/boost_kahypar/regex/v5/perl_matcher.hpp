...
#include <boost_kahypar/regex/v5/iterator_category.hpp>
...
// error checking API:
//
inline void  verify_options(boost_kahypar::regex_constants::syntax_option_type, match_flag_type mf)
{
   //
...
//
#include <boost_kahypar/regex/v5/perl_matcher_non_recursive.hpp>
// this one has to be last:
#include <boost_kahypar/regex/v5/perl_matcher_common.hpp>
