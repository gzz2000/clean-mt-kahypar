...
#include <boost_kahypar/regex/v4/regex_traits_defaults.hpp>
#endif
#ifdef BOOST_HAS_THREADS
#include <boost_kahypar/regex/pending/static_mutex.hpp>
#endif
#ifndef BOOST_REGEX_PRIMARY_TRANSFORM
#include <boost_kahypar/regex/v4/primary_transform.hpp>
#endif
#ifndef BOOST_REGEX_OBJECT_CACHE_HPP
#include <boost_kahypar/regex/v4/object_cache.hpp>
#endif
...
{
   typedef typename boost_kahypar::int_t<sizeof(way) * CHAR_BIT>::least cast_type;
...
public:
   ...
   typedef typename boost_kahypar::make_unsigned<native_mask_type>::type  unsigned_native_mask_type;
...
void cpp_regex_traits_implementation<charT>::init()
{
   ...
   if((int)cat >= 0)
   {
      ...
      static const char_class_type masks[16] = 
      {
         ::boost_kahypar::BOOST_REGEX_DETAIL_NS::char_class_alnum,
         ::boost_kahypar::BOOST_REGEX_DETAIL_NS::char_class_alpha,
         ::boost_kahypar::BOOST_REGEX_DETAIL_NS::char_class_cntrl,
         ::boost_kahypar::BOOST_REGEX_DETAIL_NS::char_class_digit,
         ::boost_kahypar::BOOST_REGEX_DETAIL_NS::char_class_graph,
         ::boost_kahypar::BOOST_REGEX_DETAIL_NS::char_class_horizontal_space,
         ::boost_kahypar::BOOST_REGEX_DETAIL_NS::char_class_lower,
         ::boost_kahypar::BOOST_REGEX_DETAIL_NS::char_class_print,
         ::boost_kahypar::BOOST_REGEX_DETAIL_NS::char_class_punct,
         ::boost_kahypar::BOOST_REGEX_DETAIL_NS::char_class_space,
         ::boost_kahypar::BOOST_REGEX_DETAIL_NS::char_class_upper,
         ::boost_kahypar::BOOST_REGEX_DETAIL_NS::char_class_vertical_space,
         ::boost_kahypar::BOOST_REGEX_DETAIL_NS::char_class_xdigit,
         ::boost_kahypar::BOOST_REGEX_DETAIL_NS::char_class_blank,
         ::boost_kahypar::BOOST_REGEX_DETAIL_NS::char_class_word,
         ::boost_kahypar::BOOST_REGEX_DETAIL_NS::char_class_unicode,
      };
#endif
   ...
   cpp_regex_traits_implementation<charT>::lookup_classname_imp(const charT* p1, const charT* p2) const
{
   ...
   static const char_class_type masks[22] = 
   {
      ...
      ::boost_kahypar::BOOST_REGEX_DETAIL_NS::char_class_upper,
      ::boost_kahypar::BOOST_REGEX_DETAIL_NS::char_class_vertical_space,
      ::boost_kahypar::BOOST_REGEX_DETAIL_NS::char_class_alnum | ::boost_kahypar::BOOST_REGEX_DETAIL_NS::char_class_word, 
      ::boost_kahypar::BOOST_REGEX_DETAIL_NS::char_class_alnum | ::boost_kahypar::BOOST_REGEX_DETAIL_NS::char_class_word, 
      ::boost_kahypar::BOOST_REGEX_DETAIL_NS::char_class_xdigit,
   };
#endif
...
{
   return
      ((mask & ::boost_kahypar::BOOST_REGEX_DETAIL_NS::char_class_space) && (this->m_pctype->is(std::ctype<charT>::space, c)))
      || ((mask & ::boost_kahypar::BOOST_REGEX_DETAIL_NS::char_class_print) && (this->m_pctype->is(std::ctype<charT>::print, c)))
      || ((mask & ::boost_kahypar::BOOST_REGEX_DETAIL_NS::char_class_cntrl) && (this->m_pctype->is(std::ctype<charT>::cntrl, c)))
      || ((mask & ::boost_kahypar::BOOST_REGEX_DETAIL_NS::char_class_upper) && (this->m_pctype->is(std::ctype<charT>::upper, c)))
      || ((mask & ::boost_kahypar::BOOST_REGEX_DETAIL_NS::char_class_lower) && (this->m_pctype->is(std::ctype<charT>::lower, c)))
      || ((mask & ::boost_kahypar::BOOST_REGEX_DETAIL_NS::char_class_alpha) && (this->m_pctype->is(std::ctype<charT>::alpha, c)))
      || ((mask & ::boost_kahypar::BOOST_REGEX_DETAIL_NS::char_class_digit) && (this->m_pctype->is(std::ctype<charT>::digit, c)))
      || ((mask & ::boost_kahypar::BOOST_REGEX_DETAIL_NS::char_class_punct) && (this->m_pctype->is(std::ctype<charT>::punct, c)))
      || ((mask & ::boost_kahypar::BOOST_REGEX_DETAIL_NS::char_class_xdigit) && (this->m_pctype->is(std::ctype<charT>::xdigit, c)))
      || ((mask & ::boost_kahypar::BOOST_REGEX_DETAIL_NS::char_class_blank) && (this->m_pctype->is(std::ctype<charT>::space, c)) && !::boost_kahypar::BOOST_REGEX_DETAIL_NS::is_separator(c))
      || ((mask & ::boost_kahypar::BOOST_REGEX_DETAIL_NS::char_class_word) && (c == '_'))
      || ((mask & ::boost_kahypar::BOOST_REGEX_DETAIL_NS::char_class_unicode) && ::boost_kahypar::BOOST_REGEX_DETAIL_NS::is_extended(c))
      || ((mask & ::boost_kahypar::BOOST_REGEX_DETAIL_NS::char_class_vertical_space) && (is_separator(c) || (c == '\v')))
      || ((mask & ::boost_kahypar::BOOST_REGEX_DETAIL_NS::char_class_horizontal_space) && this->m_pctype->is(std::ctype<charT>::space, c) && !(is_separator(c) || (c == '\v')));
}
#endif


template <class charT>
inline boost_kahypar::shared_ptr<const cpp_regex_traits_implementation<charT> > create_cpp_regex_traits(const std::locale& l)
{
   cpp_regex_traits_base<charT> key(l);
   return ::boost_kahypar::object_cache<cpp_regex_traits_base<charT>, cpp_regex_traits_implementation<charT> >::get(key, 5);
}
...
public:
   ...
   boost_kahypar::intmax_t toi(const charT*& p1, const charT* p2, int radix)const;
...
private:
   boost_kahypar::shared_ptr<const BOOST_REGEX_DETAIL_NS::cpp_regex_traits_implementation<charT> > m_pimpl;
   //
...
template <class charT>
boost_kahypar::intmax_t cpp_regex_traits<charT>::toi(const charT*& first, const charT* last, int radix)const
{
