...
#include <boost_kahypar/regex/v4/iterator_category.hpp>
...
// error checking API:
//
inline void BOOST_REGEX_CALL verify_options(boost_kahypar::regex_constants::syntax_option_type, match_flag_type mf)
{
   //
...
{   
   ...
   const ::boost_kahypar::regex_traits_wrapper<traits_type>& traits_inst = *(e.m_ptraits);
...
private:
   ...
   {
      return ::boost_kahypar::is_random_access_iterator<BidiIterator>::value ? match_dot_repeat_fast() : match_dot_repeat_slow();
   }
   bool match_backstep();
...
private:
   ...
   const ::boost_kahypar::regex_traits_wrapper<traits>& traits_inst;
...
//
#ifdef BOOST_REGEX_RECURSIVE
#include <boost_kahypar/regex/v4/perl_matcher_recursive.hpp>
#else
#include <boost_kahypar/regex/v4/perl_matcher_non_recursive.hpp>
#endif
// this one has to be last:
#include <boost_kahypar/regex/v4/perl_matcher_common.hpp>
