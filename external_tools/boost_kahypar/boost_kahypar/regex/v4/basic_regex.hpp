...
{
   std::size_t r = boost_kahypar::hash_range(i, j);
...
struct regex_data : public named_subexpressions
{
   ...
   regex_data(const ::boost_kahypar::shared_ptr<
      ::boost_kahypar::regex_traits_wrapper<traits> >& t) 
   ...
   regex_data() 
      : m_ptraits(new ::boost_kahypar::regex_traits_wrapper<traits>()), m_flags(0), m_status(0), m_expression(0), m_expression_len(0), 
         m_mark_count(0), m_first_state(0), m_restart_type(0), 
#if !defined(BOOST_NO_CXX11_UNIFIED_INITIALIZATION_SYNTAX) && !(defined(BOOST_MSVC) && (BOOST_MSVC < 1900))
      m_startmap{ 0 },
#endif
   ...
   ::boost_kahypar::shared_ptr<
      ::boost_kahypar::regex_traits_wrapper<traits>
...
public:
   ...
   basic_regex_implementation(const ::boost_kahypar::shared_ptr<
      ::boost_kahypar::regex_traits_wrapper<traits> >& t)
   ...
   const ::boost_kahypar::regex_traits_wrapper<traits>& get_traits()const
   {
...
public:
   ...
   {
      if(!m_pimpl.get())
         boost_kahypar::throw_exception(std::logic_error("Can't access subexpressions in an invalid regex."));
   ...
   boost_kahypar::shared_ptr<BOOST_REGEX_DETAIL_NS::named_subexpressions > get_named_subs()const
   {
      return m_pimpl;
   }
