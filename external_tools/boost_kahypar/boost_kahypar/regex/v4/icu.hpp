...
#include <boost_kahypar/regex/v4/unicode_iterator.hpp>
#include <boost_kahypar/mpl/int_fwd.hpp>
...
namespace boost_kahypar {
   ...
   namespace BOOST_REGEX_DETAIL_NS {
      ...
      class icu_regex_traits_implementation
      {
         ...
         typedef boost_kahypar::uint_least32_t        char_class_type;
      public:
      ...
      private:
         void init_error()
         {
            ...
            boost_kahypar::throw_exception(e);
         }
         U_NAMESPACE_QUALIFIER Locale m_locale;                                  // The ICU locale that we're using
         boost_kahypar::scoped_ptr< U_NAMESPACE_QUALIFIER Collator> m_collator;          // The full collation object
         boost_kahypar::scoped_ptr< U_NAMESPACE_QUALIFIER Collator> m_primary_collator;  // The primary collation object
      };

      inline boost_kahypar::shared_ptr<icu_regex_traits_implementation> get_icu_regex_traits_implementation(const U_NAMESPACE_QUALIFIER Locale& loc)
      {
         return boost_kahypar::shared_ptr<icu_regex_traits_implementation>(new icu_regex_traits_implementation(loc));
      }
   ...
   public:
...
#else
      typedef boost_kahypar::uint64_t              char_class_type;
#endif
      ...
      ::boost_kahypar::regex_constants::syntax_type syntax_type(char_type c)const
      {
         return ((c < 0x7f) && (c > 0)) ? BOOST_REGEX_DETAIL_NS::get_default_syntax_type(static_cast<char>(c)) : regex_constants::syntax_char;
      }
      ::boost_kahypar::regex_constants::escape_syntax_type escape_syntax_type(char_type c) const
      {
      ...
      char_class_type lookup_classname(const char_type* p1, const char_type* p2) const
      {
         ...
         int idx = ::boost_kahypar::BOOST_REGEX_DETAIL_NS::get_default_class_id(p1, p2);
         if (idx >= 0)
            return masks[idx + 1];
         ...
         if (idx < 0)
         {
            ...
            if (!s.empty())
               idx = ::boost_kahypar::BOOST_REGEX_DETAIL_NS::get_default_class_id(&*s.begin(), &*s.begin() + s.size());
            if (idx >= 0)
               return masks[idx + 1];
            if (!s.empty())
      ...
      string_type lookup_collatename(const char_type* p1, const char_type* p2) const
      {
...
#endif
         {
            ...
            // try POSIX name:
            s = ::boost_kahypar::BOOST_REGEX_DETAIL_NS::lookup_default_collate_name(s);
#ifndef BOOST_NO_TEMPLATED_ITERATOR_CONSTRUCTORS
      ...
      bool isctype(char_type c, char_class_type f) const
      {
         ...
         if (((f & mask_ascii) != 0) && (c <= 0x7F))
            return true;
         if (((f & mask_vertical) != 0) && (::boost_kahypar::BOOST_REGEX_DETAIL_NS::is_separator(c) || (c == static_cast<char_type>('\v')) || (m == U_GC_ZL_MASK) || (m == U_GC_ZP_MASK)))
            return true;
         if (((f & mask_horizontal) != 0) && !::boost_kahypar::BOOST_REGEX_DETAIL_NS::is_separator(c) && u_isspace(c) && (c != static_cast<char_type>('\v')))
            return true;
         return false;
      }
      boost_kahypar::intmax_t toi(const char_type*& p1, const char_type* p2, int radix)const
      {
      ...
      std::string error_string(::boost_kahypar::regex_constants::error_type n) const
      {
   ...
   private:
      ...
      boost_kahypar::shared_ptr< ::boost_kahypar::BOOST_REGEX_DETAIL_NS::icu_regex_traits_implementation> m_pimpl;
   };
...
namespace boost_kahypar {
   ...
   namespace BOOST_REGEX_DETAIL_NS {
      ...
      inline u32regex do_make_u32regex(InputIterator i,
         InputIterator j,
         boost_kahypar::regex_constants::syntax_option_type opt,
         const boost_kahypar::mpl::int_<1>*)
      {
         typedef boost_kahypar::u8_to_u32_iterator<InputIterator, UChar32> conv_type;
      ...
      inline u32regex do_make_u32regex(InputIterator i,
         InputIterator j,
         boost_kahypar::regex_constants::syntax_option_type opt,
         const boost_kahypar::mpl::int_<2>*)
      {
         typedef boost_kahypar::u16_to_u32_iterator<InputIterator, UChar32> conv_type;
         return u32regex(conv_type(i, i, j), conv_type(j, i, j), opt);
      }
      ...
      inline u32regex do_make_u32regex(InputIterator i,
         InputIterator j,
         boost_kahypar::regex_constants::syntax_option_type opt,
         const boost_kahypar::mpl::int_<4>*)
      {
...
#define BOOST_REGEX_UCHAR_IS_WCHAR_T (U_ICU_VERSION_MAJOR_NUM < 59 && U_SIZEOF_WCHAR_T == 2)
   ...
   BOOST_STATIC_ASSERT((boost_kahypar::is_same<UChar, wchar_t>::value));
#else
   BOOST_STATIC_ASSERT(!(boost_kahypar::is_same<UChar, wchar_t>::value));
#endif
   ...
   inline u32regex make_u32regex(InputIterator i,
      ...
      boost_kahypar::regex_constants::syntax_option_type opt)
   {
      return BOOST_REGEX_DETAIL_NS::do_make_u32regex(i, j, opt, static_cast<boost_kahypar::mpl::int_<sizeof(*i)> const*>(0));
   }
   //
   // construction from UTF-8 nul-terminated strings:
   //
   inline u32regex make_u32regex(const char* p, boost_kahypar::regex_constants::syntax_option_type opt = boost_kahypar::regex_constants::perl)
   {
      return BOOST_REGEX_DETAIL_NS::do_make_u32regex(p, p + std::strlen(p), opt, static_cast<boost_kahypar::mpl::int_<1> const*>(0));
   }
   inline u32regex make_u32regex(const unsigned char* p, boost_kahypar::regex_constants::syntax_option_type opt = boost_kahypar::regex_constants::perl)
   {
      return BOOST_REGEX_DETAIL_NS::do_make_u32regex(p, p + std::strlen(reinterpret_cast<const char*>(p)), opt, static_cast<boost_kahypar::mpl::int_<1> const*>(0));
   }
   //
   // construction from UTF-16 nul-terminated strings:
   //
#ifndef BOOST_NO_WREGEX
   inline u32regex make_u32regex(const wchar_t* p, boost_kahypar::regex_constants::syntax_option_type opt = boost_kahypar::regex_constants::perl)
   {
      return BOOST_REGEX_DETAIL_NS::do_make_u32regex(p, p + std::wcslen(p), opt, static_cast<boost_kahypar::mpl::int_<sizeof(wchar_t)> const*>(0));
   }
#endif
#if !BOOST_REGEX_UCHAR_IS_WCHAR_T
   inline u32regex make_u32regex(const UChar* p, boost_kahypar::regex_constants::syntax_option_type opt = boost_kahypar::regex_constants::perl)
   {
      return BOOST_REGEX_DETAIL_NS::do_make_u32regex(p, p + u_strlen(p), opt, static_cast<boost_kahypar::mpl::int_<2> const*>(0));
   }
#endif
   //
   ...
   inline u32regex make_u32regex(const std::basic_string<C, T, A>& s, boost_kahypar::regex_constants::syntax_option_type opt = boost_kahypar::regex_constants::perl)
   {
      return BOOST_REGEX_DETAIL_NS::do_make_u32regex(s.begin(), s.end(), opt, static_cast<boost_kahypar::mpl::int_<sizeof(C)> const*>(0));
   }
   //
   // Construction from ICU string type:
   //
   inline u32regex make_u32regex(const U_NAMESPACE_QUALIFIER UnicodeString& s, boost_kahypar::regex_constants::syntax_option_type opt = boost_kahypar::regex_constants::perl)
   {
      return BOOST_REGEX_DETAIL_NS::do_make_u32regex(s.getBuffer(), s.getBuffer() + s.length(), opt, static_cast<boost_kahypar::mpl::int_<2> const*>(0));
   }
   ...
   namespace BOOST_REGEX_DETAIL_NS {
      ...
      inline bool do_regex_match(BidiIterator first, BidiIterator last,
         ...
         boost_kahypar::mpl::int_<4> const*)
      {
         return ::boost_kahypar::regex_match(first, last, m, e, flags);
      }
      template <class BidiIterator, class Allocator>
      bool do_regex_match(BidiIterator first, BidiIterator last,
         ...
         const u32regex& e,
         match_flag_type flags,
         boost_kahypar::mpl::int_<2> const*)
      {
         typedef u16_to_u32_iterator<BidiIterator, UChar32> conv_type;
         typedef match_results<conv_type>                   match_type;
         //typedef typename match_type::allocator_type        alloc_type;
         match_type what;
         bool result = ::boost_kahypar::regex_match(conv_type(first, first, last), conv_type(last, first, last), what, e, flags);
      ...
      bool do_regex_match(BidiIterator first, BidiIterator last,
         ...
         const u32regex& e,
         match_flag_type flags,
         boost_kahypar::mpl::int_<1> const*)
      {
   ...
   namespace BOOST_REGEX_DETAIL_NS {
      ...
      inline bool do_regex_search(BidiIterator first, BidiIterator last,
         ...
         boost_kahypar::mpl::int_<4> const*)
      {
         return ::boost_kahypar::regex_search(first, last, m, e, flags, base);
      }
      template <class BidiIterator, class Allocator>
         ...
         boost_kahypar::mpl::int_<2> const*)
      {
         ...
         //typedef typename match_type::allocator_type        alloc_type;
         match_type what;
         bool result = ::boost_kahypar::regex_search(conv_type(first, first, last), conv_type(last, first, last), what, e, flags, conv_type(base));
         // copy results across to m:
         if (result) copy_results(m, what, e.get_named_subs());
         return result;
      }
   ...
   namespace BOOST_REGEX_DETAIL_NS {
      template <class I>
      inline std::pair< boost_kahypar::u8_to_u32_iterator<I>, boost_kahypar::u8_to_u32_iterator<I> >
         make_utf32_seq(I i, I j, mpl::int_<1> const*)
      {
         return std::pair< boost_kahypar::u8_to_u32_iterator<I>, boost_kahypar::u8_to_u32_iterator<I> >(boost_kahypar::u8_to_u32_iterator<I>(i, i, j), boost_kahypar::u8_to_u32_iterator<I>(j, i, j));
      }
      template <class I>
      inline std::pair< boost_kahypar::u16_to_u32_iterator<I>, boost_kahypar::u16_to_u32_iterator<I> >
         make_utf32_seq(I i, I j, mpl::int_<2> const*)
      {
         return std::pair< boost_kahypar::u16_to_u32_iterator<I>, boost_kahypar::u16_to_u32_iterator<I> >(boost_kahypar::u16_to_u32_iterator<I>(i, i, j), boost_kahypar::u16_to_u32_iterator<I>(j, i, j));
      }
      template <class I>
      inline std::pair< I, I >
      ...
      inline std::pair< boost_kahypar::u8_to_u32_iterator<const charT*>, boost_kahypar::u8_to_u32_iterator<const charT*> >
         make_utf32_seq(const charT* p, mpl::int_<1> const*)
      {
         std::size_t len = std::strlen((const char*)p);
         return std::pair< boost_kahypar::u8_to_u32_iterator<const charT*>, boost_kahypar::u8_to_u32_iterator<const charT*> >(boost_kahypar::u8_to_u32_iterator<const charT*>(p, p, p + len), boost_kahypar::u8_to_u32_iterator<const charT*>(p + len, p, p + len));
      }
      template <class charT>
      inline std::pair< boost_kahypar::u16_to_u32_iterator<const charT*>, boost_kahypar::u16_to_u32_iterator<const charT*> >
         make_utf32_seq(const charT* p, mpl::int_<2> const*)
      {
         std::size_t len = u_strlen((const UChar*)p);
         return std::pair< boost_kahypar::u16_to_u32_iterator<const charT*>, boost_kahypar::u16_to_u32_iterator<const charT*> >(boost_kahypar::u16_to_u32_iterator<const charT*>(p, p, p + len), boost_kahypar::u16_to_u32_iterator<const charT*>(p + len, p, p + len));
      }
      template <class charT>
      ...
      )
      {
         ...
         else
         {
            ...
            while (i != j)
            {
               ...
               if (!f.empty())
                  out = ::boost_kahypar::BOOST_REGEX_DETAIL_NS::regex_format_imp(out, *i, &*f.begin(), &*f.begin() + f.size(), flags, e.get_traits());
               else
                  out = ::boost_kahypar::BOOST_REGEX_DETAIL_NS::regex_format_imp(out, *i, static_cast<UChar32 const*>(0), static_cast<UChar32 const*>(0), flags, e.get_traits());
               last_m = (*i)[0].second;
...
#include <boost_kahypar/regex/v4/u32regex_iterator.hpp>
#include <boost_kahypar/regex/v4/u32regex_token_iterator.hpp>
