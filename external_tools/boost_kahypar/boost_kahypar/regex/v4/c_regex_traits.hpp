...
#include <boost_kahypar/regex/v4/regex_workaround.hpp>
#endif
...
struct c_regex_traits<char>
{
   ...
   struct locale_type{};
   typedef boost_kahypar::uint32_t char_class_type;
...
{
   static char s_delim;
   static const int s_collate_type = ::boost_kahypar::BOOST_REGEX_DETAIL_NS::find_sort_syntax(static_cast<c_regex_traits<char>*>(0), &s_delim);
   std::string result;
   //
   ...
   {
   case ::boost_kahypar::BOOST_REGEX_DETAIL_NS::sort_C:
   case ::boost_kahypar::BOOST_REGEX_DETAIL_NS::sort_unknown:
   ...
   case ::boost_kahypar::BOOST_REGEX_DETAIL_NS::sort_fixed:
   {
   ...
   case ::boost_kahypar::BOOST_REGEX_DETAIL_NS::sort_delim:
...
inline bool BOOST_REGEX_CALL c_regex_traits<char>::isctype(char c, char_class_type mask)
{
   ...
   return
      ...
      || ((mask & char_class_blank) && (std::isspace)(static_cast<unsigned char>(c)) && !::boost_kahypar::BOOST_REGEX_DETAIL_NS::is_separator(c))
      || ((mask & char_class_word) && (c == '_'))
      || ((mask & char_class_vertical) && (::boost_kahypar::BOOST_REGEX_DETAIL_NS::is_separator(c) || (c == '\v')))
      || ((mask & char_class_horizontal) && (std::isspace)(static_cast<unsigned char>(c)) && !::boost_kahypar::BOOST_REGEX_DETAIL_NS::is_separator(c) && (c != '\v'));
}
...
inline c_regex_traits<wchar_t>::string_type BOOST_REGEX_CALL c_regex_traits<wchar_t>::transform_primary(const wchar_t* p1, const wchar_t* p2)
{
   ...
   static const int s_collate_type = ::boost_kahypar::BOOST_REGEX_DETAIL_NS::find_sort_syntax(static_cast<const c_regex_traits<wchar_t>*>(0), &s_delim);
   std::wstring result;
   //
   // What we do here depends upon the format of the sort key returned by
   // sort key returned by this->transform:
...
inline bool BOOST_REGEX_CALL c_regex_traits<wchar_t>::isctype(wchar_t c, char_class_type mask)
{
   ...
   return
      ...
      || ((mask & char_class_blank) && (std::iswspace)(c) && !::boost_kahypar::BOOST_REGEX_DETAIL_NS::is_separator(c))
      || ((mask & char_class_word) && (c == '_'))
      || ((mask & char_class_unicode) && (c & ~static_cast<wchar_t>(0xff)))
      || ((mask & char_class_vertical) && (::boost_kahypar::BOOST_REGEX_DETAIL_NS::is_separator(c) || (c == L'\v')))
      || ((mask & char_class_horizontal) && (std::iswspace)(c) && !::boost_kahypar::BOOST_REGEX_DETAIL_NS::is_separator(c) && (c != L'\v'));
}
...
#pragma warning(pop)
#endif
   name = ::boost_kahypar::BOOST_REGEX_DETAIL_NS::lookup_default_collate_name(name);
   if (!name.empty())
