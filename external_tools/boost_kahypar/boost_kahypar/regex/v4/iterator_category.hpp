...
public:
   BOOST_STATIC_CONSTANT(bool, value = (::boost_kahypar::is_convertible<cat*, std::random_access_iterator_tag*>::value));
#else
...
{
private:
   typedef detail::is_random_imp_selector< ::boost_kahypar::is_pointer<I>::value> selector;
