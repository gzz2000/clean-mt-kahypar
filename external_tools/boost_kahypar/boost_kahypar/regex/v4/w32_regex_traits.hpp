...
//
typedef ::boost_kahypar::uint32_t lcid_type;   // placeholder for LCID.
typedef ::boost_kahypar::shared_ptr<void> cat_type; // placeholder for dll HANDLE.
...
#endif
bool BOOST_REGEX_CALL w32_is(lcid_type, boost_kahypar::uint32_t mask, char c);
#ifndef BOOST_NO_WREGEX
bool BOOST_REGEX_CALL w32_is(lcid_type, boost_kahypar::uint32_t mask, wchar_t c);
#endif
//
...
public:
   ...
   bool isctype(boost_kahypar::uint32_t mask, charT c)const
   {
...
public:
   ...
   bool isctype(boost_kahypar::uint32_t mask, char c)const
   {
...
private:
   ...
   boost_kahypar::uint16_t m_type_map[1u << CHAR_BIT];
   template <class U>
   void init();
};
...
template <class charT>
boost_kahypar::shared_ptr<const w32_regex_traits_implementation<charT> > create_w32_regex_traits(::boost_kahypar::BOOST_REGEX_DETAIL_NS::lcid_type l)
{
...
private:
   boost_kahypar::shared_ptr<const BOOST_REGEX_DETAIL_NS::w32_regex_traits_implementation<charT> > m_pimpl;
   //
...
#endif
   inline bool BOOST_REGEX_CALL w32_is(lcid_type idx, boost_kahypar::uint32_t m, char c)
   {
      WORD mask;
#ifndef BOOST_NO_ANSI_APIS
...
#ifndef BOOST_NO_WREGEX
   inline bool BOOST_REGEX_CALL w32_is(lcid_type idx, boost_kahypar::uint32_t m, wchar_t c)
   {
      WORD mask;
