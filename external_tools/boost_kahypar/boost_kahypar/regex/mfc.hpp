...
make_regex(const ATL::CSimpleStringT<B, b>& s, ::boost_kahypar::regex_constants::syntax_option_type f = boost_kahypar::regex_constants::normal)
{
...
inline bool regex_match(const ATL::CSimpleStringT<B, b>& s,
                 ...
                 boost_kahypar::regex_constants::match_flag_type f = boost_kahypar::regex_constants::match_default)
{
   return ::boost_kahypar::regex_match(s.GetString(),
...
inline bool regex_search(const ATL::CSimpleStringT<B, b>& s,
                 ...
                 boost_kahypar::regex_constants::match_flag_type f = boost_kahypar::regex_constants::match_default)
{
   return ::boost_kahypar::regex_search(s.GetString(),
                               s.GetString() + s.GetLength(),
                               what,
                               e,
                               f);
...
make_regex_iterator(const ATL::CSimpleStringT<B, b>& s, const basic_regex<B>& e, ::boost_kahypar::regex_constants::match_flag_type f = boost_kahypar::regex_constants::match_default)
{
...
inline regex_token_iterator<B const*> 
   make_regex_token_iterator(const ATL::CSimpleStringT<B, b>& s, const basic_regex<B>& e, int sub = 0, ::boost_kahypar::regex_constants::match_flag_type f = boost_kahypar::regex_constants::match_default)
{
...
template <class B, bool b>
inline regex_token_iterator<B const*> 
make_regex_token_iterator(const ATL::CSimpleStringT<B, b>& s, const basic_regex<B>& e, const std::vector<int>& subs, ::boost_kahypar::regex_constants::match_flag_type f = boost_kahypar::regex_constants::match_default)
{
...
inline regex_token_iterator<B const*> 
make_regex_token_iterator(const ATL::CSimpleStringT<B, b>& s, const basic_regex<B>& e, const int (& subs)[N], ::boost_kahypar::regex_constants::match_flag_type f = boost_kahypar::regex_constants::match_default)
{
   regex_token_iterator<B const*> result(s.GetString(), s.GetString() + s.GetLength(), e, subs, f);
   return result;
}
...
{
   return ::boost_kahypar::regex_replace(out, first, last, e, fmt.GetString(), flags);
}
