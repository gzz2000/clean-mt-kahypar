...
#if !defined(BOOST_REGEX_STANDALONE) && !__has_include(<boost_kahypar/version.hpp>)
...
#  include <boost_kahypar/regex/config/borland.hpp>
#endif
...
#     define BOOST_REGEX_USER_CONFIG <boost_kahypar/regex/user.hpp>
#  endif
...
#  include <boost_kahypar/predef.h>
   ...
   /*
    * C build,
    * don't include <boost_kahypar/config.hpp> because that may
...
#  include <boost_kahypar/regex/config/cwchar.hpp>
#endif
...
#  define BOOST_LIB_NAME boost_kahypar_regex
