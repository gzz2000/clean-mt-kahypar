...
//
#ifndef BOOST_TEST_TR1_REGEX
namespace global_regex_namespace = ::boost_kahypar;
#else
...
struct BaseRegexConcept
{
   ...
   void global_constraints()
   {
      ...
      BOOST_STATIC_ASSERT((::boost_kahypar::is_enum<global_regex_namespace::regex_constants::error_type>::value));
      ...
      BOOST_STATIC_ASSERT((::boost_kahypar::is_base_and_derived<std::runtime_error, global_regex_namespace::regex_error>::value  ));
   ...
   void constraints() 
   {
      ...
      BOOST_STATIC_ASSERT((::boost_kahypar::is_same< flag_type, global_regex_namespace::regex_constants::syntax_option_type>::value));
      flag_type opts
         = Regex::icase
         | Regex::nosubs
         | Regex::optimize
      ...
      // sub_match:
      BOOST_STATIC_ASSERT((::boost_kahypar::is_base_and_derived<std::pair<BidiIterator, BidiIterator>, sub_match_type>::value));
      ...
      BOOST_STATIC_ASSERT((::boost_kahypar::is_same<sub_value_type, value_type>::value));
      BOOST_STATIC_ASSERT((::boost_kahypar::is_same<sub_iter_type, BidiIterator>::value));
      ...
      BOOST_STATIC_ASSERT((::boost_kahypar::is_same<rit_regex_type, Regex>::value));
      BOOST_STATIC_ASSERT((::boost_kahypar::is_same<rit_value_type, match_results_default_type>::value));
      BOOST_STATIC_ASSERT((::boost_kahypar::is_same<rit_difference_type, std::ptrdiff_t>::value));
      BOOST_STATIC_ASSERT((::boost_kahypar::is_same<rit_pointer, const match_results_default_type*>::value));
      BOOST_STATIC_ASSERT((::boost_kahypar::is_same<rit_reference, const match_results_default_type&>::value));
      BOOST_STATIC_ASSERT((::boost_kahypar::is_convertible<rit_iterator_category*, std::forward_iterator_tag*>::value));
      ...
      BOOST_STATIC_ASSERT((::boost_kahypar::is_same<rtit_regex_type, Regex>::value));
      BOOST_STATIC_ASSERT((::boost_kahypar::is_same<rtit_value_type, sub_match_type>::value));
      BOOST_STATIC_ASSERT((::boost_kahypar::is_same<rtit_difference_type, std::ptrdiff_t>::value));
      BOOST_STATIC_ASSERT((::boost_kahypar::is_same<rtit_pointer, const sub_match_type*>::value));
      BOOST_STATIC_ASSERT((::boost_kahypar::is_same<rtit_reference, const sub_match_type&>::value));
      BOOST_STATIC_ASSERT((::boost_kahypar::is_convertible<rtit_iterator_category*, std::forward_iterator_tag*>::value));
      // this takes care of most of the checks needed:
...
struct RegexConcept
{
   ...
   typedef boost_kahypar::bidirectional_iterator_archetype<value_type> BidiIterator;
   typedef global_regex_namespace::sub_match<BidiIterator> sub_match_type;
   typedef global_regex_namespace::match_results<BidiIterator, allocator_architype<sub_match_type> > match_results_type;
   typedef output_iterator_archetype<value_type> OutIterator;
