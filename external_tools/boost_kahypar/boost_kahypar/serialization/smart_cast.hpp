...
namespace smart_cast_impl {
    ...
    struct reference {
        ...
        static T cast(U & u){
            typedef typename mpl::eval_if<
                boost_kahypar::is_polymorphic<U>,
...
T smart_cast(U u) {
    typedef
        typename mpl::eval_if<
            typename mpl::or_<
                boost_kahypar::is_same<void *, U>,
                boost_kahypar::is_same<void *, T>,
                boost_kahypar::is_same<const void *, U>,
                boost_kahypar::is_same<const void *, T>
            >,
            mpl::identity<smart_cast_impl::void_pointer< T > >,
        // else
        typename mpl::eval_if<boost_kahypar::is_pointer<U>,
            mpl::identity<smart_cast_impl::pointer< T > >,
        // else
        typename mpl::eval_if<boost_kahypar::is_reference<U>,
