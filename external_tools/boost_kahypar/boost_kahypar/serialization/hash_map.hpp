...
#include <boost_kahypar/serialization/utility.hpp> // pair
#include <boost_kahypar/serialization/hash_collections_save_imp.hpp>
#include <boost_kahypar/serialization/hash_collections_load_imp.hpp>
...
struct archive_input_hash_map
{
    inline void operator()(
        ...
        ar >> boost_kahypar::serialization::make_nvp("item", t.reference());
        std::pair<typename Container::const_iterator, bool> result =
            s.insert(boost_kahypar::move(t.reference()));
...
inline void save(
    ...
    boost_kahypar::serialization::stl::save_hash_collection<
        Archive,
...
inline void load(
    ...
    boost_kahypar::serialization::stl::load_hash_collection<
        Archive,
        BOOST_STD_EXTENSION_NAMESPACE::hash_map<
            Key, T, HashFcn, EqualKey, Allocator
        >,
        boost_kahypar::serialization::stl::archive_input_hash_map<
            Archive,
            BOOST_STD_EXTENSION_NAMESPACE::hash_map<
                Key, T, HashFcn, EqualKey, Allocator
            >
...
inline void load(
    ...
    boost_kahypar::serialization::stl::load_hash_collection<
        ...
        BOOST_STD_EXTENSION_NAMESPACE::hash_multimap<
            Key, T, HashFcn, EqualKey, Allocator
        >,
        boost_kahypar::serialization::stl::archive_input_hash_multimap<
            Archive,
            BOOST_STD_EXTENSION_NAMESPACE::hash_multimap<
                Key, T, HashFcn, EqualKey, Allocator
            >
