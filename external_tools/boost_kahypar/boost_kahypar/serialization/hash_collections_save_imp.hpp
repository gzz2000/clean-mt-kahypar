...
inline void save_hash_collection(Archive & ar, const Container &s)
{
    ...
    if(boost_kahypar::serialization::library_version_type(6) != library_version){
    ...
    while(count-- > 0){
        ...
        boost_kahypar::serialization::save_construct_data_adl(
            ar,
            &(*it),
            boost_kahypar::serialization::version<
                typename Container::value_type
            >::value
        );
        ar << boost_kahypar::serialization::make_nvp("item", *it++);
    }
}
