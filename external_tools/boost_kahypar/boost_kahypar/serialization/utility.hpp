...
inline void serialize(
    ...
    typedef typename boost_kahypar::remove_const<F>::type typef;
    ar & boost_kahypar::serialization::make_nvp("first", const_cast<typef &>(p.first));
    ar & boost_kahypar::serialization::make_nvp("second", p.second);
}
