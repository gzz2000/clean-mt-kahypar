...
#include <boost_kahypar/mpl/print.hpp>
...
struct static_warning_test{
    typename boost_kahypar::mpl::eval_if_c<
        B,
        boost_kahypar::mpl::true_,
        typename boost_kahypar::mpl::identity<
            boost_kahypar::mpl::print<
...
#define BOOST_SERIALIZATION_BSW(B, L) \
    typedef boost_kahypar::serialization::BOOST_SERIALIZATION_SS< \
        sizeof( boost_kahypar::serialization::static_warning_test< B, L > ) \
