...
#include <boost_kahypar/serialization/array_optimization.hpp>
...
private:
    ...
    friend const boost_kahypar::serialization::array_wrapper<Tx> make_array(Tx * t, S s);
public:
...
public:
    ...
    void serialize_optimized(Archive &ar, const unsigned int, mpl::false_ ) const
    {
      ...
      T * t = address();
      while(0 < c--)
            ar & boost_kahypar::serialization::make_nvp("item", *t++);
    }
    ...
    {
      boost_kahypar::serialization::split_member(ar, *this, version);
    }
