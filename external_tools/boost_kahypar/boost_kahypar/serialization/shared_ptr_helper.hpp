...
public:
    ...
    friend void boost_kahypar::serialization::load(
        Archive & ar,
        SPT< U > &t,
        const unsigned int file_version
    );
    ...
    std::list<boost_kahypar_132::shared_ptr<const void> > * m_pointers_132;
    void
    append(const boost_kahypar_132::shared_ptr<const void> & t){
        if(NULL == m_pointers_132)
            m_pointers_132 = new std::list<boost_kahypar_132::shared_ptr<const void> >;
    ...
    struct non_polymorphic {
        template<class U>
        static const boost_kahypar::serialization::extended_type_info *
        get_object_type(U & ){
            return & boost_kahypar::serialization::singleton<
                typename
                boost_kahypar::serialization::type_info_implementation< U >::type
            >::get_const_instance();
        }
    };
    struct polymorphic {
...
public:
    ...
    void reset(SPT< T > & s, T * t){
        ...
        const boost_kahypar::serialization::extended_type_info * this_type
        ...
        if(NULL == true_type)
            boost_kahypar::serialization::throw_exception(
                boost_kahypar::archive::archive_exception(
                    boost_kahypar::archive::archive_exception::unregistered_class,
        ...
        if(NULL == oid)
            boost_kahypar::serialization::throw_exception(
                boost_kahypar::archive::archive_exception(
                    boost_kahypar::archive::archive_exception::unregistered_cast,
