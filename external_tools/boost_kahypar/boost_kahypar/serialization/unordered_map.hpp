...
#include <boost_kahypar/serialization/utility.hpp>
#include <boost_kahypar/serialization/unordered_collections_save_imp.hpp>
#include <boost_kahypar/serialization/unordered_collections_load_imp.hpp>
#include <boost_kahypar/serialization/archive_input_unordered_map.hpp>
...
inline void save(
    ...
    boost_kahypar::serialization::stl::save_unordered_collection<
        Archive,
...
inline void load(
    ...
    boost_kahypar::serialization::stl::load_unordered_collection<
        Archive,
        std::unordered_map<Key, T, HashFcn, EqualKey, Allocator>,
        boost_kahypar::serialization::stl::archive_input_unordered_map<
            Archive,
            std::unordered_map<Key, T, HashFcn, EqualKey, Allocator>
        >
    >(ar, t);
...
inline void load(
    ...
    boost_kahypar::serialization::stl::load_unordered_collection<
        Archive,
        std::unordered_multimap<Key, T, HashFcn, EqualKey, Allocator>,
        boost_kahypar::serialization::stl::archive_input_unordered_multimap<
            Archive,
            std::unordered_multimap<Key, T, HashFcn, EqualKey, Allocator>
        >
    >(ar, t);
