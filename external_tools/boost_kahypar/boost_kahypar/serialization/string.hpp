...
BOOST_CLASS_IMPLEMENTATION(std::string, boost_kahypar::serialization::primitive_type)
#ifndef BOOST_NO_STD_WSTRING
BOOST_CLASS_IMPLEMENTATION(std::wstring, boost_kahypar::serialization::primitive_type)
#endif
