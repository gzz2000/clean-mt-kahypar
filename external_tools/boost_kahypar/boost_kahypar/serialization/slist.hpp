...
inline void save(
    ...
    boost_kahypar::serialization::stl::save_collection<
        Archive,
...
collection_load_impl(
    ...
    t.clear();
    boost_kahypar::serialization::detail::stack_construct<Archive, T> u(ar, item_version);
    ar >> boost_kahypar::serialization::make_nvp("item", u.reference());
    t.push_front(boost_kahypar::move(u.reference()));
    ...
    while(--count > 0){
        ...
        ar >> boost_kahypar::serialization::make_nvp("item", u.reference());
        last = t.insert_after(last, boost_kahypar::move(u.reference()));
...
inline void load(
    ...
    if(detail::is_default_constructible<U>()){
        ...
        t.clear();
        boost_kahypar::serialization::detail::stack_construct<Archive, U> u(ar, item_version);
        ar >> boost_kahypar::serialization::make_nvp("item", u.reference());
        t.push_front(boost_kahypar::move(u.reference()));
