...
/**/
    ...
    BOOST_SERIALIZATION_COLLECTION_TRAITS_HELPER(boost_kahypar::long_long_type, C)  \
    BOOST_SERIALIZATION_COLLECTION_TRAITS_HELPER(boost_kahypar::ulong_long_type, C) \
    /**/
#else
    #define BOOST_SERIALIZATION_COLLECTION_TRAITS_HELPER_INT64(C)
#endif
