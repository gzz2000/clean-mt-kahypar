...
#include <boost_kahypar/serialization/extended_type_info.hpp> // for guid_defined only
...
struct guid_initializer
{
    ...
    guid_initializer const & export_guid() const {
        ...
        //BOOST_STATIC_WARNING(! boost_kahypar::serialization::is_abstract< T >::value);
        export_guid(boost_kahypar::serialization::is_abstract< T >());
        return *this;
    }
};
...
template<>                                     \
struct guid_defined< T > : boost_kahypar::mpl::true_ {}; \
template<>                                     \
...
namespace {                                                                    \
  ...
  (::boost_kahypar::archive::detail::instantiate_ptr_serialization((Derived*)0,0), 3); \
  static int BOOST_PP_CAT(boost_serialization_mwerks_init2_, __LINE__) = (     \
      ::boost_kahypar::serialization::void_cast_register((Derived*)0,(Base*)0)         \
    , 3);                                                                      \
}
...
#define BOOST_CLASS_EXPORT_CHECK(T)                              \
    BOOST_STATIC_WARNING(                                        \
        boost_kahypar::is_polymorphic<U>::value                          \
    );                                                           \
    /**/
