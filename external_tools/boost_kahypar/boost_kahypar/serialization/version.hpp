...
struct version
{
    ...
    typedef
        typename mpl::eval_if<
            is_base_and_derived<boost_kahypar::serialization::basic_traits,T>,
...
#include <boost_kahypar/mpl/less.hpp>
#include <boost_kahypar/mpl/comparison.hpp>
...
{                                                                      \
    ...
    BOOST_STATIC_CONSTANT(int, value = version::type::value);          \
    BOOST_MPL_ASSERT((                                                 \
        boost_kahypar::mpl::less<                                              \
            boost_kahypar::mpl::int_<N>,                                       \
            boost_kahypar::mpl::int_<256>                                      \
        >                                                              \
    ));                                                                \
    /*                                                                 \
    BOOST_MPL_ASSERT((                                                 \
