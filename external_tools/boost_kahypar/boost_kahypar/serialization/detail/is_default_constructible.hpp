...
#include <boost_kahypar/config.hpp>
    ...
    // so we fake it by using boost_kahypar::has_trivial_construtor.  But this is not
    ...
    template<typename T>
    struct is_default_constructible : public boost_kahypar::has_trivial_constructor<T> {};
