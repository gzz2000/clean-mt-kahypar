...
inline bool std_category::equivalent( int code, const std::error_condition & condition ) const noexcept
{
    ...
    {
        boost_kahypar::system::error_condition bn( condition.value(), *pc_ );
        return pc_->equivalent( code, bn );
    }
    else if( condition.category() == std::generic_category() || condition.category() == boost_kahypar::system::generic_category() )
    {
        boost_kahypar::system::error_condition bn( condition.value(), boost_kahypar::system::generic_category() );
        return pc_->equivalent( code, bn );
    }
    ...
    {
        boost_kahypar::system::error_condition bn( condition.value(), *pc2->pc_ );
        return pc_->equivalent( code, bn );
    }
...
inline bool std_category::equivalent( const std::error_code & code, int condition ) const noexcept
{
    ...
    {
        boost_kahypar::system::error_code bc( code.value(), *pc_ );
        return pc_->equivalent( bc, condition );
    }
    else if( code.category() == std::generic_category() || code.category() == boost_kahypar::system::generic_category() )
    {
        boost_kahypar::system::error_code bc( code.value(), boost_kahypar::system::generic_category() );
        return pc_->equivalent( bc, condition );
    }
    ...
    {
        boost_kahypar::system::error_code bc( code.value(), *pc2->pc_ );
        return pc_->equivalent( bc, condition );
    }

#endif

    else if( *pc_ == boost_kahypar::system::generic_category() )
    {
