...
private:
    ...
    boost_kahypar::ulong_long_type id_;
...
protected:
    ...
    explicit constexpr error_category( boost_kahypar::ulong_long_type id ) noexcept: id_( id ), stdcat_(), sc_init_()
    {
    }
...
static const boost_kahypar::ulong_long_type generic_category_id = ( boost_kahypar::ulong_long_type( 0xB2AB117A ) << 32 ) + 0x257EDFD0;
static const boost_kahypar::ulong_long_type system_category_id = generic_category_id + 1;
static const boost_kahypar::ulong_long_type interop_category_id = generic_category_id + 2;
