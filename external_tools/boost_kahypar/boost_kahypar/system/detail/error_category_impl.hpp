...
#include <boost_kahypar/system/detail/std_category_impl.hpp>
#include <boost_kahypar/system/detail/mutex.hpp>
#include <new>
...
{
    static_assert( sizeof( stdcat_ ) >= sizeof( boost_kahypar::system::detail::std_category ), "sizeof(stdcat_) is not enough for std_category" );

#if defined(BOOST_MSVC) && BOOST_MSVC < 1900
    // no alignof
#else

    static_assert( alignof( decltype(stdcat_align_) ) >= alignof( boost_kahypar::system::detail::std_category ), "alignof(stdcat_) is not enough for std_category" );
    ...
    {
        ::new( static_cast<void*>( stdcat_ ) ) boost_kahypar::system::detail::std_category( this, system::detail::id_wrapper<0>() );
...
// This condition must be the same as the one in error_condition.hpp
        ...
        static const boost_kahypar::system::detail::std_category generic_instance( this, system::detail::id_wrapper<0x1F4D3>() );
...
// This condition must be the same as the one in error_code.hpp
        ...
        static const boost_kahypar::system::detail::std_category system_instance( this, system::detail::id_wrapper<0x1F4D7>() );
    ...
    return *static_cast<boost_kahypar::system::detail::std_category const*>( static_cast<void const*>( stdcat_ ) );
}
