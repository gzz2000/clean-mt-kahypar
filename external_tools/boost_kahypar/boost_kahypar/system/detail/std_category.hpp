...
private:
    ...
    boost_kahypar::system::error_category const * pc_;

public:

    boost_kahypar::system::error_category const & original_category() const noexcept
    {
        return *pc_;
    }
...
public:
    ...
    explicit std_category( boost_kahypar::system::error_category const * pc, id_wrapper<Id> ): pc_( pc )
    {
