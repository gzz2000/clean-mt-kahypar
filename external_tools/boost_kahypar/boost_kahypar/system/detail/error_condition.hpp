...
private:
    ...
    boost_kahypar::ulong_long_type cat_id() const noexcept
    {
...
public:
    ...
    BOOST_SYSTEM_CONSTEXPR explicit error_condition( boost_kahypar::system::detail::generic_value_tag vt ) noexcept:
    ...
    template<class ErrorConditionEnum> BOOST_SYSTEM_CONSTEXPR error_condition( ErrorConditionEnum e,
      typename detail::enable_if<
        is_error_condition_enum<ErrorConditionEnum>::value && !boost_kahypar::system::detail::is_same<ErrorConditionEnum, errc::errc_t>::value
      >::type* = 0) noexcept
    {
    ...
    template<class ErrorConditionEnum> BOOST_SYSTEM_CONSTEXPR error_condition( ErrorConditionEnum e,
      typename detail::enable_if<boost_kahypar::system::detail::is_same<ErrorConditionEnum, errc::errc_t>::value>::type* = 0) noexcept:
        val_( e ), cat_( 0 )
    {
    }
