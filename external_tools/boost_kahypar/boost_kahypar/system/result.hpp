...
#include <boost_kahypar/variant2/variant.hpp>
...
BOOST_NORETURN BOOST_NOINLINE inline void throw_exception_from_error( error_code const & e, boost_kahypar::source_location const& loc )
{
    boost_kahypar::throw_with_location( system_error( e ), loc );
}

BOOST_NORETURN BOOST_NOINLINE inline void throw_exception_from_error( errc::errc_t const & e, boost_kahypar::source_location const& loc )
{
    boost_kahypar::throw_with_location( system_error( make_error_code( e ) ), loc );
}

BOOST_NORETURN BOOST_NOINLINE inline void throw_exception_from_error( std::error_code const & e, boost_kahypar::source_location const& loc )
{
    boost_kahypar::throw_with_location( std::system_error( e ), loc );
}

BOOST_NORETURN BOOST_NOINLINE inline void throw_exception_from_error( std::errc const & e, boost_kahypar::source_location const& loc )
{
    boost_kahypar::throw_with_location( std::system_error( make_error_code( e ) ), loc );
}

BOOST_NORETURN BOOST_NOINLINE inline void throw_exception_from_error( std::exception_ptr const & p, boost_kahypar::source_location const& loc )
{
    if( p )
    {
    ...
    {
        boost_kahypar::throw_with_location( std::bad_exception(), loc );
    }
}
...
public:
    ...
    BOOST_CXX14_CONSTEXPR T value( boost_kahypar::source_location const& loc = BOOST_CURRENT_LOCATION ) const
    {
        if( has_value() )
        {
    ...
    BOOST_CXX14_CONSTEXPR T& value( boost_kahypar::source_location const& loc = BOOST_CURRENT_LOCATION ) &
    {
        if( has_value() )
        {
            return variant2::unsafe_get<0>( v_ );
    ...
    BOOST_CXX14_CONSTEXPR T const& value( boost_kahypar::source_location const& loc = BOOST_CURRENT_LOCATION ) const&
    {
        if( has_value() )
        {
            return variant2::unsafe_get<0>( v_ );
    ...
    template<class U = T>
        ...
        value( boost_kahypar::source_location const& loc = BOOST_CURRENT_LOCATION ) &&
    {
    ...
    template<class U = T>
        ...
        value( boost_kahypar::source_location const& loc = BOOST_CURRENT_LOCATION ) const &&
    {
        return std::move( value( loc ) );
    }
...
public:
    ...
    BOOST_CXX14_CONSTEXPR void value( boost_kahypar::source_location const& loc = BOOST_CURRENT_LOCATION ) const
    {
        if( has_value() )
        {
        }
...
public:
    ...
    BOOST_CXX14_CONSTEXPR U& value( boost_kahypar::source_location const& loc = BOOST_CURRENT_LOCATION ) const
    {
        if( has_value() )
        {
            return *variant2::unsafe_get<0>( v_ );
