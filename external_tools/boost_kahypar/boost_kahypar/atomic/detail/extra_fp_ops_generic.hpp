...
#include <boost_kahypar/atomic/detail/extra_fp_operations_fwd.hpp>
#include <boost_kahypar/atomic/detail/type_traits/is_iec559.hpp>
#include <boost_kahypar/atomic/detail/type_traits/is_integral.hpp>
