...
#include <boost_kahypar/atomic/detail/string_ops.hpp>
...
{
    typedef boost_kahypar::uint8_t BOOST_ATOMIC_DETAIL_MAY_ALIAS type;
...
{
    typedef boost_kahypar::uint16_t BOOST_ATOMIC_DETAIL_MAY_ALIAS type;

    static BOOST_CONSTEXPR_OR_CONST std::size_t native_alignment = atomics::detail::alignment_of< boost_kahypar::uint16_t >::value;
...
{
    typedef boost_kahypar::uint32_t BOOST_ATOMIC_DETAIL_MAY_ALIAS type;

    static BOOST_CONSTEXPR_OR_CONST std::size_t native_alignment = atomics::detail::alignment_of< boost_kahypar::uint32_t >::value;
...
{
    typedef boost_kahypar::uint64_t BOOST_ATOMIC_DETAIL_MAY_ALIAS type;

    static BOOST_CONSTEXPR_OR_CONST std::size_t native_alignment = atomics::detail::alignment_of< boost_kahypar::uint64_t >::value;
...
{
    typedef boost_kahypar::uint128_type BOOST_ATOMIC_DETAIL_MAY_ALIAS type;

    static BOOST_CONSTEXPR_OR_CONST std::size_t native_alignment = atomics::detail::alignment_of< boost_kahypar::uint128_type >::value;
    static BOOST_CONSTEXPR_OR_CONST std::size_t alignment = 16u;
};
...
union max_align_t
{
    ...
    boost_kahypar::float128_type f128;
#endif
};
