...
#include <boost_kahypar/config/helper_macros.hpp>
...
#define BOOST_ATOMIC_DETAIL_ALIGNED_VAR(var_alignment, var_type, var_name) \
    ...
    { \
        var_type var_name; \
        boost_kahypar::type_with_alignment< var_alignment >::type BOOST_JOIN(var_name, _aligner); \
    }
...
#define BOOST_ATOMIC_DETAIL_ALIGNED_VAR_TPL(var_alignment, var_type, var_name) \
    ...
    { \
        var_type var_name; \
        typename boost_kahypar::type_with_alignment< var_alignment >::type BOOST_JOIN(var_name, _aligner); \
    }
