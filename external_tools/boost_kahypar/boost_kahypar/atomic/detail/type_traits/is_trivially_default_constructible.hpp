...
template< typename T >
using is_trivially_default_constructible = boost_kahypar::has_trivial_constructor< T >;
#else
template< typename T >
struct is_trivially_default_constructible : public boost_kahypar::has_trivial_constructor< T > {};
#endif
