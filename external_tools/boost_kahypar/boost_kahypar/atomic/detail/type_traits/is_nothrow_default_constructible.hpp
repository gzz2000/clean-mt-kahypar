...
template< typename T >
using is_nothrow_default_constructible = boost_kahypar::has_nothrow_constructor< T >;
#else
template< typename T >
struct is_nothrow_default_constructible : public boost_kahypar::has_nothrow_constructor< T > {};
#endif
