...
#include <boost_kahypar/atomic/detail/core_arch_operations_fwd.hpp>
#include <boost_kahypar/atomic/detail/type_traits/make_signed.hpp>
#include <boost_kahypar/atomic/detail/capabilities.hpp>
#if defined(BOOST_ATOMIC_DETAIL_X86_HAS_CMPXCHG8B) || defined(BOOST_ATOMIC_DETAIL_X86_HAS_CMPXCHG16B)
#include <boost_kahypar/cstdint.hpp>
#include <boost_kahypar/atomic/detail/cas_based_exchange.hpp>
#include <boost_kahypar/atomic/detail/core_ops_cas_based.hpp>
#endif
...
#include <boost_kahypar/atomic/detail/extending_cas_based_arithmetic.hpp>
#endif
    ...
    public core_arch_operations_msvc_x86_base
{
    ...
    {
        typedef typename boost_kahypar::atomics::detail::make_signed< storage_type >::type signed_storage_type;
