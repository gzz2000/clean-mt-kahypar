...
#include <boost_kahypar/atomic/detail/classify.hpp>
#include <boost_kahypar/atomic/detail/atomic_impl.hpp>
#include <boost_kahypar/atomic/detail/type_traits/is_trivially_copyable.hpp>
...
public:
    ...
    static_assert(sizeof(value_type) > 0u, "boost_kahypar::atomic<T> requires T to be a complete type");
#if !defined(BOOST_ATOMIC_DETAIL_NO_CXX11_IS_TRIVIALLY_COPYABLE)
    static_assert(atomics::detail::is_trivially_copyable< value_type >::value, "boost_kahypar::atomic<T> requires T to be a trivially copyable type");
#endif
...
typedef atomic< boost_kahypar::ulong_long_type > atomic_ullong;
typedef atomic< boost_kahypar::long_long_type > atomic_llong;
#endif
...
typedef atomic< boost_kahypar::intptr_t > atomic_intptr_t;
typedef atomic< boost_kahypar::uintptr_t > atomic_uintptr_t;
#endif
