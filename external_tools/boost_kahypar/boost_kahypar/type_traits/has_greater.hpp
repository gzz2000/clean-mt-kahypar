...
#define BOOST_TT_FORBIDDEN_IF\
   (\
      ...
      (\
         ...
         (! \
            ( \
               ::boost_kahypar::is_base_of< Lhs_noptr, Rhs_noptr >::value || \
               ::boost_kahypar::is_base_of< Rhs_noptr, Lhs_noptr >::value || \
               ::boost_kahypar::is_same< Lhs_noptr, Rhs_noptr >::value || \
      ...
      (\
         ::boost_kahypar::type_traits_detail::is_likely_stateless_lambda<Lhs_noref>::value\
      )\
   )
