...
template<> struct is_integral< ::boost_kahypar::ulong_long_type> : public true_type{};
template<> struct is_integral< ::boost_kahypar::long_long_type> : public true_type{};
...
template<> struct is_integral<boost_kahypar::int128_type> : public true_type{};
template<> struct is_integral<boost_kahypar::uint128_type> : public true_type{};
#endif
