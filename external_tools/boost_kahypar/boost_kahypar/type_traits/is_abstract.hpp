...
struct is_abstract_imp
{
   typedef is_abstract_select< ::boost_kahypar::is_class<T>::value> selector;
...
template <class T> struct is_abstract : public integral_constant<bool, ::boost_kahypar::detail::is_abstract_imp<T>::value> {};
#else
template <class T> struct is_abstract : public integral_constant<bool, ::boost_kahypar::detail::is_polymorphic_imp<T>::value> {};
#endif
