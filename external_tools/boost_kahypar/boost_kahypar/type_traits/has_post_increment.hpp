...
#define BOOST_TT_FORBIDDEN_IF\
   (\
      /* bool */\
      ::boost_kahypar::is_same< bool, Lhs_nocv >::value || \
      /* void* */\
      (\
      ...
      /* Arrays */ \
      ::boost_kahypar::is_array<Lhs_noref>::value\
      )


#include <boost_kahypar/type_traits/detail/has_postfix_operator.hpp>
...
namespace boost_kahypar {
   ...
   template <>
   struct has_post_increment<bool, boost_kahypar::binary_op_detail::dont_care> : public false_type {};
   template <>
