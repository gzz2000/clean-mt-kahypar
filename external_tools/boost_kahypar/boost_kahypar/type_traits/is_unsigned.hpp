...
{
   BOOST_STATIC_CONSTANT(bool, value = (::boost_kahypar::detail::is_unsigned_values<T>::minus_one > ::boost_kahypar::detail::is_unsigned_values<T>::zero));
};
...
struct is_unsigned
{
   typedef ::boost_kahypar::detail::is_unsigned_select_helper< ::boost_kahypar::is_integral<T>::value || ::boost_kahypar::is_enum<T>::value > selector;
...
template <class T> struct is_unsigned : public integral_constant<bool, boost_kahypar::detail::is_unsigned<T>::value> {};
...
template <> struct is_unsigned< ::boost_kahypar::ulong_long_type> : public true_type{};
template <> struct is_unsigned<const ::boost_kahypar::ulong_long_type> : public true_type{};
template <> struct is_unsigned<volatile ::boost_kahypar::ulong_long_type> : public true_type{};
template <> struct is_unsigned<const volatile ::boost_kahypar::ulong_long_type> : public true_type{};

template <> struct is_unsigned< ::boost_kahypar::long_long_type> : public false_type{};
template <> struct is_unsigned<const ::boost_kahypar::long_long_type> : public false_type{};
template <> struct is_unsigned<volatile ::boost_kahypar::long_long_type> : public false_type{};
template <> struct is_unsigned<const volatile ::boost_kahypar::long_long_type> : public false_type{};
#endif
#if defined(CHAR_MIN) 
#if CHAR_MIN == 0
