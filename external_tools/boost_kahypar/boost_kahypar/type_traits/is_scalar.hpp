...
template <typename T>
struct is_scalar
   : public integral_constant<bool, ::boost_kahypar::is_arithmetic<T>::value || ::boost_kahypar::is_enum<T>::value || ::boost_kahypar::is_pointer<T>::value || ::boost_kahypar::is_member_pointer<T>::value>
{};
