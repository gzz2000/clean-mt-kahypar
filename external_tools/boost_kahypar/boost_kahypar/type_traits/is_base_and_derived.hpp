...
{
    BOOST_STATIC_CONSTANT(bool, value =
        (::boost_kahypar::is_convertible<D*,B*>::value));
};
...
struct is_base_and_derived_impl
{
    ...
    typedef is_base_and_derived_select<
       ::boost_kahypar::is_class<B>::value,
       ::boost_kahypar::is_class<D>::value,
       ::boost_kahypar::is_same<ncvB,ncvD>::value> selector;
...
struct is_base_and_derived_impl
{
    ...
    BOOST_STATIC_CONSTANT(bool, value = (BOOST_IS_BASE_OF(B,D) && ! ::boost_kahypar::is_same<ncvB,ncvD>::value));
};
#endif
} // namespace detail

template <class Base, class Derived> struct is_base_and_derived
   : public integral_constant<bool, (::boost_kahypar::detail::is_base_and_derived_impl<Base, Derived>::value)> {};
