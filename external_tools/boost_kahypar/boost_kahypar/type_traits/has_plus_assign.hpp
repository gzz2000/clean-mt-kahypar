...
namespace boost_kahypar
{
   ...
   namespace binary_op_detail {
      ...
      struct has_plus_assign_ret_imp : public boost_kahypar::false_type {};

      template <class T, class U, class Ret>
      struct has_plus_assign_ret_imp<T, U, Ret, typename boost_kahypar::make_void<decltype(std::declval<typename add_reference<T>::type>() += std::declval<typename add_reference<U>::type>())>::type>
      ...
      struct has_plus_assign_void_imp : public boost_kahypar::false_type {};

      template <class T, class U>
      struct has_plus_assign_void_imp<T, U, typename boost_kahypar::make_void<decltype(std::declval<typename add_reference<T>::type>() += std::declval<typename add_reference<U>::type>())>::type>
      ...
      template <class T, class U, class = void>
      struct has_plus_assign_dc_imp : public boost_kahypar::false_type {};

      template <class T, class U>
      struct has_plus_assign_dc_imp<T, U, typename boost_kahypar::make_void<decltype(std::declval<typename add_reference<T>::type>() += std::declval<typename add_reference<U>::type>())>::type>
         : public boost_kahypar::true_type {};

      template <class T, class U, class Ret>
      struct has_plus_assign_filter_ret : public boost_kahypar::binary_op_detail:: has_plus_assign_ret_imp <T, U, Ret> {};
      template <class T, class U>
      struct has_plus_assign_filter_ret<T, U, void> : public boost_kahypar::binary_op_detail:: has_plus_assign_void_imp <T, U> {};
      template <class T, class U>
      struct has_plus_assign_filter_ret<T, U, boost_kahypar::binary_op_detail::dont_care> : public boost_kahypar::binary_op_detail:: has_plus_assign_dc_imp <T, U> {};

      template <class T, class U, class Ret, bool f>
      struct has_plus_assign_filter_impossible : public boost_kahypar::binary_op_detail:: has_plus_assign_filter_ret <T, U, Ret> {};
      template <class T, class U, class Ret>
      struct has_plus_assign_filter_impossible<T, U, Ret, true> : public boost_kahypar::false_type {};

   }

   template <class T, class U = T, class Ret = boost_kahypar::binary_op_detail::dont_care>
   struct has_plus_assign : public boost_kahypar::binary_op_detail:: has_plus_assign_filter_impossible <T, U, Ret, boost_kahypar::is_arithmetic<typename boost_kahypar::remove_reference<T>::type>::value && boost_kahypar::is_pointer<typename remove_reference<U>::type>::value && !boost_kahypar::is_same<bool, typename boost_kahypar::remove_cv<typename remove_reference<T>::type>::type>::value> {};
...
#define BOOST_TT_FORBIDDEN_IF\
   (\
      ...
      (\
         ::boost_kahypar::is_pointer< Rhs_noref >::value && \
         ::boost_kahypar::is_fundamental< Lhs_nocv >::value && \
         (!  ::boost_kahypar::is_same< Lhs_nocv, bool >::value )\
      ) || \
