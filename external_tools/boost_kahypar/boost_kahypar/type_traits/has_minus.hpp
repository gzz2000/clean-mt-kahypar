...
namespace boost_kahypar
{
   ...
   namespace binary_op_detail {
      ...
      struct has_minus_ret_imp : public boost_kahypar::false_type {};

      template <class T, class U, class Ret>
      struct has_minus_ret_imp<T, U, Ret, typename boost_kahypar::make_void<decltype(std::declval<typename add_reference<T>::type>() - std::declval<typename add_reference<U>::type>())>::type>
      ...
      struct has_minus_void_imp : public boost_kahypar::false_type {};

      template <class T, class U>
      struct has_minus_void_imp<T, U, typename boost_kahypar::make_void<decltype(std::declval<typename add_reference<T>::type>() - std::declval<typename add_reference<U>::type>())>::type>
      ...
      template <class T, class U, class = void>
      struct has_minus_dc_imp : public boost_kahypar::false_type {};

      template <class T, class U>
      struct has_minus_dc_imp<T, U, typename boost_kahypar::make_void<decltype(std::declval<typename add_reference<T>::type>() - std::declval<typename add_reference<U>::type>())>::type>
         : public boost_kahypar::true_type {};

      template <class T, class U, class Ret>
      struct has_minus_ret_filter : public boost_kahypar::binary_op_detail::has_minus_ret_imp <T, U, Ret> {};
      template <class T, class U>
      struct has_minus_ret_filter<T, U, void> : public boost_kahypar::binary_op_detail::has_minus_void_imp <T, U> {};
      template <class T, class U>
      struct has_minus_ret_filter<T, U, boost_kahypar::binary_op_detail::dont_care> : public boost_kahypar::binary_op_detail::has_minus_dc_imp <T, U> {};

      template <class T, class U, class Ret, bool b>
      struct has_minus_void_ptr_filter : public boost_kahypar::binary_op_detail::has_minus_ret_filter <T, U, Ret> {};
      template <class T, class U, class Ret>
      struct has_minus_void_ptr_filter<T, U, Ret, true> : public boost_kahypar::false_type {};

   }

   template <class T, class U = T, class Ret = boost_kahypar::binary_op_detail::dont_care>
   struct has_minus : 
      public boost_kahypar::binary_op_detail::has_minus_void_ptr_filter<
         T, U, Ret, 
...
#define BOOST_TT_FORBIDDEN_IF\
   (\
      ...
      (\
         ::boost_kahypar::is_pointer< Lhs_noref >::value && \
         ::boost_kahypar::is_pointer< Rhs_noref >::value && \
         (!  ::boost_kahypar::is_same< Lhs_nocv, Rhs_nocv >::value )\
      )\
      )

#define BOOST_TT_FORBIDDEN_IF_NEW (boost_kahypar::is_void<typename remove_pointer<typename boost_kahypar::remove_reference<T>::type>::type>::value || boost_kahypar::is_void<typename remove_pointer<typename boost_kahypar::remove_reference<U>::type>::type>::value)
