...
namespace boost_kahypar {
   ...
   namespace detail
   {
      ...
      template <class T>          struct has_nothrow_assign_imp<T, false, true>{ static const bool value = noexcept(boost_kahypar::declval<typename add_reference<T>::type>() = boost_kahypar::declval<typename add_reference<T const>::type>()); };
   ...
   struct has_nothrow_assign : public integral_constant < bool,
      ...
      >::value
#else
      ::boost_kahypar::has_trivial_assign<T>::value
#endif
#else
