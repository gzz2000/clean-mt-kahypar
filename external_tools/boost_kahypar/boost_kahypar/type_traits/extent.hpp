...
{
   BOOST_STATIC_CONSTANT(std::size_t, value = (::boost_kahypar::detail::extent_imp<T, N-1>::value));
};
...
struct extent
   : public ::boost_kahypar::integral_constant<std::size_t, ::boost_kahypar::detail::extent_imp<T,N>::value>
{
};
