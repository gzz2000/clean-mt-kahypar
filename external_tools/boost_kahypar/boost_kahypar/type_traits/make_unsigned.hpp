...
{
private:
   BOOST_STATIC_ASSERT_MSG((::boost_kahypar::is_integral<T>::value || ::boost_kahypar::is_enum<T>::value), "The template argument to make_unsigned must be an integer or enum type.");
   BOOST_STATIC_ASSERT_MSG((! ::boost_kahypar::is_same<typename remove_cv<T>::type, bool>::value), "The template argument to make_unsigned must not be the type bool");

   typedef typename remove_cv<T>::type t_no_cv;
   typedef typename conditional<
      (::boost_kahypar::is_unsigned<T>::value && ::boost_kahypar::is_integral<T>::value 
            ...
            typename conditional<
               ...
               typename conditional<
                  ...
                  typename conditional<
                     ...
                     typename conditional<
                        sizeof(t_no_cv) == sizeof(boost_kahypar::ulong_long_type), 
