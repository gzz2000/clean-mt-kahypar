...
{
   typedef is_polymorphic_selector< ::boost_kahypar::is_class<T>::value> selector;
...
template <class T> struct is_polymorphic : public integral_constant<bool, ::boost_kahypar::detail::is_polymorphic_imp<T>::value> {};
