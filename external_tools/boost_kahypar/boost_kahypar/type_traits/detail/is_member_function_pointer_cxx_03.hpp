...
#define BOOST_TT_IS_MEMBER_FUNCTION_POINTER_CXX_03_HPP_INCLUDED
   ...
   //
#   include <boost_kahypar/type_traits/detail/is_mem_fun_pointer_impl.hpp>
...
#   include <boost_kahypar/type_traits/detail/is_mem_fun_pointer_tester.hpp>
#endif
...
template <class T> struct is_member_function_pointer 
   : public ::boost_kahypar::integral_constant<bool, ::boost_kahypar::type_traits::is_mem_fun_pointer_impl<typename remove_cv<T>::type>::value>{};
...
#pragma warning(disable:6334)
        ...
        BOOST_STATIC_CONSTANT(
            bool, value = (
                1 == sizeof(::boost_kahypar::type_traits::is_mem_fun_pointer_tester(self_type::make_t))
            ));
#if BOOST_WORKAROUND(BOOST_MSVC_FULL_VER, >= 140050000)
#pragma warning(pop)
#endif
...
struct is_member_function_pointer_impl
    : public is_mem_fun_pointer_select< 
      ::boost_kahypar::is_reference<T>::value || ::boost_kahypar::is_array<T>::value>::template result_<T>{};
...
struct is_member_function_pointer
   : public integral_constant<bool, ::boost_kahypar::detail::is_member_function_pointer_impl<T>::value>{};
