...
template<class C1, class C2> struct common_member_class
{
    typedef typename boost_kahypar::conditional<
        ...
        boost_kahypar::is_base_of<C1, C2>::value,
        C2,
        typename boost_kahypar::conditional<boost_kahypar::is_base_of<C2, C1>::value, C1, void>::type
...
private:
    ...
    typedef typename boost_kahypar::remove_pointer<CPT>::type CT;
