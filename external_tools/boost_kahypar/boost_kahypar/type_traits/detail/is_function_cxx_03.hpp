...
#   include <boost_kahypar/type_traits/detail/is_function_ptr_helper.hpp>
#else
#   include <boost_kahypar/type_traits/detail/is_function_ptr_tester.hpp>
...
{
    template< typename T > struct result_
        : public ::boost_kahypar::type_traits::is_function_ptr_helper<T*> {};
};

template <typename T>
struct is_function_impl
    : public is_function_chooser< ::boost_kahypar::is_reference<T>::value >
...
#pragma warning(disable:6334)
    ...
    BOOST_STATIC_CONSTANT(
        bool, value = sizeof(::boost_kahypar::type_traits::is_function_ptr_tester(t))
...
#else
template <class T> struct is_function : integral_constant<bool, ::boost_kahypar::detail::is_function_impl<T>::value> {};
#ifndef BOOST_NO_CXX11_RVALUE_REFERENCES
...
#include <boost_kahypar/type_traits/detail/is_function_msvc10_fix.hpp>
#endif
