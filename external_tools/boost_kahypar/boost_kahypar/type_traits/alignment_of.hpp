...
struct alignment_of_impl
{
    ...
    BOOST_STATIC_CONSTANT(std::size_t, value =
        (::boost_kahypar::detail::alignment_logic<
            sizeof(::boost_kahypar::detail::alignment_of_hack<T>) - sizeof(T),
            __alignof(T)
        >::value));
...
template <class T> struct alignment_of : public integral_constant<std::size_t, ::boost_kahypar::detail::alignment_of_impl<T>::value>{};
