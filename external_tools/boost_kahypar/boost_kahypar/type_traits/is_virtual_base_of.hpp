...
#pragma GCC system_header
      ...
      template<class T, class U,
         typename boost_kahypar::make_void<decltype((U*)(std::declval<T*>()))>::type* =
         nullptr>
   ...
   struct is_virtual_base_of : public
      boost_kahypar::integral_constant<
      bool,
      boost_kahypar::is_base_of<T, U>::value &&
   ...
   {
      typedef boost_kahypar::integral_constant<bool, (boost_kahypar::is_base_of<Base, Derived>::value && !boost_kahypar::is_same<Base, Derived>::value)> tag_type;
...
template <class Base, class Derived> struct is_virtual_base_of : public integral_constant<bool, (::boost_kahypar::detail::is_virtual_base_of_impl2<Base, Derived>::value)> {};
