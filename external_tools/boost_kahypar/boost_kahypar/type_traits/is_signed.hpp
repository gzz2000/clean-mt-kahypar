...
{
   typedef typename remove_cv<T>::type no_cv_t;
   BOOST_STATIC_CONSTANT(bool, value = (!(::boost_kahypar::detail::is_signed_values<T>::minus_one  > boost_kahypar::detail::is_signed_values<T>::zero)));
};
...
{
   typedef ::boost_kahypar::detail::is_signed_select_helper< ::boost_kahypar::is_integral<T>::value || ::boost_kahypar::is_enum<T>::value> selector;
...
template <class T> struct is_signed : public integral_constant<bool, boost_kahypar::detail::is_signed_impl<T>::value> {};
...
template <> struct is_signed< ::boost_kahypar::long_long_type> : public true_type{};
template <> struct is_signed<const ::boost_kahypar::long_long_type> : public true_type{};
template <> struct is_signed<volatile ::boost_kahypar::long_long_type> : public true_type{};
template <> struct is_signed<const volatile ::boost_kahypar::long_long_type> : public true_type{};

template <> struct is_signed< ::boost_kahypar::ulong_long_type> : public false_type{};
template <> struct is_signed<const ::boost_kahypar::ulong_long_type> : public false_type{};
template <> struct is_signed<volatile ::boost_kahypar::ulong_long_type> : public false_type{};
template <> struct is_signed<const volatile ::boost_kahypar::ulong_long_type> : public false_type{};
#endif
#if defined(CHAR_MIN) 
#if CHAR_MIN != 0
