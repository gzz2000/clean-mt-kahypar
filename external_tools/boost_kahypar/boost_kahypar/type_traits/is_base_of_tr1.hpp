...
namespace boost_kahypar { namespace tr1{
   ...
   namespace detail{
      ...
      struct is_base_of_imp
      {
          ...
          BOOST_STATIC_CONSTANT(bool, value = ((::boost_kahypar::detail::is_base_and_derived_impl<ncvB,ncvD>::value) || (::boost_kahypar::is_same<ncvB,ncvD>::value)));
      };
   }

   template <class Base, class Derived> struct is_base_of
      : public integral_constant<bool, (::boost_kahypar::tr1::detail::is_base_of_imp<Base, Derived>::value)>{};
