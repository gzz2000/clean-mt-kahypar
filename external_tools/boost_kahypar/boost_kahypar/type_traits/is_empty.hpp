...
struct is_empty_impl
{
    ...
    BOOST_STATIC_CONSTANT(
        bool, 
        value = ( ::boost_kahypar::detail::empty_helper<cvt,::boost_kahypar::is_class<T>::value>::value || BOOST_INTERNAL_IS_EMPTY(cvt)));
};
...
struct is_empty_impl
{
   ...
   BOOST_STATIC_CONSTANT(
       bool, value = (
              ::boost_kahypar::detail::empty_helper<
                  cvt
                , ::boost_kahypar::is_class<T>::value
                , ::boost_kahypar::is_convertible< r_type,int>::value
...
template <class T> struct is_empty : integral_constant<bool, ::boost_kahypar::detail::is_empty_impl<T>::value> {};
