...
#  define BOOST_TT_CXX11_IS_CONVERTIBLE
   ...
   template<typename From, typename To, bool b = or_helper<boost_kahypar::is_void<From>, boost_kahypar::is_function<To>, boost_kahypar::is_array<To> >::value>
   ...
   class is_convertible_basic_impl<From, To, false>
   {
      ...
      static decltype(test_aux<To1>(boost_kahypar::declval<From1>()), one()) test(int);
...
#pragma option push -w-8074
    ...
    {
        static ::boost_kahypar::type_traits::no_type BOOST_TT_DECL _m_check(...);
        static ::boost_kahypar::type_traits::yes_type BOOST_TT_DECL _m_check(T);
    };
...
template <typename T> struct checker
{
    static boost_kahypar::type_traits::no_type _m_check(any_conversion ...);
    static boost_kahypar::type_traits::yes_type _m_check(T, int);
};
...
struct is_convertible_basic_impl
{
    ...
    static bool const value =
        sizeof( boost_kahypar::detail::checker<To>::_m_check(static_cast<rvalue_type>(_m_from), 0) )
        == sizeof(::boost_kahypar::type_traits::yes_type);
#else
    static bool const value =
        sizeof( boost_kahypar::detail::checker<To>::_m_check(_m_from, 0) )
        == sizeof(::boost_kahypar::type_traits::yes_type);
#endif
};
...
struct is_convertible_basic_impl
{
    static ::boost_kahypar::type_traits::no_type BOOST_TT_DECL _m_check(any_conversion ...);
    static ::boost_kahypar::type_traits::yes_type BOOST_TT_DECL _m_check(To, int);
    typedef typename add_lvalue_reference<From>::type lvalue_type;
    typedef typename add_rvalue_reference<From>::type rvalue_type; 
    static lvalue_type _m_from;
    ...
    BOOST_STATIC_CONSTANT(bool, value =
        sizeof( _m_check(static_cast<rvalue_type>(_m_from), 0) ) == sizeof(::boost_kahypar::type_traits::yes_type)
        );
#else
    BOOST_STATIC_CONSTANT(bool, value =
        sizeof( _m_check(_m_from, 0) ) == sizeof(::boost_kahypar::type_traits::yes_type)
        );
#endif
};
...
struct is_convertible_basic_impl
{
    ...
    template <class T>
    static ::boost_kahypar::type_traits::no_type BOOST_TT_DECL _m_check(any_conversion,  float, T);
    static ::boost_kahypar::type_traits::yes_type BOOST_TT_DECL _m_check(To, int, int);
    typedef typename add_lvalue_reference<From>::type lvalue_type;
    typedef typename add_rvalue_reference<From>::type rvalue_type;
    static lvalue_type _m_from;
...
#ifndef BOOST_NO_CXX11_RVALUE_REFERENCES
    enum { value =
        sizeof( _m_check(static_cast<rvalue_type>(_m_from), 0, 0) ) == sizeof(::boost_kahypar::type_traits::yes_type)
        };
#else
    enum { value =
        sizeof( _m_check(_m_from, 0, 0) ) == sizeof(::boost_kahypar::type_traits::yes_type)
        };
#endif
};
...
{
    static ::boost_kahypar::type_traits::no_type BOOST_TT_DECL _m_check(...);
    static ::boost_kahypar::type_traits::yes_type BOOST_TT_DECL _m_check(To);
    typedef typename add_lvalue_reference<From>::type lvalue_type;
    typedef typename add_rvalue_reference<From>::type rvalue_type;
    static lvalue_type _m_from;
#ifndef BOOST_NO_CXX11_RVALUE_REFERENCES
    BOOST_STATIC_CONSTANT(bool, value =
        sizeof( _m_check(static_cast<rvalue_type>(_m_from)) ) == sizeof(::boost_kahypar::type_traits::yes_type)
        );
#else
    BOOST_STATIC_CONSTANT(bool, value =
        sizeof( _m_check(_m_from) ) == sizeof(::boost_kahypar::type_traits::yes_type)
        );
#endif
};
...
struct is_convertible_basic_impl:
  is_convertible_basic_impl_aux<
    From,To,
    ::boost_kahypar::is_function<typename ::boost_kahypar::remove_reference<From>::type>::value
  >
{};
...
{
    enum { 
       value = ( ::boost_kahypar::detail::is_convertible_basic_impl<From,To>::value && ! ::boost_kahypar::is_array<To>::value && ! ::boost_kahypar::is_function<To>::value) 
    };
};
...
struct is_convertible_impl
{
   BOOST_STATIC_CONSTANT(bool, value = ( ::boost_kahypar::detail::is_convertible_basic_impl<From, To>::value && !::boost_kahypar::is_array<To>::value && !::boost_kahypar::is_function<To>::value));
};
#endif
...
struct is_convertible_impl_dispatch_base
{
   ...
   typedef is_convertible_impl_select< 
      ::boost_kahypar::is_arithmetic<From>::value, 
      ::boost_kahypar::is_arithmetic<To>::value,
      ...
      ::boost_kahypar::is_abstract<To>::value
#else
      false
#endif
   > selector;
...
template <class From, class To> 
struct is_convertible : public integral_constant<bool, ::boost_kahypar::detail::is_convertible_impl_dispatch<From, To>::value> 
{
   BOOST_STATIC_ASSERT_MSG(boost_kahypar::is_complete<To>::value || boost_kahypar::is_void<To>::value || boost_kahypar::is_array<To>::value, "Destination argument type to is_convertible must be a complete type");
   BOOST_STATIC_ASSERT_MSG(boost_kahypar::is_complete<From>::value || boost_kahypar::is_void<From>::value || boost_kahypar::is_array<From>::value, "From argument type to is_convertible must be a complete type");
};
...
struct is_convertible : public integral_constant<bool, BOOST_IS_CONVERTIBLE(From, To)> 
{
   ...
   BOOST_STATIC_ASSERT_MSG(boost_kahypar::is_complete<From>::value || boost_kahypar::is_void<From>::value || boost_kahypar::is_array<From>::value || boost_kahypar::is_reference<From>::value, "From argument type to is_convertible must be a complete type");
#endif
